...
requestBody.source.identity.application.additionalData = new Map<string, unknown>([
					["@odata.type", "#microsoft.graph.identity"]
				]);
requestBody.source.identity.additionalData = new Map<string, unknown>([
				["@odata.type", "#microsoft.graph.identitySet"]
			]);
requestBody.source.region = null,
requestBody.source.languageId = null,
requestBody.source.additionalData = new Map<string, unknown>([
...
requestBody.mediaConfig.additionalData = new Map<string, unknown>([

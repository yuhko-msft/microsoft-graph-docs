...
Choose one of the following least privileged permissions to call this method. If necessary, you can consider other possible permissions that have a higher privilege. Delegated permissions for personal Microsoft accounts and applications are not supported for this method. For more information, see [User permissions](/graph/permissions-reference#user-permissions).

...
-->
``` http
GET https://graph.microsoft.com/v1.0/me/tasks/lists/delta
```
...
{
    "@odata.context": "https://graph.microsoft.com/v1.0/$metadata#Collection(baseTaskList)",
    "@odata.nextLink": "https://graph.microsoft.com/v1.0/me/tasks/lists/delta?$skiptoken=AVCnFFj2r7PtnjtkD-g_6Y5Ntek1m4V",
    "value": [
        {

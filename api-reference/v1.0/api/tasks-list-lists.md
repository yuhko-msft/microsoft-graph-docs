...
This method supports the `$expand`, `$filter`, and `$top`  [OData query parameters](/graph/query-parameters) to customize the response.
...
-->
``` http
GET https://graph.microsoft.com/v1.0/me/tasks/lists
```

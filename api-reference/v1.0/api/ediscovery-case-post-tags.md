...
The following table shows the properties that are required when you create a [tag](../resources/ediscovery-tag.md).
...
``` http
POST https://graph.microsoft.com/v1.0/compliance/ediscovery/cases/47746044-fd0b-4a30-acfc-5272b691ba5b/tags
...

{
  ...
  "parent@odata.bind":"https://graph.microsoft.com/v1.0/compliance/ediscovery/cases/47746044-fd0b-4a30-acfc-5272b691ba5b/tags/98fdad78bbce4519b75474bc150575c3"
}
```

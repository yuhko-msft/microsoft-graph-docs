...
|wellKnownListName|wellKnownListName_v2|Property that indicates the list name if the given list is a well-known list. The possible values are: `none`, `defaultList`, `flaggedEmails`, `unknownFutureValue`.|

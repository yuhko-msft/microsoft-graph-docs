...
Represents a subtask in a bigger [baseTask](./baseTask.md). A **checklistItem** allows breaking down a complex task into more actionable, smaller tasks.
...
|displayName|String|Field that indicates the title of **checklistItem**.|

...
>
> Limitations apply when this API is called in app-only context. For more details, see [known issues](/graph/known-issues#missing-functionality-when-teams-apps-in-the-app-catalog-are-listed-using-app-only-context).

...
>
> There are limitations when this API is called in app-only context. For more details, see the [known issues](../../../concepts/known-issues.md#Missing-functionality-when-Teams-Apps-in-the-app-catalog-are-listed-using-app-only-context).

...
> **Note:** There are limitations when this API is called in app context. For more details, see [known issues with Microsoft Graph Teamwork](../../../concepts/known-issues.md).

...
>
> There are limitations when this API is called in app-only context. For more details, see [known issues](/graph/concepts/known-issues#Missing-functionality-when-Teams-Apps-in-the-app-catalog-are-listed-using-app-only-context).

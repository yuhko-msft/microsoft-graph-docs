...
-->
``` http
POST /user/tasks/lists/{wellKnownTaskListId}/tasks/{taskId}/checklistItems
```
...
-->
``` http
POST https://graph.microsoft.com/beta/user/tasks/lists/{wellKnownTaskListId}/tasks/{taskId}/checklistItems

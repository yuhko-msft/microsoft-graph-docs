...
|[print](../resources/printtaskdefinition.md) | Not supported | Not supported | PrintTaskDefinition.ReadWrite.All |
...
|[Print](../resources/printtaskdefinition.md)|`print/taskDefinitions/{id}/tasks`|

...
description: "Get the number of Microsoft Teams activity by activity type. The numbers include activities for both licensed and non-licensed users."
...
Get the number of Microsoft Teams activity by activity type. The numbers include activities for both licensed and non-licensed users.
...
```http
GET /reports/getTeamsTeamActivityDetail(period='D7')
```

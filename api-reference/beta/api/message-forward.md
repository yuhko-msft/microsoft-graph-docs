...
|mimeContent|String|Base64-encoded MIME content of message to send in reply.|
...
The following example shows how to forward a message and define the MIME content in the message.

<!-- {
  "blockType": "request",
  "name": "message_forward_with_mime_content"
}-->

...
description: "List the AAD users whose profile data is shared with external tenants."
author: "adimitui"
...
List the AAD users whose profile data is shared with external tenants.

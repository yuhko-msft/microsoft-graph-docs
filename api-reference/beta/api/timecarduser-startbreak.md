...
description: "[Documentation in Progress] Start break in a specific timecard. This particular API is protected by Intune and storage is by Intune, and it utilizes Intune Conditional Launch Policy to block applications after you clock out""
author: "esmathur"
...
Start a break in a specific [timeCardUser](../resources/timeCardUser.md).
...
```http
POST /users/{userId}/schedule/timecards/endBreak
```

...
-->
``` http
GET /user/tasks/lists/{wellKnownTaskListId}/tasks/{taskId}/checklistItems
```
...
-->
``` http
GET https://graph.microsoft.com/beta/user/tasks/lists/{wellKnownTaskListId}/tasks/{taskId}/checklistItems
```

...
[Message tracing](/microsoft-365/security/office-365-security/message-trace-scc?view=o365-worldwide&preserve-view=true) is a service offered as part of [Microsoft Defender for Office 365](/microsoft-365/security/office-365-security/defender-for-office-365?view=o365-worldwide&preserve-view=true), and is available in the Microsoft 365 Defender portal ([https://security.microsoft.com/](https://security.microsoft.com/)) and Exchange Admin Center ([https://admin.exchange.microsoft.com](https://admin.exchange.microsoft.com/#/messagetrace)). The message trace API allows apps to track email messages as they flow through your Exchange Online organization. You can determine if a message was received, rejected, deferred, or delivered by the service. It also shows what actions were taken on the message before it reached its final status. The information from message trace helps determining what happened to messages, troubleshooting mail flow issues, and validating policy changes.
...
| **Message trace (preview)**|||
|Get message trace| [Get message trace](../api/messagetrace-get.md) preview | [https://graph.microsoft.com/beta/admin/exchange/messageTraces](https://developer.microsoft.com/graph/graph-explorer?request=admin/exchange/messageTraces&method=GET&version=beta&GraphUrl=https://graph.microsoft.com) |
| **Secure scores**|||

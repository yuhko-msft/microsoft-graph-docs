...
| **Message trace (preview)**|||
|List message traces| [List messageTraces](../api/exchangeadmin-list-messagetraces.md) preview | [https://graph.microsoft.com/beta/admin/exchange/messageTraces](https://developer.microsoft.com/graph/graph-explorer?request=admin/exchange/messageTraces&method=GET&version=beta&GraphUrl=https://graph.microsoft.com) |
| **Secure scores**|||

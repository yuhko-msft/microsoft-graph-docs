...
|alertDetections|[alertDetection](alertdetection.md) collection|The pertinent information of detections related to the alert.|
...
|investigationSecurityStates|[investigationSecurityState](investigationsecuritystate.md) collection|Investigation state for the alert.|
...
|messageSecurityStates|[messageSecurityState](messagesecuritystate.md) collection|Security pertinent information for message entities that are related to the alert.|
...
|uriClickSecurityStates|[uriClickSecurityState](uriclicksecuritystate.md) collection|URI Click information (malicious and benign ones) that are related to the alert.|
...
```json
{
  ...
  "alertDetections": [{"@odata.type": "microsoft.graph.alertDetection"}],
  "assignedTo": "String",
  ...
  "incidentIds": ["String"],
  "investigationSecurityStates": [{"@odata.type": "microsoft.graph.investigationSecurityState"}],
  "lastModifiedDateTime": "String (timestamp)",
  "malwareStates": [{"@odata.type": "microsoft.graph.malwareState"}],
  "messageSecurityStates": [{"@odata.type": "microsoft.graph.messageSecurityState"}],
  ...
  "uriClickSecurityStates": [{"@odata.type": "microsoft.graph.uriClickSecurityState"}],

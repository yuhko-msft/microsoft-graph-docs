...
| Non-custodial data source | [microsoft.graph.ediscovery.noncustodialDataSource](ediscovery-noncustodialdatasource.md) | Non-custodial data sources let you add data to a case without the need to associate it to a custodian. To learn more, see [Add non-custodial data sources to an Advanced eDiscovery case](/microsoft-365/compliance/non-custodial-data-sources). |

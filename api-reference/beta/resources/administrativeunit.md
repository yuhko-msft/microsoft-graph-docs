...
|membershipRule|string|Specifies the rule using which Dynamic Member|
|membershipType|string|Specifies how memberships are handled for the Administrative Unit. Possible values are 'Assigned' and 'Dynamic'.|

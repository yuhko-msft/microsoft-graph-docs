...
| [Get transitiveReports count](../api/directoryobject-gettransitivereportscount.md) | Integer | Get the transitive reports count for a user from the transitiveReports navigation property. |

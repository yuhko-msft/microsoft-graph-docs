...
| [Get transitiveReports count](../api/directoryobject-gettransitivereportscount.md) | [directoryObject](directoryobject.md) collection | Get the transitive reports count for a user from the transitiveReports navigation property. |

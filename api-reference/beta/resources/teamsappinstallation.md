...
|[Install app in chat](../api/chat-add-installedApp.md) | [teamsAppInstallation](teamsappinstallation.md) collection | Adds (installs) an app to a chat or meeting.|
|[List apps in chat](../api/chat-list-installedApps.md) |None | Lists apps in a chat.|
|[Get app in chat](../api/chat-get-installedApp.md) | None | Lists apps installed in the personal scope of a user.|
|[Update an app in chat](../api/chat-update-installedApp.md) | None | Update to the latest version of the app installed in chat.|
|[Uninstall app from chat](../api/chat-delete-installedApp.md) | [teamsAppInstallation](teamsappinstallation.md) collection | Removes (uninstalls) app from a chat.|

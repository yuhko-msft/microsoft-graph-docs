...
|deviceProperties|[keyValuePair_2OfString_String](../resources/intune-policyset-keyvaluepair_2ofstring_string.md) collection|Device properties used for filter evaluation during device check-in time.|

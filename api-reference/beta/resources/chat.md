...
|[Send activity notification](../api/chat-sendactivitynotification.md) | None | Send an activity feed notification to the members of the chat. | Delegated and application* |

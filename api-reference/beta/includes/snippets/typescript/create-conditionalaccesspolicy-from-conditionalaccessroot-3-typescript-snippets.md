...
requestBody.conditions.deviceStates = new ConditionalAccessDeviceStates();
requestBody.conditions.deviceStates.includeStates = [
					"All"
				]
requestBody.conditions.deviceStates.excludeStates = [
					"Compliant"
				]
...
requestBody.sessionControls.cloudAppSecurity.cloudAppSecurityType = "blockDownloads";
requestBody.sessionControls.cloudAppSecurity.isEnabled = true;
requestBody.sessionControls.signInFrequency = new SignInFrequencySessionControl();
requestBody.sessionControls.signInFrequency.value = 4;
requestBody.sessionControls.signInFrequency.type = "hours";
requestBody.sessionControls.signInFrequency.isEnabled = true;
const result = async () => {

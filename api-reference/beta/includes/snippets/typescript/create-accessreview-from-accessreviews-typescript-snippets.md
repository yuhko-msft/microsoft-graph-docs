...
const accessreviewreviewer = new AccessReviewReviewer();
accessreviewreviewer.additionalData = new Map<string, unknown>([
					["id", "f260246a-09b1-4fd5-8d18-daed736071ec"]
				]);
const accessreviewreviewer1 = new AccessReviewReviewer();
accessreviewreviewer1.additionalData = new Map<string, unknown>([

...
requestBody.defaultLocation.address.additionalData = new Map<string, unknown>([
...
requestBody.defaultLocation.additionalData = new Map<string, unknown>([
...
bookingreminder.additionalData = new Map<string, unknown>([
...
requestBody.schedulingPolicy.additionalData = new Map<string, unknown>([

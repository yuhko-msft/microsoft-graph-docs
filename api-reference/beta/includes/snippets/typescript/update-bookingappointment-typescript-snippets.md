...
requestBody.end.additionalData = new Map<string, unknown>([
...
requestBody.invoiceDate.additionalData = new Map<string, unknown>([
			["@odata.type", "#microsoft.graph.dateTimeTimeZone"]
		]);
...
requestBody.start.additionalData = new Map<string, unknown>([
			["@odata.type", "#microsoft.graph.dateTimeTimeZone"]
		]);

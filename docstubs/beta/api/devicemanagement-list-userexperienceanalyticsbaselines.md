...
Get the userExperienceAnalyticsBaseline objects from an userExperienceAnalyticsBaselines navigation property.
...
<!-- {
  "blockType": "request",
  "name": "list_userexperienceanalyticsbaselines"
}
-->

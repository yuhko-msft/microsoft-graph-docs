...
If successful, this method returns a `201 Created` response code and an unifiedRoleAssignmentMultiple object in the response body.
...
<!-- {
  "blockType": "request",
  "name": "create_unifiedroleassignmentmultiple"
}
-->

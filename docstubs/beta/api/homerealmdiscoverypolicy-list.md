---
title: "List homeRealmDiscoveryPolicy"
description: ""
...
Get a list of the homeRealmDiscoveryPolicy objects and their properties.
...
```http
GET https://graph.microsoft.com/beta/applications/{id}/homeRealmDiscoveryPolicies/{id}

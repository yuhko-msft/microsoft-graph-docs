...
Get a list of the deviceInstallState objects and their properties.
...
```http
GET https://graph.microsoft.com/beta/deviceAppManagement/managedEBooks/{id}/deviceStates/{id}

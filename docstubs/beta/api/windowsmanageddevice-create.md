...
Create a new windowsManagedDevice object.
...
The following table shows the properties that are required when you create a windowsManagedDevice object.
...
If successful, this method returns a `201 Created` response code and a windowsManagedDevice object in the response body.
...
<!-- {
  "blockType": "request",
  "name": "create_windowsmanageddevice"
}
-->

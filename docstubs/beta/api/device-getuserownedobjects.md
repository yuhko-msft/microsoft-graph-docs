---
title: "device : getUserOwnedObjects"
description: ""
...
<!-- {
  "blockType": "request",
  "name": "device_getuserownedobjects"
}
-->

```http
POST https://graph.microsoft.com/beta/devices/{id}/getUserOwnedObjects

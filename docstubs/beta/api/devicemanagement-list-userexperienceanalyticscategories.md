...
Get the userExperienceAnalyticsCategory objects from an userExperienceAnalyticsCategories navigation property.
...
<!-- {
  "blockType": "request",
  "name": "list_userexperienceanalyticscategories"
}
-->

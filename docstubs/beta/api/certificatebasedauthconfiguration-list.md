...
Get a list of the certificateBasedAuthConfiguration objects and their properties.
...
```http
GET https://graph.microsoft.com/beta/certificateBasedAuthConfiguration/{id}

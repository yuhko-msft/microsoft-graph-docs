...
If successful, this method returns a `201 Created` response code and a reviewSet object in the response body.
...
<!-- {
  "blockType": "request",
  "name": "create_reviewset"
}
-->

```http
POST https://graph.microsoft.com/beta/compliance/ediscovery/cases/{id}/reviewSets/{id}

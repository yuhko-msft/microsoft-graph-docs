...
```http
/deviceManagement/userExperienceAnalyticsDevicePerformance/{id}/summarizeDevicePerformanceDevices
...
```http
GET https://graph.microsoft.com/beta/deviceManagement/userExperienceAnalyticsDevicePerformance/{id}/summarizeDevicePerformanceDevices

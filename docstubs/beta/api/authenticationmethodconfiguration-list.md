---
title: "List authenticationMethodConfiguration"
description: ""
...
Get a list of the authenticationMethodConfiguration objects and their properties.
...
```http
GET https://graph.microsoft.com/beta/authenticationMethodConfigurations/{id}

...
If successful, this method returns a `201 Created` response code and an organizationalBranding object in the response body.
...
<!-- {
  "blockType": "request",
  "name": "create_organizationalbranding"
}
-->

```http
POST https://graph.microsoft.com/beta/branding

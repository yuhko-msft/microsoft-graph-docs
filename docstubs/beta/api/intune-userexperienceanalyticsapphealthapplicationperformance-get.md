...
Read the properties and relationships a userExperienceAnalyticsAppHealthApplicationPerformance object.
...
```http
GET https://graph.microsoft.com/beta/deviceManagement/userExperienceAnalyticsAppHealthApplicationPerformance/{id}

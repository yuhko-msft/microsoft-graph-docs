---
title: "List userInstallStateSummary"
description: ""
...
Get a list of the userInstallStateSummary objects and their properties.
...
```http
GET https://graph.microsoft.com/beta/deviceAppManagement/managedEBooks/{id}/userStateSummary/{id}

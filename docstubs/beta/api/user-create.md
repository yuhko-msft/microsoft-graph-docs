...
```http
/users/{id}
/deviceManagement/managedDevices/{id}/users/{id}
/deviceManagement/comanagedDevices/{id}/users/{id}
...
In the request body, supply JSON representation of the user object.

...
In the request body, supply JSON representation of the userExperienceAnalyticsMetricHistory object.
...
```http
POST https://graph.microsoft.com/beta/deviceManagement/userExperienceAnalyticsMetricHistory/{id}

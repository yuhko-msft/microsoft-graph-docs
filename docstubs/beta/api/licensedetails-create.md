...
If successful, this method returns a `201 Created` response code and a licenseDetails object in the response body.
...
<!-- {
  "blockType": "request",
  "name": "create_licensedetails"
}
-->

```http
POST https://graph.microsoft.com/beta/me/licenseDetails/{id}

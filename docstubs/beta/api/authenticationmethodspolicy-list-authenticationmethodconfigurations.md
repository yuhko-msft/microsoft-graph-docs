...
Get the authenticationMethodConfiguration objects from an authenticationMethodConfigurations navigation property.
...
<!-- {
  "blockType": "request",
  "name": "list_authenticationmethodconfigurations"
}
-->

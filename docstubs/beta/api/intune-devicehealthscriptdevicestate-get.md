...
Read the properties and relationships a deviceHealthScriptDeviceState object.
...
```http
GET https://graph.microsoft.com/beta/deviceManagement/deviceHealthScripts/{id}/deviceRunStates/{id}

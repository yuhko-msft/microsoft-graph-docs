...
Get a list of the outlookCategory objects and their properties.
...
```http
GET https://graph.microsoft.com/beta/users/{id}/outlook/masterCategories/{id}

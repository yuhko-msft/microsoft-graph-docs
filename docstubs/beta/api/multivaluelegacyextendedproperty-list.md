---
title: "List multiValueLegacyExtendedProperty"
description: ""
...
Get a list of the multiValueLegacyExtendedProperty objects and their properties.
...
```http
GET https://graph.microsoft.com/beta/users/{id}/calendar/multiValueExtendedProperties/{id}

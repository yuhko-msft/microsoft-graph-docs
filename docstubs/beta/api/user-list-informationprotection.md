...
Get the informationProtection objects from an informationProtection navigation property.
...
If successful, this method returns a `200 Ok` response code and an informationProtection object in the response body.

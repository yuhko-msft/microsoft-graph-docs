---
title: "Create deviceRegistrationPolicy"
description: ""
...
# Create deviceRegistrationPolicy

Namespace: microsoft.graph

[!INCLUDE [beta-disclaimer](../../includes/beta-disclaimer.md)]

Create a new deviceRegistrationPolicy object.
...
If successful, this method returns a `201 Created` response code and a deviceRegistrationPolicy object in the response body.
...
<!-- {
  "blockType": "request",
  "name": "create_deviceregistrationpolicy"
}
-->

```http
POST https://graph.microsoft.com/beta/deviceRegistrationPolicy

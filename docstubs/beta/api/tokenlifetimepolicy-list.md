---
title: "List tokenLifetimePolicy"
description: ""
...
Get a list of the tokenLifetimePolicy objects and their properties.
...
```http
GET https://graph.microsoft.com/beta/applications/{id}/tokenLifetimePolicies/{id}

...
If successful, this method returns a `201 Created` response code and an eBookInstallSummary object in the response body.
...
<!-- {
  "blockType": "request",
  "name": "create_ebookinstallsummary"
}
-->

```http
POST https://graph.microsoft.com/beta/deviceAppManagement/managedEBooks/{id}/installSummary

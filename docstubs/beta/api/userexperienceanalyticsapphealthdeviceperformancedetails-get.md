...
Read the properties and relationships an userExperienceAnalyticsAppHealthDevicePerformanceDetails object.
...
```http
GET https://graph.microsoft.com/beta/deviceManagement/userExperienceAnalyticsAppHealthDevicePerformanceDetails/{id}

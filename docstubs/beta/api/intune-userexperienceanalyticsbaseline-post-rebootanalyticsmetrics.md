---
title: "Add rebootAnalyticsMetrics"
description: ""
...
# Add rebootAnalyticsMetrics

Namespace: microsoft.graph

[!INCLUDE [beta-disclaimer](../../includes/beta-disclaimer.md)]

Add userExperienceAnalyticsCategory by posting to the userExperienceAnalyticsCategory collection.
...
<!-- {
  "blockType": "request",
  "name": "add_rebootanalyticsmetrics"
}
-->

```http
POST https://graph.microsoft.com/beta/deviceManagement/userExperienceAnalyticsCategories/{id}

---
title: "List resourceSpecificPermissionGrant"
description: ""
...
Get a list of the resourceSpecificPermissionGrant objects and their properties.
...
```http
GET https://graph.microsoft.com/beta/permissionGrants/{id}

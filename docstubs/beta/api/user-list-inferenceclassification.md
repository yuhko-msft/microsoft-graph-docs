...
Get the inferenceClassification objects from an inferenceClassification navigation property.
...
```http
GET https://graph.microsoft.com/beta/users/{id}/inferenceClassification

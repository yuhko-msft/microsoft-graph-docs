...
Create a new qrAuthenticationMethodConfiguration object.
...
If successful, this method returns a `201 Created` response code and a qrAuthenticationMethodConfiguration object in the response body.
...
<!-- {
  "blockType": "request",
  "name": "create_qrauthenticationmethodconfiguration"
}
-->

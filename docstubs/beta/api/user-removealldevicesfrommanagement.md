...
```http
/users/{id}/removeAllDevicesFromManagement
/deviceManagement/managedDevices/{id}/users/{id}/removeAllDevicesFromManagement
/deviceManagement/comanagedDevices/{id}/users/{id}/removeAllDevicesFromManagement

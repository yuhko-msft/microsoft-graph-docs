...
Create a new eventMessageResponse object.
...
If successful, this method returns a `201 Created` response code and an eventMessageResponse object in the response body.
...
<!-- {
  "blockType": "request",
  "name": "create_eventmessageresponse"
}
-->

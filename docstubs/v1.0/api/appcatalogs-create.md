...
Create a new appCatalogs object.
...
If successful, this method returns a `201 Created` response code and an appCatalogs object in the response body.
...
<!-- {
  "blockType": "request",
  "name": "create_appcatalogs"
}
-->

```http
POST https://graph.microsoft.com/v1.0/appCatalogs

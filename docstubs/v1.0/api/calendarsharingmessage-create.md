...
Create a new calendarSharingMessage object.
...
If successful, this method returns a `201 Created` response code and a calendarSharingMessage object in the response body.
...
<!-- {
  "blockType": "request",
  "name": "create_calendarsharingmessage"
}
-->

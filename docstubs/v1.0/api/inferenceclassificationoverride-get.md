...
Read the properties and relationships an inferenceClassificationOverride object.
...
```http
GET https://graph.microsoft.com/v1.0/users/{id}/inferenceClassification/overrides/{id}

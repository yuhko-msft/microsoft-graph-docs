...
Get a list of the eBookInstallSummary objects and their properties.
...
```http
GET https://graph.microsoft.com/v1.0/deviceAppManagement/managedEBooks/{id}/installSummary

---
title: "List singleValueLegacyExtendedProperty"
description: ""
...
Get a list of the singleValueLegacyExtendedProperty objects and their properties.
...
```http
GET https://graph.microsoft.com/v1.0/users/{id}/calendar/singleValueExtendedProperties/{id}

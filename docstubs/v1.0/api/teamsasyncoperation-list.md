---
title: "List teamsAsyncOperation"
description: ""
...
Get a list of the teamsAsyncOperation objects and their properties.
...
```http
GET https://graph.microsoft.com/v1.0/teams/{id}/operations/{id}

...
Get the teamsAppDefinition objects from a teamsAppDefinition navigation property.
...
```http
GET https://graph.microsoft.com/v1.0/appCatalogs/teamsApps/{id}/appDefinitions/{id}

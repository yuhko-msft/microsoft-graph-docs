...
Create a new [androidForWorkScepCertificateProfile](../resources/androidforworkscepcertificateprofile.md) object.
...
-->
``` http
POST ** Collection URI for microsoft.graph.androidForWorkScepCertificateProfile not found
```
...
## Request body
In the request body, supply a JSON representation of the [androidForWorkScepCertificateProfile](../resources/androidforworkscepcertificateprofile.md) object.
...
If successful, this method returns a `201 Created` response code and an [androidForWorkScepCertificateProfile](../resources/androidforworkscepcertificateprofile.md) object in the response body.
...
<!-- {
  "blockType": "request",
  "name": "create_androidforworkscepcertificateprofile_from_"
}
-->
``` http
POST https://graph.microsoft.com/beta** Collection URI for microsoft.graph.androidForWorkScepCertificateProfile not found
...
{
  "@odata.type": "#microsoft.graph.androidForWorkScepCertificateProfile",
  "id": "fc9aeaac-eaac-fc9a-acea-9afcacea9afc",

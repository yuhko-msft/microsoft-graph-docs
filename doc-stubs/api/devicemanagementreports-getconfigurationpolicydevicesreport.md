---
title: "deviceManagementReports: getConfigurationPolicyDevicesReport"
...
# deviceManagementReports: getConfigurationPolicyDevicesReport
...
<!-- {
  "blockType": "request",
  "name": "devicemanagementreports_getconfigurationpolicydevicesreport"
}
-->
``` http
POST https://graph.microsoft.com/v1.0/deviceManagement/reports/getConfigurationPolicyDevicesReport

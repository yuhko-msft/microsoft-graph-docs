...
-->
``` http
DELETE /me/profile/notes/{personAnnotationId}
DELETE /users/{usersId}/profile/notes/{personAnnotationId}
```
...
-->
``` http
DELETE https://graph.microsoft.com/beta/me/profile/notes/{personAnnotationId}
```

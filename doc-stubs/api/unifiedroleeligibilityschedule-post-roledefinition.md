...
-->
``` http
POST /unifiedRoleAssignmentSchedule/activatedUsing/roleDefinition/$ref
```
...
-->
``` http
POST https://graph.microsoft.com/beta/unifiedRoleAssignmentSchedule/activatedUsing/roleDefinition/$ref

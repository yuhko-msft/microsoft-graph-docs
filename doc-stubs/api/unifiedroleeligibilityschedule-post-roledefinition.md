...
-->
``` http
POST /roleManagement/directory/roleAssignmentSchedules/{unifiedRoleAssignmentScheduleId}/activatedUsing/roleDefinition/$ref
```
...
-->
``` http
POST https://graph.microsoft.com/beta/roleManagement/directory/roleAssignmentSchedules/{unifiedRoleAssignmentScheduleId}/activatedUsing/roleDefinition/$ref

...
Read the properties and relationships of an [androidManagedStoreAppConfiguration](../resources/intune-androidmanagedstoreappconfiguration.md) object.
...
If successful, this method returns a `200 OK` response code and an [androidManagedStoreAppConfiguration](../resources/intune-androidmanagedstoreappconfiguration.md) object in the response body.

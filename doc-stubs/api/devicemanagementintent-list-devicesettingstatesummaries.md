...
description: "Get the deviceManagementIntentDeviceSettingStateSummary resources from the deviceSettingStateSummaries navigation property."
...
Get the deviceManagementIntentDeviceSettingStateSummary resources from the deviceSettingStateSummaries navigation property.
...
-->
``` http
GET https://graph.microsoft.com/v1.0/deviceManagement/intents/{deviceManagementIntentId}/deviceSettingStateSummaries
```

---
title: "emailSecurityEventsRoot: getListEmails"
...
# emailSecurityEventsRoot: getListEmails
...
-->
``` http
GET /security/emailSecurityEvents/getListEmails
```
...
<!-- {
  "blockType": "request",
  "name": "emailsecurityeventsroot_getlistemails"
}
-->
``` http
GET https://graph.microsoft.com/beta/security/emailSecurityEvents/getListEmails
```

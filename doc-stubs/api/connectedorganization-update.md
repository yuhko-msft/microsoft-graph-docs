...
-->
``` http
PATCH /entitlementManagement/connectedOrganizations/{connectedOrganizationId}
```
...
-->
``` http
PATCH https://graph.microsoft.com/v1.0/entitlementManagement/connectedOrganizations/{connectedOrganizationId}

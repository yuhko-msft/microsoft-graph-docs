...
-->
``` http
GET ** Collection URI for Microsoft.DirectoryServices.tenantRelationship not found
```
...
-->
``` http
GET https://graph.microsoft.com/beta** Collection URI for Microsoft.DirectoryServices.tenantRelationship not found
```
...
<!-- {
  "blockType": "response",
  "truncated": true,
  "@odata.type": "Collection(Microsoft.DirectoryServices.tenantRelationship)"
}
-->
``` http
HTTP/1.1 200 OK

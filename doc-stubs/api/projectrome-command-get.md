...
Read the properties and relationships of a [command](../resources/projectrome-command.md) object.
...
If successful, this method returns a `200 OK` response code and a [command](../resources/projectrome-command.md) object in the response body.

...
description: "Get the printServiceEndpoint resources from the endpoints navigation property."
...
Get the printServiceEndpoint resources from the endpoints navigation property.
...
-->
``` http
GET https://graph.microsoft.com/beta/print/services/{printServiceId}/endpoints
```

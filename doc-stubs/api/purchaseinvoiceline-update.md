...
The following table shows the properties that are required when you update the [purchaseInvoiceLine](../resources/purchaseinvoiceline.md).
...
-->
``` http
PATCH https://graph.microsoft.com/v1.0/financials/companies/{companyId}/purchaseInvoiceLines/{purchaseInvoiceLineId}

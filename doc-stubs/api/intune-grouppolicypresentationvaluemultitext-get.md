...
Read the properties and relationships of a [groupPolicyPresentationValueMultiText](../resources/intune-grouppolicypresentationvaluemultitext.md) object.
...
If successful, this method returns a `200 OK` response code and a [groupPolicyPresentationValueMultiText](../resources/intune-grouppolicypresentationvaluemultitext.md) object in the response body.

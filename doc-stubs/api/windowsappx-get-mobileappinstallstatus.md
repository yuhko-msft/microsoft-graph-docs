...
Read the properties and relationships of a [mobileAppInstallStatus](../resources/intune-mobileappinstallstatus.md) object.
...
If successful, this method returns a `200 OK` response code and a [mobileAppInstallStatus](../resources/intune-mobileappinstallstatus.md) object in the response body.

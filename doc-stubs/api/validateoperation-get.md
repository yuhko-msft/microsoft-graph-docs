...
Read the properties and relationships of a [validateOperation](../resources/validateoperation.md) object.
...
If successful, this method returns a `200 OK` response code and a [validateOperation](../resources/validateoperation.md) object in the response body.

---
title: "workbookFunctions: dstDev"
...
-->
``` http
POST /workbooks/{workbooksId}/workbook/functions/dstDev
```
...
<!-- {
  "blockType": "request",
  "name": "workbookfunctions_dstdev"
}
-->
``` http
POST https://graph.microsoft.com/beta/workbooks/{workbooksId}/workbook/functions/dstDev

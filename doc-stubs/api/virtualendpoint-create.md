...
Create a new [virtualEndpoint](../resources/virtualendpoint.md) object.
...
-->
``` http
POST https://graph.microsoft.com/v1.0** Collection URI for microsoft.graph.virtualEndpoint not found

---
title: "iosManagedAppProtection: hasPayloadLinks"
...
# iosManagedAppProtection: hasPayloadLinks
...
<!-- {
  "blockType": "request",
  "name": "iosmanagedappprotection_haspayloadlinks"
}
-->
``` http
POST https://graph.microsoft.com/v1.0/deviceAppManagement/iosManagedAppProtections/hasPayloadLinks

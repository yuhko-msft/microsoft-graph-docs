...
description: "Deletes a deviceManagementScriptAssignment object."
...
Deletes a [deviceManagementScriptAssignment](../resources/devicemanagementscriptassignment.md) object.
...
<!-- {
  "blockType": "request",
  "name": "delete_devicemanagementscriptassignment"
}
-->
``` http
DELETE https://graph.microsoft.com/v1.0/deviceManagement/deviceShellScripts/{deviceShellScriptId}/assignments/{deviceManagementScriptAssignmentId}
```

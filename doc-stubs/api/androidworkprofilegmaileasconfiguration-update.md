...
description: "Update the properties of an androidWorkProfileGmailEasConfiguration object."
...
Update the properties of an [androidWorkProfileGmailEasConfiguration](../resources/androidworkprofilegmaileasconfiguration.md) object.
...
The following table shows the properties that are required when you update the [androidWorkProfileGmailEasConfiguration](../resources/androidworkprofilegmaileasconfiguration.md).
...
<!-- {
  "blockType": "request",
  "name": "update_androidworkprofilegmaileasconfiguration"
}
-->
``` http
PATCH https://graph.microsoft.com/v1.0** Entity URI for microsoft.graph.androidWorkProfileGmailEasConfiguration not found

...
-->
``` http
PATCH /drives/{drivesId}/activities/{itemActivityOLDId}/driveItem/versions
```
...
-->
``` http
PATCH https://graph.microsoft.com/beta/drives/{drivesId}/activities/{itemActivityOLDId}/driveItem/versions

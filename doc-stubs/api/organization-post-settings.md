...
Create a new organizationSettings object.
...
-->
``` http
POST /organization/{organizationId}/settings
```
...
-->
``` http
POST https://graph.microsoft.com/v1.0/organization/{organizationId}/settings

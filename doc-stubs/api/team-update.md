...
-->
``` http
PATCH /compliance/dataSubjectRequests/{dataSubjectRequestId}/team
```
...
-->
``` http
PATCH https://graph.microsoft.com/beta/compliance/dataSubjectRequests/{dataSubjectRequestId}/team

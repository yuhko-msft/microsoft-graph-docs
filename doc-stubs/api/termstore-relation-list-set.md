---
title: "List set"
description: "Get the set resources from the set navigation property."
...
Get the set resources from the set navigation property.
...
-->
``` http
GET https://graph.microsoft.com/v1.0/sites/{sitesId}/termStore/groups/{groupId}/sets/{setId}/children/{termId}/relations/{relationId}/set
```

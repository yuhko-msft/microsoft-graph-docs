...
Read the properties and relationships of a [macOSCustomConfiguration](../resources/macoscustomconfiguration.md) object.
...
If successful, this method returns a `200 OK` response code and a [macOSCustomConfiguration](../resources/macoscustomconfiguration.md) object in the response body.

...
description: "Get a list of the synchronizationSchema objects and their properties."
...
Get a list of the [synchronizationSchema](../resources/synchronization-synchronizationschema.md) objects and their properties.
...
-->
``` http
GET ** Collection URI for microsoft.synchronization.synchronizationSchema not found
```
...
-->
``` http
GET https://graph.microsoft.com/beta** Collection URI for microsoft.synchronization.synchronizationSchema not found
```

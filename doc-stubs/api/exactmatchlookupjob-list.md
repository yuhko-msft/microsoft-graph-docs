...
description: "Get a list of the exactMatchLookupJob objects and their properties."
...
Get a list of the [exactMatchLookupJob](../resources/exactmatchlookupjob.md) objects and their properties.
...
<!-- {
  "blockType": "request",
  "name": "list_exactmatchlookupjob"
}
-->
``` http
GET https://graph.microsoft.com/v1.0** Collection URI for microsoft.graph.exactMatchLookupJob not found
```

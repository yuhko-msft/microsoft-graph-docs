...
-->
``` http
GET /customerCreationOperations/{customerCreationOperationsId}/customer
```
...
-->
``` http
GET https://graph.microsoft.com/beta/customerCreationOperations/{customerCreationOperationsId}/customer
```

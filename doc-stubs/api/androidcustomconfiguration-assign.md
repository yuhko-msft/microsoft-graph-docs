---
title: "androidCustomConfiguration: assign"
...
# androidCustomConfiguration: assign
...
-->
``` http
POST ** Entity URI for microsoft.graph.androidCustomConfiguration not found/assign
```
...
<!-- {
  "blockType": "request",
  "name": "androidcustomconfiguration_assign"
}
-->
``` http
POST https://graph.microsoft.com/beta** Entity URI for microsoft.graph.androidCustomConfiguration not found/assign

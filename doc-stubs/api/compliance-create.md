...
-->
``` http
POST ** Collection URI for microsoft.compliance.dataSubjectRequest.compliance not found
```
...
-->
``` http
POST https://graph.microsoft.com/beta** Collection URI for microsoft.compliance.dataSubjectRequest.compliance not found

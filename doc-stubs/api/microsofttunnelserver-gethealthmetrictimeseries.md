...
If successful, this action returns a `200 OK` response code and a [keyValuePair](../resources/keyvaluepair.md) collection in the response body.
...
-->
``` http
POST https://graph.microsoft.com/v1.0/deviceManagement/microsoftTunnelSites/{microsoftTunnelSiteId}/microsoftTunnelServers/{microsoftTunnelServerId}/getHealthMetricTimeSeries

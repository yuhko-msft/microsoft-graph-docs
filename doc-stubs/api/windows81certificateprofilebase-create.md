---
title: "Create windows81CertificateProfileBase"
description: "Create a new windows81CertificateProfileBase object."
...
# Create windows81CertificateProfileBase
Namespace: microsoft.graph

[!INCLUDE [beta-disclaimer](../../includes/beta-disclaimer.md)]

Create a new [windows81CertificateProfileBase](../resources/windows81certificateprofilebase.md) object.
...
-->
``` http
POST ** Collection URI for microsoft.graph.windows81CertificateProfileBase not found
```
...
If successful, this method returns a `201 Created` response code and a [windows81CertificateProfileBase](../resources/windows81certificateprofilebase.md) object in the response body.
...
<!-- {
  "blockType": "request",
  "name": "create_windows81certificateprofilebase_from_"
}
-->
``` http
POST https://graph.microsoft.com/beta** Collection URI for microsoft.graph.windows81CertificateProfileBase not found

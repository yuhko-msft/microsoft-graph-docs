...
The following table shows the properties that are required when you update the [macOSEndpointProtectionConfiguration](../resources/macosendpointprotectionconfiguration.md).
...
-->
``` http
PATCH https://graph.microsoft.com/v1.0** Entity URI for microsoft.graph.macOSEndpointProtectionConfiguration not found

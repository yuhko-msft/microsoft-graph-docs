...
description: "Get the connectedOrganization resources from the connectedOrganizations navigation property."
...
Get the connectedOrganization resources from the connectedOrganizations navigation property.
...
-->
``` http
GET https://graph.microsoft.com/beta/entitlementManagement/connectedOrganizations
```

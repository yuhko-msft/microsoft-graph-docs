---
title: "androidWorkProfileGeneralDeviceConfiguration: assign"
...
# androidWorkProfileGeneralDeviceConfiguration: assign
...
-->
``` http
POST ** Entity URI for microsoft.graph.androidWorkProfileGeneralDeviceConfiguration not found/assign
```
...
<!-- {
  "blockType": "request",
  "name": "androidworkprofilegeneraldeviceconfiguration_assign"
}
-->
``` http
POST https://graph.microsoft.com/beta** Entity URI for microsoft.graph.androidWorkProfileGeneralDeviceConfiguration not found/assign

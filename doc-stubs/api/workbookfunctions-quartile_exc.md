---
title: "workbookFunctions: quartile_Exc"
...
# workbookFunctions: quartile_Exc
...
-->
``` http
POST /workbooks/{workbooksId}/workbook/functions/quartile_Exc
```
...
-->
``` http
POST https://graph.microsoft.com/beta/workbooks/{workbooksId}/workbook/functions/quartile_Exc

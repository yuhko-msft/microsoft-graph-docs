...
Create a new [settings](../resources/admin-settings.md) object.
...
-->
``` http
POST ** Collection URI for microsoft.graph.admin.settings not found
```
...
-->
``` http
POST https://graph.microsoft.com/beta** Collection URI for microsoft.graph.admin.settings not found

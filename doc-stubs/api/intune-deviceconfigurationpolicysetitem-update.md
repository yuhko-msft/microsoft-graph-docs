...
Update the properties of a [deviceConfigurationPolicySetItem](../resources/intune-deviceconfigurationpolicysetitem.md) object.
...
-->
``` http
PATCH /deviceConfigurationPolicySetItem
```
...
## Request body
In the request body, supply a JSON representation of the [deviceConfigurationPolicySetItem](../resources/intune-deviceconfigurationpolicysetitem.md) object.

The following table shows the properties that are required when you create the [deviceConfigurationPolicySetItem](../resources/intune-deviceconfigurationpolicysetitem.md).
...
If successful, this method returns a `200 OK` response code and an updated [deviceConfigurationPolicySetItem](../resources/intune-deviceconfigurationpolicysetitem.md) object in the response body.
...
-->
``` http
PATCH https://graph.microsoft.com/beta/deviceConfigurationPolicySetItem

...
The following table shows the properties that are required when you update the [macOSTrustedRootCertificate](../resources/macostrustedrootcertificate.md).
...
<!-- {
  "blockType": "request",
  "name": "update_macostrustedrootcertificate"
}
-->
``` http

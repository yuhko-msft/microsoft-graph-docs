---
title: "List sets"
description: "Get the set resources from the sets navigation property."
...
Get the set resources from the sets navigation property.
...
-->
``` http
GET https://graph.microsoft.com/beta/sites/{sitesId}/termStore/groups/{groupId}/sets
```

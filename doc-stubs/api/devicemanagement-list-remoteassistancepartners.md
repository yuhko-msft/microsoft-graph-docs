...
description: "Get the remoteAssistancePartner resources from the remoteAssistancePartners navigation property."
...
Get the remoteAssistancePartner resources from the remoteAssistancePartners navigation property.
...
<!-- {
  "blockType": "request",
  "name": "list_remoteassistancepartner"
}
-->
``` http
  ...
  "value": [
    {
      ...
      "id": "b4f85512-5512-b4f8-1255-f8b41255f8b4",
      "displayName": "String",

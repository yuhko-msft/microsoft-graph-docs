...
-->
``` http
GET ** Entity URI for microsoft.management.services.api.officeSuiteApp not found/getRelatedAppStates
```
...
-->
``` http
GET https://graph.microsoft.com/beta** Entity URI for microsoft.management.services.api.officeSuiteApp not found/getRelatedAppStates(userPrincipalName='parameterValue',deviceId='parameterValue')
```

...
description: "Deletes a deviceManagementExchangeConnector object."
...
Deletes a [deviceManagementExchangeConnector](../resources/devicemanagementexchangeconnector.md) object.
...
<!-- {
  "blockType": "request",
  "name": "delete_devicemanagementexchangeconnector"
}
-->
``` http

...
-->
``` http
GET /drive/following/{driveItemId}/workbook
GET /drives/{drivesId}/following/{driveItemId}/workbook
```
...
-->
``` http
GET https://graph.microsoft.com/v1.0/drive/following/{driveItemId}/workbook
```

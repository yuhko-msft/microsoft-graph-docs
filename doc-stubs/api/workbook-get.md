...
-->
``` http
GET /drive/activities/{itemActivityOLDId}/driveItem/workbook
GET /drives/{drivesId}/activities/{itemActivityOLDId}/driveItem/workbook
```
...
-->
``` http
GET https://graph.microsoft.com/beta/drive/activities/{itemActivityOLDId}/driveItem/workbook
```

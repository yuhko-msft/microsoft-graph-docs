...
-->
``` http
DELETE /policyRoot/activityBasedTimeoutPolicies/{id}
```
...
<!-- {
  "blockType": "request",
  "name": "delete_activitybasedtimeoutpolicies_from_policyroot"
}
-->
``` http
DELETE https://graph.microsoft.com/beta/policyRoot/activityBasedTimeoutPolicies/{id}
```

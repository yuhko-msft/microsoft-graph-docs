---
title: "List plannerPlanDetails"
description: "Get a list of the plannerPlanDetails objects and their properties."
...
# List plannerPlanDetails
Namespace: microsoft.graph



Get a list of the [plannerPlanDetails](../resources/plannerplandetails.md) objects and their properties.
...
<!-- {
  "blockType": "request",
  "name": "list_plannerplandetails"
}
-->
``` http
GET https://graph.microsoft.com/v1.0** Collection URI for microsoft.graph.plannerPlanDetails not found
```

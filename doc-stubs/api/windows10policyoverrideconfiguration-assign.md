---
title: "windows10PolicyOverrideConfiguration: assign"
...
# windows10PolicyOverrideConfiguration: assign
...
-->
``` http
POST ** Entity URI for microsoft.graph.windows10PolicyOverrideConfiguration not found/assign
```
...
<!-- {
  "blockType": "request",
  "name": "windows10policyoverrideconfiguration_assign"
}
-->
``` http
POST https://graph.microsoft.com/beta** Entity URI for microsoft.graph.windows10PolicyOverrideConfiguration not found/assign

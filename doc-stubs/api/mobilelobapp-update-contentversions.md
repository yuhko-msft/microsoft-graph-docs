...
-->
``` http
PATCH ** Collection URI for microsoft.management.services.api.mobileAppContent not found
```
...
-->
``` http
PATCH https://graph.microsoft.com/beta** Collection URI for microsoft.management.services.api.mobileAppContent not found

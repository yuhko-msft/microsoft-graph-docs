...
-->
``` http
POST /rbacApplication/roleAssignmentRequests/{unifiedRoleAssignmentRequestId}/targetSchedule/$ref
```
...
-->
``` http
POST https://graph.microsoft.com/beta/rbacApplication/roleAssignmentRequests/{unifiedRoleAssignmentRequestId}/targetSchedule/$ref

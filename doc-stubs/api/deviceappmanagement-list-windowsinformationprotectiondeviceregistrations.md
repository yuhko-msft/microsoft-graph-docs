...
description: "Get the windowsInformationProtectionDeviceRegistration resources from the windowsInformationProtectionDeviceRegistrations navigation property."
...
Get the windowsInformationProtectionDeviceRegistration resources from the windowsInformationProtectionDeviceRegistrations navigation property.
...
-->
``` http
GET https://graph.microsoft.com/v1.0/deviceAppManagement/windowsInformationProtectionDeviceRegistrations
```

---
title: "List androidDeviceOwnerCertificateProfileBase"
description: "Get the androidDeviceOwnerCertificateProfileBase resources from the identityCertificateForClientAuthentication navigation property."
...
Get the androidDeviceOwnerCertificateProfileBase resources from the identityCertificateForClientAuthentication navigation property.
...
-->
``` http
GET https://graph.microsoft.com/v1.0** Collection URI for microsoft.graph.androidDeviceOwnerCertificateProfileBase not found
```

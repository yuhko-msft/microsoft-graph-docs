...
-->
``` http
PATCH /users/{usersId}/messages/{messageId}/event/singleValueExtendedProperties
```
...
-->
``` http
PATCH https://graph.microsoft.com/beta/users/{usersId}/messages/{messageId}/event/singleValueExtendedProperties

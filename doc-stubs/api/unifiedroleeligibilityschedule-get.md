...
-->
``` http
GET /unifiedRoleAssignmentSchedule/activatedUsing
GET /rbacApplication/roleEligibilitySchedules/{unifiedRoleEligibilityScheduleId}
```
...
-->
``` http
GET https://graph.microsoft.com/beta/unifiedRoleAssignmentSchedule/activatedUsing
```

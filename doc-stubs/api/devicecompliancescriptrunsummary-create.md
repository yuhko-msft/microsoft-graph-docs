...
Create a new [deviceComplianceScriptRunSummary](../resources/devicecompliancescriptrunsummary.md) object.
...
-->
``` http
POST ** Collection URI for microsoft.management.services.api.deviceComplianceScriptRunSummary not found
```
...
-->
``` http
POST https://graph.microsoft.com/beta** Collection URI for microsoft.management.services.api.deviceComplianceScriptRunSummary not found

...
-->
``` http
POST /groups/{groupsId}/endpoints/{endpointId}/getMemberGroups
POST /servicePrincipals/{servicePrincipalsId}/endpoints/{endpointId}/getMemberGroups
```
...
-->
``` http
POST https://graph.microsoft.com/beta/groups/{groupsId}/endpoints/{endpointId}/getMemberGroups

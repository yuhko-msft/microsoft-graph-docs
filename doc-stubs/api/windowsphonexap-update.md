...
Update the properties of a [windowsPhoneXAP](../resources/windowsphonexap.md) object.
...
-->
``` http
PATCH ** Entity URI for microsoft.graph.windowsPhoneXAP not found
```
...
## Request body
In the request body, supply a JSON representation of the [windowsPhoneXAP](../resources/windowsphonexap.md) object.

The following table shows the properties that are required when you create the [windowsPhoneXAP](../resources/windowsphonexap.md).
...
|productIdentifier|String|**TODO: Add Description**|
...
If successful, this method returns a `200 OK` response code and an updated [windowsPhoneXAP](../resources/windowsphonexap.md) object in the response body.
...
<!-- {
  "blockType": "request",
  "name": "update_windowsphonexap"
}
-->
``` http
PATCH https://graph.microsoft.com/beta** Entity URI for microsoft.graph.windowsPhoneXAP not found
...
{
  "@odata.type": "#microsoft.graph.windowsPhoneXAP",
  "id": "d08204ac-04ac-d082-ac04-82d0ac0482d0",
  "displayName": "String",
  "description": "String",
  "publisher": "String",
  "largeIcon": {

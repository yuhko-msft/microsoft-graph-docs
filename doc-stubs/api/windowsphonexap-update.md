...
-->
``` http
PATCH ** Entity URI for microsoft.management.services.api.windowsPhoneXAP not found
```
...
-->
``` http
PATCH https://graph.microsoft.com/beta** Entity URI for microsoft.management.services.api.windowsPhoneXAP not found
...
{
  "@odata.type": "#microsoft.graph.windowsPhoneXAP",
  "id": "77a48fa1-8fa1-77a4-a18f-a477a18fa477",
  "displayName": "String",
  "description": "String",
  "publisher": "String",
  "largeIcon": {

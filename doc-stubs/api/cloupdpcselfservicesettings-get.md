---
title: "Get cloupdPcSelfServiceSettings"
...
# Get cloupdPcSelfServiceSettings
...
-->
``` http
GET /selfServiceSettings/{selfServiceSettingsId}
```
...
-->
``` http
GET https://graph.microsoft.com/beta/selfServiceSettings/{selfServiceSettingsId}
```

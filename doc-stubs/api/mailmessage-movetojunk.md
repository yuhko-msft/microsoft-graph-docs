...
-->
``` http
POST /security/emailSecurityEvents/mailMessages/{mailMessageId}/moveToJunk
```
...
<!-- {
  "blockType": "request",
  "name": "mailmessage_movetojunk"
}
-->
``` http
POST https://graph.microsoft.com/beta/security/emailSecurityEvents/mailMessages/{mailMessageId}/moveToJunk

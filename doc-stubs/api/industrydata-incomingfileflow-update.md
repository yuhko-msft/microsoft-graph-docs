...
Update the properties of an [incomingFileFlow](../resources/industrydata-incomingfileflow.md) object.
...
-->
``` http
PATCH ** Entity URI for microsoft.graph.industryData.incomingFileFlow not found
```
...
If successful, this method returns a `200 OK` response code and an updated [incomingFileFlow](../resources/industrydata-incomingfileflow.md) object in the response body.
...
-->
``` http
PATCH https://graph.microsoft.com/beta** Entity URI for microsoft.graph.industryData.incomingFileFlow not found

---
title: "Add deviceConfiguration"
description: "Add deviceConfiguration by posting to the deviceConfiguration collection."
...
Add deviceConfiguration by posting to the deviceConfiguration collection.
...
-->
``` http
POST /deviceManagement/deviceConfigurations/{deviceConfigurationId}/groupAssignments/{deviceConfigurationGroupAssignmentId}/deviceConfiguration/$ref
```
...
If successful, this method returns a `204 No Content` response code and a [deviceConfiguration](../resources/deviceconfiguration.md) object in the response body.
...
-->
``` http
POST https://graph.microsoft.com/beta/deviceManagement/deviceConfigurations/{deviceConfigurationId}/groupAssignments/{deviceConfigurationGroupAssignmentId}/deviceConfiguration/$ref
...
{
  "@odata.type": "#microsoft.graph.deviceConfiguration",
  "id": "ebadd3f4-d3f4-ebad-f4d3-adebf4d3adeb",

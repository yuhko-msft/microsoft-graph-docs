...
GET /print/reports/getSkypeForBusinessParticipantActivityUserCounts
```
...
-->
``` http
GET https://graph.microsoft.com/v1.0/reports/getSkypeForBusinessParticipantActivityUserCounts(period='parameterValue')
```

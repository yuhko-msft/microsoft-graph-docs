---
title: "List comanagedDevices"
description: "Get the managedDevice resources from the comanagedDevices navigation property."
...
# List comanagedDevices
Namespace: microsoft.graph

[!INCLUDE [beta-disclaimer](../../includes/beta-disclaimer.md)]

Get the managedDevice resources from the comanagedDevices navigation property.
...
-->
``` http
GET https://graph.microsoft.com/beta/deviceManagement/comanagedDevices
```

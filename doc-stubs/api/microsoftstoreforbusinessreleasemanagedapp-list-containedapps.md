...
-->
``` http
GET /deviceAppManagement/mobileApps/{mobileAppId}/containedApps
```
...
-->
``` http
GET https://graph.microsoft.com/beta/deviceAppManagement/mobileApps/{mobileAppId}/containedApps
```

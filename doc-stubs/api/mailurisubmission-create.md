...
The following table shows the properties that are required when you create the [mailUriSubmission](../resources/mailurisubmission.md).
...
<!-- {
  "blockType": "request",
  "name": "create_mailurisubmission_from_"
}
-->
``` http

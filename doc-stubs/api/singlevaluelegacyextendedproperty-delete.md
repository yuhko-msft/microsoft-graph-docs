...
-->
``` http
DELETE /note/singleValueExtendedProperties/{singleValueLegacyExtendedPropertyId}
```
...
-->
``` http
DELETE https://graph.microsoft.com/beta/note/singleValueExtendedProperties/{singleValueLegacyExtendedPropertyId}
```

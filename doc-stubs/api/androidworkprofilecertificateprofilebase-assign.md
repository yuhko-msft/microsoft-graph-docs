---
title: "androidWorkProfileCertificateProfileBase: assign"
...
# androidWorkProfileCertificateProfileBase: assign
...
<!-- {
  "blockType": "request",
  "name": "androidworkprofilecertificateprofilebase_assign"
}
-->
``` http
POST https://graph.microsoft.com/v1.0/deviceManagement/deviceConfigurations/{deviceConfigurationId}/identityCertificate/assign

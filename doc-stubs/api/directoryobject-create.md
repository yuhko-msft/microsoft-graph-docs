...
-->
``` http
POST ** Collection URI for Microsoft.Teams.Shifts.directoryObject not found
```
...
-->
``` http
POST https://graph.microsoft.com/beta** Collection URI for Microsoft.Teams.Shifts.directoryObject not found

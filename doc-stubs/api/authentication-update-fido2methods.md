...
description: "Update the properties of a fido2Methods object."
...
Update the properties of a fido2Methods object.
...
-->
``` http
PATCH /user/authentication/fido2Methods
```
...
-->
``` http
PATCH https://graph.microsoft.com/beta/user/authentication/fido2Methods

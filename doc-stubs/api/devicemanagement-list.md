...
-->
``` http
GET ** Collection URI for microsoft.management.services.api.deviceManagement not found
```
...
-->
``` http
GET https://graph.microsoft.com/beta** Collection URI for microsoft.management.services.api.deviceManagement not found
```
...
<!-- {
  "blockType": "response",
  "truncated": true,
  "@odata.type": "Collection(microsoft.management.services.api.deviceManagement)"
}
-->
``` http
HTTP/1.1 200 OK

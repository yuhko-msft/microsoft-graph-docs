---
title: "workbookFunctions: tbillYield"
...
-->
``` http
POST /workbooks/{workbooksId}/workbook/functions/tbillYield
```
...
<!-- {
  "blockType": "request",
  "name": "workbookfunctions_tbillyield"
}
-->
``` http
POST https://graph.microsoft.com/beta/workbooks/{workbooksId}/workbook/functions/tbillYield

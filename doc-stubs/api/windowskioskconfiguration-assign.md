---
title: "windowsKioskConfiguration: assign"
...
# windowsKioskConfiguration: assign
...
-->
``` http
POST ** Entity URI for microsoft.graph.windowsKioskConfiguration not found/assign
```
...
<!-- {
  "blockType": "request",
  "name": "windowskioskconfiguration_assign"
}
-->
``` http
POST https://graph.microsoft.com/v1.0** Entity URI for microsoft.graph.windowsKioskConfiguration not found/assign

...
-->
``` http
GET /rbacApplication/resourceNamespaces/{unifiedRbacResourceNamespaceId}
GET /rbacApplicationMultiple/resourceNamespaces/{unifiedRbacResourceNamespaceId}
```
...
-->
``` http
GET https://graph.microsoft.com/beta/rbacApplication/resourceNamespaces/{unifiedRbacResourceNamespaceId}
```

...
-->
``` http
POST /appConsentRequest/userConsentRequests/{userConsentRequestId}/approval
```
...
-->
``` http
POST https://graph.microsoft.com/beta/appConsentRequest/userConsentRequests/{userConsentRequestId}/approval

---
title: "Get inheritsPermissionsFrom"
...
-->
``` http
GET /roleManagement/directory/roleDefinitions/{unifiedRoleDefinitionId}/inheritsPermissionsFrom
```
...
-->
``` http
GET https://graph.microsoft.com/beta/roleManagement/directory/roleDefinitions/{unifiedRoleDefinitionId}/inheritsPermissionsFrom
```

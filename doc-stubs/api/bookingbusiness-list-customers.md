...
description: "Get the bookingCustomer resources from the customers navigation property."
...
Get the bookingCustomer resources from the customers navigation property.
...
-->
``` http
GET https://graph.microsoft.com/v1.0/bookingBusinesses/{bookingBusinessesId}/customers
```

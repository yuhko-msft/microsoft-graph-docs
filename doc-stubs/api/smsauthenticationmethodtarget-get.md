...
-->
``` http
GET https://graph.microsoft.com/beta/smsAuthenticationMethodConfiguration/includeTargets/{smsAuthenticationMethodTargetId}
```
...

{
  "value": {
    "@odata.type": "#microsoft.graph.smsAuthenticationMethodTarget",
    "id": "f161be81-be81-f161-81be-61f181be61f1",

...
The following table shows the properties that are required when you update the [macOSWiredNetworkConfiguration](../resources/macoswirednetworkconfiguration.md).
...
{
  "@odata.type": "#microsoft.graph.macOSWiredNetworkConfiguration",
  "id": "6c7dd24b-d24b-6c7d-4bd2-7d6c4bd27d6c",

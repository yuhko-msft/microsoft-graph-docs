...
description: "Get the educationCategory resources from the assignmentCategories navigation property."
...
Get the educationCategory resources from the assignmentCategories navigation property.
...
-->
``` http
GET https://graph.microsoft.com/v1.0/education/classes/{educationClassId}/assignmentCategories
```

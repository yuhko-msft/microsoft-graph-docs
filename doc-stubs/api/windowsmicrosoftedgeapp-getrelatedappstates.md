...
-->
``` http
GET https://graph.microsoft.com/beta** Entity URI for microsoft.graph.windowsMicrosoftEdgeApp not found/getRelatedAppStates(userPrincipalName='parameterValue',deviceId='parameterValue')
```

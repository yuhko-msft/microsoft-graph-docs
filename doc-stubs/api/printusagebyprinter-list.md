---
title: "List printUsageByPrinters"
description: "Get a list of the printUsageByPrinter objects and their properties."
...
# List printUsageByPrinters
Namespace: microsoft.graph



Get a list of the [printUsageByPrinter](../resources/printusagebyprinter.md) objects and their properties.
...
-->
``` http
GET https://graph.microsoft.com/v1.0/print/reports/dailyPrintUsageByPrinter
```

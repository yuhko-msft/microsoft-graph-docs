...
description: "Get a list of the deviceManagementSettingCategory objects and their properties."
...
Get a list of the [deviceManagementSettingCategory](../resources/devicemanagementsettingcategory.md) objects and their properties.
...
<!-- {
  "blockType": "request",
  "name": "list_devicemanagementsettingcategory"
}
-->
``` http
GET https://graph.microsoft.com/v1.0/deviceManagement/categories
```

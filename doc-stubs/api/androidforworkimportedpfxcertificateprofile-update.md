...
description: "Update the properties of an androidForWorkImportedPFXCertificateProfile object."
...
Update the properties of an [androidForWorkImportedPFXCertificateProfile](../resources/androidforworkimportedpfxcertificateprofile.md) object.
...
The following table shows the properties that are required when you update the [androidForWorkImportedPFXCertificateProfile](../resources/androidforworkimportedpfxcertificateprofile.md).
...
<!-- {
  "blockType": "request",
  "name": "update_androidforworkimportedpfxcertificateprofile"
}
-->
``` http
PATCH https://graph.microsoft.com/v1.0** Entity URI for microsoft.graph.androidForWorkImportedPFXCertificateProfile not found

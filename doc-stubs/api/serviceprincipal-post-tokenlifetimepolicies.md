...
-->
``` http
POST /policyRoot/tokenLifetimePolicies/$ref
...
-->
``` http
POST https://graph.microsoft.com/beta/policyRoot/tokenLifetimePolicies/$ref
...
{
  "@odata.type": "#Microsoft.DirectoryServices.tokenLifetimePolicy",
  "id": "b96693aa-93aa-b966-aa93-66b9aa9366b9",
  "deletedDateTime": "String (timestamp)",
  "description": "String",
  "displayName": "String",
  "definition": [

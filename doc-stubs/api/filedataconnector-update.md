...
Update the properties of a [fileDataConnector](../resources/filedataconnector.md) object.
...
If successful, this method returns a `200 OK` response code and an updated [fileDataConnector](../resources/filedataconnector.md) object in the response body.

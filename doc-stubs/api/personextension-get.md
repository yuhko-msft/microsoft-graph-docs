...
-->
``` http
GET /me/profile/extensions/{personExtensionId}
GET /users/{usersId}/profile/extensions/{personExtensionId}
```
...
-->
``` http
GET https://graph.microsoft.com/v1.0/me/profile/extensions/{personExtensionId}
```

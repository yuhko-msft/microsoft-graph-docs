...
description: "Get a list of the workbookChartGridlines objects and their properties."
...
Get a list of the [workbookChartGridlines](../resources/workbookchartgridlines.md) objects and their properties.
...
-->
``` http
GET https://graph.microsoft.com/beta** Collection URI for microsoft.graph.workbookChartGridlines not found
```

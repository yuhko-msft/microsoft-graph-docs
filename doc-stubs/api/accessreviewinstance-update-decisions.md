...
-->
``` http
PATCH /user/pendingAccessReviewInstances/{accessReviewInstanceId}/decisions
```
...
-->
``` http
PATCH https://graph.microsoft.com/beta/user/pendingAccessReviewInstances/{accessReviewInstanceId}/decisions
...
{
  "@odata.type": "#microsoft.graph.accessReviewInstanceDecisionItem",
  "id": "aa67aa44-aa44-aa67-44aa-67aa44aa67aa",
  "accessReviewId": "String",
  "reviewedBy": {
    "@odata.type": "microsoft.graph.userIdentity"
  },

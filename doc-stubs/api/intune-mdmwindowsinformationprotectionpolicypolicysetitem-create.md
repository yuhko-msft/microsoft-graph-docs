...
Create a new [mdmWindowsInformationProtectionPolicyPolicySetItem](../resources/intune-mdmwindowsinformationprotectionpolicypolicysetitem.md) object.
...
If successful, this method returns a `201 Created` response code and a [mdmWindowsInformationProtectionPolicyPolicySetItem](../resources/intune-mdmwindowsinformationprotectionpolicypolicysetitem.md) object in the response body.

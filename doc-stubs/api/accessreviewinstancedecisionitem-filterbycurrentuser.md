...
-->
``` http
GET /user/pendingAccessReviewInstances/{accessReviewInstanceId}/decisions/filterByCurrentUser
```
...
-->
``` http
GET https://graph.microsoft.com/beta/user/pendingAccessReviewInstances/{accessReviewInstanceId}/decisions/filterByCurrentUser(on='parameterValue')
```

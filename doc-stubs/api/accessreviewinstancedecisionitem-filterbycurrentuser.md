...
-->
``` http
GET /me/pendingAccessReviewInstances/{accessReviewInstanceId}/decisions/filterByCurrentUser
GET /users/{usersId}/pendingAccessReviewInstances/{accessReviewInstanceId}/decisions/filterByCurrentUser
```
...
-->
``` http
GET https://graph.microsoft.com/beta/me/pendingAccessReviewInstances/{accessReviewInstanceId}/decisions/filterByCurrentUser(on='parameterValue')
```

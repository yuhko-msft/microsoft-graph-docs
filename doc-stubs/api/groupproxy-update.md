...
description: "Update the properties of a groupProxy object."
...
Update the properties of a [groupProxy](../resources/groupproxy.md) object.
...
-->
``` http
PATCH /directory/groupProxies/{groupProxyId}
```
...
The following table shows the properties that are required when you update the [groupProxy](../resources/groupproxy.md).
...
-->
``` http
PATCH https://graph.microsoft.com/beta/directory/groupProxies/{groupProxyId}

...
Create a new [androidDeviceComplianceLocalActionLockDevice](../resources/intune-androiddevicecompliancelocalactionlockdevice.md) object.
...
If successful, this method returns a `201 Created` response code and an [androidDeviceComplianceLocalActionLockDevice](../resources/intune-androiddevicecompliancelocalactionlockdevice.md) object in the response body.

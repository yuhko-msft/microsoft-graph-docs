...
Read the properties and relationships of an [aospDeviceOwnerDeviceConfiguration](../resources/intune-aospdeviceownerdeviceconfiguration.md) object.
...
If successful, this method returns a `200 OK` response code and an [aospDeviceOwnerDeviceConfiguration](../resources/intune-aospdeviceownerdeviceconfiguration.md) object in the response body.

...
Create a new [androidManagedAppProtection](../resources/intune-androidmanagedappprotection.md) object.
...
The following table shows the properties that are required when you create the [androidManagedAppProtection](../resources/intune-androidmanagedappprotection.md).
...
If successful, this method returns a `201 Created` response code and an [androidManagedAppProtection](../resources/intune-androidmanagedappprotection.md) object in the response body.

...
-->
``` http
GET /deviceManagement/cloudManagedDesktop/onPremisesConnections
```
...
-->
``` http
GET https://graph.microsoft.com/beta/deviceManagement/cloudManagedDesktop/onPremisesConnections
```

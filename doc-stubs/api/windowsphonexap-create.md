...
Create a new [windowsPhoneXAP](../resources/windowsphonexap.md) object.
...
-->
``` http
POST ** Collection URI for microsoft.graph.windowsPhoneXAP not found
```
...
If successful, this method returns a `201 Created` response code and a [windowsPhoneXAP](../resources/windowsphonexap.md) object in the response body.
...
<!-- {
  "blockType": "request",
  "name": "create_windowsphonexap_from_"
}
-->
``` http
POST https://graph.microsoft.com/beta** Collection URI for microsoft.graph.windowsPhoneXAP not found

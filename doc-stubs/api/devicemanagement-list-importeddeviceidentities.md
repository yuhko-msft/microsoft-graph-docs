...
description: "Get the importedDeviceIdentity resources from the importedDeviceIdentities navigation property."
...
Get the importedDeviceIdentity resources from the importedDeviceIdentities navigation property.
...
<!-- {
  "blockType": "request",
  "name": "list_importeddeviceidentity"
}
-->
``` http
GET https://graph.microsoft.com/v1.0/deviceManagement/importedDeviceIdentities
```

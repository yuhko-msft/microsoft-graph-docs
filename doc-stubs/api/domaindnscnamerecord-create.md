...
-->
``` http
POST https://graph.microsoft.com/v1.0** Collection URI for Microsoft.DirectoryServices.domainDnsCnameRecord not found
...
{
  "@odata.type": "#Microsoft.DirectoryServices.domainDnsCnameRecord",
  "id": "4dbd9764-9764-4dbd-6497-bd4d6497bd4d",
  "isOptional": "Boolean",
  "label": "String",
  "recordType": "String",
  "supportedService": "String",

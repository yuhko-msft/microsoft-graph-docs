...
-->
``` http
GET /user/todo/lists/{todoTaskListId}/tasks
```
...
-->
``` http
GET https://graph.microsoft.com/beta/user/todo/lists/{todoTaskListId}/tasks
```
...
<!-- {
  "blockType": "response",
  "truncated": true,
  "@odata.type": "Collection(microsoft.toDo.todoTask)"
}
-->
``` http
HTTP/1.1 200 OK

...
description: "Get the continuousAccessEvaluationPolicy resources from the continuousAccessEvaluationPolicy navigation property."
...
Get the continuousAccessEvaluationPolicy resources from the continuousAccessEvaluationPolicy navigation property.
...
-->
``` http
GET https://graph.microsoft.com/v1.0/identityContainer/continuousAccessEvaluationPolicy
```

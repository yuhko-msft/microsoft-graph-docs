...
description: "Update the properties of an androidWorkProfileNineWorkEasConfiguration object."
...
Update the properties of an [androidWorkProfileNineWorkEasConfiguration](../resources/androidworkprofilenineworkeasconfiguration.md) object.
...
-->
``` http
PATCH ** Entity URI for microsoft.graph.androidWorkProfileNineWorkEasConfiguration not found
```
...
## Request body
In the request body, supply a JSON representation of the [androidWorkProfileNineWorkEasConfiguration](../resources/androidworkprofilenineworkeasconfiguration.md) object.

The following table shows the properties that are required when you update the [androidWorkProfileNineWorkEasConfiguration](../resources/androidworkprofilenineworkeasconfiguration.md).
...
If successful, this method returns a `200 OK` response code and an updated [androidWorkProfileNineWorkEasConfiguration](../resources/androidworkprofilenineworkeasconfiguration.md) object in the response body.
...
<!-- {
  "blockType": "request",
  "name": "update_androidworkprofilenineworkeasconfiguration"
}
-->
``` http
PATCH https://graph.microsoft.com/beta** Entity URI for microsoft.graph.androidWorkProfileNineWorkEasConfiguration not found
...
{
  "@odata.type": "#microsoft.graph.androidWorkProfileNineWorkEasConfiguration",
  "id": "f08c7e22-7e22-f08c-227e-8cf0227e8cf0",

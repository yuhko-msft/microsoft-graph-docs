---
title: "deviceManagementIntent: compare"
...
# deviceManagementIntent: compare
...
-->
``` http
GET https://graph.microsoft.com/v1.0/deviceManagement/intents/{deviceManagementIntentId}/compare(templateId='parameterValue')
```

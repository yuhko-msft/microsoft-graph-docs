...
-->
``` http
GET /officeGraphInsights/used/{usedInsightId}
```
...
-->
``` http
GET https://graph.microsoft.com/beta/officeGraphInsights/used/{usedInsightId}
```
...

{
  "value": {
    "@odata.type": "#microsoft.graph.usedInsight",
    "id": "849aeac3-eac3-849a-c3ea-9a84c3ea9a84",
    "lastUsed": {

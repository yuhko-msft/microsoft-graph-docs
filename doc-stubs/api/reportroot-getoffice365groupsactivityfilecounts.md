...
GET /print/reports/getOffice365GroupsActivityFileCounts
```
...
-->
``` http
GET https://graph.microsoft.com/v1.0/reports/getOffice365GroupsActivityFileCounts(period='parameterValue')
```

---
title: "Update migratableTo"
description: "Update the properties of a migratableTo object."
...
Update the properties of a migratableTo object.
...
-->
``` http
PATCH /deviceManagement/templates/{deviceManagementTemplateId}/migratableTo
```
...
|templateType|deviceManagementTemplateType|**TODO: Add Description**. Possible values are: `securityBaseline`, `specializedDevices`, `advancedThreatProtectionSecurityBaseline`, `deviceConfiguration`, `custom`, `securityTemplate`, `microsoftEdgeSecurityBaseline`, `microsoftOffice365ProPlusSecurityBaseline`, `deviceCompliance`, `deviceConfigurationForOffice365`, `cloudPC`.|
...
<!-- {
  "blockType": "request",
  "name": "update_migratableto"
}
-->
``` http
PATCH https://graph.microsoft.com/beta/deviceManagement/templates/{deviceManagementTemplateId}/migratableTo

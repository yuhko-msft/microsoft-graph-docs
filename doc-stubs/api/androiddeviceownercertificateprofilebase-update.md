---
title: "Update androidDeviceOwnerCertificateProfileBase"
description: "Update the properties of an androidDeviceOwnerCertificateProfileBase object."
...
# Update androidDeviceOwnerCertificateProfileBase
Namespace: microsoft.graph

[!INCLUDE [beta-disclaimer](../../includes/beta-disclaimer.md)]

Update the properties of an [androidDeviceOwnerCertificateProfileBase](../resources/androiddeviceownercertificateprofilebase.md) object.
...
The following table shows the properties that are required when you update the [androidDeviceOwnerCertificateProfileBase](../resources/androiddeviceownercertificateprofilebase.md).
...
If successful, this method returns a `200 OK` response code and an updated [androidDeviceOwnerCertificateProfileBase](../resources/androiddeviceownercertificateprofilebase.md) object in the response body.
...
<!-- {
  "blockType": "request",
  "name": "update_androiddeviceownercertificateprofilebase"
}
-->
``` http
...

{
  ...
  "id": "36d4ac32-ac32-36d4-32ac-d43632acd436",

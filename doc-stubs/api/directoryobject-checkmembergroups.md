...
-->
``` http
POST /unifiedRoleScheduleBase/principal/checkMemberGroups
POST /groups/{groupsId}/createdOnBehalfOf/checkMemberGroups
POST /directoryObjects/{directoryObjectsId}/checkMemberGroups
POST /unifiedRoleScheduleBase/directoryScope/checkMemberGroups
POST /stsPolicy/appliesTo/{directoryObjectId}/checkMemberGroups
POST /unifiedRoleScheduleInstanceBase/principal/checkMemberGroups
POST /directory/deletedItems/{directoryObjectId}/checkMemberGroups
POST /unifiedRoleScheduleInstanceBase/directoryScope/checkMemberGroups
```
...
-->
``` http
POST https://graph.microsoft.com/beta/unifiedRoleScheduleBase/principal/checkMemberGroups

---
title: "deviceManagement: getRoleScopeTagsByIds"
...
# deviceManagement: getRoleScopeTagsByIds
...
-->
``` http
GET https://graph.microsoft.com/v1.0/deviceManagement/getRoleScopeTagsByIds(ids=[
  "String"
])
```

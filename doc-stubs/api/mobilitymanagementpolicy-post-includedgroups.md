...
-->
``` http
POST /mobilityManagementPolicies/{mobilityManagementPoliciesId}/includedGroups/$ref
```
...
-->
``` http
POST https://graph.microsoft.com/beta/mobilityManagementPolicies/{mobilityManagementPoliciesId}/includedGroups/$ref

...
-->
``` http
GET ** Collection URI for Microsoft.AAD.Reporting.user not found
```
...
-->
``` http
GET https://graph.microsoft.com/beta** Collection URI for Microsoft.AAD.Reporting.user not found
```
...
<!-- {
  "blockType": "response",
  "truncated": true,
  "@odata.type": "Collection(Microsoft.AAD.Reporting.user)"
}
-->
``` http
HTTP/1.1 200 OK
...

{
  "value": [
    {
      "@odata.type": "#Microsoft.AAD.Reporting.user",
      "signInActivity": {

...
-->
``` http
GET ** Collection URI for Microsoft.OfficeGraph.user not found
```
...
-->
``` http
GET https://graph.microsoft.com/beta** Collection URI for Microsoft.OfficeGraph.user not found
```
...
<!-- {
  "blockType": "response",
  "truncated": true,
  "@odata.type": "Collection(Microsoft.OfficeGraph.user)"
}
-->
``` http
HTTP/1.1 200 OK
...

{
  "value": [
    {
      "@odata.type": "#Microsoft.OfficeGraph.user"
    }
  ]
}
```

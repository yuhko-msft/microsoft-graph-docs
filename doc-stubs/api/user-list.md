...
-->
``` http
GET ** Collection URI for microsoft.toDo.user not found
```
...
-->
``` http
GET https://graph.microsoft.com/beta** Collection URI for microsoft.toDo.user not found
```
...
<!-- {
  "blockType": "response",
  "truncated": true,
  "@odata.type": "Collection(microsoft.toDo.user)"
}
-->
``` http
HTTP/1.1 200 OK
...

{
  "value": [
    {
      "@odata.type": "#microsoft.toDo.user"
    }
  ]
}
```

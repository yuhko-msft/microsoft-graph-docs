...
-->
``` http
GET /rbacApplication/roleAssignments/{unifiedRoleAssignmentId}/appScope
```
...
-->
``` http
GET https://graph.microsoft.com/v1.0/rbacApplication/roleAssignments/{unifiedRoleAssignmentId}/appScope
```

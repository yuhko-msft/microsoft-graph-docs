...
-->
``` http
GET /rbacApplication/roleAssignmentRequests/{unifiedRoleAssignmentRequestId}/targetSchedule
```
...
-->
``` http
GET https://graph.microsoft.com/beta/rbacApplication/roleAssignmentRequests/{unifiedRoleAssignmentRequestId}/targetSchedule
```
...
<!-- {
  "blockType": "response",
  "truncated": true,
  "@odata.type": "Collection(Microsoft.Identity.Governance.Common.Data.ExternalModels.V1.unifiedRoleAssignmentSchedule)"
}
-->
``` http
HTTP/1.1 200 OK
  ...
  "value": [
    {
      ...
      "id": "2b48d4df-d4df-2b48-dfd4-482bdfd4482b",
      "principalId": "String",

...
-->
``` http
PATCH /entitlementManagement/assignments/{accessPackageAssignmentId}/target
PATCH /entitlementManagement/assignmentRequests/{accessPackageAssignmentRequestId}/requestor
```
...
-->
``` http
PATCH https://graph.microsoft.com/v1.0/entitlementManagement/assignments/{accessPackageAssignmentId}/target

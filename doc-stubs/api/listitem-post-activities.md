...
Create a new itemActivity object.
...
-->
``` http
POST /drives/{drivesId}/activities/{itemActivityId}/driveItem/listItem/activities
```
...
-->
``` http
POST https://graph.microsoft.com/beta/drives/{drivesId}/activities/{itemActivityId}/driveItem/listItem/activities

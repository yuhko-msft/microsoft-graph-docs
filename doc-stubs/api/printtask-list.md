---
title: "List printTasks"
description: "Get a list of the printTask objects and their properties."
...
Get a list of the [printTask](../resources/printtask.md) objects and their properties.
...
-->
``` http
GET /print/printers/{printerId}/jobs/{printJobId}/tasks
...
-->
``` http
GET https://graph.microsoft.com/beta/print/printers/{printerId}/jobs/{printJobId}/tasks
```

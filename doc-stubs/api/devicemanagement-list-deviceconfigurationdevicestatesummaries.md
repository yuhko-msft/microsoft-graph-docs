---
title: "List deviceConfigurationDeviceStateSummary"
description: "Get the deviceConfigurationDeviceStateSummary resources from the deviceConfigurationDeviceStateSummaries navigation property."
...
# List deviceConfigurationDeviceStateSummary
Namespace: microsoft.graph

[!INCLUDE [beta-disclaimer](../../includes/beta-disclaimer.md)]

Get the deviceConfigurationDeviceStateSummary resources from the deviceConfigurationDeviceStateSummaries navigation property.
...
<!-- {
  "blockType": "request",
  "name": "list_deviceconfigurationdevicestatesummary"
}
-->
``` http

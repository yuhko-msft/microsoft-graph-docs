...
|usernameSource|userEmailSource|**TODO: Add Description**. Possible values are: `userPrincipalName`, `primarySmtpAddress`.|
|usernameAADSource|usernameSource|**TODO: Add Description**. Possible values are: `userPrincipalName`, `primarySmtpAddress`, `samAccountName`.|
...
-->
``` http
POST https://graph.microsoft.com/beta** Collection URI for microsoft.graph.easEmailProfileConfigurationBase not found
...
{
  "@odata.type": "#microsoft.graph.easEmailProfileConfigurationBase",
  "id": "da2be8ad-e8ad-da2b-ade8-2bdaade82bda",

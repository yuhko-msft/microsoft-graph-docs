...
-->
``` http
PATCH /users/{usersId}/contacts/{contactId}/multiValueExtendedProperties
```
...
-->
``` http
PATCH https://graph.microsoft.com/beta/users/{usersId}/contacts/{contactId}/multiValueExtendedProperties

...
description: "Get a list of the androidWorkProfileCustomConfiguration objects and their properties."
...
Get a list of the [androidWorkProfileCustomConfiguration](../resources/androidworkprofilecustomconfiguration.md) objects and their properties.
...
<!-- {
  "blockType": "request",
  "name": "list_androidworkprofilecustomconfiguration"
}
-->
``` http
GET https://graph.microsoft.com/beta** Collection URI for microsoft.graph.androidWorkProfileCustomConfiguration not found
```

...
-->
``` http
PATCH ** Entity URI for microsoft.management.services.api.windowsPhone81AppXBundle not found
```
...
-->
``` http
PATCH https://graph.microsoft.com/beta** Entity URI for microsoft.management.services.api.windowsPhone81AppXBundle not found

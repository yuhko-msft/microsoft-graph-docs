...
Create a new [iosVppEBookAssignment](../resources/intune-iosvppebookassignment.md) object.
...
If successful, this method returns a `201 Created` response code and an [iosVppEBookAssignment](../resources/intune-iosvppebookassignment.md) object in the response body.

---
title: "Update macOSCertificateProfileBase"
description: "Update the properties of a macOSCertificateProfileBase object."
...
# Update macOSCertificateProfileBase
Namespace: microsoft.graph

[!INCLUDE [beta-disclaimer](../../includes/beta-disclaimer.md)]

Update the properties of a [macOSCertificateProfileBase](../resources/macoscertificateprofilebase.md) object.
...
The following table shows the properties that are required when you update the [macOSCertificateProfileBase](../resources/macoscertificateprofilebase.md).
...
If successful, this method returns a `200 OK` response code and an updated [macOSCertificateProfileBase](../resources/macoscertificateprofilebase.md) object in the response body.
...
<!-- {
  "blockType": "request",
  "name": "update_macoscertificateprofilebase"
}
-->
``` http
...

{
  ...
  "id": "9ceae2e9-e2e9-9cea-e9e2-ea9ce9e2ea9c",

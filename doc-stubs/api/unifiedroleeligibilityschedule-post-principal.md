...
-->
``` http
POST /unifiedRoleAssignmentSchedule/activatedUsing/principal/$ref
```
...
-->
``` http
POST https://graph.microsoft.com/beta/unifiedRoleAssignmentSchedule/activatedUsing/principal/$ref

...
-->
``` http
GET ** Collection URI for Microsoft.Fast.PI.ViewGenerator.V2.Profile.Models.extension not found
```
...
-->
``` http
GET https://graph.microsoft.com/beta** Collection URI for Microsoft.Fast.PI.ViewGenerator.V2.Profile.Models.extension not found
```
...
<!-- {
  "blockType": "response",
  "truncated": true,
  "@odata.type": "Collection(Microsoft.Fast.PI.ViewGenerator.V2.Profile.Models.extension)"
}
-->
``` http
HTTP/1.1 200 OK

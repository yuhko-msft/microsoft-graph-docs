...
-->
``` http
POST /entitlementManagement/assignments/{accessPackageAssignmentId}/target/connectedOrganization/externalSponsors/$ref
```
...
-->
``` http
POST https://graph.microsoft.com/v1.0/entitlementManagement/assignments/{accessPackageAssignmentId}/target/connectedOrganization/externalSponsors/$ref

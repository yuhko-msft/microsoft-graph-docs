...
-->
``` http
POST /workbooks/{workbooksId}/activities/{itemActivityOLDId}/listItem/createdByUser/$ref
```
...
-->
``` http
POST https://graph.microsoft.com/beta/workbooks/{workbooksId}/activities/{itemActivityOLDId}/listItem/createdByUser/$ref

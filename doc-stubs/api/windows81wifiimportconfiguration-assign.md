---
title: "windows81WifiImportConfiguration: assign"
...
# windows81WifiImportConfiguration: assign
...
-->
``` http
POST ** Entity URI for microsoft.graph.windows81WifiImportConfiguration not found/assign
```
...
<!-- {
  "blockType": "request",
  "name": "windows81wifiimportconfiguration_assign"
}
-->
``` http
POST https://graph.microsoft.com/v1.0** Entity URI for microsoft.graph.windows81WifiImportConfiguration not found/assign

...
description: "Get a list of the authenticationMethodConfiguration objects and their properties."
...
Get a list of the [authenticationMethodConfiguration](../resources/authenticationmethodconfiguration.md) objects and their properties.
...
<!-- {
  "blockType": "response",
  "truncated": true,
  "@odata.type": "Collection(microsoft.graph.authenticationMethodConfiguration)"
}
-->
``` http
HTTP/1.1 200 OK
  ...
  "value": [
    {
      ...
      "id": "8d679a8f-9a8f-8d67-8f9a-678d8f9a678d",
      "state": "String"
    }
  ]
}

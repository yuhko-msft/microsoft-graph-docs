...
description: "Get the androidForWorkAppConfigurationSchema resources from the androidForWorkAppConfigurationSchemas navigation property."
...
Get the androidForWorkAppConfigurationSchema resources from the androidForWorkAppConfigurationSchemas navigation property.
...
<!-- {
  "blockType": "request",
  "name": "list_androidforworkappconfigurationschema"
}
-->
``` http
  ...
  "value": [
    {
      ...
      "id": "8d4c0c4a-0c4a-8d4c-4a0c-4c8d4a0c4c8d",
      "exampleJson": "Binary",
      "schemaItems": [
        {

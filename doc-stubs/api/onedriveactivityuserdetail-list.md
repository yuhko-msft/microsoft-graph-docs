...
description: "Get a list of the oneDriveActivityUserDetail objects and their properties."
...
Get a list of the [oneDriveActivityUserDetail](../resources/onedriveactivityuserdetail.md) objects and their properties.
...
<!-- {
  "blockType": "request",
  "name": "list_onedriveactivityuserdetail"
}
-->
``` http
GET https://graph.microsoft.com/v1.0** Collection URI for microsoft.graph.oneDriveActivityUserDetail not found
```

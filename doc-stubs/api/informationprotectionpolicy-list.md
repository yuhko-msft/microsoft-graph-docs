...
description: "Get a list of the informationProtectionPolicy objects and their properties."
...
Get a list of the [informationProtectionPolicy](../resources/informationprotectionpolicy.md) objects and their properties.
...
-->
``` http
GET https://graph.microsoft.com/beta** Collection URI for microsoft.graph.informationProtectionPolicy not found
```

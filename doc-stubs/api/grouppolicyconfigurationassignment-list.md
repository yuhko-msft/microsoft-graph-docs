...
description: "Get a list of the groupPolicyConfigurationAssignment objects and their properties."
...
Get a list of the [groupPolicyConfigurationAssignment](../resources/grouppolicyconfigurationassignment.md) objects and their properties.
...
<!-- {
  "blockType": "request",
  "name": "list_grouppolicyconfigurationassignment"
}
-->
``` http
GET https://graph.microsoft.com/v1.0/deviceManagement/groupPolicyConfigurations/{groupPolicyConfigurationId}/assignments
```

...
Get a list of the [sourceCollection](../resources/ediscovery-sourcecollection.md) objects and their properties.
...
-->
``` http
GET https://graph.microsoft.com/v1.0/compliance/ediscovery/cases/{caseId}/sourceCollections
```
  ...
  "value": [
    {
      ...
      "id": "71bf7439-7439-71bf-3974-bf713974bf71",
      "displayName": "String",
      "description": "String",
      "createdBy": {

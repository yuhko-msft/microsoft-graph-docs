...
-->
``` http
GET /presentation/comments/{documentCommentId}/replies/{documentCommentReplyId}
```
...
-->
``` http
GET https://graph.microsoft.com/beta/presentation/comments/{documentCommentId}/replies/{documentCommentReplyId}
```

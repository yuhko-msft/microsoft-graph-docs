...
-->
``` http
GET /me/authentication/emailMethods/{emailAuthenticationMethodId}
GET /users/{usersId}/authentication/emailMethods/{emailAuthenticationMethodId}
```
...
-->
``` http
GET https://graph.microsoft.com/v1.0/me/authentication/emailMethods/{emailAuthenticationMethodId}
```
...

{
  "value": {
    "@odata.type": "#microsoft.graph.emailAuthenticationMethod",
    "id": "09fa44d0-44d0-09fa-d044-fa09d044fa09",
    "emailAddress": "String"
  }
}
```

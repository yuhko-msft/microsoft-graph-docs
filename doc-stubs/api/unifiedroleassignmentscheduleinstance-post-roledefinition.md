...
-->
``` http
POST /unifiedRoleAssignmentScheduleInstance/roleDefinition/$ref
```
...
-->
``` http
POST https://graph.microsoft.com/beta/unifiedRoleAssignmentScheduleInstance/roleDefinition/$ref

...
-->
``` http
GET /rbacApplication/roleAssignmentRequests/{unifiedRoleAssignmentRequestId}/roleDefinition
```
...
-->
``` http
GET https://graph.microsoft.com/beta/rbacApplication/roleAssignmentRequests/{unifiedRoleAssignmentRequestId}/roleDefinition
```

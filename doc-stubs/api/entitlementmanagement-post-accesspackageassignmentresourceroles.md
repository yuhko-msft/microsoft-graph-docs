...
-->
``` http
POST /entitlementManagement/accessPackageAssignmentResourceRoles
```
...
-->
``` http
POST https://graph.microsoft.com/beta/entitlementManagement/accessPackageAssignmentResourceRoles

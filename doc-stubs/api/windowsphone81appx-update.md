...
Update the properties of a [windowsPhone81AppX](../resources/windowsphone81appx.md) object.
...
-->
``` http
PATCH ** Entity URI for microsoft.graph.windowsPhone81AppX not found
```
...
The following table shows the properties that are required when you update the [windowsPhone81AppX](../resources/windowsphone81appx.md).
...
If successful, this method returns a `200 OK` response code and an updated [windowsPhone81AppX](../resources/windowsphone81appx.md) object in the response body.
...
<!-- {
  "blockType": "request",
  "name": "update_windowsphone81appx"
}
-->
``` http
PATCH https://graph.microsoft.com/beta** Entity URI for microsoft.graph.windowsPhone81AppX not found
...
{
  "@odata.type": "#microsoft.graph.windowsPhone81AppX",
  "id": "7f95a555-a555-7f95-55a5-957f55a5957f",

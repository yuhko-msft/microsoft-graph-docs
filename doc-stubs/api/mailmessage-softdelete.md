...
-->
``` http
POST /security/emailSecurityEvents/mailMessages/{mailMessageId}/softDelete
```
...
<!-- {
  "blockType": "request",
  "name": "mailmessage_softdelete"
}
-->
``` http
POST https://graph.microsoft.com/beta/security/emailSecurityEvents/mailMessages/{mailMessageId}/softDelete

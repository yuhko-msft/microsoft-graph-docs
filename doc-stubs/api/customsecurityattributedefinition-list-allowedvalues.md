...
description: "Get the allowedValue resources from the allowedValues navigation property."
...
Get the allowedValue resources from the allowedValues navigation property.
...
<!-- {
  "blockType": "response",
  "truncated": true,
  "@odata.type": "Collection(Microsoft.DirectoryServices.allowedValue)"
}
-->
``` http
HTTP/1.1 200 OK
  ...
  "value": [
    {
      ...
      "id": "eebb8e74-8e74-eebb-748e-bbee748ebbee",
      "isActive": "Boolean"
    }
  ]
}

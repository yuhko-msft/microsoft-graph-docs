---
title: "easEmailProfileConfigurationBase: assign"
...
# easEmailProfileConfigurationBase: assign
...
-->
``` http
POST ** Entity URI for microsoft.graph.easEmailProfileConfigurationBase not found/assign
```
...
<!-- {
  "blockType": "request",
  "name": "easemailprofileconfigurationbase_assign"
}
-->
``` http
POST https://graph.microsoft.com/v1.0** Entity URI for microsoft.graph.easEmailProfileConfigurationBase not found/assign

---
title: "List deviceComplianceDeviceOverview"
description: "Get the deviceComplianceDeviceOverview resources from the deviceStatusOverview navigation property."
...
# List deviceComplianceDeviceOverview
Namespace: microsoft.graph

[!INCLUDE [beta-disclaimer](../../includes/beta-disclaimer.md)]

Get the deviceComplianceDeviceOverview resources from the deviceStatusOverview navigation property.
...
<!-- {
  "blockType": "request",
  "name": "list_devicecompliancedeviceoverview"
}
-->
``` http
  ...
  "value": [
    {
      ...
      "id": "6a6e44ba-44ba-6a6e-ba44-6e6aba446e6a",

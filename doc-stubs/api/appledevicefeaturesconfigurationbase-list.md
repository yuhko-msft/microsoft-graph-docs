...
description: "Get a list of the appleDeviceFeaturesConfigurationBase objects and their properties."
...
Get a list of the [appleDeviceFeaturesConfigurationBase](../resources/appledevicefeaturesconfigurationbase.md) objects and their properties.
...
<!-- {
  "blockType": "request",
  "name": "list_appledevicefeaturesconfigurationbase"
}
-->
``` http
GET https://graph.microsoft.com/v1.0** Collection URI for microsoft.graph.appleDeviceFeaturesConfigurationBase not found
```

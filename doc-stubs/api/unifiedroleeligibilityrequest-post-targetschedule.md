...
-->
``` http
POST /rbacApplication/roleEligibilityRequests/{unifiedRoleEligibilityRequestId}/targetSchedule/$ref
```
...
-->
``` http
POST https://graph.microsoft.com/beta/rbacApplication/roleEligibilityRequests/{unifiedRoleEligibilityRequestId}/targetSchedule/$ref

---
title: "iosTrustedRootCertificateProfile: assign"
...
# iosTrustedRootCertificateProfile: assign
...
-->
``` http
POST ** Entity URI for microsoft.graph.iosTrustedRootCertificateProfile not found/assign
```
...
<!-- {
  "blockType": "request",
  "name": "iostrustedrootcertificateprofile_assign"
}
-->
``` http
POST https://graph.microsoft.com/beta** Entity URI for microsoft.graph.iosTrustedRootCertificateProfile not found/assign

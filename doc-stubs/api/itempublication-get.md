...
-->
``` http
GET /me/profile/publications/{itemPublicationId}
GET /users/{usersId}/profile/publications/{itemPublicationId}
```
...
-->
``` http
GET https://graph.microsoft.com/v1.0/me/profile/publications/{itemPublicationId}
```

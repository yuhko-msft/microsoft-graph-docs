...
-->
``` http
POST ** Collection URI for BadUnresolvedEntityType:Microsoft.IGAELM.EC.FrontEnd.ExternalModel.rbacApplication not found
```
...
-->
``` http
POST https://graph.microsoft.com/v1.0** Collection URI for BadUnresolvedEntityType:Microsoft.IGAELM.EC.FrontEnd.ExternalModel.rbacApplication not found

...
-->
``` http
PATCH /users/{usersId}/todo/lists/{todoTaskListId}/tasks/{todoTaskId}/extensions
```
...
-->
``` http
PATCH https://graph.microsoft.com/v1.0/users/{usersId}/todo/lists/{todoTaskListId}/tasks/{todoTaskId}/extensions
...
{
  "@odata.type": "#microsoft.graph.extension",
  "id": "4c82e56c-e56c-4c82-6ce5-824c6ce5824c"
}
```

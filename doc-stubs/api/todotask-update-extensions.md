...
-->
``` http
PATCH /user/todo/lists/{todoTaskListId}/tasks/{todoTaskId}/extensions
```
...
-->
``` http
PATCH https://graph.microsoft.com/v1.0/user/todo/lists/{todoTaskListId}/tasks/{todoTaskId}/extensions

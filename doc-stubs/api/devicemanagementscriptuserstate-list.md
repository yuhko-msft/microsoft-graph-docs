...
description: "Get a list of the deviceManagementScriptUserState objects and their properties."
...
Get a list of the [deviceManagementScriptUserState](../resources/devicemanagementscriptuserstate.md) objects and their properties.
...
-->
``` http
GET https://graph.microsoft.com/v1.0/deviceManagement/deviceShellScripts/{deviceShellScriptId}/userRunStates
```

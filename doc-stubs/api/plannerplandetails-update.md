...
-->
``` http
PATCH /me/planner/favoritePlans/{plannerPlanId}/details
PATCH /users/{usersId}/planner/favoritePlans/{plannerPlanId}/details
```
...
-->
``` http
PATCH https://graph.microsoft.com/beta/me/planner/favoritePlans/{plannerPlanId}/details

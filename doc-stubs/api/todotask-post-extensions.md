...
-->
``` http
POST /users/{usersId}/todo/lists/{todoTaskListId}/tasks/{todoTaskId}/extensions
```
...
-->
``` http
POST https://graph.microsoft.com/beta/users/{usersId}/todo/lists/{todoTaskListId}/tasks/{todoTaskId}/extensions

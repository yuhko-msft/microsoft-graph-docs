...
POST /lists/{listsId}/extensions
POST /tasks/{tasksId}/extensions
POST /groups/{groupsId}/extensions
POST /devices/{devicesId}/extensions
POST /organization/{organizationId}/extensions
POST /administrativeUnits/{administrativeUnitsId}/extensions
```
...
{
  "@odata.type": "#microsoft.graph.extension",
  "id": "21b4c74b-c74b-21b4-4bc7-b4214bc7b421"
}
```

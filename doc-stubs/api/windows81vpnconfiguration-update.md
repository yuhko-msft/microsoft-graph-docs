...
The following table shows the properties that are required when you update the [windows81VpnConfiguration](../resources/windows81vpnconfiguration.md).
...
-->
``` http
PATCH https://graph.microsoft.com/beta** Entity URI for microsoft.graph.windows81VpnConfiguration not found
...
{
  "@odata.type": "#microsoft.graph.windows81VpnConfiguration",
  "id": "bfbabcfc-bcfc-bfba-fcbc-babffcbcbabf",

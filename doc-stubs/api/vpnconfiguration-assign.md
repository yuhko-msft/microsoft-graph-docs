...
-->
``` http
POST ** Entity URI for microsoft.graph.vpnConfiguration not found/assign
```
...
<!-- {
  "blockType": "request",
  "name": "vpnconfiguration_assign"
}
-->
``` http
POST https://graph.microsoft.com/v1.0** Entity URI for microsoft.graph.vpnConfiguration not found/assign

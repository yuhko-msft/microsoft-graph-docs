...
-->
``` http
PATCH /educationUser/assignments/{educationAssignmentId}
PATCH /educationClass/assignments/{educationAssignmentId}
```
...
-->
``` http
PATCH https://graph.microsoft.com/beta/educationUser/assignments/{educationAssignmentId}

---
title: "workbookFunctions: coupPcd"
...
-->
``` http
POST /workbooks/{workbooksId}/workbook/functions/coupPcd
```
...
<!-- {
  "blockType": "request",
  "name": "workbookfunctions_couppcd"
}
-->
``` http
POST https://graph.microsoft.com/beta/workbooks/{workbooksId}/workbook/functions/coupPcd

...
Create a new [userExperienceAnalyticsWorkFromAnywhereHardwareReadinessMetric](../resources/userexperienceanalyticsworkfromanywherehardwarereadinessmetric.md) object.
...
-->
``` http
POST ** Collection URI for microsoft.management.services.api.userExperienceAnalyticsWorkFromAnywhereHardwareReadinessMetric not found
```
...
-->
``` http
POST https://graph.microsoft.com/beta** Collection URI for microsoft.management.services.api.userExperienceAnalyticsWorkFromAnywhereHardwareReadinessMetric not found

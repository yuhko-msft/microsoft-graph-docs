...
-->
``` http
POST ** Collection URI for BadUnresolvedEntityType:microsoft.graph.group not found/$ref
```
...
-->
``` http
POST https://graph.microsoft.com/beta** Collection URI for BadUnresolvedEntityType:microsoft.graph.group not found/$ref

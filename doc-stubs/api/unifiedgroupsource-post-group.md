...
-->
``` http
POST ** Collection URI for microsoft.compliance.ediscovery.contract.group not found/$ref
```
...
-->
``` http
POST https://graph.microsoft.com/beta** Collection URI for microsoft.compliance.ediscovery.contract.group not found/$ref

...
-->
``` http
GET /unifiedRoleAssignmentSchedule/activatedUsing/directoryScope
```
...
-->
``` http
GET https://graph.microsoft.com/beta/unifiedRoleAssignmentSchedule/activatedUsing/directoryScope
```

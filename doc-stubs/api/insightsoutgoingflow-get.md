...
Read the properties and relationships of an [insightsOutgoingFlow](../resources/insightsoutgoingflow.md) object.
...
If successful, this method returns a `200 OK` response code and an [insightsOutgoingFlow](../resources/insightsoutgoingflow.md) object in the response body.

...
description: "Get a list of the auditLogRoot objects and their properties."
...
Get a list of the [auditLogRoot](../resources/auditlogroot.md) objects and their properties.
...
-->
``` http
GET https://graph.microsoft.com/beta** Collection URI for microsoft.graph.auditLogRoot not found
```
  ...
  "value": [
    {
      ...
      "id": "bbd277ed-77ed-bbd2-ed77-d2bbed77d2bb"
    }
  ]
}
```

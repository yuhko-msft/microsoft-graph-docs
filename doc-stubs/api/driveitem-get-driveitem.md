...
-->
``` http
GET /drives/{drivesId}/activities/{itemActivityOLDId}/driveItem/children
```
...
-->
``` http
GET https://graph.microsoft.com/beta/drives/{drivesId}/activities/{itemActivityOLDId}/driveItem/children
```

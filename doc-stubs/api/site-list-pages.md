---
title: "List pages"
description: "Get the sitePage resources from the pages navigation property."
...
Get the sitePage resources from the pages navigation property.
...
-->
``` http
GET https://graph.microsoft.com/v1.0/sites/{sitesId}/pages
```

...
description: "Get the driveItem resources from the following navigation property."
...
Get the driveItem resources from the following navigation property.
...
-->
``` http
GET https://graph.microsoft.com/beta/drive/following
```

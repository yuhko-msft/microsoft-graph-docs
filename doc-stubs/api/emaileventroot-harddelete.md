---
title: "emailEventRoot: hardDelete"
...
-->
``` http
POST /security/emailEvent/hardDelete
```
...
<!-- {
  "blockType": "request",
  "name": "emaileventroot_harddelete"
}
-->
``` http
POST https://graph.microsoft.com/beta/security/emailEvent/hardDelete

---
title: "emailEventRoot: movetoDeletedItems"
...
# emailEventRoot: movetoDeletedItems
...
-->
``` http
POST /security/emailEvent/movetoDeletedItems
```
...
<!-- {
  "blockType": "request",
  "name": "emaileventroot_movetodeleteditems"
}
-->
``` http
POST https://graph.microsoft.com/beta/security/emailEvent/movetoDeletedItems

---
title: "androidManagedAppProtection: hasPayloadLinks"
...
# androidManagedAppProtection: hasPayloadLinks
...
<!-- {
  "blockType": "request",
  "name": "androidmanagedappprotection_haspayloadlinks"
}
-->
``` http
POST https://graph.microsoft.com/v1.0/deviceAppManagement/androidManagedAppProtections/hasPayloadLinks

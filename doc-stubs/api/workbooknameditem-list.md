...
description: "Get a list of the workbookNamedItem objects and their properties."
...
Get a list of the [workbookNamedItem](../resources/workbooknameditem.md) objects and their properties.
...
-->
``` http
GET /workbooks/{workbooksId}/workbook/names
...
-->
``` http
GET https://graph.microsoft.com/beta/workbooks/{workbooksId}/workbook/names
```

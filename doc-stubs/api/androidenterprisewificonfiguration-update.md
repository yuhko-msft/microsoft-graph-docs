...
The following table shows the properties that are required when you update the [androidEnterpriseWiFiConfiguration](../resources/androidenterprisewificonfiguration.md).
...
-->
``` http
PATCH https://graph.microsoft.com/v1.0** Entity URI for microsoft.graph.androidEnterpriseWiFiConfiguration not found

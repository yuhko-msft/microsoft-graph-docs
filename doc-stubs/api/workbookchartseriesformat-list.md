...
description: "Get a list of the workbookChartSeriesFormat objects and their properties."
...
Get a list of the [workbookChartSeriesFormat](../resources/workbookchartseriesformat.md) objects and their properties.
...
-->
``` http
GET https://graph.microsoft.com/beta** Collection URI for microsoft.graph.workbookChartSeriesFormat not found
```

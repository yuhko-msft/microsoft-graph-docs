---
title: "workbookFunctions: priceMat"
...
-->
``` http
POST /workbooks/{workbooksId}/workbook/functions/priceMat
```
...
<!-- {
  "blockType": "request",
  "name": "workbookfunctions_pricemat"
}
-->
``` http
POST https://graph.microsoft.com/beta/workbooks/{workbooksId}/workbook/functions/priceMat

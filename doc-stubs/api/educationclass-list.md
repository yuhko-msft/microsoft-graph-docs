...
-->
``` http
GET ** Collection URI for microsoft.education.assignments.api.educationClass not found
```
...
-->
``` http
GET https://graph.microsoft.com/beta** Collection URI for microsoft.education.assignments.api.educationClass not found
```
...
<!-- {
  "blockType": "response",
  "truncated": true,
  "@odata.type": "Collection(microsoft.education.assignments.api.educationClass)"
}
-->
``` http
HTTP/1.1 200 OK

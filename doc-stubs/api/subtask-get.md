...
-->
``` http
GET /me/todo/lists/{todoTaskListId}/tasks/{todoTaskId}/subtasks/{subtaskId}
GET /users/{usersId}/todo/lists/{todoTaskListId}/tasks/{todoTaskId}/subtasks/{subtaskId}
```
...
-->
``` http
GET https://graph.microsoft.com/beta/me/todo/lists/{todoTaskListId}/tasks/{todoTaskId}/subtasks/{subtaskId}
```

...
-->
``` http
POST /deviceManagementReports/getUnhealthyDefenderAgentsReport
```
...
-->
``` http
POST https://graph.microsoft.com/beta/deviceManagementReports/getUnhealthyDefenderAgentsReport

...
description: "Get a list of the deviceManagementIntentSettingCategory objects and their properties."
...
Get a list of the [deviceManagementIntentSettingCategory](../resources/devicemanagementintentsettingcategory.md) objects and their properties.
...
<!-- {
  "blockType": "request",
  "name": "list_devicemanagementintentsettingcategory"
}
-->
``` http
GET https://graph.microsoft.com/v1.0/deviceManagement/intents/{deviceManagementIntentId}/categories
```

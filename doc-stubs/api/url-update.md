---
title: "Update url"
description: "Update the properties of an url object."
...
Update the properties of an [url](../resources/url.md) object.
...
If successful, this method returns a `200 OK` response code and an updated [url](../resources/url.md) object in the response body.
...
-->
``` http
PATCH https://graph.microsoft.com/beta/url

---
title: "androidVpnConfiguration: assign"
...
# androidVpnConfiguration: assign
...
-->
``` http
POST ** Entity URI for microsoft.graph.androidVpnConfiguration not found/assign
```
...
<!-- {
  "blockType": "request",
  "name": "androidvpnconfiguration_assign"
}
-->
``` http
POST https://graph.microsoft.com/v1.0** Entity URI for microsoft.graph.androidVpnConfiguration not found/assign

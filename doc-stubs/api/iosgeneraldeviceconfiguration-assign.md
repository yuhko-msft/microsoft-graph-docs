---
title: "iosGeneralDeviceConfiguration: assign"
...
# iosGeneralDeviceConfiguration: assign
...
-->
``` http
POST ** Entity URI for microsoft.graph.iosGeneralDeviceConfiguration not found/assign
```
...
<!-- {
  "blockType": "request",
  "name": "iosgeneraldeviceconfiguration_assign"
}
-->
``` http
POST https://graph.microsoft.com/beta** Entity URI for microsoft.graph.iosGeneralDeviceConfiguration not found/assign

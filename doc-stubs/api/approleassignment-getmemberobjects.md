---
title: "appRoleAssignment: getMemberObjects"
...
-->
``` http
POST /me/appRoleAssignments/{appRoleAssignmentId}/getMemberObjects
```
...
-->
``` http
POST https://graph.microsoft.com/v1.0/me/appRoleAssignments/{appRoleAssignmentId}/getMemberObjects

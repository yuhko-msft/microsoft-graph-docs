...
description: "Update the properties of a resourceNamespaces object."
...
Update the properties of a resourceNamespaces object.
...
-->
``` http
PATCH /roleManagement/deviceManagement/resourceNamespaces
```
...
-->
``` http
PATCH https://graph.microsoft.com/beta/roleManagement/deviceManagement/resourceNamespaces
...
{
  "@odata.type": "#microsoft.graph.unifiedRbacResourceNamespace",
  "id": "a2236d5c-6d5c-a223-5c6d-23a25c6d23a2",
  "name": "String"
}
```

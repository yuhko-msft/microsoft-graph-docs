...
-->
``` http
POST https://graph.microsoft.com/beta** Collection URI for microsoft.graph.managedDeviceMobileAppConfigurationUserSummary not found
...
{
  "@odata.type": "#microsoft.graph.managedDeviceMobileAppConfigurationUserSummary",
  "id": "2a1f38b3-38b3-2a1f-b338-1f2ab3381f2a",
  "configurationVersion": "Integer",
  "conflictCount": "Integer",
  "errorCount": "Integer",
  "failedCount": "Integer",

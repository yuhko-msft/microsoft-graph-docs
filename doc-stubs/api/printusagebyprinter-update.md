...
-->
``` http
PATCH /print/reports/dailyPrintUsageByPrinter/{printUsageByPrinterId}
PATCH /print/reports/monthlyPrintUsageByPrinter/{printUsageByPrinterId}
PATCH /print/reports/dailyPrintUsageSummariesByPrinter/{printUsageByPrinterId}
PATCH /print/reports/monthlyPrintUsageSummariesByPrinter/{printUsageByPrinterId}
```
...
-->
``` http
PATCH https://graph.microsoft.com/v1.0/print/reports/dailyPrintUsageByPrinter/{printUsageByPrinterId}

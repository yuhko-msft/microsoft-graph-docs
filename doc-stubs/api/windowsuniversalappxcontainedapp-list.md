...
-->
``` http
GET https://graph.microsoft.com/beta** Collection URI for microsoft.graph.windowsUniversalAppXContainedApp not found
```
  ...
  "value": [
    {
      ...
      "id": "5b66036a-036a-5b66-6a03-665b6a03665b",

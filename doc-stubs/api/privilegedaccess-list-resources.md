...
description: "Get the governanceResource resources from the resources navigation property."
...
Get the governanceResource resources from the resources navigation property.
...
-->
``` http
GET https://graph.microsoft.com/v1.0/privilegedAccess/{privilegedAccessId}/resources
```

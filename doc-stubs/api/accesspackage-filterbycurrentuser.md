...
-->
``` http
GET /entitlementManagement/accessPackages/filterByCurrentUser
```
...
-->
``` http
GET https://graph.microsoft.com/v1.0/entitlementManagement/accessPackages/filterByCurrentUser(on='parameterValue')
```

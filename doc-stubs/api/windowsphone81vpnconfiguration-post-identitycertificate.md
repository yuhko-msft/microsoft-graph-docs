---
title: "Add windowsPhone81CertificateProfileBase"
...
# Add windowsPhone81CertificateProfileBase
...
-->
``` http
POST ** Collection URI for microsoft.graph.windowsPhone81CertificateProfileBase not found/$ref
```
...
If successful, this method returns a `204 No Content` response code and a [windowsPhone81CertificateProfileBase](../resources/windowsphone81certificateprofilebase.md) object in the response body.
...
-->
``` http
POST https://graph.microsoft.com/beta** Collection URI for microsoft.graph.windowsPhone81CertificateProfileBase not found/$ref

...
description: "Get a list of the managedAppPolicyDeploymentSummary objects and their properties."
...
Get a list of the [managedAppPolicyDeploymentSummary](../resources/managedapppolicydeploymentsummary.md) objects and their properties.
...
-->
``` http
GET https://graph.microsoft.com/beta** Collection URI for microsoft.graph.managedAppPolicyDeploymentSummary not found
```

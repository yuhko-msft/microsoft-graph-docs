...
-->
``` http
POST ** Entity URI for microsoft.management.services.api.windowsManagedDevice not found/createDeviceLogCollectionRequest
```
...
-->
``` http
POST https://graph.microsoft.com/beta** Entity URI for microsoft.management.services.api.windowsManagedDevice not found/createDeviceLogCollectionRequest

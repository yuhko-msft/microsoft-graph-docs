---
title: "Update locatedRiskEvent"
description: "Update the properties of a locatedRiskEvent object."
...
# Update locatedRiskEvent
Namespace: microsoft.graph



Update the properties of a [locatedRiskEvent](../resources/locatedriskevent.md) object.
...
The following table shows the properties that are required when you update the [locatedRiskEvent](../resources/locatedriskevent.md).
...
If successful, this method returns a `200 OK` response code and an updated [locatedRiskEvent](../resources/locatedriskevent.md) object in the response body.
...
<!-- {
  "blockType": "request",
  "name": "update_locatedriskevent"
}
-->
``` http
PATCH https://graph.microsoft.com/v1.0/locatedRiskEvent

...
-->
``` http
DELETE /policyRoot/permissionGrantPolicies/{id}
```
...
<!-- {
  "blockType": "request",
  "name": "delete_permissiongrantpolicies_from_policyroot"
}
-->
``` http
DELETE https://graph.microsoft.com/beta/policyRoot/permissionGrantPolicies/{id}
```

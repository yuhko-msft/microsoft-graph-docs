...
-->
``` http
POST /workbooks/{workbooksId}/workbook/functions/dvar
```
...
<!-- {
  "blockType": "request",
  "name": "workbookfunctions_dvar"
}
-->
``` http
POST https://graph.microsoft.com/beta/workbooks/{workbooksId}/workbook/functions/dvar

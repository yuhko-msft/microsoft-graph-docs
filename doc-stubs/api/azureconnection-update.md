---
title: "Update AzureConnection"
description: "Update the properties of an AzureConnection object."
...
Update the properties of an [AzureConnection](../resources/azureconnection.md) object.
...
-->
``` http
PATCH /azureConnections/{azureConnectionsId}
```
...
<!-- {
  "blockType": "request",
  "name": "update_azureconnection"
}
-->
``` http
PATCH https://graph.microsoft.com/beta/azureConnections/{azureConnectionsId}

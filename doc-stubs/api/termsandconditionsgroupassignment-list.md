...
description: "Get a list of the termsAndConditionsGroupAssignment objects and their properties."
...
Get a list of the [termsAndConditionsGroupAssignment](../resources/termsandconditionsgroupassignment.md) objects and their properties.
...
<!-- {
  "blockType": "request",
  "name": "list_termsandconditionsgroupassignment"
}
-->
``` http
GET https://graph.microsoft.com/v1.0/deviceManagement/termsAndConditions/{termsAndConditionsId}/groupAssignments
```

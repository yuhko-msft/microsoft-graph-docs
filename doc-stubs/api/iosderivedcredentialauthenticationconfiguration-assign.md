---
title: "iosDerivedCredentialAuthenticationConfiguration: assign"
...
# iosDerivedCredentialAuthenticationConfiguration: assign
...
-->
``` http
POST ** Entity URI for microsoft.graph.iosDerivedCredentialAuthenticationConfiguration not found/assign
```
...
<!-- {
  "blockType": "request",
  "name": "iosderivedcredentialauthenticationconfiguration_assign"
}
-->
``` http
POST https://graph.microsoft.com/v1.0** Entity URI for microsoft.graph.iosDerivedCredentialAuthenticationConfiguration not found/assign

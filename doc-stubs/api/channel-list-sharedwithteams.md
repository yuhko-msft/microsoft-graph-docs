---
title: "List sharedWithTeams"
description: "Get the sharedWithChannelTeamInfo resources from the sharedWithTeams navigation property."
...
# List sharedWithTeams
Namespace: microsoft.graph

[!INCLUDE [beta-disclaimer](../../includes/beta-disclaimer.md)]

Get the sharedWithChannelTeamInfo resources from the sharedWithTeams navigation property.
...
-->
``` http
GET https://graph.microsoft.com/beta/teams/{teamsId}/channels/{channelId}/sharedWithTeams
```

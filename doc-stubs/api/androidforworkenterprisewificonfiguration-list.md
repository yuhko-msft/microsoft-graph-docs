...
description: "Get a list of the androidForWorkEnterpriseWiFiConfiguration objects and their properties."
...
Get a list of the [androidForWorkEnterpriseWiFiConfiguration](../resources/androidforworkenterprisewificonfiguration.md) objects and their properties.
...
<!-- {
  "blockType": "request",
  "name": "list_androidforworkenterprisewificonfiguration"
}
-->
``` http
GET https://graph.microsoft.com/beta** Collection URI for microsoft.graph.androidForWorkEnterpriseWiFiConfiguration not found
```

...
description: "Get a list of the baseItemVersion objects and their properties."
...
Get a list of the [baseItemVersion](../resources/baseitemversion.md) objects and their properties.
...
<!-- {
  "blockType": "request",
  "name": "list_baseitemversion"
}
-->
``` http
GET https://graph.microsoft.com/beta** Collection URI for microsoft.graph.baseItemVersion not found
```

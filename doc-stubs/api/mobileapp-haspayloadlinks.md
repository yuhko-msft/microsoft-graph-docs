---
title: "mobileApp: hasPayloadLinks"
...
<!-- {
  "blockType": "request",
  "name": "mobileapp_haspayloadlinks"
}
-->
``` http
POST https://graph.microsoft.com/v1.0/deviceAppManagement/mobileApps/hasPayloadLinks

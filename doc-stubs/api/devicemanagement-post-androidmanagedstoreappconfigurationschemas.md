...
Create a new androidManagedStoreAppConfigurationSchema object.
...
-->
``` http
POST https://graph.microsoft.com/v1.0/deviceManagement/androidManagedStoreAppConfigurationSchemas

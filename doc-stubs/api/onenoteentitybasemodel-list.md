...
description: "Get a list of the onenoteEntityBaseModel objects and their properties."
...
Get a list of the [onenoteEntityBaseModel](../resources/onenoteentitybasemodel.md) objects and their properties.
...
<!-- {
  "blockType": "request",
  "name": "list_onenoteentitybasemodel"
}
-->
``` http
GET https://graph.microsoft.com/beta** Collection URI for microsoft.graph.onenoteEntityBaseModel not found
```

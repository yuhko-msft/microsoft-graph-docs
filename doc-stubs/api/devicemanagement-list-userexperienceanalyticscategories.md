...
description: "Get the userExperienceAnalyticsCategory resources from the userExperienceAnalyticsCategories navigation property."
...
Get the userExperienceAnalyticsCategory resources from the userExperienceAnalyticsCategories navigation property.
...
-->
``` http
GET https://graph.microsoft.com/v1.0/deviceManagement/userExperienceAnalyticsCategories
```

...
-->
``` http
DELETE ** Entity URI for microsoft.graph.industryData.azureDataLakeConnector not found
```
...
-->
``` http
DELETE https://graph.microsoft.com/beta** Entity URI for microsoft.graph.industryData.azureDataLakeConnector not found
```

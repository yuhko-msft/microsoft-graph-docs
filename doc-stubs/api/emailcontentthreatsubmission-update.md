...
Update the properties of an [emailContentThreatSubmission](../resources/emailcontentthreatsubmission.md) object.
...
If successful, this method returns a `200 OK` response code and an updated [emailContentThreatSubmission](../resources/emailcontentthreatsubmission.md) object in the response body.

---
title: "List deviceHealthScriptRunSummary"
description: "Get the deviceHealthScriptRunSummary resources from the runSummary navigation property."
...
# List deviceHealthScriptRunSummary
Namespace: microsoft.graph

[!INCLUDE [beta-disclaimer](../../includes/beta-disclaimer.md)]

Get the deviceHealthScriptRunSummary resources from the runSummary navigation property.
...
<!-- {
  "blockType": "response",
  "truncated": true,
  "@odata.type": "Collection(microsoft.management.services.api.deviceHealthScriptRunSummary)"
}
-->
``` http
HTTP/1.1 200 OK

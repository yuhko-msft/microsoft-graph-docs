---
title: "Update deviceManagementConfigurationSimpleSettingDefinition"
description: "Update the properties of a deviceManagementConfigurationSimpleSettingDefinition object."
...
# Update deviceManagementConfigurationSimpleSettingDefinition
Namespace: microsoft.graph

[!INCLUDE [beta-disclaimer](../../includes/beta-disclaimer.md)]

Update the properties of a [deviceManagementConfigurationSimpleSettingDefinition](../resources/devicemanagementconfigurationsimplesettingdefinition.md) object.
...
-->
``` http
PATCH /deviceManagementConfigurationSimpleSettingDefinition
```
...
## Request body
In the request body, supply a JSON representation of the [deviceManagementConfigurationSimpleSettingDefinition](../resources/devicemanagementconfigurationsimplesettingdefinition.md) object.

The following table shows the properties that are required when you update the [deviceManagementConfigurationSimpleSettingDefinition](../resources/devicemanagementconfigurationsimplesettingdefinition.md).
...
If successful, this method returns a `200 OK` response code and an updated [deviceManagementConfigurationSimpleSettingDefinition](../resources/devicemanagementconfigurationsimplesettingdefinition.md) object in the response body.
...
<!-- {
  "blockType": "request",
  "name": "update_devicemanagementconfigurationsimplesettingdefinition"
}
-->
``` http
PATCH https://graph.microsoft.com/beta/deviceManagementConfigurationSimpleSettingDefinition
...
{
  "@odata.type": "#microsoft.graph.deviceManagementConfigurationSimpleSettingDefinition",
  "id": "16f84610-4610-16f8-1046-f8161046f816",
  "accessTypes": "String",
  "applicability": {
    "@odata.type": "microsoft.graph.deviceManagementConfigurationSettingApplicability"
  },

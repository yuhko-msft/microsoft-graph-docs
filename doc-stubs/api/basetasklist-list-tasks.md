...
-->
``` http
GET /user/tasks/lists/{wellKnownTaskListId}/tasks/{taskId}/parentList/tasks
```
...
-->
``` http
GET https://graph.microsoft.com/beta/user/tasks/lists/{wellKnownTaskListId}/tasks/{taskId}/parentList/tasks
```

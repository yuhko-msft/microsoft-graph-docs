...
Read the properties and relationships of an [iosMobileAppConfiguration](../resources/intune-iosmobileappconfiguration.md) object.
...
If successful, this method returns a `200 OK` response code and an [iosMobileAppConfiguration](../resources/intune-iosmobileappconfiguration.md) object in the response body.

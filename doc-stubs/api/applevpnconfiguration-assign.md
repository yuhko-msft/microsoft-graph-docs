---
title: "appleVpnConfiguration: assign"
...
-->
``` http
POST ** Entity URI for microsoft.graph.appleVpnConfiguration not found/assign
```
...
<!-- {
  "blockType": "request",
  "name": "applevpnconfiguration_assign"
}
-->
``` http
POST https://graph.microsoft.com/v1.0** Entity URI for microsoft.graph.appleVpnConfiguration not found/assign

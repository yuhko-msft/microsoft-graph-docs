...
-->
``` http
PATCH ** Entity URI for microsoft.management.services.api.windowsAppX not found
```
...
<!-- {
  "blockType": "request",
  "name": "update_windowsappx"
}
-->
``` http
PATCH https://graph.microsoft.com/beta** Entity URI for microsoft.management.services.api.windowsAppX not found

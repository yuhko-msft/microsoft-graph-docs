...
The following table shows the properties that are required when you update the [windowsAppX](../resources/windowsappx.md).
...
-->
``` http
PATCH https://graph.microsoft.com/v1.0** Entity URI for microsoft.graph.windowsAppX not found

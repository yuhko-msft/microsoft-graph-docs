...
You can specify the following properties when creating an **itemPhone**.
...
|type|phoneType|**TODO: Add Description**. The possible values are: `home`, `business`, `mobile`, `other`, `assistant`, `homeFax`, `businessFax`, `otherFax`, `pager`, `radio`. Required.|
|number|String|**TODO: Add Description** Required.|
...
{
  "@odata.type": "#Microsoft.Fast.PI.ViewGenerator.V2.Profile.Models.itemPhone",
  "id": "96cac131-c131-96ca-31c1-ca9631c1ca96",
  "allowedAudiences": "String",
  "inference": {
    "@odata.type": "microsoft.graph.inferenceData"
  },

---
title: "androidWiFiConfiguration: assign"
...
# androidWiFiConfiguration: assign
...
-->
``` http
POST ** Entity URI for microsoft.graph.androidWiFiConfiguration not found/assign
```
...
<!-- {
  "blockType": "request",
  "name": "androidwificonfiguration_assign"
}
-->
``` http
POST https://graph.microsoft.com/v1.0** Entity URI for microsoft.graph.androidWiFiConfiguration not found/assign

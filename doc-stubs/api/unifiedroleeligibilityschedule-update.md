...
-->
``` http
PATCH /unifiedRoleAssignmentSchedule/activatedUsing
PATCH /rbacApplication/roleEligibilitySchedules/{unifiedRoleEligibilityScheduleId}
```
...
-->
``` http
PATCH https://graph.microsoft.com/beta/unifiedRoleAssignmentSchedule/activatedUsing

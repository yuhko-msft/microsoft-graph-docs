---
title: "List governanceRoleAssignment"
description: "Get the governanceRoleAssignment resources from the linkedEligibleRoleAssignment navigation property."
...
Get the governanceRoleAssignment resources from the linkedEligibleRoleAssignment navigation property.
...
-->
``` http
GET https://graph.microsoft.com/v1.0/governanceRoleAssignments/{governanceRoleAssignmentsId}/linkedEligibleRoleAssignment
```

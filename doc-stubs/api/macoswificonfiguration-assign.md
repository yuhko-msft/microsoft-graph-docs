---
title: "macOSWiFiConfiguration: assign"
...
-->
``` http
POST https://graph.microsoft.com/v1.0** Entity URI for microsoft.graph.macOSWiFiConfiguration not found/assign

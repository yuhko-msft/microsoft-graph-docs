...
-->
``` http
POST ** Collection URI for microsoft.graph.windowsAppX not found
```
...
-->
``` http
POST https://graph.microsoft.com/beta** Collection URI for microsoft.graph.windowsAppX not found
...
{
  "@odata.type": "#microsoft.graph.windowsAppX",
  "id": "5a1430b2-30b2-5a14-b230-145ab230145a",

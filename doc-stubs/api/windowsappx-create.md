...
Create a new [windowsAppX](../resources/windowsappx.md) object.
...
-->
``` http
POST ** Collection URI for microsoft.management.services.api.windowsAppX not found
```
...
If successful, this method returns a `201 Created` response code and a [windowsAppX](../resources/windowsappx.md) object in the response body.
...
<!-- {
  "blockType": "request",
  "name": "create_windowsappx_from_"
}
-->
``` http
POST https://graph.microsoft.com/beta** Collection URI for microsoft.management.services.api.windowsAppX not found

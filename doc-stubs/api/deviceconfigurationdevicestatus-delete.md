...
description: "Deletes a deviceConfigurationDeviceStatus object."
...
Deletes a [deviceConfigurationDeviceStatus](../resources/deviceconfigurationdevicestatus.md) object.
...
<!-- {
  "blockType": "request",
  "name": "delete_deviceconfigurationdevicestatus"
}
-->
``` http

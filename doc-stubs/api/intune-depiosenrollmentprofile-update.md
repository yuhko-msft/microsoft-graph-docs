...
Update the properties of a [depIOSEnrollmentProfile](../resources/intune-depiosenrollmentprofile.md) object.
...
## Request body
In the request body, supply a JSON representation of the [depIOSEnrollmentProfile](../resources/intune-depiosenrollmentprofile.md) object.

The following table shows the properties that are required when you update the [depIOSEnrollmentProfile](../resources/intune-depiosenrollmentprofile.md).
...
If successful, this method returns a `200 OK` response code and an updated [depIOSEnrollmentProfile](../resources/intune-depiosenrollmentprofile.md) object in the response body.

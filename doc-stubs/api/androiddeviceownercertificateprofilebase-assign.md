---
title: "androidDeviceOwnerCertificateProfileBase: assign"
...
# androidDeviceOwnerCertificateProfileBase: assign
...
<!-- {
  "blockType": "request",
  "name": "androiddeviceownercertificateprofilebase_assign"
}
-->
``` http

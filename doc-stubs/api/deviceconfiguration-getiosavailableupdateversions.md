...
# deviceConfiguration: getIosAvailableUpdateVersions
...
-->
``` http
GET https://graph.microsoft.com/v1.0/deviceManagement/deviceConfigurations/getIosAvailableUpdateVersions
```

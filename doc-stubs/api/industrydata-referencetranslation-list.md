---
title: "List referenceTranslations"
description: "Get a list of the referenceTranslation objects and their properties."
...
# List referenceTranslations
Namespace: microsoft.graph.industryData

[!INCLUDE [beta-disclaimer](../../includes/beta-disclaimer.md)]

Get a list of the [referenceTranslation](../resources/industrydata-referencetranslation.md) objects and their properties.
...
<!-- {
  "blockType": "response",
  "truncated": true,
  "@odata.type": "Collection(microsoft.graph.industryData.referenceTranslation)"
}
-->
``` http
HTTP/1.1 200 OK

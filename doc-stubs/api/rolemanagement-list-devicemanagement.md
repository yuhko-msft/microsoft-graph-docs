...
description: "Get the rbacApplicationMultiple resources from the deviceManagement navigation property."
...
Get the rbacApplicationMultiple resources from the deviceManagement navigation property.
...
-->
``` http
GET https://graph.microsoft.com/v1.0/roleManagement/deviceManagement
```

...
-->
``` http
GET https://graph.microsoft.com/beta** Collection URI for microsoft.graph.activeDirectoryWindowsAutopilotDeploymentProfile not found
```
  ...
  "value": [
    {
      ...
      "id": "40617f04-7f04-4061-047f-6140047f6140",

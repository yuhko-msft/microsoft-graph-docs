...
description: "Get the connectorGroup resources from the connectorGroups navigation property."
...
Get the connectorGroup resources from the connectorGroups navigation property.
...
-->
``` http
GET https://graph.microsoft.com/v1.0/onPremisesPublishingProfiles/{onPremisesPublishingProfilesId}/connectorGroups
```

...
GET /print/reports/getYammerDeviceUsageDistributionUserCounts
```
...
-->
``` http
GET https://graph.microsoft.com/v1.0/reports/getYammerDeviceUsageDistributionUserCounts(period='parameterValue')
```

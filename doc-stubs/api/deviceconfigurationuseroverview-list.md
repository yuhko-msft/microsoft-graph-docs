...
description: "Get a list of the deviceConfigurationUserOverview objects and their properties."
...
Get a list of the [deviceConfigurationUserOverview](../resources/deviceconfigurationuseroverview.md) objects and their properties.
...
-->
``` http
GET https://graph.microsoft.com/v1.0** Collection URI for microsoft.graph.deviceConfigurationUserOverview not found
```

...
Update the properties of an [insightsOutgoingFlow](../resources/industrydata-insightsoutgoingflow.md) object.
...
If successful, this method returns a `200 OK` response code and an updated [insightsOutgoingFlow](../resources/industrydata-insightsoutgoingflow.md) object in the response body.

...
-->
``` http
POST https://graph.microsoft.com/v1.0/compliance/ediscovery/cases/{caseId}/noncustodialDataSources/{noncustodialDataSourceId}/dataSource
...
{
  "@odata.type": "#microsoft.graph.ediscovery.dataSource",
  "id": "d54a1d78-1d78-d54a-781d-4ad5781d4ad5",
  "displayName": "String",

...
-->
``` http
POST /compliance/ediscovery/cases/{caseId}/noncustodialDataSources/{noncustodialDataSourceId}/dataSource
```
...
-->
``` http
POST https://graph.microsoft.com/beta/compliance/ediscovery/cases/{caseId}/noncustodialDataSources/{noncustodialDataSourceId}/dataSource
...
{
  "@odata.type": "#microsoft.graph.ediscovery.dataSource",
  "id": "62e330f8-30f8-62e3-f830-e362f830e362",
  "displayName": "String",

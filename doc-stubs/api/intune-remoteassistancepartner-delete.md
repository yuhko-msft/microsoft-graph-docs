...
description: "Deletes a remoteAssistancePartner object."
...
Deletes a [remoteAssistancePartner](../resources/intune-remoteassistancepartner.md) object.
...
<!-- {
  "blockType": "request",
  "name": "delete_remoteassistancepartner"
}
-->
``` http

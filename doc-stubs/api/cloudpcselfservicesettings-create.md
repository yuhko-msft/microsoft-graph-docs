---
title: "Create cloudPcSelfServiceSettings"
...
# Create cloudPcSelfServiceSettings
Namespace: microsoft.graph

Create a new [cloudPcSelfServiceSettings](../resources/cloudpcselfservicesettings.md) object.
...
-->
``` http
POST https://graph.microsoft.com/v1.0** Collection URI for microsoft.graph.cloudPcSelfServiceSettings not found

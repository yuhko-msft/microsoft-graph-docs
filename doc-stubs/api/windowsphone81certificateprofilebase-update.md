---
title: "Update windowsPhone81CertificateProfileBase"
description: "Update the properties of a windowsPhone81CertificateProfileBase object."
...
Update the properties of a [windowsPhone81CertificateProfileBase](../resources/windowsphone81certificateprofilebase.md) object.
...
The following table shows the properties that are required when you update the [windowsPhone81CertificateProfileBase](../resources/windowsphone81certificateprofilebase.md).
...
If successful, this method returns a `200 OK` response code and an updated [windowsPhone81CertificateProfileBase](../resources/windowsphone81certificateprofilebase.md) object in the response body.
...
<!-- {
  "blockType": "request",
  "name": "update_windowsphone81certificateprofilebase"
}
-->
``` http

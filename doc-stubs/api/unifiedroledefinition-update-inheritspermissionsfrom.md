---
title: "Update inheritsPermissionsFrom"
description: "Update the properties of an inheritsPermissionsFrom object."
...
# Update inheritsPermissionsFrom
Namespace: microsoft.graph

Update the properties of an inheritsPermissionsFrom object.
...
-->
``` http
PATCH /roleManagement/directory/roleDefinitions/{unifiedRoleDefinitionId}/inheritsPermissionsFrom
```
...
<!-- {
  "blockType": "request",
  "name": "update_inheritspermissionsfrom"
}
-->
``` http
PATCH https://graph.microsoft.com/beta/roleManagement/directory/roleDefinitions/{unifiedRoleDefinitionId}/inheritsPermissionsFrom

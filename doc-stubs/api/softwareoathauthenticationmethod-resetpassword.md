...
-->
``` http
POST /user/authentication/oathMethods/{softwareOathAuthenticationMethodId}/resetPassword
```
...
-->
``` http
POST https://graph.microsoft.com/beta/user/authentication/oathMethods/{softwareOathAuthenticationMethodId}/resetPassword

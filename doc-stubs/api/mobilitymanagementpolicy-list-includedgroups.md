...
-->
``` http
GET /mobilityManagementPolicies/{mobilityManagementPoliciesId}/includedGroups
```
...
-->
``` http
GET https://graph.microsoft.com/beta/mobilityManagementPolicies/{mobilityManagementPoliciesId}/includedGroups
```

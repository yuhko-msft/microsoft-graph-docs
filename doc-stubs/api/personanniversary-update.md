...
PATCH /users/{usersId}/profile/anniversaries/{personAnniversaryId}
```
...
The following table shows the properties that are required when you update the [personAnniversary](../resources/personanniversary.md).

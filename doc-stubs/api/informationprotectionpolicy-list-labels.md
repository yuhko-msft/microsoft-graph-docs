---
title: "List labels"
description: "Get the informationProtectionLabel resources from the labels navigation property."
...
Get the informationProtectionLabel resources from the labels navigation property.
...
-->
``` http
GET https://graph.microsoft.com/v1.0/users/{usersId}/informationProtection/policy/labels
```

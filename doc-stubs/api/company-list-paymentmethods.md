...
description: "Get the paymentMethod resources from the paymentMethods navigation property."
...
Get the paymentMethod resources from the paymentMethods navigation property.
...
-->
``` http
GET https://graph.microsoft.com/v1.0/financials/companies/{companyId}/paymentMethods
```

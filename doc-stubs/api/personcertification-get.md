...
-->
``` http
GET /user/{userId}/profile/certifications/{personCertificationId}
```
...
-->
``` http
GET https://graph.microsoft.com/beta/user/{userId}/profile/certifications/{personCertificationId}
```

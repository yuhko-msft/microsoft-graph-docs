...
Update the properties of a [mobileAppPolicySetItem](../resources/intune-mobileapppolicysetitem.md) object.
...
If successful, this method returns a `200 OK` response code and an updated [mobileAppPolicySetItem](../resources/intune-mobileapppolicysetitem.md) object in the response body.

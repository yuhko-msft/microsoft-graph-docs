...
description: "Get a list of the windowsInformationProtection objects and their properties."
...
Get a list of the [windowsInformationProtection](../resources/windowsinformationprotection.md) objects and their properties.
...
<!-- {
  "blockType": "request",
  "name": "list_windowsinformationprotection"
}
-->
``` http
GET https://graph.microsoft.com/beta** Collection URI for microsoft.graph.windowsInformationProtection not found
```

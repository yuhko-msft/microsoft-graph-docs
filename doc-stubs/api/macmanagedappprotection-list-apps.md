...
-->
``` http
GET /deviceAppManagement/macManagedAppProtections/{macManagedAppProtectionId}/apps
```
...
-->
``` http
GET https://graph.microsoft.com/beta/deviceAppManagement/macManagedAppProtections/{macManagedAppProtectionId}/apps
```

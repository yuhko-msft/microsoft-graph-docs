---
title: "organization: getMemberGroups"
...
-->
``` http
POST /organization/{organizationId}/getMemberGroups
```
...
-->
``` http
POST https://graph.microsoft.com/beta/organization/{organizationId}/getMemberGroups

---
title: "List onenotes"
description: "Get a list of the onenote objects and their properties."
...
Get a list of the [onenote](../resources/onenote.md) objects and their properties.
...
-->
``` http
GET https://graph.microsoft.com/beta** Collection URI for microsoft.graph.onenote not found
```

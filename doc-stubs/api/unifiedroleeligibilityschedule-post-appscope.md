...
-->
``` http
POST /unifiedRoleAssignmentSchedule/activatedUsing/appScope/$ref
```
...
-->
``` http
POST https://graph.microsoft.com/beta/unifiedRoleAssignmentSchedule/activatedUsing/appScope/$ref

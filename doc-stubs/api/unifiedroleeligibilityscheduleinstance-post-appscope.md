...
-->
``` http
POST /unifiedRoleAssignmentScheduleInstance/activatedUsing/appScope/$ref
```
...
-->
``` http
POST https://graph.microsoft.com/beta/unifiedRoleAssignmentScheduleInstance/activatedUsing/appScope/$ref

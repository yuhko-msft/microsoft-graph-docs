...
-->
``` http
POST /roleManagement/directory/roleAssignmentScheduleInstances/{unifiedRoleAssignmentScheduleInstanceId}/activatedUsing/appScope/$ref
```
...
-->
``` http
POST https://graph.microsoft.com/beta/roleManagement/directory/roleAssignmentScheduleInstances/{unifiedRoleAssignmentScheduleInstanceId}/activatedUsing/appScope/$ref
...
{
  "@odata.type": "#microsoft.graph.appScope",
  "id": "7c4ac0f5-c0f5-7c4a-f5c0-4a7cf5c04a7c",
  "type": "String",
  "displayName": "String"
}
```

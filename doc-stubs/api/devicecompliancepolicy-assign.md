...
-->
``` http
POST /deviceCompliancePolicyGroupAssignment/deviceCompliancePolicy/assign
...
-->
``` http
POST https://graph.microsoft.com/beta/deviceCompliancePolicyGroupAssignment/deviceCompliancePolicy/assign

...
-->
``` http
GET ** Collection URI for Microsoft.Teams.GraphSvc.onlineMeeting not found
```
...
-->
``` http
GET https://graph.microsoft.com/beta** Collection URI for Microsoft.Teams.GraphSvc.onlineMeeting not found
```
...
<!-- {
  "blockType": "response",
  "truncated": true,
  "@odata.type": "Collection(Microsoft.Teams.GraphSvc.onlineMeeting)"
}
-->
``` http
HTTP/1.1 200 OK
  ...
  "value": [
    {
      ...
      "id": "58c0d292-d292-58c0-92d2-c05892d2c058"
    }
  ]
}
```

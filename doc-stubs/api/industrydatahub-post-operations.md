...
|status|longRunningOperationStatus|**TODO: Add Description**. The possible values are: `notstarted`, `running`, `succeeded`, `failed`. Optional.|
...
{
  "@odata.type": "#microsoft.graph.longRunningOperation",
  "id": "4937fab4-fab4-4937-b4fa-3749b4fa3749",

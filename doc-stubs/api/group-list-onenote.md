---
title: "List onenote"
description: "Get the onenote resources from the onenote navigation property."
...
Get the onenote resources from the onenote navigation property.
...
-->
``` http
GET https://graph.microsoft.com/beta/groups/{groupsId}/onenote
```

...
description: "Get a list of the targetedManagedAppConfigurationPolicySetItem objects and their properties."
...
Get a list of the [targetedManagedAppConfigurationPolicySetItem](../resources/targetedmanagedappconfigurationpolicysetitem.md) objects and their properties.
...
<!-- {
  "blockType": "request",
  "name": "list_targetedmanagedappconfigurationpolicysetitem"
}
-->
``` http
GET https://graph.microsoft.com/beta** Collection URI for microsoft.graph.targetedManagedAppConfigurationPolicySetItem not found
```
  ...
  "value": [
    {
      ...
      "id": "cba3ed0a-ed0a-cba3-0aed-a3cb0aeda3cb",

...
-->
``` http
PATCH /policies/permissionGrantPolicies/{permissionGrantPolicyId}
```
...
-->
``` http
PATCH https://graph.microsoft.com/beta/policies/permissionGrantPolicies/{permissionGrantPolicyId}

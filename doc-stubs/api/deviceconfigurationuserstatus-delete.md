...
description: "Deletes a deviceConfigurationUserStatus object."
...
Deletes a [deviceConfigurationUserStatus](../resources/deviceconfigurationuserstatus.md) object.
...
<!-- {
  "blockType": "request",
  "name": "delete_deviceconfigurationuserstatus"
}
-->
``` http

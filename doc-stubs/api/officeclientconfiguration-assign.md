---
title: "officeClientConfiguration: assign"
...
# officeClientConfiguration: assign
...
<!-- {
  "blockType": "request",
  "name": "officeclientconfiguration_assign"
}
-->
``` http
POST https://graph.microsoft.com/v1.0/officeConfiguration/clientConfigurations/{officeClientConfigurationId}/assign

...
Update the properties of a [macOSWiFiConfiguration](../resources/macoswificonfiguration.md) object.
...
-->
``` http
PATCH ** Entity URI for microsoft.graph.macOSWiFiConfiguration not found
```
...
The following table shows the properties that are required when you update the [macOSWiFiConfiguration](../resources/macoswificonfiguration.md).
...
If successful, this method returns a `200 OK` response code and an updated [macOSWiFiConfiguration](../resources/macoswificonfiguration.md) object in the response body.
...
<!-- {
  "blockType": "request",
  "name": "update_macoswificonfiguration"
}
-->
``` http
PATCH https://graph.microsoft.com/v1.0** Entity URI for microsoft.graph.macOSWiFiConfiguration not found

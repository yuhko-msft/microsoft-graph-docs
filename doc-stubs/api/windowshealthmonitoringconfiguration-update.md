...
The following table shows the properties that are required when you update the [windowsHealthMonitoringConfiguration](../resources/windowshealthmonitoringconfiguration.md).
...
-->
``` http
PATCH https://graph.microsoft.com/beta** Entity URI for microsoft.graph.windowsHealthMonitoringConfiguration not found
...
{
  "@odata.type": "#microsoft.graph.windowsHealthMonitoringConfiguration",
  "id": "88e4bb0b-bb0b-88e4-0bbb-e4880bbbe488",

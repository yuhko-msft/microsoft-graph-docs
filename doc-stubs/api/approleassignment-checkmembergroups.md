---
title: "appRoleAssignment: checkMemberGroups"
...
-->
``` http
POST /me/appRoleAssignments/{appRoleAssignmentId}/checkMemberGroups
```
...
-->
``` http
POST https://graph.microsoft.com/v1.0/me/appRoleAssignments/{appRoleAssignmentId}/checkMemberGroups

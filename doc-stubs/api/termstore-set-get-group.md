...
-->
``` http
GET /termStore/groups/{groupId}/sets/{setId}/parentGroup
```
...
-->
``` http
GET https://graph.microsoft.com/beta/termStore/groups/{groupId}/sets/{setId}/parentGroup
```

...
-->
``` http
GET https://graph.microsoft.com/beta/roleManagement/directory/roleEligibilityScheduleRequests/{unifiedRoleEligibilityScheduleRequestId}/targetSchedule
```
  ...
  "value": [
    {
      ...
      "id": "e0524d4a-4d4a-e052-4a4d-52e04a4d52e0",
      "appScopeId": "String",

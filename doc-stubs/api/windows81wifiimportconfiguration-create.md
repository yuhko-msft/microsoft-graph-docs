...
-->
``` http
POST ** Collection URI for microsoft.graph.windows81WifiImportConfiguration not found
```
...
<!-- {
  "blockType": "request",
  "name": "create_windows81wifiimportconfiguration_from_"
}
-->
``` http
POST https://graph.microsoft.com/beta** Collection URI for microsoft.graph.windows81WifiImportConfiguration not found

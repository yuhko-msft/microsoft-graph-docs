...
description: "Get the deviceComplianceActionItem resources from the scheduledActionConfigurations navigation property."
...
Get the deviceComplianceActionItem resources from the scheduledActionConfigurations navigation property.
...
<!-- {
  "blockType": "request",
  "name": "list_devicecomplianceactionitem"
}
-->
``` http

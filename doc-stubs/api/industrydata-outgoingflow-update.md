...
-->
``` http
PATCH ** Entity URI for microsoft.graph.industryData.outgoingFlow not found
```
...
-->
``` http
PATCH https://graph.microsoft.com/beta** Entity URI for microsoft.graph.industryData.outgoingFlow not found

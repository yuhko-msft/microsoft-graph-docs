...
-->
``` http
POST /identity/userFlowAttributes/$ref
```
...
-->
``` http
POST https://graph.microsoft.com/beta/identity/userFlowAttributes/$ref
...
{
  "@odata.type": "#Microsoft.Cpim.Api.DataModels.identityUserFlowAttribute",
  "id": "53d74cbe-4cbe-53d7-be4c-d753be4cd753",
  "displayName": "String",
  "description": "String",
  "userFlowAttributeType": "String",
  "dataType": "String"

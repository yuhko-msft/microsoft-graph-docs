...
description: "Get a list of the groupPolicyPresentationLongDecimalTextBox objects and their properties."
...
Get a list of the [groupPolicyPresentationLongDecimalTextBox](../resources/grouppolicypresentationlongdecimaltextbox.md) objects and their properties.
...
<!-- {
  "blockType": "request",
  "name": "list_grouppolicypresentationlongdecimaltextbox"
}
-->
``` http
GET https://graph.microsoft.com/v1.0** Collection URI for microsoft.graph.groupPolicyPresentationLongDecimalTextBox not found
```

---
title: "windows10EndpointProtectionConfiguration: assign"
...
# windows10EndpointProtectionConfiguration: assign
...
-->
``` http
POST ** Entity URI for microsoft.graph.windows10EndpointProtectionConfiguration not found/assign
```
...
<!-- {
  "blockType": "request",
  "name": "windows10endpointprotectionconfiguration_assign"
}
-->
``` http
POST https://graph.microsoft.com/beta** Entity URI for microsoft.graph.windows10EndpointProtectionConfiguration not found/assign

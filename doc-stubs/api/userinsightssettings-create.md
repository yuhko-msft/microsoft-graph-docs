...
-->
``` http
POST ** Collection URI for Microsoft.OfficeGraph.userInsightsSettings not found
```
...
-->
``` http
POST https://graph.microsoft.com/beta** Collection URI for Microsoft.OfficeGraph.userInsightsSettings not found

---
title: "deviceManagement: getRoleScopeTagsByResource"
...
# deviceManagement: getRoleScopeTagsByResource
...
-->
``` http
GET https://graph.microsoft.com/v1.0/deviceManagement/getRoleScopeTagsByResource(resource='parameterValue')
```

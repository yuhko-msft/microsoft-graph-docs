...
-->
``` http
PATCH /onlineMeeting/permissionGrants/{resourceSpecificPermissionGrantId}
```
...
-->
``` http
PATCH https://graph.microsoft.com/beta/onlineMeeting/permissionGrants/{resourceSpecificPermissionGrantId}
...
{
  "@odata.type": "#microsoft.graph.resourceSpecificPermissionGrant",
  "id": "670cdcce-dcce-670c-cedc-0c67cedc0c67"
}
```

...
Get a list of the [synchronizationSchema](../resources/synchronizationschema.md) objects and their properties.
...
-->
``` http
GET https://graph.microsoft.com/v1.0** Collection URI for microsoft.graph.synchronizationSchema not found
```

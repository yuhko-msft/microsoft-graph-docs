...
The following table shows the properties that are required when you update the [win32LobApp](../resources/win32lobapp.md).
...
<!-- {
  "blockType": "request",
  "name": "update_win32lobapp"
}
-->
``` http
PATCH https://graph.microsoft.com/beta** Entity URI for microsoft.graph.win32LobApp not found

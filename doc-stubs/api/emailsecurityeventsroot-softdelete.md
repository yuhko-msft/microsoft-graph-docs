---
title: "emailSecurityEventsRoot: softDelete"
...
# emailSecurityEventsRoot: softDelete
...
-->
``` http
POST /security/emailSecurityEvents/softDelete
```
...
<!-- {
  "blockType": "request",
  "name": "emailsecurityeventsroot_softdelete"
}
-->
``` http
POST https://graph.microsoft.com/beta/security/emailSecurityEvents/softDelete

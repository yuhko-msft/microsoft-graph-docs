...
-->
``` http
PATCH /drives/{drivesId}/activities/{itemActivityOLDId}/driveItem/listItem/driveItem
```
...
-->
``` http
PATCH https://graph.microsoft.com/beta/drives/{drivesId}/activities/{itemActivityOLDId}/driveItem/listItem/driveItem

...
Get a list of the [caseExportOperation](../resources/caseexportoperation.md) objects and their properties.
...
-->
``` http
GET ** Collection URI for microsoft.compliance.ediscovery.contract.caseExportOperation not found
```
...
-->
``` http
GET https://graph.microsoft.com/beta** Collection URI for microsoft.compliance.ediscovery.contract.caseExportOperation not found
```
...
<!-- {
  "blockType": "response",
  "truncated": true,
  "@odata.type": "Collection(microsoft.compliance.ediscovery.contract.caseExportOperation)"
}
-->
``` http
HTTP/1.1 200 OK

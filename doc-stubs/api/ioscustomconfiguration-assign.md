---
title: "iosCustomConfiguration: assign"
...
-->
``` http
POST ** Entity URI for microsoft.graph.iosCustomConfiguration not found/assign
```
...
<!-- {
  "blockType": "request",
  "name": "ioscustomconfiguration_assign"
}
-->
``` http
POST https://graph.microsoft.com/beta** Entity URI for microsoft.graph.iosCustomConfiguration not found/assign

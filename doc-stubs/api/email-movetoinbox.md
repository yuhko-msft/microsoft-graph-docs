...
-->
``` http
POST /security/emailEvent/emails/{emailId}/movetoInbox
```
...
<!-- {
  "blockType": "request",
  "name": "email_movetoinbox"
}
-->
``` http
POST https://graph.microsoft.com/beta/security/emailEvent/emails/{emailId}/movetoInbox

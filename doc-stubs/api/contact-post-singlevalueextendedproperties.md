...
-->
``` http
POST /users/{usersId}/contactFolders/{contactFolderId}/contacts/{contactId}/singleValueExtendedProperties
```
...
-->
``` http
POST https://graph.microsoft.com/beta/users/{usersId}/contactFolders/{contactFolderId}/contacts/{contactId}/singleValueExtendedProperties

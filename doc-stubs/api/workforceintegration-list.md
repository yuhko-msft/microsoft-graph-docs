...
description: "Get a list of the workforceIntegration objects and their properties."
...
Get a list of the [workforceIntegration](../resources/workforceintegration.md) objects and their properties.
...
<!-- {
  "blockType": "response",
  "truncated": true,
  "@odata.type": "Collection(Microsoft.Teams.Shifts.workforceIntegration)"
}
-->
``` http
HTTP/1.1 200 OK

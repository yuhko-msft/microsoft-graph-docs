...
description: "Get the localizedNotificationMessage resources from the localizedNotificationMessages navigation property."
...
Get the localizedNotificationMessage resources from the localizedNotificationMessages navigation property.
...
<!-- {
  "blockType": "request",
  "name": "list_localizednotificationmessage"
}
-->
``` http

...
-->
``` http
POST ** Collection URI for microsoft.graph.windowsStoreApp not found
```
...
<!-- {
  "blockType": "request",
  "name": "create_windowsstoreapp_from_"
}
-->
``` http
POST https://graph.microsoft.com/v1.0** Collection URI for microsoft.graph.windowsStoreApp not found

...
-->
``` http
POST /policyRoot/homeRealmDiscoveryPolicies/$ref
...
-->
``` http
POST https://graph.microsoft.com/beta/policyRoot/homeRealmDiscoveryPolicies/$ref
...
{
  "@odata.type": "#Microsoft.DirectoryServices.homeRealmDiscoveryPolicy",
  "id": "5576b4d7-b4d7-5576-d7b4-7655d7b47655",
  "deletedDateTime": "String (timestamp)",
  "description": "String",
  "displayName": "String",
  "definition": [

---
title: "editionUpgradeConfiguration: assign"
...
# editionUpgradeConfiguration: assign
...
-->
``` http
POST ** Entity URI for microsoft.graph.editionUpgradeConfiguration not found/assign
```
...
<!-- {
  "blockType": "request",
  "name": "editionupgradeconfiguration_assign"
}
-->
``` http
POST https://graph.microsoft.com/beta** Entity URI for microsoft.graph.editionUpgradeConfiguration not found/assign

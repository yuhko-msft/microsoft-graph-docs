...
-->
``` http
GET /users/{usersId}/mailFolders/{mailFolderId}/messages/{messageId}/extensions
```
...
-->
``` http
GET https://graph.microsoft.com/beta/users/{usersId}/mailFolders/{mailFolderId}/messages/{messageId}/extensions
```

...
Read the properties and relationships of a [defaultManagedAppProtection](../resources/intune-defaultmanagedappprotection.md) object.
...
If successful, this method returns a `200 OK` response code and a [defaultManagedAppProtection](../resources/intune-defaultmanagedappprotection.md) object in the response body.

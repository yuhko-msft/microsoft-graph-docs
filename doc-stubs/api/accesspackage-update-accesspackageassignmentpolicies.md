---
title: "Update accessPackageAssignmentPolicies"
description: "Update the properties of an accessPackageAssignmentPolicies object."
...
# Update accessPackageAssignmentPolicies
Namespace: microsoft.graph

Update the properties of an accessPackageAssignmentPolicies object.
...
-->
``` http
PATCH /identityGovernance/entitlementManagement/accessPackageCatalogs/{accessPackageCatalogId}/accessPackages/{accessPackageId}/accessPackageAssignmentPolicies
```
...
<!-- {
  "blockType": "request",
  "name": "update_accesspackageassignmentpolicies"
}
-->
``` http
PATCH https://graph.microsoft.com/beta/identityGovernance/entitlementManagement/accessPackageCatalogs/{accessPackageCatalogId}/accessPackages/{accessPackageId}/accessPackageAssignmentPolicies

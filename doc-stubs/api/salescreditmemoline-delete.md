...
description: "Deletes a salesCreditMemoLine object."
...
Deletes a [salesCreditMemoLine](../resources/salescreditmemoline.md) object.
...
-->
``` http
DELETE https://graph.microsoft.com/v1.0/financials/companies/{companyId}/salesCreditMemoLines/{salesCreditMemoLineId}
```

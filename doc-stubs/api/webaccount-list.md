...
description: "Get a list of the webAccount objects and their properties."
...
Get a list of the [webAccount](../resources/webaccount.md) objects and their properties.
...
-->
``` http
GET https://graph.microsoft.com/v1.0/me/profile/webAccounts
```

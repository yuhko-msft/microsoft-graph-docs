---
title: "Update mailSubmission"
description: "Update the properties of a mailSubmission object."
...
Update the properties of a [mailSubmission](../resources/mailsubmission.md) object.
...
The following table shows the properties that are required when you update the [mailSubmission](../resources/mailsubmission.md).
...
If successful, this method returns a `200 OK` response code and an updated [mailSubmission](../resources/mailsubmission.md) object in the response body.
...
<!-- {
  "blockType": "request",
  "name": "update_mailsubmission"
}
-->
``` http
PATCH https://graph.microsoft.com/beta/mailSubmission

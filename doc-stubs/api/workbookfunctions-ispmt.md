...
-->
``` http
POST /workbooks/{workbooksId}/workbook/functions/ispmt
```
...
|per|[Json](../resources/json.md)|**TODO: Add Description**|
...
<!-- {
  "blockType": "request",
  "name": "workbookfunctions_ispmt"
}
-->
``` http
POST https://graph.microsoft.com/beta/workbooks/{workbooksId}/workbook/functions/ispmt

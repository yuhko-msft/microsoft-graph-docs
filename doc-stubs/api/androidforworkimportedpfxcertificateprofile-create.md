...
Create a new [androidForWorkImportedPFXCertificateProfile](../resources/androidforworkimportedpfxcertificateprofile.md) object.
...
-->
``` http
POST ** Collection URI for microsoft.graph.androidForWorkImportedPFXCertificateProfile not found
```
...
## Request body
In the request body, supply a JSON representation of the [androidForWorkImportedPFXCertificateProfile](../resources/androidforworkimportedpfxcertificateprofile.md) object.
...
If successful, this method returns a `201 Created` response code and an [androidForWorkImportedPFXCertificateProfile](../resources/androidforworkimportedpfxcertificateprofile.md) object in the response body.
...
<!-- {
  "blockType": "request",
  "name": "create_androidforworkimportedpfxcertificateprofile_from_"
}
-->
``` http
POST https://graph.microsoft.com/beta** Collection URI for microsoft.graph.androidForWorkImportedPFXCertificateProfile not found

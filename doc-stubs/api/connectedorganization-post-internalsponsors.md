...
-->
``` http
POST /entitlementManagement/assignments/{accessPackageAssignmentId}/target/connectedOrganization/internalSponsors/$ref
```
...
-->
``` http
POST https://graph.microsoft.com/v1.0/entitlementManagement/assignments/{accessPackageAssignmentId}/target/connectedOrganization/internalSponsors/$ref

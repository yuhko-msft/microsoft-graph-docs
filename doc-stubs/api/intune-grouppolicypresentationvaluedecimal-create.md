...
Create a new [groupPolicyPresentationValueDecimal](../resources/intune-grouppolicypresentationvaluedecimal.md) object.
...
If successful, this method returns a `201 Created` response code and a [groupPolicyPresentationValueDecimal](../resources/intune-grouppolicypresentationvaluedecimal.md) object in the response body.
...
-->
``` http
POST https://graph.microsoft.com/beta** Collection URI for microsoft.graph.groupPolicyPresentationValueDecimal not found

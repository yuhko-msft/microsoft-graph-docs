---
title: "androidWorkProfileVpnConfiguration: assign"
...
# androidWorkProfileVpnConfiguration: assign
...
-->
``` http
POST ** Entity URI for microsoft.graph.androidWorkProfileVpnConfiguration not found/assign
```
...
<!-- {
  "blockType": "request",
  "name": "androidworkprofilevpnconfiguration_assign"
}
-->
``` http
POST https://graph.microsoft.com/v1.0** Entity URI for microsoft.graph.androidWorkProfileVpnConfiguration not found/assign

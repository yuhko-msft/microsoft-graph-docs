---
title: "deviceManagementIntent: updateSettings"
...
# deviceManagementIntent: updateSettings
...
-->
``` http
POST https://graph.microsoft.com/v1.0/deviceManagement/intents/{deviceManagementIntentId}/updateSettings

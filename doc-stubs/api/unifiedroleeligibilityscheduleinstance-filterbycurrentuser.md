...
-->
``` http
GET /rbacApplication/roleEligibilityScheduleInstances/filterByCurrentUser
```
...
-->
``` http
GET https://graph.microsoft.com/beta/rbacApplication/roleEligibilityScheduleInstances/filterByCurrentUser(on='parameterValue')
```
...
<!-- {
  "blockType": "response",
  "truncated": true,
  "@odata.type": "Collection(Microsoft.Identity.Governance.Common.Data.ExternalModels.V1.unifiedRoleEligibilityScheduleInstance)"
}
-->
``` http
HTTP/1.1 200 OK

---
title: "emailSecurityEventsRoot: movetoDeletedItems"
...
# emailSecurityEventsRoot: movetoDeletedItems
...
-->
``` http
POST /security/emailSecurityEvents/movetoDeletedItems
```
...
<!-- {
  "blockType": "request",
  "name": "emailsecurityeventsroot_movetodeleteditems"
}
-->
``` http
POST https://graph.microsoft.com/beta/security/emailSecurityEvents/movetoDeletedItems

...
description: "Get the plannerPlan resources from the recentPlans navigation property."
...
Get the plannerPlan resources from the recentPlans navigation property.
...
-->
``` http
GET https://graph.microsoft.com/v1.0/users/{usersId}/planner/recentPlans
```

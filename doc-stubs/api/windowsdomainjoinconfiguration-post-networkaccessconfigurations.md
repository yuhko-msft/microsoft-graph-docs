...
-->
``` http
POST ** Collection URI for microsoft.graph.deviceConfiguration not found/$ref
```
...
-->
``` http
POST https://graph.microsoft.com/v1.0** Collection URI for microsoft.graph.deviceConfiguration not found/$ref

...
description: "Get the userAppInstallStatus resources from the userStatuses navigation property."
...
Get the userAppInstallStatus resources from the userStatuses navigation property.
...
-->
``` http
GET https://graph.microsoft.com/v1.0/deviceAppManagement/mobileApps/{mobileAppId}/userStatuses
```

...
-->
``` http
GET /entitlementManagement/connectedOrganizations/{connectedOrganizationId}
```
...
-->
``` http
GET https://graph.microsoft.com/v1.0/entitlementManagement/connectedOrganizations/{connectedOrganizationId}
```

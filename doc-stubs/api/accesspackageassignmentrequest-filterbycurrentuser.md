...
-->
``` http
GET /entitlementManagement/assignmentRequests/filterByCurrentUser
```
...
|:---|:---|:---|
|on|accessPackageAssignmentRequestFilterByCurrentUserOptions|**TODO: Add Description**|
...
-->
``` http
GET https://graph.microsoft.com/v1.0/entitlementManagement/assignmentRequests/filterByCurrentUser(on='parameterValue')
```

...
-->
``` http
PATCH /users/{usersId}/managedDevices/{managedDeviceId}/securityBaselineStates
```
...
-->
``` http
PATCH https://graph.microsoft.com/beta/users/{usersId}/managedDevices/{managedDeviceId}/securityBaselineStates

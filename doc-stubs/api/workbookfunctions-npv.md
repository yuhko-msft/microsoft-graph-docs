...
-->
``` http
POST /workbooks/{workbooksId}/workbook/functions/npv
```
...
<!-- {
  "blockType": "request",
  "name": "workbookfunctions_npv"
}
-->
``` http
POST https://graph.microsoft.com/beta/workbooks/{workbooksId}/workbook/functions/npv

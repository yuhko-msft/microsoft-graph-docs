---
title: "Create macOSCertificateProfileBase"
description: "Create a new macOSCertificateProfileBase object."
...
# Create macOSCertificateProfileBase
Namespace: microsoft.graph

Create a new [macOSCertificateProfileBase](../resources/macoscertificateprofilebase.md) object.
...
-->
``` http
POST ** Collection URI for microsoft.graph.macOSCertificateProfileBase not found
```
...
If successful, this method returns a `201 Created` response code and a [macOSCertificateProfileBase](../resources/macoscertificateprofilebase.md) object in the response body.
...
-->
``` http
POST https://graph.microsoft.com/beta** Collection URI for microsoft.graph.macOSCertificateProfileBase not found
...
{
  "@odata.type": "#microsoft.graph.macOSCertificateProfileBase",
  "id": "1f0a7354-7354-1f0a-5473-0a1f54730a1f",

...
-->
``` http
PATCH /users/{usersId}/contacts/{contactId}/singleValueExtendedProperties
```
...
-->
``` http
PATCH https://graph.microsoft.com/beta/users/{usersId}/contacts/{contactId}/singleValueExtendedProperties

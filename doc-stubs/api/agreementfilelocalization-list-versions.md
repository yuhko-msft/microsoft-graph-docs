---
title: "List versions"
description: "Get the agreementFileVersion resources from the versions navigation property."
...
Get the agreementFileVersion resources from the versions navigation property.
...
<!-- {
  "blockType": "response",
  "truncated": true,
  "@odata.type": "Collection(microsoft.graph.agreementFileVersion)"
}
-->
``` http
HTTP/1.1 200 OK

...
Create a new [managedAppProtectionPolicySetItem](../resources/intune-managedappprotectionpolicysetitem.md) object.
...
## Request body
In the request body, supply a JSON representation of the [managedAppProtectionPolicySetItem](../resources/intune-managedappprotectionpolicysetitem.md) object.

The following table shows the properties that are required when you create the [managedAppProtectionPolicySetItem](../resources/intune-managedappprotectionpolicysetitem.md).
...
If successful, this method returns a `201 Created` response code and a [managedAppProtectionPolicySetItem](../resources/intune-managedappprotectionpolicysetitem.md) object in the response body.
...
-->
``` http
POST https://graph.microsoft.com/beta** Collection URI for microsoft.graph.managedAppProtectionPolicySetItem not found

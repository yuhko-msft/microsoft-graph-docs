...
description: "Deletes a deviceComplianceScheduledActionForRule object."
...
Deletes a [deviceComplianceScheduledActionForRule](../resources/devicecompliancescheduledactionforrule.md) object.
...
<!-- {
  "blockType": "request",
  "name": "delete_devicecompliancescheduledactionforrule"
}
-->
``` http

...
-->
``` http
GET /me/appConsentRequestsForApproval/{appConsentRequestId}
```
...
-->
``` http
GET https://graph.microsoft.com/beta/me/appConsentRequestsForApproval/{appConsentRequestId}
```
...

{
  "value": {
    "@odata.type": "#microsoft.graph.appConsentRequest",
    "id": "27ddea0e-ea0e-27dd-0eea-dd270eeadd27",

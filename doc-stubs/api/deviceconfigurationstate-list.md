...
description: "Get a list of the deviceConfigurationState objects and their properties."
...
Get a list of the [deviceConfigurationState](../resources/deviceconfigurationstate.md) objects and their properties.
...
-->
``` http
GET https://graph.microsoft.com/v1.0/me/managedDevices/{managedDeviceId}/deviceConfigurationStates
```

...
-->
``` http
GET /entitlementManagement/assignmentRequests/{accessPackageAssignmentRequestId}/assignment
```
...
-->
``` http
GET https://graph.microsoft.com/v1.0/entitlementManagement/assignmentRequests/{accessPackageAssignmentRequestId}/assignment
```

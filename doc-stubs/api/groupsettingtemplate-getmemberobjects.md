---
title: "groupSettingTemplate: getMemberObjects"
...
-->
``` http
POST /groupSettingTemplates/{groupSettingTemplatesId}/getMemberObjects
```
...
-->
``` http
POST https://graph.microsoft.com/v1.0/groupSettingTemplates/{groupSettingTemplatesId}/getMemberObjects

...
description: "Get the outlookTaskGroup resources from the taskGroups navigation property."
...
Get the outlookTaskGroup resources from the taskGroups navigation property.
...
<!-- {
  "blockType": "request",
  "name": "list_outlooktaskgroup"
}
-->
``` http
GET https://graph.microsoft.com/v1.0/users/{usersId}/outlook/taskGroups
```

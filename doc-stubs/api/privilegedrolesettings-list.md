...
description: "Get a list of the privilegedRoleSettings objects and their properties."
...
Get a list of the [privilegedRoleSettings](../resources/privilegedrolesettings.md) objects and their properties.
...
-->
``` http
GET https://graph.microsoft.com/v1.0** Collection URI for microsoft.graph.privilegedRoleSettings not found
```

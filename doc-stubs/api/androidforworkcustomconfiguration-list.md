...
description: "Get a list of the androidForWorkCustomConfiguration objects and their properties."
...
Get a list of the [androidForWorkCustomConfiguration](../resources/androidforworkcustomconfiguration.md) objects and their properties.
...
<!-- {
  "blockType": "request",
  "name": "list_androidforworkcustomconfiguration"
}
-->
``` http
GET https://graph.microsoft.com/v1.0** Collection URI for microsoft.graph.androidForWorkCustomConfiguration not found
```

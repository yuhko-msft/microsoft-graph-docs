...
-->
``` http
GET /print/reports/dailyPrintUsageByUser/{printUsageByUserId}
GET /print/reports/monthlyPrintUsageByUser/{printUsageByUserId}
GET /print/reports/dailyPrintUsageSummariesByUser/{printUsageByUserId}
GET /print/reports/monthlyPrintUsageSummariesByUser/{printUsageByUserId}
```
...
-->
``` http
GET https://graph.microsoft.com/v1.0/print/reports/dailyPrintUsageByUser/{printUsageByUserId}
```

...
description: "Get a list of the inferenceClassification objects and their properties."
...
Get a list of the [inferenceClassification](../resources/inferenceclassification.md) objects and their properties.
...
-->
``` http
GET https://graph.microsoft.com/beta** Collection URI for microsoft.graph.inferenceClassification not found
```
  ...
  "value": [
    {
      ...
      "id": "0a6e130b-130b-0a6e-0b13-6e0a0b136e0a"
    }
  ]
}
```

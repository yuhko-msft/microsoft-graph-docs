...
description: "Get a list of the urlAssessmentRequest objects and their properties."
...
Get a list of the [urlAssessmentRequest](../resources/urlassessmentrequest.md) objects and their properties.
...
<!-- {
  "blockType": "request",
  "name": "list_urlassessmentrequest"
}
-->
``` http
GET https://graph.microsoft.com/beta** Collection URI for microsoft.graph.urlAssessmentRequest not found
```

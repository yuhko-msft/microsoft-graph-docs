...
description: "Get the purchaseInvoiceLine resources from the purchaseInvoiceLines navigation property."
...
Get the purchaseInvoiceLine resources from the purchaseInvoiceLines navigation property.
...
-->
``` http
GET https://graph.microsoft.com/v1.0/financials/companies/{companyId}/purchaseInvoices/{purchaseInvoiceId}/purchaseInvoiceLines
```

...
description: "Get a list of the privilegedAccess objects and their properties."
...
Get a list of the [privilegedAccess](../resources/privilegedaccess.md) objects and their properties.
...
<!-- {
  "blockType": "request",
  "name": "list_privilegedaccess"
}
-->
``` http
GET https://graph.microsoft.com/v1.0/privilegedAccess
```

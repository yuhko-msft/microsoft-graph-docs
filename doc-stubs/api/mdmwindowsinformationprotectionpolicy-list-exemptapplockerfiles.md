...
description: "Get the windowsInformationProtectionAppLockerFile resources from the exemptAppLockerFiles navigation property."
...
Get the windowsInformationProtectionAppLockerFile resources from the exemptAppLockerFiles navigation property.
...
-->
``` http
GET https://graph.microsoft.com/beta/deviceAppManagement/mdmWindowsInformationProtectionPolicies/{mdmWindowsInformationProtectionPolicyId}/exemptAppLockerFiles
```

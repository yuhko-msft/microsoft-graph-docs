...
description: "Get a list of the androidWorkProfileEasEmailProfileBase objects and their properties."
...
Get a list of the [androidWorkProfileEasEmailProfileBase](../resources/androidworkprofileeasemailprofilebase.md) objects and their properties.
...
<!-- {
  "blockType": "request",
  "name": "list_androidworkprofileeasemailprofilebase"
}
-->
``` http
GET https://graph.microsoft.com/v1.0** Collection URI for microsoft.graph.androidWorkProfileEasEmailProfileBase not found
```

...
description: "Get a list of the deviceComplianceDeviceOverview objects and their properties."
...
Get a list of the [deviceComplianceDeviceOverview](../resources/devicecompliancedeviceoverview.md) objects and their properties.
...
-->
``` http
GET https://graph.microsoft.com/v1.0** Collection URI for microsoft.graph.deviceComplianceDeviceOverview not found
```

...
Read the properties and relationships of an [androidManagedAppProtection](../resources/intune-androidmanagedappprotection.md) object.
...
If successful, this method returns a `200 OK` response code and an [androidManagedAppProtection](../resources/intune-androidmanagedappprotection.md) object in the response body.

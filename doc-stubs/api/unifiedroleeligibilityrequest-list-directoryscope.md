...
-->
``` http
GET /rbacApplication/roleEligibilityRequests/{unifiedRoleEligibilityRequestId}/directoryScope
```
...
-->
``` http
GET https://graph.microsoft.com/beta/rbacApplication/roleEligibilityRequests/{unifiedRoleEligibilityRequestId}/directoryScope
```

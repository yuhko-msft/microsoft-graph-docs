---
title: "androidDeviceOwnerWiFiConfiguration: assign"
...
# androidDeviceOwnerWiFiConfiguration: assign
...
-->
``` http
POST ** Entity URI for microsoft.graph.androidDeviceOwnerWiFiConfiguration not found/assign
```
...
<!-- {
  "blockType": "request",
  "name": "androiddeviceownerwificonfiguration_assign"
}
-->
``` http
POST https://graph.microsoft.com/v1.0** Entity URI for microsoft.graph.androidDeviceOwnerWiFiConfiguration not found/assign

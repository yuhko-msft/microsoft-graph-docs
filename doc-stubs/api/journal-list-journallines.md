...
description: "Get the journalLine resources from the journalLines navigation property."
...
Get the journalLine resources from the journalLines navigation property.
...
-->
``` http
GET https://graph.microsoft.com/v1.0/financials/companies/{companyId}/journals/{journalId}/journalLines
```

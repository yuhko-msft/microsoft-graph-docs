...
description: "Get a list of the deviceConfigurationDeviceOverview objects and their properties."
...
Get a list of the [deviceConfigurationDeviceOverview](../resources/deviceconfigurationdeviceoverview.md) objects and their properties.
...
-->
``` http
GET https://graph.microsoft.com/beta** Collection URI for microsoft.graph.deviceConfigurationDeviceOverview not found
```

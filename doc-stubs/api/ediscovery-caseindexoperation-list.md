...
Get a list of the [caseIndexOperation](../resources/ediscovery-caseindexoperation.md) objects and their properties.
...
-->
``` http
GET ** Collection URI for microsoft.graph.ediscovery.caseIndexOperation not found
```
...
-->
``` http
GET https://graph.microsoft.com/beta** Collection URI for microsoft.graph.ediscovery.caseIndexOperation not found
```

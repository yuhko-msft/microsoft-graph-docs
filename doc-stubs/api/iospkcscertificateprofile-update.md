...
description: "Update the properties of an iosPkcsCertificateProfile object."
...
Update the properties of an [iosPkcsCertificateProfile](../resources/iospkcscertificateprofile.md) object.
...
-->
``` http
PATCH ** Entity URI for microsoft.graph.iosPkcsCertificateProfile not found
```
...
## Request body
In the request body, supply a JSON representation of the [iosPkcsCertificateProfile](../resources/iospkcscertificateprofile.md) object.

The following table shows the properties that are required when you update the [iosPkcsCertificateProfile](../resources/iospkcscertificateprofile.md).
...
<!-- {
  "blockType": "request",
  "name": "update_iospkcscertificateprofile"
}
-->
``` http
PATCH https://graph.microsoft.com/beta** Entity URI for microsoft.graph.iosPkcsCertificateProfile not found
...
{
  "@odata.type": "#microsoft.graph.iosPkcsCertificateProfile",
  "id": "1a1446ed-46ed-1a14-ed46-141aed46141a",

...
-->
``` http
PATCH /termStore/groups/{groupId}/sets/{setId}/terms/{termId}/relations
```
...
-->
``` http
PATCH https://graph.microsoft.com/beta/termStore/groups/{groupId}/sets/{setId}/terms/{termId}/relations

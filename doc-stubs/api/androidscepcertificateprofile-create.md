...
-->
``` http
POST ** Collection URI for microsoft.graph.androidScepCertificateProfile not found
```
...
If successful, this method returns a `201 Created` response code and an [androidScepCertificateProfile](../resources/androidscepcertificateprofile.md) object in the response body.
...
<!-- {
  "blockType": "request",
  "name": "create_androidscepcertificateprofile_from_"
}
-->
``` http
POST https://graph.microsoft.com/beta** Collection URI for microsoft.graph.androidScepCertificateProfile not found

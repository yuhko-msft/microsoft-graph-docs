---
title: "Create windowsInformationProtection"
description: "Create a new windowsInformationProtection object."
...
# Create windowsInformationProtection
Namespace: microsoft.graph

[!INCLUDE [beta-disclaimer](../../includes/beta-disclaimer.md)]

Create a new [windowsInformationProtection](../resources/windowsinformationprotection.md) object.
...
-->
``` http
POST ** Collection URI for microsoft.graph.windowsInformationProtection not found
```
...
The following table shows the properties that are required when you create the [windowsInformationProtection](../resources/windowsinformationprotection.md).
...
If successful, this method returns a `201 Created` response code and a [windowsInformationProtection](../resources/windowsinformationprotection.md) object in the response body.
...
<!-- {
  "blockType": "request",
  "name": "create_windowsinformationprotection_from_"
}
-->
``` http
POST https://graph.microsoft.com/beta** Collection URI for microsoft.graph.windowsInformationProtection not found

...
-->
``` http
POST /security/emailSecurityEvents/mailMessages/{mailMessageId}/hardDelete
```
...
<!-- {
  "blockType": "request",
  "name": "mailmessage_harddelete"
}
-->
``` http
POST https://graph.microsoft.com/beta/security/emailSecurityEvents/mailMessages/{mailMessageId}/hardDelete

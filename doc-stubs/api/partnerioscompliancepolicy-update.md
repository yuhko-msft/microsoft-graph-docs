---
title: "Update partnerIOSCompliancePolicy"
description: "Update the properties of a partnerIOSCompliancePolicy object."
...
# Update partnerIOSCompliancePolicy
Namespace: microsoft.graph

Update the properties of a [partnerIOSCompliancePolicy](../resources/partnerioscompliancepolicy.md) object.
...
-->
``` http
PATCH ** Entity URI for microsoft.graph.partnerIOSCompliancePolicy not found
```
...
The following table shows the properties that are required when you update the [partnerIOSCompliancePolicy](../resources/partnerioscompliancepolicy.md).
...
If successful, this method returns a `200 OK` response code and an updated [partnerIOSCompliancePolicy](../resources/partnerioscompliancepolicy.md) object in the response body.
...
<!-- {
  "blockType": "request",
  "name": "update_partnerioscompliancepolicy"
}
-->
``` http
PATCH https://graph.microsoft.com/beta** Entity URI for microsoft.graph.partnerIOSCompliancePolicy not found

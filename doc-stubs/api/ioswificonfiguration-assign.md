---
title: "iosWiFiConfiguration: assign"
...
-->
``` http
POST ** Entity URI for microsoft.graph.iosWiFiConfiguration not found/assign
```
...
<!-- {
  "blockType": "request",
  "name": "ioswificonfiguration_assign"
}
-->
``` http
POST https://graph.microsoft.com/v1.0** Entity URI for microsoft.graph.iosWiFiConfiguration not found/assign

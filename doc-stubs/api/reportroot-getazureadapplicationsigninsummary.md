...
GET /print/reports/getAzureADApplicationSignInSummary
```
...
-->
``` http
GET https://graph.microsoft.com/v1.0/reports/getAzureADApplicationSignInSummary(period='parameterValue')
```

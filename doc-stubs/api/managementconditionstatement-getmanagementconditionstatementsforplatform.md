...
# managementConditionStatement: getManagementConditionStatementsForPlatform
...
-->
``` http
GET https://graph.microsoft.com/v1.0/deviceManagement/managementConditionStatements/getManagementConditionStatementsForPlatform(platform='parameterValue')
```

...
-->
``` http
PATCH ** Entity URI for microsoft.graph.windowsPhone81VpnConfiguration not found
```
...
The following table shows the properties that are required when you update the [windowsPhone81VpnConfiguration](../resources/windowsphone81vpnconfiguration.md).
...
<!-- {
  "blockType": "request",
  "name": "update_windowsphone81vpnconfiguration"
}
-->
``` http
PATCH https://graph.microsoft.com/beta** Entity URI for microsoft.graph.windowsPhone81VpnConfiguration not found
...
{
  "@odata.type": "#microsoft.graph.windowsPhone81VpnConfiguration",
  "id": "f06af787-f787-f06a-87f7-6af087f76af0",

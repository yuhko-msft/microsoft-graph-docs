...
-->
``` http
POST /governanceRoleDefinitions/{governanceRoleDefinitionsId}/resource
```
...
-->
``` http
POST https://graph.microsoft.com/beta/governanceRoleDefinitions/{governanceRoleDefinitionsId}/resource

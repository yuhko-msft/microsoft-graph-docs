...
The following table shows the properties that are required when you update the [androidForWorkVpnConfiguration](../resources/androidforworkvpnconfiguration.md).
...
{
  "@odata.type": "#microsoft.graph.androidForWorkVpnConfiguration",
  "id": "735340be-40be-7353-be40-5373be405373",

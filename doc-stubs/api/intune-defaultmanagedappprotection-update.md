...
The following table shows the properties that are required when you update the [defaultManagedAppProtection](../resources/intune-defaultmanagedappprotection.md).

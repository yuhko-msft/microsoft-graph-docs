...
-->
``` http
PATCH /temporaryAccessPassAuthenticationMethodConfiguration/includeTargets
```
...
-->
``` http
PATCH https://graph.microsoft.com/beta/temporaryAccessPassAuthenticationMethodConfiguration/includeTargets

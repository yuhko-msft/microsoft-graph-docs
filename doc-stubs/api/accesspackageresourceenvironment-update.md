...
-->
``` http
PATCH /accessPackageResources/{accessPackageResourcesId}/accessPackageResourceEnvironment
PATCH /entitlementManagement/accessPackageResourceEnvironments/{accessPackageResourceEnvironmentId}
```
...
-->
``` http
PATCH https://graph.microsoft.com/beta/accessPackageResources/{accessPackageResourcesId}/accessPackageResourceEnvironment

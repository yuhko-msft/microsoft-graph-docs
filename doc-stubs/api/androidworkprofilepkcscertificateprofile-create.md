...
The following table shows the properties that are required when you create the [androidWorkProfilePkcsCertificateProfile](../resources/androidworkprofilepkcscertificateprofile.md).
...
If successful, this method returns a `201 Created` response code and an [androidWorkProfilePkcsCertificateProfile](../resources/androidworkprofilepkcscertificateprofile.md) object in the response body.
...
-->
``` http
POST https://graph.microsoft.com/v1.0** Collection URI for microsoft.graph.androidWorkProfilePkcsCertificateProfile not found

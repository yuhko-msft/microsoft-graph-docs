---
title: "iosUpdateConfiguration: assign"
...
-->
``` http
POST ** Entity URI for microsoft.graph.iosUpdateConfiguration not found/assign
```
...
<!-- {
  "blockType": "request",
  "name": "iosupdateconfiguration_assign"
}
-->
``` http
POST https://graph.microsoft.com/beta** Entity URI for microsoft.graph.iosUpdateConfiguration not found/assign

---
title: "EmployeeGraphQLResponse: whoplus"
...
# EmployeeGraphQLResponse: whoplus
...
-->
``` http
POST ** Collection URI for microsoft.graph.linkedIn.EmployeeGraphQLResponse not found/whoplus
```
...
<!-- {
  "blockType": "request",
  "name": "employeegraphqlresponse_whoplus"
}
-->
``` http
POST https://graph.microsoft.com/beta** Collection URI for microsoft.graph.linkedIn.EmployeeGraphQLResponse not found/whoplus

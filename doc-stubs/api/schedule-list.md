...
-->
``` http
GET ** Collection URI for Microsoft.Teams.Shifts.schedule not found
```
...
-->
``` http
GET https://graph.microsoft.com/v1.0** Collection URI for Microsoft.Teams.Shifts.schedule not found
```

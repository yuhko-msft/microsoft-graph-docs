...
Get a list of the [dataSourceContainer](../resources/ediscovery-datasourcecontainer.md) objects and their properties.
...
-->
``` http
GET https://graph.microsoft.com/v1.0** Collection URI for microsoft.graph.ediscovery.dataSourceContainer not found
```

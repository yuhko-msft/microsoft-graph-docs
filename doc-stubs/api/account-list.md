---
title: "List accounts"
description: "Get a list of the account objects and their properties."
...
Get a list of the [account](../resources/account.md) objects and their properties.
...
-->
``` http
GET https://graph.microsoft.com/v1.0/financials/companies/{companyId}/accounts
```

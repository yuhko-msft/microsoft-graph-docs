...
description: "Get the itemCategory resources from the itemCategories navigation property."
...
Get the itemCategory resources from the itemCategories navigation property.
...
-->
``` http
GET https://graph.microsoft.com/v1.0/financials/companies/{companyId}/itemCategories
```

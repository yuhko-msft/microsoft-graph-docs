...
description: "Get the plannerPlan resources from the favoritePlans navigation property."
...
Get the plannerPlan resources from the favoritePlans navigation property.
...
-->
``` http
GET /users/{usersId}/planner/favoritePlans
```
...
-->
``` http
GET https://graph.microsoft.com/v1.0/users/{usersId}/planner/favoritePlans
```

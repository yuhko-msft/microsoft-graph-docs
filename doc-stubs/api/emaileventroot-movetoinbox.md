---
title: "emailEventRoot: movetoInbox"
...
-->
``` http
POST /security/emailEvent/movetoInbox
```
...
<!-- {
  "blockType": "request",
  "name": "emaileventroot_movetoinbox"
}
-->
``` http
POST https://graph.microsoft.com/beta/security/emailEvent/movetoInbox

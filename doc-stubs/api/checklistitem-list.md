...
Get a list of the [checklistItem](../resources/checklistitem.md) objects and their properties.
...
-->
``` http
GET https://graph.microsoft.com/beta/baseTask/checklistItems
```

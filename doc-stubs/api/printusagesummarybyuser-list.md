---
title: "List PrintUsageSummaryByUsers"
description: "Get a list of the PrintUsageSummaryByUser objects and their properties."
...
# List PrintUsageSummaryByUsers
Namespace: microsoft.graph

[!INCLUDE [beta-disclaimer](../../includes/beta-disclaimer.md)]

Get a list of the [PrintUsageSummaryByUser](../resources/printusagesummarybyuser.md) objects and their properties.
...
<!-- {
  "blockType": "request",
  "name": "list_printusagesummarybyuser"
}
-->
``` http

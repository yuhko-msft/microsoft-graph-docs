...
description: "Get the unifiedRoleAssignmentMultiple resources from the roleAssignments navigation property."
...
Get the unifiedRoleAssignmentMultiple resources from the roleAssignments navigation property.
...
-->
``` http
GET https://graph.microsoft.com/v1.0/roleManagement/cloudPC/roleAssignments
```

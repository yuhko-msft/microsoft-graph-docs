---
title: "androidDeviceOwnerTrustedRootCertificate: assign"
...
# androidDeviceOwnerTrustedRootCertificate: assign
...
<!-- {
  "blockType": "request",
  "name": "androiddeviceownertrustedrootcertificate_assign"
}
-->
``` http

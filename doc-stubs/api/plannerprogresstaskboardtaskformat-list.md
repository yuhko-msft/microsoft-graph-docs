...
description: "Get a list of the plannerProgressTaskBoardTaskFormat objects and their properties."
...
Get a list of the [plannerProgressTaskBoardTaskFormat](../resources/plannerprogresstaskboardtaskformat.md) objects and their properties.
...
-->
``` http
GET https://graph.microsoft.com/beta** Collection URI for microsoft.graph.plannerProgressTaskBoardTaskFormat not found
```

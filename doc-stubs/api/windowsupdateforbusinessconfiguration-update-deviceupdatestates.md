...
-->
``` http
PATCH ** Collection URI for microsoft.graph.windowsUpdateState not found
```
...
If successful, this method returns a `200 OK` response code and an updated [windowsUpdateState](../resources/intune-windowsupdatestate.md) object in the response body.
...
-->
``` http
PATCH https://graph.microsoft.com/beta** Collection URI for microsoft.graph.windowsUpdateState not found

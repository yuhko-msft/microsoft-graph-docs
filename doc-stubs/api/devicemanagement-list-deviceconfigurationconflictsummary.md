...
description: "Get the deviceConfigurationConflictSummary resources from the deviceConfigurationConflictSummary navigation property."
...
Get the deviceConfigurationConflictSummary resources from the deviceConfigurationConflictSummary navigation property.
...
<!-- {
  "blockType": "request",
  "name": "list_deviceconfigurationconflictsummary"
}
-->
``` http
GET https://graph.microsoft.com/v1.0/deviceManagement/deviceConfigurationConflictSummary
```

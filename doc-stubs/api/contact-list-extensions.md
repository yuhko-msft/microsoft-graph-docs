...
-->
``` http
GET /users/{usersId}/contactFolders/{contactFolderId}/contacts/{contactId}/extensions
```
...
-->
``` http
GET https://graph.microsoft.com/beta/users/{usersId}/contactFolders/{contactFolderId}/contacts/{contactId}/extensions
```

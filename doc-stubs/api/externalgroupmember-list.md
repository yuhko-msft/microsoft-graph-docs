...
description: "Get a list of the externalGroupMember objects and their properties."
...
Get a list of the [externalGroupMember](../resources/externalgroupmember.md) objects and their properties.
...
-->
``` http
GET https://graph.microsoft.com/v1.0/external/connections/{externalConnectionId}/groups/{externalGroupId}/members
```

...
-->
``` http
PATCH /muteParticipantOperation
```
...
The following table shows the properties that are required when you update the [muteParticipantOperation](../resources/muteparticipantoperation.md).
...
-->
``` http
PATCH https://graph.microsoft.com/beta/muteParticipantOperation

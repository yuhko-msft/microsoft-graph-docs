...
description: "Deletes a salesOrderLine object."
...
Deletes a [salesOrderLine](../resources/salesorderline.md) object.
...
-->
``` http
DELETE https://graph.microsoft.com/v1.0/financials/companies/{companyId}/salesOrderLines/{salesOrderLineId}
```

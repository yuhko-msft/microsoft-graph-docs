...
description: "Read the properties and relationships of a windowsDriverUpdateProfileAssignment object."
...
Read the properties and relationships of a [windowsDriverUpdateProfileAssignment](../resources/intune-windowsdriverupdateprofileassignment.md) object.
...
If successful, this method returns a `200 OK` response code and a [windowsDriverUpdateProfileAssignment](../resources/intune-windowsdriverupdateprofileassignment.md) object in the response body.
...
<!-- {
  "blockType": "request",
  "name": "get_windowsdriverupdateprofileassignment"
}
-->
``` http

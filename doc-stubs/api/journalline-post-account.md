...
-->
``` http
POST /financials/companies/{companyId}/journalLines/{journalLineId}/account
```
...
-->
``` http
POST https://graph.microsoft.com/v1.0/financials/companies/{companyId}/journalLines/{journalLineId}/account

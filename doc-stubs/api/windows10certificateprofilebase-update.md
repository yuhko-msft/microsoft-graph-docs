---
title: "Update windows10CertificateProfileBase"
description: "Update the properties of a windows10CertificateProfileBase object."
...
# Update windows10CertificateProfileBase
Namespace: microsoft.graph



Update the properties of a [windows10CertificateProfileBase](../resources/windows10certificateprofilebase.md) object.
...
-->
``` http
PATCH ** Entity URI for microsoft.graph.windows10CertificateProfileBase not found
```
...
## Request body
In the request body, supply a JSON representation of the [windows10CertificateProfileBase](../resources/windows10certificateprofilebase.md) object.

The following table shows the properties that are required when you update the [windows10CertificateProfileBase](../resources/windows10certificateprofilebase.md).
...
If successful, this method returns a `200 OK` response code and an updated [windows10CertificateProfileBase](../resources/windows10certificateprofilebase.md) object in the response body.
...
<!-- {
  "blockType": "request",
  "name": "update_windows10certificateprofilebase"
}
-->
``` http
PATCH https://graph.microsoft.com/v1.0** Entity URI for microsoft.graph.windows10CertificateProfileBase not found
...
{
  "@odata.type": "#microsoft.graph.windows10CertificateProfileBase",
  "id": "c3b16543-6543-c3b1-4365-b1c34365b1c3",

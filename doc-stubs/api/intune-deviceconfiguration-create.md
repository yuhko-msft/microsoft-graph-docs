---
title: "Create deviceConfiguration"
...
Create a new [deviceConfiguration](../resources/intune-deviceconfiguration.md) object.
...
|scenarioType|scenarioType|**TODO: Add Description**. Possible values are: `general`, `resourceAccess`.|
...
If successful, this method returns a `201 Created` response code and a [deviceConfiguration](../resources/intune-deviceconfiguration.md) object in the response body.
...
{
  "@odata.type": "#microsoft.graph.deviceConfiguration",
  "id": "9007f605-f605-9007-05f6-079005f60790",

---
title: "windows10EnterpriseModernAppManagementConfiguration: assign"
...
# windows10EnterpriseModernAppManagementConfiguration: assign
...
-->
``` http
POST ** Entity URI for microsoft.graph.windows10EnterpriseModernAppManagementConfiguration not found/assign
```
...
<!-- {
  "blockType": "request",
  "name": "windows10enterprisemodernappmanagementconfiguration_assign"
}
-->
``` http
POST https://graph.microsoft.com/beta** Entity URI for microsoft.graph.windows10EnterpriseModernAppManagementConfiguration not found/assign

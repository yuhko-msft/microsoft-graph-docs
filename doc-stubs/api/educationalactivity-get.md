...
-->
``` http
GET /user/{userId}/profile/educationalActivities/{educationalActivityId}
```
...
-->
``` http
GET https://graph.microsoft.com/beta/user/{userId}/profile/educationalActivities/{educationalActivityId}
```

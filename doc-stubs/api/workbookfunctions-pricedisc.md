---
title: "workbookFunctions: priceDisc"
...
-->
``` http
POST /workbooks/{workbooksId}/workbook/functions/priceDisc
```
...
<!-- {
  "blockType": "request",
  "name": "workbookfunctions_pricedisc"
}
-->
``` http
POST https://graph.microsoft.com/beta/workbooks/{workbooksId}/workbook/functions/priceDisc

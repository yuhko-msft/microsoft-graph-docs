...
Create a new [windowsDriverUpdateProfileAssignment](../resources/intune-windowsdriverupdateprofileassignment.md) object.
...
The following table shows the properties that are required when you create the [windowsDriverUpdateProfileAssignment](../resources/intune-windowsdriverupdateprofileassignment.md).
...
If successful, this method returns a `201 Created` response code and a [windowsDriverUpdateProfileAssignment](../resources/intune-windowsdriverupdateprofileassignment.md) object in the response body.
...
<!-- {
  "blockType": "request",
  "name": "create_windowsdriverupdateprofileassignment_from_"
}
-->
``` http

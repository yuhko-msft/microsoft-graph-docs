---
title: "androidWorkProfileTrustedRootCertificate: assign"
...
# androidWorkProfileTrustedRootCertificate: assign
...
<!-- {
  "blockType": "request",
  "name": "androidworkprofiletrustedrootcertificate_assign"
}
-->
``` http
POST https://graph.microsoft.com/v1.0/deviceManagement/deviceConfigurations/{deviceConfigurationId}/rootCertificate/assign

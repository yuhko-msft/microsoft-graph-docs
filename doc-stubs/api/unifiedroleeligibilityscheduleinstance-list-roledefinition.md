...
-->
``` http
GET /unifiedRoleAssignmentScheduleInstance/activatedUsing/roleDefinition
```
...
-->
``` http
GET https://graph.microsoft.com/beta/unifiedRoleAssignmentScheduleInstance/activatedUsing/roleDefinition
```

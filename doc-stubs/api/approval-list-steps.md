...
-->
``` http
GET /users/{usersId}/approvals/{approvalId}/steps
```
...
-->
``` http
GET https://graph.microsoft.com/beta/users/{usersId}/approvals/{approvalId}/steps
```
  ...
  "value": [
    {
      ...
      "id": "3724e825-e825-3724-25e8-243725e82437",
      "displayName": "String",
      "reviewedBy": {

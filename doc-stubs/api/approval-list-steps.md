...
-->
``` http
GET https://graph.microsoft.com/v1.0/users/{usersId}/appConsentRequestsForApproval/{appConsentRequestId}/userConsentRequests/{userConsentRequestId}/approval/steps
```

...
-->
``` http
GET /groups/{groupsId}/calendar/calendarView/{eventId}/exceptionOccurrences
```
...
-->
``` http
GET https://graph.microsoft.com/v1.0/groups/{groupsId}/calendar/calendarView/{eventId}/exceptionOccurrences
```

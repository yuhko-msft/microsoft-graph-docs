...
-->
``` http
POST ** Collection URI for microsoft.graph.stsPolicy not found
```
...
-->
``` http
POST https://graph.microsoft.com/beta** Collection URI for microsoft.graph.stsPolicy not found
...
{
  "@odata.type": "#microsoft.graph.stsPolicy",
  "id": "2e2030f5-30f5-2e20-f530-202ef530202e",
  "deletedDateTime": "String (timestamp)",
  "description": "String",
  "displayName": "String",
  "definition": [

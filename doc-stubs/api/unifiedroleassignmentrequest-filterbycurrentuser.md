...
-->
``` http
GET /rbacApplication/roleAssignmentRequests/filterByCurrentUser
```
...
-->
``` http
GET https://graph.microsoft.com/beta/rbacApplication/roleAssignmentRequests/filterByCurrentUser(on='parameterValue')
```

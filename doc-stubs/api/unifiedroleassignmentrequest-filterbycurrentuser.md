...
-->
``` http
GET /roleManagement/directory/roleAssignmentRequests/filterByCurrentUser
```
...
-->
``` http
GET https://graph.microsoft.com/beta/roleManagement/directory/roleAssignmentRequests/filterByCurrentUser(on='parameterValue')
```

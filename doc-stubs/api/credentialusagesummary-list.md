...
-->
``` http
GET ** Collection URI for Microsoft.AAD.Reporting.credentialUsageSummary not found
```
...
-->
``` http
GET https://graph.microsoft.com/beta** Collection URI for Microsoft.AAD.Reporting.credentialUsageSummary not found
```
...
<!-- {
  "blockType": "response",
  "truncated": true,
  "@odata.type": "Collection(Microsoft.AAD.Reporting.credentialUsageSummary)"
}
-->
``` http
HTTP/1.1 200 OK
  ...
  "value": [
    {
      ...
      "id": "1ac930b0-30b0-1ac9-b030-c91ab030c91a",
      "feature": "String",

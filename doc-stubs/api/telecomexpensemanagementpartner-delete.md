...
description: "Deletes a telecomExpenseManagementPartner object."
...
Deletes a [telecomExpenseManagementPartner](../resources/telecomexpensemanagementpartner.md) object.
...
<!-- {
  "blockType": "request",
  "name": "delete_telecomexpensemanagementpartner"
}
-->
``` http

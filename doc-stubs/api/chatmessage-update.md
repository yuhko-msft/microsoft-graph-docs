...
PATCH /teams/{teamsId}/channels/{channelId}/messages/{chatMessageId}/replies/{chatMessageId}
```
...
The following table shows the properties that are required when you update the [chatMessage](../resources/chatmessage.md).
...
-->
``` http
PATCH https://graph.microsoft.com/v1.0/chats/{chatsId}/messages/{chatMessageId}
...
{
  "@odata.type": "#microsoft.graph.chatMessage",
  "id": "2e86470d-470d-2e86-0d47-862e0d47862e",
  "replyToId": "String",
  "from": {
    "@odata.type": "microsoft.graph.identitySet"
  },

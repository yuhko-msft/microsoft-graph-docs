---
title: "deviceManagementTemplate: compare"
...
# deviceManagementTemplate: compare
...
-->
``` http
GET https://graph.microsoft.com/v1.0/deviceManagement/templates/{deviceManagementTemplateId}/compare(templateId='parameterValue')
```

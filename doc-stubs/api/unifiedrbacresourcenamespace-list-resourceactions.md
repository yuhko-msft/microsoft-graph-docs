...
-->
``` http
GET /rbacApplication/resourceNamespaces/{unifiedRbacResourceNamespaceId}/resourceActions
```
...
-->
``` http
GET https://graph.microsoft.com/beta/rbacApplication/resourceNamespaces/{unifiedRbacResourceNamespaceId}/resourceActions
```
...
<!-- {
  "blockType": "response",
  "truncated": true,
  "@odata.type": "Collection(Microsoft.EnterpriseRbac.unifiedRbacResourceAction)"
}
-->
``` http
HTTP/1.1 200 OK

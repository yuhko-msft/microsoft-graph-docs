...
Create a new [iosGeneralDeviceConfiguration](../resources/intune-iosgeneraldeviceconfiguration.md) object.
...
The following table shows the properties that are required when you create the [iosGeneralDeviceConfiguration](../resources/intune-iosgeneraldeviceconfiguration.md).
...
If successful, this method returns a `201 Created` response code and an [iosGeneralDeviceConfiguration](../resources/intune-iosgeneraldeviceconfiguration.md) object in the response body.
...
<!-- {
  "blockType": "request",
  "name": "create_iosgeneraldeviceconfiguration_from_"
}
-->
``` http

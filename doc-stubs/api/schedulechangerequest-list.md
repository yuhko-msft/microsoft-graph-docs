...
-->
``` http
GET ** Collection URI for Microsoft.Teams.Shifts.scheduleChangeRequest not found
```
...
-->
``` http
GET https://graph.microsoft.com/beta** Collection URI for Microsoft.Teams.Shifts.scheduleChangeRequest not found
```
...
<!-- {
  "blockType": "response",
  "truncated": true,
  "@odata.type": "Collection(Microsoft.Teams.Shifts.scheduleChangeRequest)"
}
-->
``` http
HTTP/1.1 200 OK

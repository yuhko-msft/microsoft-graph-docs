...
-->
``` http
PATCH /drive/activities/{itemActivityOLDId}/driveItem/thumbnails/{thumbnailSetId}
PATCH /drives/{drivesId}/activities/{itemActivityOLDId}/driveItem/thumbnails/{thumbnailSetId}
```
...
-->
``` http
PATCH https://graph.microsoft.com/beta/drive/activities/{itemActivityOLDId}/driveItem/thumbnails/{thumbnailSetId}

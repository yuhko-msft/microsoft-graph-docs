...
-->
``` http
POST /governanceRoleSettings/{governanceRoleSettingsId}/resource
```
...
-->
``` http
POST https://graph.microsoft.com/beta/governanceRoleSettings/{governanceRoleSettingsId}/resource

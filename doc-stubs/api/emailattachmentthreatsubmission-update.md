---
title: "Update emailAttachmentThreatSubmission"
description: "Update the properties of an emailAttachmentThreatSubmission object."
...
# Update emailAttachmentThreatSubmission
Namespace: microsoft.graph

[!INCLUDE [beta-disclaimer](../../includes/beta-disclaimer.md)]

Update the properties of an [emailAttachmentThreatSubmission](../resources/emailattachmentthreatsubmission.md) object.
...
-->
``` http
PATCH /emailAttachmentThreatSubmission
PATCH /submission/emailAttachmentThreats/{emailAttachmentThreatSubmissionId}
```
...
If successful, this method returns a `200 OK` response code and an updated [emailAttachmentThreatSubmission](../resources/emailattachmentthreatsubmission.md) object in the response body.
...
<!-- {
  "blockType": "request",
  "name": "update_emailattachmentthreatsubmission"
}
-->
``` http
PATCH https://graph.microsoft.com/beta/emailAttachmentThreatSubmission

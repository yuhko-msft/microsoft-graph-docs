...
-->
``` http
GET /drive/activities/{itemActivityOLDId}/driveItem/listItem/versions/{listItemVersionId}
GET /drives/{drivesId}/activities/{itemActivityOLDId}/driveItem/listItem/versions/{listItemVersionId}
```
...
-->
``` http
GET https://graph.microsoft.com/beta/drive/activities/{itemActivityOLDId}/driveItem/listItem/versions/{listItemVersionId}
```

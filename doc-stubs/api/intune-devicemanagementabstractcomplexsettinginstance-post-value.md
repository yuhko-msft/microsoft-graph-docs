...
-->
``` http
POST /deviceManagementComplexSettingInstance/value/$ref
...
If successful, this method returns a `204 No Content` response code and a [deviceManagementSettingInstance](../resources/intune-devicemanagementsettinginstance.md) object in the response body.
...
-->
``` http
POST https://graph.microsoft.com/beta/deviceManagementComplexSettingInstance/value/$ref

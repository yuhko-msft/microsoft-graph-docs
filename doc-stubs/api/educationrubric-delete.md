...
description: "Deletes an educationRubric object."
...
Deletes an [educationRubric](../resources/educationrubric.md) object.
...
-->
``` http
DELETE https://graph.microsoft.com/v1.0/education/classes/{educationClassId}/assignments/{educationAssignmentId}/rubric
```

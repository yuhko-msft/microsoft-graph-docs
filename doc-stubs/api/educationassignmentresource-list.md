...
description: "Get a list of the educationAssignmentResource objects and their properties."
...
Get a list of the [educationAssignmentResource](../resources/educationassignmentresource.md) objects and their properties.
...
<!-- {
  "blockType": "request",
  "name": "list_educationassignmentresource"
}
-->
``` http
GET https://graph.microsoft.com/v1.0/education/classes/{educationClassId}/assignments/{educationAssignmentId}/resources
```

...
-->
``` http
POST /financials/companies/{companyId}/salesQuoteLines/{salesQuoteLineId}/item
```
...
-->
``` http
POST https://graph.microsoft.com/v1.0/financials/companies/{companyId}/salesQuoteLines/{salesQuoteLineId}/item

...
description: "Get a list of the deviceAndAppManagementRoleDefinition objects and their properties."
...
Get a list of the [deviceAndAppManagementRoleDefinition](../resources/deviceandappmanagementroledefinition.md) objects and their properties.
...
<!-- {
  "blockType": "request",
  "name": "list_deviceandappmanagementroledefinition"
}
-->
``` http
GET https://graph.microsoft.com/beta** Collection URI for microsoft.graph.deviceAndAppManagementRoleDefinition not found
```
  ...
  "value": [
    {
      ...
      "id": "8213daf3-daf3-8213-f3da-1382f3da1382",
      "description": "String",
      "displayName": "String",
      "isBuiltIn": "Boolean",

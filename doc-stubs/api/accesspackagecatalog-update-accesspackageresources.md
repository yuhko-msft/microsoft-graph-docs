---
title: "Update accessPackageResources"
description: "Update the properties of an accessPackageResources object."
...
# Update accessPackageResources
Namespace: microsoft.graph

Update the properties of an accessPackageResources object.
...
-->
``` http
PATCH /identityGovernance/entitlementManagement/accessPackageCatalogs/{accessPackageCatalogId}/accessPackageResources
```
...
<!-- {
  "blockType": "request",
  "name": "update_accesspackageresources"
}
-->
``` http
PATCH https://graph.microsoft.com/beta/identityGovernance/entitlementManagement/accessPackageCatalogs/{accessPackageCatalogId}/accessPackageResources

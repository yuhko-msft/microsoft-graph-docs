...
-->
``` http
GET ** Collection URI for BadUnresolvedEntityType:microsoft.graph.group not found
```
...
-->
``` http
GET https://graph.microsoft.com/beta** Collection URI for BadUnresolvedEntityType:microsoft.graph.group not found
```

...
-->
``` http
GET /deviceManagement/cloudManagedDesktop/azureConnections
```
...
-->
``` http
GET https://graph.microsoft.com/beta/deviceManagement/cloudManagedDesktop/azureConnections
```

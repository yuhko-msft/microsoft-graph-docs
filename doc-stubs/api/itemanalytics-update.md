...
PATCH /workbooks/{workbooksId}/analytics
```
...
The following table shows the properties that are required when you update the [itemAnalytics](../resources/itemanalytics.md).

---
title: "application: checkMemberGroups"
...
-->
``` http
POST /applications/{applicationsId}/checkMemberGroups
```
...
-->
``` http
POST https://graph.microsoft.com/beta/applications/{applicationsId}/checkMemberGroups

...
description: "Get a list of the managementCondition objects and their properties."
...
Get a list of the [managementCondition](../resources/managementcondition.md) objects and their properties.
...
-->
``` http
GET https://graph.microsoft.com/v1.0/deviceManagement/managementConditions
```

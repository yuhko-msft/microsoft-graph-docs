...
-->
``` http
PATCH /deviceManagement/cloudManagedDesktop/onPremisesConnections
```
...
-->
``` http
PATCH https://graph.microsoft.com/beta/deviceManagement/cloudManagedDesktop/onPremisesConnections

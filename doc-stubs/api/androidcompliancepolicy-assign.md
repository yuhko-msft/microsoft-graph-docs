---
title: "androidCompliancePolicy: assign"
...
# androidCompliancePolicy: assign
...
-->
``` http
POST https://graph.microsoft.com/beta** Entity URI for microsoft.graph.androidCompliancePolicy not found/assign

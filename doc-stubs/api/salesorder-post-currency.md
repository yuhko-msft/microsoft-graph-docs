...
-->
``` http
POST /financials/companies/{companyId}/salesOrders/{salesOrderId}/currency
```
...
-->
``` http
POST https://graph.microsoft.com/beta/financials/companies/{companyId}/salesOrders/{salesOrderId}/currency

...
-->
``` http
POST https://graph.microsoft.com/v1.0** Collection URI for microsoft.graph.windowsUpdates.updatableAssetGroup not found
...
{
  "@odata.type": "#microsoft.graph.windowsUpdates.updatableAssetGroup",
  "id": "e6ed0551-0551-e6ed-5105-ede65105ede6"
}
```

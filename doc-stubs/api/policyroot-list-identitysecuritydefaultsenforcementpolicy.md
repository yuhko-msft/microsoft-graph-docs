...
description: "Get the identitySecurityDefaultsEnforcementPolicy resources from the identitySecurityDefaultsEnforcementPolicy navigation property."
...
Get the identitySecurityDefaultsEnforcementPolicy resources from the identitySecurityDefaultsEnforcementPolicy navigation property.
...
<!-- {
  "blockType": "request",
  "name": "list_identitysecuritydefaultsenforcementpolicy"
}
-->
``` http
...
<!-- {
  "blockType": "response",
  "truncated": true,
  "@odata.type": "Collection(Microsoft.IdentityProtectionServices.identitySecurityDefaultsEnforcementPolicy)"
}
-->
``` http
HTTP/1.1 200 OK

...
-->
``` http
POST /drives/{drivesId}/activities/{itemActivityId}/driveItem/activities
```
...
-->
``` http
POST https://graph.microsoft.com/beta/drives/{drivesId}/activities/{itemActivityId}/driveItem/activities

...
The following table shows the properties that are required when you update the [windows81GeneralConfiguration](../resources/windows81generalconfiguration.md).
...
-->
``` http
PATCH https://graph.microsoft.com/v1.0** Entity URI for microsoft.graph.windows81GeneralConfiguration not found

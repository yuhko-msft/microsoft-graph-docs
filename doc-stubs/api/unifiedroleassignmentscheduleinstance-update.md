...
-->
``` http
PATCH /unifiedRoleAssignmentScheduleInstance
PATCH /rbacApplication/roleAssignmentScheduleInstances/{unifiedRoleAssignmentScheduleInstanceId}
```
...
-->
``` http
PATCH https://graph.microsoft.com/beta/unifiedRoleAssignmentScheduleInstance
...
{
  "@odata.type": "#microsoft.graph.unifiedRoleAssignmentScheduleInstance",
  "id": "9058a4c1-a4c1-9058-c1a4-5890c1a45890",
  "principalId": "String",
  "roleDefinitionId": "String",
  "directoryScopeId": "String",
  "appScopeId": "String",

...
-->
``` http
POST /workbooks/{workbooksId}/workbook/functions/ipmt
```
...
<!-- {
  "blockType": "request",
  "name": "workbookfunctions_ipmt"
}
-->
``` http
POST https://graph.microsoft.com/beta/workbooks/{workbooksId}/workbook/functions/ipmt

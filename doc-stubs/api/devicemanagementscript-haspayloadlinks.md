---
title: "deviceManagementScript: hasPayloadLinks"
...
# deviceManagementScript: hasPayloadLinks
...
<!-- {
  "blockType": "request",
  "name": "devicemanagementscript_haspayloadlinks"
}
-->
``` http
POST https://graph.microsoft.com/v1.0/deviceManagement/deviceManagementScripts/hasPayloadLinks

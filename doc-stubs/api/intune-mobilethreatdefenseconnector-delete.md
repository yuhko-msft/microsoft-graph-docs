...
description: "Deletes a mobileThreatDefenseConnector object."
...
Deletes a [mobileThreatDefenseConnector](../resources/intune-mobilethreatdefenseconnector.md) object.
...
<!-- {
  "blockType": "request",
  "name": "delete_mobilethreatdefenseconnector"
}
-->
``` http

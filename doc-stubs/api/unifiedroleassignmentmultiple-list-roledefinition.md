...
-->
``` http
GET /roleManagement/cloudPC/roleAssignments/{unifiedRoleAssignmentMultipleId}/roleDefinition
```
...
-->
``` http
GET https://graph.microsoft.com/v1.0/roleManagement/cloudPC/roleAssignments/{unifiedRoleAssignmentMultipleId}/roleDefinition
```

...
-->
``` http
GET ** Collection URI for Microsoft.IdentityProtectionServices.countryNamedLocation not found
```
...
-->
``` http
GET https://graph.microsoft.com/beta** Collection URI for Microsoft.IdentityProtectionServices.countryNamedLocation not found
```
...
<!-- {
  "blockType": "response",
  "truncated": true,
  "@odata.type": "Collection(Microsoft.IdentityProtectionServices.countryNamedLocation)"
}
-->
``` http
HTTP/1.1 200 OK

...
-->
``` http
POST https://graph.microsoft.com/v1.0** Collection URI for microsoft.graph.windows10PkcsCertificateProfile not found
...
{
  "@odata.type": "#microsoft.graph.windows10PkcsCertificateProfile",
  "id": "8ea568b2-68b2-8ea5-b268-a58eb268a58e",

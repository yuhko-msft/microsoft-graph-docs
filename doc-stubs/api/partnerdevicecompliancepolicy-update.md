---
title: "Update partnerDeviceCompliancePolicy"
description: "Update the properties of a partnerDeviceCompliancePolicy object."
...
# Update partnerDeviceCompliancePolicy
Namespace: microsoft.graph

Update the properties of a [partnerDeviceCompliancePolicy](../resources/partnerdevicecompliancepolicy.md) object.
...
-->
``` http
PATCH ** Entity URI for microsoft.graph.partnerDeviceCompliancePolicy not found
```
...
The following table shows the properties that are required when you update the [partnerDeviceCompliancePolicy](../resources/partnerdevicecompliancepolicy.md).
...
If successful, this method returns a `200 OK` response code and an updated [partnerDeviceCompliancePolicy](../resources/partnerdevicecompliancepolicy.md) object in the response body.
...
<!-- {
  "blockType": "request",
  "name": "update_partnerdevicecompliancepolicy"
}
-->
``` http
PATCH https://graph.microsoft.com/beta** Entity URI for microsoft.graph.partnerDeviceCompliancePolicy not found

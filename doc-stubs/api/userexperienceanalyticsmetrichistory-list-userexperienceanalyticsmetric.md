...
description: "Get the userExperienceAnalyticsMetric resources from the userExperienceAnalyticsMetric navigation property."
...
Get the userExperienceAnalyticsMetric resources from the userExperienceAnalyticsMetric navigation property.
...
-->
``` http
GET https://graph.microsoft.com/v1.0/deviceManagement/userExperienceAnalyticsDeviceMetricHistory/{userExperienceAnalyticsMetricHistoryId}/userExperienceAnalyticsMetric
```

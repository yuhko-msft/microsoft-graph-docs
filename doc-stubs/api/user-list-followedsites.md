...
description: "Get the site resources from the followedSites navigation property."
...
Get the site resources from the followedSites navigation property.
...
-->
``` http
GET https://graph.microsoft.com/beta/me/followedSites
```

...
-->
``` http
POST /unifiedRoleAssignmentScheduleInstance/activatedUsing/$ref
```
...
-->
``` http
POST https://graph.microsoft.com/beta/unifiedRoleAssignmentScheduleInstance/activatedUsing/$ref

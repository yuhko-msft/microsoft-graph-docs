...
Read the properties and relationships of an [iosVppEBook](../resources/intune-iosvppebook.md) object.
...
If successful, this method returns a `200 OK` response code and an [iosVppEBook](../resources/intune-iosvppebook.md) object in the response body.

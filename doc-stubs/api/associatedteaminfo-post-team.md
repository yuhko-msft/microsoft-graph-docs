...
-->
``` http
POST /users/{usersId}/teamwork/associatedTeams/{associatedTeamInfoId}/team/$ref
```
...
-->
``` http
POST https://graph.microsoft.com/beta/users/{usersId}/teamwork/associatedTeams/{associatedTeamInfoId}/team/$ref

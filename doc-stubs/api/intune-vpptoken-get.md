...
Read the properties and relationships of a [vppToken](../resources/intune-vpptoken.md) object.
...
If successful, this method returns a `200 OK` response code and a [vppToken](../resources/intune-vpptoken.md) object in the response body.

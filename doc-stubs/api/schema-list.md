...
Get a list of the [schema](../resources/schema.md) objects and their properties.
...
-->
``` http
GET https://graph.microsoft.com/beta** Collection URI for microsoft.graph.schema not found
```
  ...
  "value": [
    {
      ...
      "id": "01993845-3845-0199-4538-990145389901",
      "baseType": "String",
      "properties": [
        {

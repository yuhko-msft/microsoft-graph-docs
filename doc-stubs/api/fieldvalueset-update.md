...
-->
``` http
PATCH /drive/activities/{itemActivityOLDId}/driveItem/listItem/fields
PATCH /drives/{drivesId}/activities/{itemActivityOLDId}/driveItem/listItem/fields
PATCH /drive/activities/{itemActivityOLDId}/driveItem/listItem/versions/{listItemVersionId}/fields
PATCH /drives/{drivesId}/activities/{itemActivityOLDId}/driveItem/listItem/versions/{listItemVersionId}/fields
```
...
-->
``` http
PATCH https://graph.microsoft.com/beta/drive/activities/{itemActivityOLDId}/driveItem/listItem/fields

...
-->
``` http
POST /roleManagement/directory/roleAssignments/{unifiedRoleAssignmentId}/roleDefinition/$ref
```
...
-->
``` http
POST https://graph.microsoft.com/beta/roleManagement/directory/roleAssignments/{unifiedRoleAssignmentId}/roleDefinition/$ref

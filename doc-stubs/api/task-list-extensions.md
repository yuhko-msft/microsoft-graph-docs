...
-->
``` http
GET /user/tasks/lists/{wellKnownTaskListId}/tasks/{taskId}/extensions
```
...
-->
``` http
GET https://graph.microsoft.com/beta/user/tasks/lists/{wellKnownTaskListId}/tasks/{taskId}/extensions
```

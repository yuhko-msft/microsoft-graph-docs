...
GET /print/reports/getYammerGroupsActivityGroupCounts
```
...
-->
``` http
GET https://graph.microsoft.com/v1.0/reports/getYammerGroupsActivityGroupCounts(period='parameterValue')
```

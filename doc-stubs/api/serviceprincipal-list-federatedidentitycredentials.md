...
description: "Get the federatedIdentityCredential resources from the federatedIdentityCredentials navigation property."
...
Get the federatedIdentityCredential resources from the federatedIdentityCredentials navigation property.
...
-->
``` http
GET https://graph.microsoft.com/beta/servicePrincipals/{servicePrincipalsId}/federatedIdentityCredentials
```

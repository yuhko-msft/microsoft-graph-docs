...
-->
``` http
PATCH /users/{usersId}/todo/lists/{todoTaskListId}/tasks
```
...
-->
``` http
PATCH https://graph.microsoft.com/beta/users/{usersId}/todo/lists/{todoTaskListId}/tasks
...
{
  "@odata.type": "#microsoft.graph.todoTask",
  "id": "39165798-5798-3916-9857-163998571639",
  "body": {
    "@odata.type": "microsoft.graph.itemBody"
  },
  "completedDateTime": {

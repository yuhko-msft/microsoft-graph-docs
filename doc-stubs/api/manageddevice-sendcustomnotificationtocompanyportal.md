---
title: "managedDevice: sendCustomNotificationToCompanyPortal"
...
-->
``` http
POST /me/managedDevices/{managedDeviceId}/sendCustomNotificationToCompanyPortal
...
<!-- {
  "blockType": "request",
  "name": "manageddevice_sendcustomnotificationtocompanyportal"
}
-->
``` http
POST https://graph.microsoft.com/v1.0/me/managedDevices/{managedDeviceId}/sendCustomNotificationToCompanyPortal

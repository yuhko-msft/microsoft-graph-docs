...
Read the properties and relationships of a [microsoftTunnelServer](../resources/intune-microsofttunnelserver.md) object.
...
If successful, this method returns a `200 OK` response code and a [microsoftTunnelServer](../resources/intune-microsofttunnelserver.md) object in the response body.

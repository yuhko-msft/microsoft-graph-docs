...
description: "Get the printUsageByUser resources from the monthlyPrintUsageSummariesByUser navigation property."
...
Get the printUsageByUser resources from the monthlyPrintUsageSummariesByUser navigation property.
...
-->
``` http
GET https://graph.microsoft.com/v1.0/print/reports/monthlyPrintUsageSummariesByUser
```

...
description: "Get a list of the dimension objects and their properties."
...
Get a list of the [dimension](../resources/dimension.md) objects and their properties.
...
-->
``` http
GET https://graph.microsoft.com/beta/financials/companies/{companyId}/dimensions
```

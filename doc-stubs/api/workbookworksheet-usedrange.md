...
-->
``` http
GET /workbookRange/worksheet/usedRange
```
...
|:---|:---|:---|
|valuesOnly|Boolean|**TODO: Add Description**|
...
-->
``` http
GET https://graph.microsoft.com/beta/workbookRange/worksheet/usedRange(valuesOnly=Boolean)
```

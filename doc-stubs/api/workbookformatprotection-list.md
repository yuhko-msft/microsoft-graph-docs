...
description: "Get a list of the workbookFormatProtection objects and their properties."
...
Get a list of the [workbookFormatProtection](../resources/workbookformatprotection.md) objects and their properties.
...
-->
``` http
GET https://graph.microsoft.com/beta** Collection URI for microsoft.graph.workbookFormatProtection not found
```

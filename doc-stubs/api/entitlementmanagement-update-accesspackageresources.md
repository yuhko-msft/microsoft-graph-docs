...
-->
``` http
PATCH /identityGovernance/entitlementManagement/accessPackageResources
```
...
-->
``` http
PATCH https://graph.microsoft.com/beta/identityGovernance/entitlementManagement/accessPackageResources
...
{
  "@odata.type": "#microsoft.graph.accessPackageResource",
  "id": "8bf071aa-71aa-8bf0-aa71-f08baa71f08b",
  "displayName": "String",
  "description": "String",
  "url": "String",
  "resourceType": "String",

...
-->
``` http
PATCH /users/{usersId}/outlook/taskGroups/{outlookTaskGroupId}/taskFolders
```
...
-->
``` http
PATCH https://graph.microsoft.com/beta/users/{usersId}/outlook/taskGroups/{outlookTaskGroupId}/taskFolders
...
{
  "@odata.type": "#microsoft.graph.outlookTaskFolder",
  "id": "42dfd9f6-d9f6-42df-f6d9-df42f6d9df42",
  "changeKey": "String",
  "name": "String",
  "isDefaultFolder": "Boolean",
  "parentGroupKey": "Guid"

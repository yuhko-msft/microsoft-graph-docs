...
description: "Get a list of the schedulingGroup objects and their properties."
...
Get a list of the [schedulingGroup](../resources/schedulinggroup.md) objects and their properties.
...
-->
``` http
GET /teams/{teamsId}/schedule/schedulingGroups
```
...
-->
``` http
GET https://graph.microsoft.com/beta/teams/{teamsId}/schedule/schedulingGroups
```

...
-->
``` http
POST /me/authentication/passwordMethods/{passwordAuthenticationMethodId}/resetPassword
POST /users/{usersId}/authentication/passwordMethods/{passwordAuthenticationMethodId}/resetPassword
```
...
-->
``` http
POST https://graph.microsoft.com/v1.0/me/authentication/passwordMethods/{passwordAuthenticationMethodId}/resetPassword

---
title: "androidForWorkTrustedRootCertificate: assign"
...
# androidForWorkTrustedRootCertificate: assign
...
<!-- {
  "blockType": "request",
  "name": "androidforworktrustedrootcertificate_assign"
}
-->
``` http
POST https://graph.microsoft.com/beta/deviceManagement/deviceConfigurations/{deviceConfigurationId}/identityCertificate/rootCertificate/assign

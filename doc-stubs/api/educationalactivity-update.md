...
PATCH /users/{usersId}/profile/educationalActivities/{educationalActivityId}
```
...
-->
``` http
PATCH https://graph.microsoft.com/v1.0/me/profile/educationalActivities/{educationalActivityId}

...
description: "Get a list of the deviceCustomAttributeShellScript objects and their properties."
...
Get a list of the [deviceCustomAttributeShellScript](../resources/devicecustomattributeshellscript.md) objects and their properties.
...
<!-- {
  "blockType": "response",
  "truncated": true,
  "@odata.type": "Collection(microsoft.management.services.api.deviceCustomAttributeShellScript)"
}
-->
``` http
HTTP/1.1 200 OK

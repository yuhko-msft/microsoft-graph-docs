...
-->
``` http
POST /deviceManagement/reusableSettings/{deviceManagementConfigurationReusableSettingId}/referencingConfigurationPolicies
```
...
-->
``` http
POST https://graph.microsoft.com/beta/deviceManagement/reusableSettings/{deviceManagementConfigurationReusableSettingId}/referencingConfigurationPolicies

...
-->
``` http
POST /print/reports/dailyPrintUsageByPrinter
POST /print/reports/monthlyPrintUsageByPrinter
...
-->
``` http
POST https://graph.microsoft.com/v1.0/print/reports/dailyPrintUsageByPrinter

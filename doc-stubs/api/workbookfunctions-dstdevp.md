---
title: "workbookFunctions: dstDevP"
...
-->
``` http
POST /workbooks/{workbooksId}/workbook/functions/dstDevP
```
...
<!-- {
  "blockType": "request",
  "name": "workbookfunctions_dstdevp"
}
-->
``` http
POST https://graph.microsoft.com/beta/workbooks/{workbooksId}/workbook/functions/dstDevP

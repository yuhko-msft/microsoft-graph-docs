...
description: "Deletes a deviceConfigurationGroupAssignment object."
...
Deletes a [deviceConfigurationGroupAssignment](../resources/deviceconfigurationgroupassignment.md) object.
...
<!-- {
  "blockType": "request",
  "name": "delete_deviceconfigurationgroupassignment"
}
-->
``` http
DELETE https://graph.microsoft.com/v1.0/deviceManagement/deviceConfigurations/{deviceConfigurationId}/groupAssignments/{deviceConfigurationGroupAssignmentId}
```

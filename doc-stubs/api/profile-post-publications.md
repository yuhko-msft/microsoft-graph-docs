...
-->
``` http
POST /users/{usersId}/profile/publications
```
...
The following table shows the properties that are required when you create the [itemPublication](../resources/itempublication.md).
...
-->
``` http
POST https://graph.microsoft.com/v1.0/users/{usersId}/profile/publications

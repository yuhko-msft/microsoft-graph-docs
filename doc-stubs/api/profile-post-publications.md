---
title: "Create itemPublication"
description: "Create a new itemPublication object."
...
Create a new itemPublication object.
...
-->
``` http
POST /user/{userId}/profile/publications
```
...
You can specify the following properties when creating an **itemPublication**.
...
|publishedDate|Date|**TODO: Add Description** Optional.|
|publisher|String|**TODO: Add Description** Optional.|
...
-->
``` http
POST https://graph.microsoft.com/beta/user/{userId}/profile/publications
...
{
  "@odata.type": "#Microsoft.Fast.PI.ViewGenerator.V2.Profile.Models.itemPublication",
  "id": "964cc293-c293-964c-93c2-4c9693c24c96",
  "allowedAudiences": "String",
  "inference": {
    "@odata.type": "microsoft.graph.inferenceData"
  },

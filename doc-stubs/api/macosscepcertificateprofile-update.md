...
The following table shows the properties that are required when you update the [macOSScepCertificateProfile](../resources/macosscepcertificateprofile.md).
...
{
  "@odata.type": "#microsoft.graph.macOSScepCertificateProfile",
  "id": "7f61208f-208f-7f61-8f20-617f8f20617f",

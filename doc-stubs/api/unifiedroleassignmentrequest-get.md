...
-->
``` http
GET /rbacApplication/roleAssignmentRequests/{unifiedRoleAssignmentRequestId}
```
...
-->
``` http
GET https://graph.microsoft.com/beta/rbacApplication/roleAssignmentRequests/{unifiedRoleAssignmentRequestId}
```

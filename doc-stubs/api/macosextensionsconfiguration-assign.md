---
title: "macOSExtensionsConfiguration: assign"
...
# macOSExtensionsConfiguration: assign
...
-->
``` http
POST ** Entity URI for microsoft.graph.macOSExtensionsConfiguration not found/assign
```
...
<!-- {
  "blockType": "request",
  "name": "macosextensionsconfiguration_assign"
}
-->
``` http
POST https://graph.microsoft.com/v1.0** Entity URI for microsoft.graph.macOSExtensionsConfiguration not found/assign

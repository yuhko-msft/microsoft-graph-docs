...
|type|cloudPcOnPremisesConnectionType|**TODO: Add Description**. The possible values are: `hybridAzureADJoin`, `azureADJoin`, `unknownFutureValue`.|
...
|healthCheckStatus|cloudPcOnPremisesConnectionStatus|**TODO: Add Description**. The possible values are: `pending`, `running`, `passed`, `failed`, `warning`, `unknownFutureValue`.|
...
{
  "@odata.type": "#microsoft.graph.cloudPcOnPremisesConnection",
  "id": "b360397b-397b-b360-7b39-60b37b3960b3",
  "type": "String",
  "displayName": "String",
  "subscriptionId": "String",
  "subscriptionName": "String",

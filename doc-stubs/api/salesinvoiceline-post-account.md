...
-->
``` http
POST /financials/companies/{companyId}/salesInvoiceLines/{salesInvoiceLineId}/account
```
...
-->
``` http
POST https://graph.microsoft.com/v1.0/financials/companies/{companyId}/salesInvoiceLines/{salesInvoiceLineId}/account

...
description: "Get a list of the workbookApplication objects and their properties."
...
Get a list of the [workbookApplication](../resources/workbookapplication.md) objects and their properties.
...
-->
``` http
GET https://graph.microsoft.com/beta** Collection URI for microsoft.graph.workbookApplication not found
```

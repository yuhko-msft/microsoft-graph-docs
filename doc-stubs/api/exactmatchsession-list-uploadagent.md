---
title: "List exactMatchUploadAgent"
description: "Get the exactMatchUploadAgent resources from the uploadAgent navigation property."
...
# List exactMatchUploadAgent
Namespace: microsoft.graph



Get the exactMatchUploadAgent resources from the uploadAgent navigation property.
...
<!-- {
  "blockType": "request",
  "name": "list_exactmatchuploadagent"
}
-->
``` http
GET https://graph.microsoft.com/v1.0/dataClassification/exactMatchDataStores/{exactMatchDataStoreId}/sessions/{exactMatchSessionId}/uploadAgent
```

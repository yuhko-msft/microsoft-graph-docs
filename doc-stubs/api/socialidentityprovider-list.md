...
-->
``` http
GET ** Collection URI for microsoft.graph.socialIdentityProvider not found
```
...
-->
``` http
GET https://graph.microsoft.com/v1.0** Collection URI for microsoft.graph.socialIdentityProvider not found
```
...
<!-- {
  "blockType": "response",
  "truncated": true,
  "@odata.type": "Collection(microsoft.graph.socialIdentityProvider)"
}
-->
``` http
HTTP/1.1 200 OK

...
The following table shows the properties that are required when you update the [windowsPhone81SCEPCertificateProfile](../resources/windowsphone81scepcertificateprofile.md).

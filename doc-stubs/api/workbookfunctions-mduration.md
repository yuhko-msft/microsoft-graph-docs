---
title: "workbookFunctions: mduration"
...
-->
``` http
POST /workbooks/{workbooksId}/workbook/functions/mduration
```
...
|coupon|[Json](../resources/json.md)|**TODO: Add Description**|
...
<!-- {
  "blockType": "request",
  "name": "workbookfunctions_mduration"
}
-->
``` http
POST https://graph.microsoft.com/beta/workbooks/{workbooksId}/workbook/functions/mduration

...
-->
``` http
GET ** Collection URI for Microsoft.IdentityProtectionServices.identitySecurityDefaultsEnforcementPolicy not found
```
...
-->
``` http
GET https://graph.microsoft.com/beta** Collection URI for Microsoft.IdentityProtectionServices.identitySecurityDefaultsEnforcementPolicy not found
```

...
The following table shows the properties that are required when you update the [siteSource](../resources/sitesource.md).
...
{
  "@odata.type": "#microsoft.graph.siteSource",
  "id": "f133d9f2-d9f2-f133-f2d9-33f1f2d933f1",
  "displayName": "String",

---
title: "workbookFunctions: yearFrac"
...
-->
``` http
POST /workbooks/{workbooksId}/workbook/functions/yearFrac
```
...
<!-- {
  "blockType": "request",
  "name": "workbookfunctions_yearfrac"
}
-->
``` http
POST https://graph.microsoft.com/beta/workbooks/{workbooksId}/workbook/functions/yearFrac

...
-->
``` http
POST /unifiedRoleScheduleBase/principal/checkMemberObjects
POST /groups/{groupsId}/createdOnBehalfOf/checkMemberObjects
POST /directoryObjects/{directoryObjectsId}/checkMemberObjects
POST /unifiedRoleScheduleBase/directoryScope/checkMemberObjects
POST /stsPolicy/appliesTo/{directoryObjectId}/checkMemberObjects
POST /unifiedRoleScheduleInstanceBase/principal/checkMemberObjects
POST /directory/deletedItems/{directoryObjectId}/checkMemberObjects
POST /unifiedRoleScheduleInstanceBase/directoryScope/checkMemberObjects
```
...
-->
``` http
POST https://graph.microsoft.com/beta/unifiedRoleScheduleBase/principal/checkMemberObjects

...
-->
``` http
PATCH /users/{usersId}/messages/{messageId}/extensions/{extensionId}
PATCH /users/{usersId}/contacts/{contactId}/extensions/{extensionId}
PATCH /users/{usersId}/messages/{messageId}/event/extensions/{extensionId}
PATCH /groups/{groupsId}/conversations/{conversationId}/threads/{conversationThreadId}/posts/{postId}/extensions/{extensionId}
```
...
-->
``` http
PATCH https://graph.microsoft.com/beta/users/{usersId}/messages/{messageId}/extensions/{extensionId}
...
{
  "@odata.type": "#microsoft.graph.extension",
  "id": "a86eab83-ab83-a86e-83ab-6ea883ab6ea8"
}
```

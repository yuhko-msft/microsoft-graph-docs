...
-->
``` http
POST ** Collection URI for microsoft.graph.deviceManagementSettingInstance not found
```
...
-->
``` http
POST https://graph.microsoft.com/v1.0** Collection URI for microsoft.graph.deviceManagementSettingInstance not found

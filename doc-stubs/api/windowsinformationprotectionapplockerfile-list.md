...
description: "Get a list of the windowsInformationProtectionAppLockerFile objects and their properties."
...
Get a list of the [windowsInformationProtectionAppLockerFile](../resources/windowsinformationprotectionapplockerfile.md) objects and their properties.
...
-->
``` http
GET https://graph.microsoft.com/beta/windowsInformationProtection/exemptAppLockerFiles
```

...
Read the properties and relationships of a [macOSScepCertificateProfile](../resources/intune-macosscepcertificateprofile.md) object.
...
If successful, this method returns a `200 OK` response code and a [macOSScepCertificateProfile](../resources/intune-macosscepcertificateprofile.md) object in the response body.

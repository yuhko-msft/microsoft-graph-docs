...
-->
``` http
PATCH /users/{usersId}/calendarGroups/{calendarGroupId}/calendars
```
...
-->
``` http
PATCH https://graph.microsoft.com/beta/users/{usersId}/calendarGroups/{calendarGroupId}/calendars

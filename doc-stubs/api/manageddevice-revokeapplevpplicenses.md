...
-->
``` http
POST /me/managedDevices/{managedDeviceId}/revokeAppleVppLicenses
...
-->
``` http
POST https://graph.microsoft.com/v1.0/me/managedDevices/{managedDeviceId}/revokeAppleVppLicenses
```

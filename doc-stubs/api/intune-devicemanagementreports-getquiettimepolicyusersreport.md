---
title: "deviceManagementReports: getQuietTimePolicyUsersReport"
...
# deviceManagementReports: getQuietTimePolicyUsersReport
...
<!-- {
  "blockType": "request",
  "name": "devicemanagementreports_getquiettimepolicyusersreport"
}
-->
``` http
POST https://graph.microsoft.com/beta/deviceManagement/reports/getQuietTimePolicyUsersReport

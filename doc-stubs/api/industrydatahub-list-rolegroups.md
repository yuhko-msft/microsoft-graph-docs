...
description: "Get the roleGroup resources from the roleGroups navigation property."
...
Get the roleGroup resources from the roleGroups navigation property.
...
<!-- {
  "blockType": "response",
  "truncated": true,
  "@odata.type": "Collection(microsoft.industryData.roleGroup)"
}
-->
``` http
HTTP/1.1 200 OK

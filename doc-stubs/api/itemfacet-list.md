...
-->
``` http
GET ** Collection URI for Microsoft.Fast.PI.ViewGenerator.V2.Profile.Models.itemFacet not found
```
...
-->
``` http
GET https://graph.microsoft.com/beta** Collection URI for Microsoft.Fast.PI.ViewGenerator.V2.Profile.Models.itemFacet not found
```
...
<!-- {
  "blockType": "response",
  "truncated": true,
  "@odata.type": "Collection(Microsoft.Fast.PI.ViewGenerator.V2.Profile.Models.itemFacet)"
}
-->
``` http
HTTP/1.1 200 OK

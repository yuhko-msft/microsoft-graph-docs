...
-->
``` http
GET /deviceManagement/reusableSettings/{deviceManagementConfigurationReusableSettingId}/referencingConfigurationPolicies
```
...
-->
``` http
GET https://graph.microsoft.com/beta/deviceManagement/reusableSettings/{deviceManagementConfigurationReusableSettingId}/referencingConfigurationPolicies
```

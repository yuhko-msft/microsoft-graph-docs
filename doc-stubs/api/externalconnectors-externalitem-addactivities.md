...
|:---|:---|:---|
|activities|[microsoft.graph.externalConnectors.activity](../resources/externalconnectors-activity.md) collection|**TODO: Add Description**|
...
<!-- {
  "blockType": "request",
  "name": "externalitem_addactivities"
}
-->
``` http

...
-->
``` http
POST /identityGovernance/entitlementManagement/accessPackageAssignmentRequests/{accessPackageAssignmentRequestId}/accessPackageAssignment/accessPackageAssignmentRequests
```
...
-->
``` http
POST https://graph.microsoft.com/beta/identityGovernance/entitlementManagement/accessPackageAssignmentRequests/{accessPackageAssignmentRequestId}/accessPackageAssignment/accessPackageAssignmentRequests
...
{
  "@odata.type": "#microsoft.graph.accessPackageAssignmentRequest",
  "id": "9aa103f7-03f7-9aa1-f703-a19af703a19a",
  "answers": [
    {
      "@odata.type": "microsoft.graph.accessPackageAnswerString"
    }

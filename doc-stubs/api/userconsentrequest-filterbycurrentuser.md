...
-->
``` http
GET /appConsentRequest/userConsentRequests/filterByCurrentUser
```
...
-->
``` http
GET https://graph.microsoft.com/beta/appConsentRequest/userConsentRequests/filterByCurrentUser(on='parameterValue')
```

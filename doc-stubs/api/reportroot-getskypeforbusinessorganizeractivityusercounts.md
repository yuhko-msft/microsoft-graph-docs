...
GET /print/reports/getSkypeForBusinessOrganizerActivityUserCounts
```
...
-->
``` http
GET https://graph.microsoft.com/v1.0/reports/getSkypeForBusinessOrganizerActivityUserCounts(period='parameterValue')
```

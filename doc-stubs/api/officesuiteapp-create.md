...
-->
``` http
POST ** Collection URI for microsoft.management.services.api.officeSuiteApp not found
```
...
-->
``` http
POST https://graph.microsoft.com/beta** Collection URI for microsoft.management.services.api.officeSuiteApp not found

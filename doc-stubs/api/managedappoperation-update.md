...
PATCH /users/{usersId}/managedAppRegistrations/{managedAppRegistrationId}/operations/{managedAppOperationId}
```
...
The following table shows the properties that are required when you update the [managedAppOperation](../resources/managedappoperation.md).
...
{
  "@odata.type": "#microsoft.graph.managedAppOperation",
  "id": "1a9ae806-e806-1a9a-06e8-9a1a06e89a1a",
  "displayName": "String",

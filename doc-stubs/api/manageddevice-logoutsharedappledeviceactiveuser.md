...
-->
``` http
POST /me/managedDevices/{managedDeviceId}/logoutSharedAppleDeviceActiveUser
...
-->
``` http
POST https://graph.microsoft.com/beta/me/managedDevices/{managedDeviceId}/logoutSharedAppleDeviceActiveUser
```

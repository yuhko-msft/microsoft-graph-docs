...
-->
``` http
GET /policyRoot/featureRolloutPolicies/{featureRolloutPolicyId}
```
...
-->
``` http
GET https://graph.microsoft.com/v1.0/policyRoot/featureRolloutPolicies/{featureRolloutPolicyId}
```

...
Create a new [windowsPhoneEASEmailProfileConfiguration](../resources/windowsphoneeasemailprofileconfiguration.md) object.
...
-->
``` http
POST ** Collection URI for microsoft.graph.windowsPhoneEASEmailProfileConfiguration not found
```
...
If successful, this method returns a `201 Created` response code and a [windowsPhoneEASEmailProfileConfiguration](../resources/windowsphoneeasemailprofileconfiguration.md) object in the response body.
...
<!-- {
  "blockType": "request",
  "name": "create_windowsphoneeasemailprofileconfiguration_from_"
}
-->
``` http
POST https://graph.microsoft.com/beta** Collection URI for microsoft.graph.windowsPhoneEASEmailProfileConfiguration not found
...
{
  "@odata.type": "#microsoft.graph.windowsPhoneEASEmailProfileConfiguration",
  "id": "15493bc3-3bc3-1549-c33b-4915c33b4915",

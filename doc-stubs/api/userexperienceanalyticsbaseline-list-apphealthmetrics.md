...
description: "Get the userExperienceAnalyticsCategory resources from the appHealthMetrics navigation property."
...
Get the userExperienceAnalyticsCategory resources from the appHealthMetrics navigation property.
...
-->
``` http
GET https://graph.microsoft.com/v1.0/deviceManagement/userExperienceAnalyticsBaselines/{userExperienceAnalyticsBaselineId}/appHealthMetrics
```

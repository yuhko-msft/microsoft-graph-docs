...
-->
``` http
POST /rbacApplication/roleAssignments/{unifiedRoleAssignmentId}/appScope
```
...
-->
``` http
POST https://graph.microsoft.com/v1.0/rbacApplication/roleAssignments/{unifiedRoleAssignmentId}/appScope

...
-->
``` http
POST /roleManagement/directory/roleAssignments/{unifiedRoleAssignmentId}/appScope
```
...
-->
``` http
POST https://graph.microsoft.com/beta/roleManagement/directory/roleAssignments/{unifiedRoleAssignmentId}/appScope

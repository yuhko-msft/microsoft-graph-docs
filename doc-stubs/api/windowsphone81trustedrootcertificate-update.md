...
The following table shows the properties that are required when you update the [windowsPhone81TrustedRootCertificate](../resources/windowsphone81trustedrootcertificate.md).
...
<!-- {
  "blockType": "request",
  "name": "update_windowsphone81trustedrootcertificate"
}
-->
``` http

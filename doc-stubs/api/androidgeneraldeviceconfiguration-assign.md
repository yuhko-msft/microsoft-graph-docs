---
title: "androidGeneralDeviceConfiguration: assign"
...
# androidGeneralDeviceConfiguration: assign
...
-->
``` http
POST ** Entity URI for microsoft.graph.androidGeneralDeviceConfiguration not found/assign
```
...
<!-- {
  "blockType": "request",
  "name": "androidgeneraldeviceconfiguration_assign"
}
-->
``` http
POST https://graph.microsoft.com/beta** Entity URI for microsoft.graph.androidGeneralDeviceConfiguration not found/assign

---
title: "organization: getMemberObjects"
...
-->
``` http
POST /organization/{organizationId}/getMemberObjects
```
...
-->
``` http
POST https://graph.microsoft.com/beta/organization/{organizationId}/getMemberObjects

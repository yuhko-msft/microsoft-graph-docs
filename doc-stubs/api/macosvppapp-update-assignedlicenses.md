...
-->
``` http
PATCH ** Collection URI for microsoft.management.services.api.macOsVppAppAssignedLicense not found
```
...
-->
``` http
PATCH https://graph.microsoft.com/beta** Collection URI for microsoft.management.services.api.macOsVppAppAssignedLicense not found

---
title: "androidDeviceOwnerCompliancePolicy: assign"
...
# androidDeviceOwnerCompliancePolicy: assign
...
-->
``` http
POST ** Entity URI for microsoft.graph.androidDeviceOwnerCompliancePolicy not found/assign
```
...
<!-- {
  "blockType": "request",
  "name": "androiddeviceownercompliancepolicy_assign"
}
-->
``` http
POST https://graph.microsoft.com/v1.0** Entity URI for microsoft.graph.androidDeviceOwnerCompliancePolicy not found/assign

...
-->
``` http
PATCH ** Entity URI for microsoft.graph.managedIOSLobApp not found
```
...
The following table shows the properties that are required when you update the [managedIOSLobApp](../resources/managedioslobapp.md).
...
If successful, this method returns a `200 OK` response code and an updated [managedIOSLobApp](../resources/managedioslobapp.md) object in the response body.
...
<!-- {
  "blockType": "request",
  "name": "update_managedioslobapp"
}
-->
``` http
PATCH https://graph.microsoft.com/beta** Entity URI for microsoft.graph.managedIOSLobApp not found
...
{
  "@odata.type": "#microsoft.graph.managedIOSLobApp",
  "id": "ab5777cd-77cd-ab57-cd77-57abcd7757ab",

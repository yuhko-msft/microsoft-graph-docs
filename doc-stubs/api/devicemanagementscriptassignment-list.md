---
title: "List deviceManagementScriptAssignments"
description: "Get a list of the deviceManagementScriptAssignment objects and their properties."
...
Get a list of the [deviceManagementScriptAssignment](../resources/devicemanagementscriptassignment.md) objects and their properties.
...
-->
``` http
GET https://graph.microsoft.com/v1.0/deviceManagement/deviceShellScripts/{deviceShellScriptId}/assignments
```

...
Create a new [purchaseInvoiceLine](../resources/purchaseinvoiceline.md) object.
...
-->
``` http
POST https://graph.microsoft.com/v1.0/financials/companies/{companyId}/purchaseInvoiceLines

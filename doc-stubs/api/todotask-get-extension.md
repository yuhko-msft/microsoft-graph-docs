...
-->
``` http
GET /users/{usersId}/todo/lists/{todoTaskListId}/tasks/{todoTaskId}/extensions
```
...
-->
``` http
GET https://graph.microsoft.com/v1.0/users/{usersId}/todo/lists/{todoTaskListId}/tasks/{todoTaskId}/extensions
```

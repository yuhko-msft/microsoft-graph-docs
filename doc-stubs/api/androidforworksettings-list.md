...
description: "Get a list of the androidForWorkSettings objects and their properties."
...
Get a list of the [androidForWorkSettings](../resources/androidforworksettings.md) objects and their properties.
...
-->
``` http
GET https://graph.microsoft.com/v1.0** Collection URI for microsoft.graph.androidForWorkSettings not found
```

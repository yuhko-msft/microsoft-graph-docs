...
-->
``` http
POST /administrativeUnit/checkMemberObjects
POST /directory/administrativeUnits/{administrativeUnitId}/checkMemberObjects
```
...
-->
``` http
POST https://graph.microsoft.com/v1.0/administrativeUnit/checkMemberObjects

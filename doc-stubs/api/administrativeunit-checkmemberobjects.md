...
-->
``` http
POST /administrativeUnits/{administrativeUnitsId}/checkMemberObjects
```
...
-->
``` http
POST https://graph.microsoft.com/beta/administrativeUnits/{administrativeUnitsId}/checkMemberObjects

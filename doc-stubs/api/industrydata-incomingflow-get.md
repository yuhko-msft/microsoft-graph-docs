...
Read the properties and relationships of an [incomingFlow](../resources/industrydata-incomingflow.md) object.
...
If successful, this method returns a `200 OK` response code and an [incomingFlow](../resources/industrydata-incomingflow.md) object in the response body.

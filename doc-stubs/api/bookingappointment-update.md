...
The following table shows the properties that are required when you update the [bookingAppointment](../resources/bookingappointment.md).
...
-->
``` http
PATCH https://graph.microsoft.com/v1.0/bookingBusinesses/{bookingBusinessesId}/appointments/{bookingAppointmentId}

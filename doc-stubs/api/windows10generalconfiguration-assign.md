---
title: "windows10GeneralConfiguration: assign"
...
# windows10GeneralConfiguration: assign
...
-->
``` http
POST https://graph.microsoft.com/beta** Entity URI for microsoft.graph.windows10GeneralConfiguration not found/assign

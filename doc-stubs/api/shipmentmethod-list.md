...
description: "Get a list of the shipmentMethod objects and their properties."
...
Get a list of the [shipmentMethod](../resources/shipmentmethod.md) objects and their properties.
...
-->
``` http
GET https://graph.microsoft.com/v1.0/financials/companies/{companyId}/shipmentMethods
```

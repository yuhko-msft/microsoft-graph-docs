---
title: "windows81GeneralConfiguration: assign"
...
# windows81GeneralConfiguration: assign
...
-->
``` http
POST ** Entity URI for microsoft.graph.windows81GeneralConfiguration not found/assign
```
...
<!-- {
  "blockType": "request",
  "name": "windows81generalconfiguration_assign"
}
-->
``` http
POST https://graph.microsoft.com/beta** Entity URI for microsoft.graph.windows81GeneralConfiguration not found/assign

...
-->
``` http
GET /accessPackages/{accessPackagesId}/incompatibleAccessPackages
```
...
-->
``` http
GET https://graph.microsoft.com/beta/accessPackages/{accessPackagesId}/incompatibleAccessPackages
```

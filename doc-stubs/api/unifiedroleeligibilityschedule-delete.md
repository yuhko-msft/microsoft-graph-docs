...
-->
``` http
DELETE /unifiedRoleAssignmentSchedule/activatedUsing
DELETE /rbacApplication/roleEligibilitySchedules/{unifiedRoleEligibilityScheduleId}
```
...
-->
``` http
DELETE https://graph.microsoft.com/beta/unifiedRoleAssignmentSchedule/activatedUsing
```

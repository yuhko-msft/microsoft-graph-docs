---
title: "List governanceRoleDefinition"
description: "Get the governanceRoleDefinition resources from the roleDefinition navigation property."
...
# List governanceRoleDefinition
Namespace: microsoft.graph



Get the governanceRoleDefinition resources from the roleDefinition navigation property.
...
-->
``` http
GET https://graph.microsoft.com/v1.0/governanceRoleAssignmentRequests/{governanceRoleAssignmentRequestsId}/roleDefinition
```

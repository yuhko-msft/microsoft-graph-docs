...
-->
``` http
POST /users/{usersId}/mailFolders/{mailFolderId}/messages/{messageId}/attachments
```
...
-->
``` http
POST https://graph.microsoft.com/beta/users/{usersId}/mailFolders/{mailFolderId}/messages/{messageId}/attachments

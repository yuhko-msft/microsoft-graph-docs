...
|:---|:---|:---|
|cancellationMessage|String|**TODO: Add Description**|
...
-->
``` http
POST https://graph.microsoft.com/v1.0/bookingBusinesses/{bookingBusinessesId}/appointments/{bookingAppointmentId}/cancel

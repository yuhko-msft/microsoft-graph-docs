---
title: "workbookFunctions: coupDays"
...
-->
``` http
POST /workbooks/{workbooksId}/workbook/functions/coupDays
```
...
<!-- {
  "blockType": "request",
  "name": "workbookfunctions_coupdays"
}
-->
``` http
POST https://graph.microsoft.com/beta/workbooks/{workbooksId}/workbook/functions/coupDays

...
-->
``` http
PATCH /rbacApplication/roleEligibilityRequests/{unifiedRoleEligibilityRequestId}
```
...
-->
``` http
PATCH https://graph.microsoft.com/beta/rbacApplication/roleEligibilityRequests/{unifiedRoleEligibilityRequestId}
...
{
  "@odata.type": "#microsoft.graph.unifiedRoleEligibilityRequest",
  "id": "92f7a402-a402-92f7-02a4-f79202a4f792",
  "action": "String",
  "principalId": "String",
  "roleDefinitionId": "String",
  "directoryScopeId": "String",

...
Create a new [rbacApplicationMultiple](../resources/rbacapplicationmultiple.md) object.
...
-->
``` http
POST ** Collection URI for microsoft.graph.rbacApplicationMultiple not found
```
...
-->
``` http
POST https://graph.microsoft.com/beta** Collection URI for microsoft.graph.rbacApplicationMultiple not found

...
description: "Get a list of the windowsAutopilotSettings objects and their properties."
...
Get a list of the [windowsAutopilotSettings](../resources/windowsautopilotsettings.md) objects and their properties.
...
-->
``` http
GET https://graph.microsoft.com/v1.0** Collection URI for microsoft.graph.windowsAutopilotSettings not found
```

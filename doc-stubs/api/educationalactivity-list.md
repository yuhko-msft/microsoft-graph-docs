...
description: "Get a list of the educationalActivity objects and their properties."
...
Get a list of the [educationalActivity](../resources/educationalactivity.md) objects and their properties.
...
-->
``` http
GET https://graph.microsoft.com/v1.0/me/profile/educationalActivities
```
  ...
  "value": [
    {
      ...
      "id": "5e62375d-375d-5e62-5d37-625e5d37625e",

...
<!-- {
  "blockType": "request",
  "name": "list_androiddeviceownervpnconfiguration"
}
-->
``` http
GET https://graph.microsoft.com/v1.0** Collection URI for microsoft.graph.androidDeviceOwnerVpnConfiguration not found
```

...
description: "Get a list of the onenoteResource objects and their properties."
...
Get a list of the [onenoteResource](../resources/onenoteresource.md) objects and their properties.
...
-->
``` http
GET https://graph.microsoft.com/beta/me/onenote/resources
```

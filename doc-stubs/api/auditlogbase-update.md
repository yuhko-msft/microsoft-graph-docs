---
title: "Update auditLogBase"
description: "Update the properties of an auditLogBase object."
...
Update the properties of an [auditLogBase](../resources/auditlogbase.md) object.
...
The following table shows the properties that are required when you update the [auditLogBase](../resources/auditlogbase.md).
...
If successful, this method returns a `200 OK` response code and an updated [auditLogBase](../resources/auditlogbase.md) object in the response body.
...
<!-- {
  "blockType": "request",
  "name": "update_auditlogbase"
}
-->
``` http
PATCH https://graph.microsoft.com/beta/auditLogBase

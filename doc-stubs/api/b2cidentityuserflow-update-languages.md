...
description: "Update the properties of a languages object."
...
Update the properties of a languages object.
...
-->
``` http
PATCH /identity/b2cUserFlows/{b2cIdentityUserFlowId}/languages
```
...
-->
``` http
PATCH https://graph.microsoft.com/beta/identity/b2cUserFlows/{b2cIdentityUserFlowId}/languages
...
{
  "@odata.type": "#microsoft.graph.userFlowLanguageConfiguration",
  "id": "d39dad22-ad22-d39d-22ad-9dd322ad9dd3",
  "isEnabled": "Boolean",
  "displayName": "String"
}
```

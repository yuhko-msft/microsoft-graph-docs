---
title: "Update iosTrustedRootCertificateProfile"
description: "Update the properties of an iosTrustedRootCertificateProfile object."
...
# Update iosTrustedRootCertificateProfile
Namespace: microsoft.graph

Update the properties of an [iosTrustedRootCertificateProfile](../resources/iostrustedrootcertificateprofile.md) object.
...
-->
``` http
PATCH ** Entity URI for microsoft.graph.iosTrustedRootCertificateProfile not found
```
...
The following table shows the properties that are required when you update the [iosTrustedRootCertificateProfile](../resources/iostrustedrootcertificateprofile.md).
...
If successful, this method returns a `200 OK` response code and an updated [iosTrustedRootCertificateProfile](../resources/iostrustedrootcertificateprofile.md) object in the response body.
...
<!-- {
  "blockType": "request",
  "name": "update_iostrustedrootcertificateprofile"
}
-->
``` http
PATCH https://graph.microsoft.com/beta** Entity URI for microsoft.graph.iosTrustedRootCertificateProfile not found

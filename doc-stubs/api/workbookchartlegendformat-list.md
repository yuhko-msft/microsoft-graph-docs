...
description: "Get a list of the workbookChartLegendFormat objects and their properties."
...
Get a list of the [workbookChartLegendFormat](../resources/workbookchartlegendformat.md) objects and their properties.
...
-->
``` http
GET https://graph.microsoft.com/beta** Collection URI for microsoft.graph.workbookChartLegendFormat not found
```

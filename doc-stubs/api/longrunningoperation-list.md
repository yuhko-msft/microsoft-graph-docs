...
-->
``` http
GET https://graph.microsoft.com/beta/industryData/operations
```
...
<!-- {
  "blockType": "response",
  "truncated": true,
  "@odata.type": "Collection(microsoft.industryData.longRunningOperation)"
}
-->
``` http
HTTP/1.1 200 OK

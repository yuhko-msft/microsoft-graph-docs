...
description: "Get the groupPolicyDefinition resources from the groupPolicyDefinitions navigation property."
...
Get the groupPolicyDefinition resources from the groupPolicyDefinitions navigation property.
...
-->
``` http
GET https://graph.microsoft.com/v1.0/deviceManagement/groupPolicyDefinitions
```

...
description: "Create a new dimension object."
...
Create a new [dimension](../resources/dimension.md) object.
...
-->
``` http
POST /financials/companies/{companyId}/dimensions
```
...
-->
``` http
POST https://graph.microsoft.com/v1.0/financials/companies/{companyId}/dimensions

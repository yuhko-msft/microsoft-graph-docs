...
description: "Get a list of the androidForWorkGmailEasConfiguration objects and their properties."
...
Get a list of the [androidForWorkGmailEasConfiguration](../resources/androidforworkgmaileasconfiguration.md) objects and their properties.
...
<!-- {
  "blockType": "request",
  "name": "list_androidforworkgmaileasconfiguration"
}
-->
``` http
GET https://graph.microsoft.com/v1.0** Collection URI for microsoft.graph.androidForWorkGmailEasConfiguration not found
```

---
title: "windowsHealthMonitoringConfiguration: assign"
...
# windowsHealthMonitoringConfiguration: assign
...
-->
``` http
POST ** Entity URI for microsoft.graph.windowsHealthMonitoringConfiguration not found/assign
```
...
<!-- {
  "blockType": "request",
  "name": "windowshealthmonitoringconfiguration_assign"
}
-->
``` http
POST https://graph.microsoft.com/v1.0** Entity URI for microsoft.graph.windowsHealthMonitoringConfiguration not found/assign

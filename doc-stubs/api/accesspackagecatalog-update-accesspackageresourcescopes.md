...
-->
``` http
PATCH /identityGovernance/entitlementManagement/accessPackageCatalogs/{accessPackageCatalogId}/accessPackageResourceScopes
```
...
-->
``` http
PATCH https://graph.microsoft.com/beta/identityGovernance/entitlementManagement/accessPackageCatalogs/{accessPackageCatalogId}/accessPackageResourceScopes
...
{
  "@odata.type": "#microsoft.graph.accessPackageResourceScope",
  "id": "014d5792-5792-014d-9257-4d0192574d01",
  "displayName": "String",
  "description": "String",
  "originId": "String",
  "originSystem": "String",

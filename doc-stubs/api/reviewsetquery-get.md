...
-->
``` http
GET /compliance/ediscovery/cases/{ediscoveryCaseId}/reviewSets/{reviewSetId}/queries/{reviewSetQueryId}
```
...
-->
``` http
GET https://graph.microsoft.com/beta/compliance/ediscovery/cases/{ediscoveryCaseId}/reviewSets/{reviewSetId}/queries/{reviewSetQueryId}
```

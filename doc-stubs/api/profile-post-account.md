...
You can specify the following properties when creating a **userAccountInformation**.
...
|ageGroup|String|**TODO: Add Description** Required.|
|countryCode|String|**TODO: Add Description** Required.|
|preferredLanguageTag|[Microsoft.Fast.PI.ViewGenerator.V2.Profile.Models.localeInfo](../resources/localeinfo.md)|**TODO: Add Description** Required.|
...
{
  "@odata.type": "#Microsoft.Fast.PI.ViewGenerator.V2.Profile.Models.userAccountInformation",
  "id": "c047a0a7-a0a7-c047-a7a0-47c0a7a047c0",
  "allowedAudiences": "String",
  "inference": {
    "@odata.type": "microsoft.graph.inferenceData"
  },

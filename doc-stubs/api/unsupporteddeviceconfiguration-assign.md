---
title: "unsupportedDeviceConfiguration: assign"
...
# unsupportedDeviceConfiguration: assign
...
-->
``` http
POST ** Entity URI for microsoft.graph.unsupportedDeviceConfiguration not found/assign
```
...
<!-- {
  "blockType": "request",
  "name": "unsupporteddeviceconfiguration_assign"
}
-->
``` http
POST https://graph.microsoft.com/v1.0** Entity URI for microsoft.graph.unsupportedDeviceConfiguration not found/assign

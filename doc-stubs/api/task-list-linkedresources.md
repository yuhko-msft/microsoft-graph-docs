...
-->
``` http
GET /user/tasks/lists/{wellKnownTaskListId}/tasks/{taskId}/linkedResources
```
...
-->
``` http
GET https://graph.microsoft.com/beta/user/tasks/lists/{wellKnownTaskListId}/tasks/{taskId}/linkedResources
```

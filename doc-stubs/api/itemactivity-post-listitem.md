...
-->
``` http
POST /drives/{drivesId}/activities/{itemActivityId}/listItem
```
...
-->
``` http
POST https://graph.microsoft.com/beta/drives/{drivesId}/activities/{itemActivityId}/listItem
...
{
  "@odata.type": "#microsoft.graph.listItem",
  "id": "820e8d7e-8d7e-820e-7e8d-0e827e8d0e82",
  "createdBy": {
    "@odata.type": "microsoft.graph.identitySet"
  },

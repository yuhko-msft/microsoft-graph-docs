...
-->
``` http
DELETE /unifiedRoleScheduleBase/principal
DELETE /groups/{groupsId}/createdOnBehalfOf
DELETE /directoryObjects/{directoryObjectsId}
DELETE /unifiedRoleScheduleBase/directoryScope
DELETE /stsPolicy/appliesTo/{directoryObjectId}
DELETE /unifiedRoleScheduleInstanceBase/principal
DELETE /directory/deletedItems/{directoryObjectId}
DELETE /unifiedRoleScheduleInstanceBase/directoryScope
```
...
-->
``` http
DELETE https://graph.microsoft.com/beta/unifiedRoleScheduleBase/principal
```

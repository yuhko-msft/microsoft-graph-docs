---
title: "windows10PFXImportCertificateProfile: assign"
...
# windows10PFXImportCertificateProfile: assign
...
-->
``` http
POST ** Entity URI for microsoft.graph.windows10PFXImportCertificateProfile not found/assign
```
...
<!-- {
  "blockType": "request",
  "name": "windows10pfximportcertificateprofile_assign"
}
-->
``` http
POST https://graph.microsoft.com/v1.0** Entity URI for microsoft.graph.windows10PFXImportCertificateProfile not found/assign

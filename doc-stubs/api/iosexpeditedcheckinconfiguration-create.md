---
title: "Create iosExpeditedCheckinConfiguration"
...
# Create iosExpeditedCheckinConfiguration
Namespace: microsoft.graph



Create a new [iosExpeditedCheckinConfiguration](../resources/iosexpeditedcheckinconfiguration.md) object.
...
-->
``` http
POST ** Collection URI for microsoft.graph.iosExpeditedCheckinConfiguration not found
```
...
If successful, this method returns a `201 Created` response code and an [iosExpeditedCheckinConfiguration](../resources/iosexpeditedcheckinconfiguration.md) object in the response body.
...
<!-- {
  "blockType": "request",
  "name": "create_iosexpeditedcheckinconfiguration_from_"
}
-->
``` http
POST https://graph.microsoft.com/v1.0** Collection URI for microsoft.graph.iosExpeditedCheckinConfiguration not found

---
title: "aospDeviceOwnerCompliancePolicy: assign"
...
# aospDeviceOwnerCompliancePolicy: assign
...
-->
``` http
POST ** Entity URI for microsoft.graph.aospDeviceOwnerCompliancePolicy not found/assign
```
...
<!-- {
  "blockType": "request",
  "name": "aospdeviceownercompliancepolicy_assign"
}
-->
``` http
POST https://graph.microsoft.com/beta** Entity URI for microsoft.graph.aospDeviceOwnerCompliancePolicy not found/assign

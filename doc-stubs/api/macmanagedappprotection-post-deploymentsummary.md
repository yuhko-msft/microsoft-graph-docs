...
-->
``` http
POST /deviceAppManagement/macManagedAppProtections/{macManagedAppProtectionId}/deploymentSummary
```
...
-->
``` http
POST https://graph.microsoft.com/beta/deviceAppManagement/macManagedAppProtections/{macManagedAppProtectionId}/deploymentSummary

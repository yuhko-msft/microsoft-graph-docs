...
description: "Get a list of the workbookTable objects and their properties."
...
Get a list of the [workbookTable](../resources/workbooktable.md) objects and their properties.
...
GET /workbooks/{workbooksId}/workbook/names/{workbookNamedItemId}/worksheet/tables
```

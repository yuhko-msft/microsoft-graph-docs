...
-->
``` http
PATCH ** Collection URI for microsoft.graph.securityBaselineDeviceState not found
```
...
If successful, this method returns a `200 OK` response code and an updated [securityBaselineDeviceState](../resources/intune-securitybaselinedevicestate.md) object in the response body.
...
-->
``` http
PATCH https://graph.microsoft.com/beta** Collection URI for microsoft.graph.securityBaselineDeviceState not found

---
title: "Update urlThreatSubmission"
description: "Update the properties of an urlThreatSubmission object."
...
# Update urlThreatSubmission
Namespace: microsoft.graph

[!INCLUDE [beta-disclaimer](../../includes/beta-disclaimer.md)]

Update the properties of an [urlThreatSubmission](../resources/urlthreatsubmission.md) object.
...
PATCH /submission/urlThreats/{urlThreatSubmissionId}
```
...
If successful, this method returns a `200 OK` response code and an updated [urlThreatSubmission](../resources/urlthreatsubmission.md) object in the response body.

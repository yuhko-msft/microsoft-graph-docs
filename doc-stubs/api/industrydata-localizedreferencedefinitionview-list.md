...
Get a list of the [localizedReferenceDefinitionView](../resources/industrydata-localizedreferencedefinitionview.md) objects and their properties.
...
-->
``` http
GET ** Collection URI for microsoft.graph.industryData.localizedReferenceDefinitionView not found
```
...
-->
``` http
GET https://graph.microsoft.com/beta** Collection URI for microsoft.graph.industryData.localizedReferenceDefinitionView not found
```

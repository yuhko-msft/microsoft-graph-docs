...
description: "Get the userExperienceAnalyticsBaseline resources from the userExperienceAnalyticsBaselines navigation property."
...
Get the userExperienceAnalyticsBaseline resources from the userExperienceAnalyticsBaselines navigation property.
...
<!-- {
  "blockType": "response",
  "truncated": true,
  "@odata.type": "Collection(microsoft.management.services.api.userExperienceAnalyticsBaseline)"
}
-->
``` http
HTTP/1.1 200 OK
  ...
  "value": [
    {
      ...
      "id": "21543508-3508-2154-0835-542108355421",
      "displayName": "String",

---
title: "androidOmaCpConfiguration: assign"
...
# androidOmaCpConfiguration: assign
...
-->
``` http
POST ** Entity URI for microsoft.graph.androidOmaCpConfiguration not found/assign
```
...
<!-- {
  "blockType": "request",
  "name": "androidomacpconfiguration_assign"
}
-->
``` http
POST https://graph.microsoft.com/v1.0** Entity URI for microsoft.graph.androidOmaCpConfiguration not found/assign

...
description: "Update the properties of an androidCompliancePolicy object."
...
Update the properties of an [androidCompliancePolicy](../resources/androidcompliancepolicy.md) object.
...
-->
``` http
PATCH ** Entity URI for microsoft.graph.androidCompliancePolicy not found
```
...
The following table shows the properties that are required when you update the [androidCompliancePolicy](../resources/androidcompliancepolicy.md).
...
<!-- {
  "blockType": "request",
  "name": "update_androidcompliancepolicy"
}
-->
``` http
PATCH https://graph.microsoft.com/v1.0** Entity URI for microsoft.graph.androidCompliancePolicy not found

...
description: "Get a list of the defaultDeviceCompliancePolicy objects and their properties."
...
Get a list of the [defaultDeviceCompliancePolicy](../resources/defaultdevicecompliancepolicy.md) objects and their properties.
...
<!-- {
  "blockType": "request",
  "name": "list_defaultdevicecompliancepolicy"
}
-->
``` http
GET https://graph.microsoft.com/beta** Collection URI for microsoft.graph.defaultDeviceCompliancePolicy not found
```
  ...
  "value": [
    {
      ...
      "id": "29c570b0-70b0-29c5-b070-c529b070c529",

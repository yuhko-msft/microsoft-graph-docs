...
-->
``` http
POST /compliance/recordsManagement/events/{retentionEventId}/labels/$ref
```
...
If successful, this method returns a `204 No Content` response code and a [retentionLabel](../resources/recordsmanagement-retentionlabel.md) object in the response body.
...
-->
``` http
POST https://graph.microsoft.com/beta/compliance/recordsManagement/events/{retentionEventId}/labels/$ref

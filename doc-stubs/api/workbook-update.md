...
-->
``` http
PATCH /drive/following/{driveItemId}/workbook
PATCH /drives/{drivesId}/following/{driveItemId}/workbook
```
...
-->
``` http
PATCH https://graph.microsoft.com/v1.0/drive/following/{driveItemId}/workbook

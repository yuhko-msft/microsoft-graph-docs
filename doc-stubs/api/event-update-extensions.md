...
-->
``` http
PATCH /users/{usersId}/messages/{messageId}/event/extensions
```
...
-->
``` http
PATCH https://graph.microsoft.com/beta/users/{usersId}/messages/{messageId}/event/extensions
...
{
  "@odata.type": "#microsoft.graph.extension",
  "id": "a7383831-3831-a738-3138-38a7313838a7"
}
```

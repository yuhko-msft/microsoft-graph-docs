---
title: "List children"
description: "Get the driveItem resources from the children navigation property."
...
Get the driveItem resources from the children navigation property.
...
-->
``` http
GET https://graph.microsoft.com/beta/workbooks/{workbooksId}/children
```

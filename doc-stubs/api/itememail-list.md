...
description: "Get a list of the itemEmail objects and their properties."
...
Get a list of the [itemEmail](../resources/itememail.md) objects and their properties.
...
-->
``` http
GET https://graph.microsoft.com/v1.0/me/profile/emails
```

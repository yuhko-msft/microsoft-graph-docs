...
If successful, this method returns a `201 Created` response code and an [iosPkcsCertificateProfile](../resources/iospkcscertificateprofile.md) object in the response body.
...
-->
``` http
POST https://graph.microsoft.com/beta** Collection URI for microsoft.graph.iosPkcsCertificateProfile not found

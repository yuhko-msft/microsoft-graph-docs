...
-->
``` http
POST ** Collection URI for microsoft.compliance.ediscovery.contract.caseIndexOperation not found/$ref
```
...
-->
``` http
POST https://graph.microsoft.com/beta** Collection URI for microsoft.compliance.ediscovery.contract.caseIndexOperation not found/$ref
...
Content-Type: application/json
{
  ...
  "status": "String",
  "action": "String",
  "id": "82976da6-6da6-8297-a66d-9782a66d9782",
  "displayName": "String"
}
```

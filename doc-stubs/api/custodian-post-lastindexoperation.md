...
-->
``` http
POST /compliance/ediscovery/cases/{ediscoveryCaseId}/custodians/{custodianId}/lastIndexOperation/$ref
```
...
-->
``` http
POST https://graph.microsoft.com/beta/compliance/ediscovery/cases/{ediscoveryCaseId}/custodians/{custodianId}/lastIndexOperation/$ref
...

{
  ...
  "status": "String",
  "action": "String",
  "id": "3d548efc-8efc-3d54-fc8e-543dfc8e543d",
  "displayName": "String"
}
```

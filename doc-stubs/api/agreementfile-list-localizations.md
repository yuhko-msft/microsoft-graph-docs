...
description: "Get the agreementFileLocalization resources from the localizations navigation property."
...
Get the agreementFileLocalization resources from the localizations navigation property.
...
-->
``` http
GET https://graph.microsoft.com/beta/agreements/{agreementsId}/file/localizations
```

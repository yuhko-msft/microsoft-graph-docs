...
Update the properties of a [windowsDomainJoinConfiguration](../resources/windowsdomainjoinconfiguration.md) object.
...
|computerNameStaticPrefix|String|**TODO: Add Description**|
|computerNameSuffixRandomCharCount|Int32|**TODO: Add Description**|
|activeDirectoryDomainName|String|**TODO: Add Description**|
...
If successful, this method returns a `200 OK` response code and an updated [windowsDomainJoinConfiguration](../resources/windowsdomainjoinconfiguration.md) object in the response body.
...
<!-- {
  "blockType": "request",
  "name": "update_windowsdomainjoinconfiguration"
}
-->
``` http

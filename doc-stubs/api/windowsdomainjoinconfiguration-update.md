...
The following table shows the properties that are required when you update the [windowsDomainJoinConfiguration](../resources/windowsdomainjoinconfiguration.md).
...

{
  ...
  "id": "c29c453a-453a-c29c-3a45-9cc23a459cc2",

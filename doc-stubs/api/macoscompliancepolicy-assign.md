---
title: "macOSCompliancePolicy: assign"
...
-->
``` http
POST ** Entity URI for microsoft.graph.macOSCompliancePolicy not found/assign
```
...
<!-- {
  "blockType": "request",
  "name": "macoscompliancepolicy_assign"
}
-->
``` http
POST https://graph.microsoft.com/beta** Entity URI for microsoft.graph.macOSCompliancePolicy not found/assign

...
``` http
GET /unifiedRoleAssignmentScheduleInstance
GET /rbacApplication/roleAssignmentScheduleInstances/{unifiedRoleAssignmentScheduleInstanceId}
```
...
-->
``` http
GET https://graph.microsoft.com/beta/unifiedRoleAssignmentScheduleInstance
```

---
title: "Update windowsCertificateProfileBase"
description: "Update the properties of a windowsCertificateProfileBase object."
...
# Update windowsCertificateProfileBase
Namespace: microsoft.graph



Update the properties of a [windowsCertificateProfileBase](../resources/windowscertificateprofilebase.md) object.
...
The following table shows the properties that are required when you update the [windowsCertificateProfileBase](../resources/windowscertificateprofilebase.md).
...
If successful, this method returns a `200 OK` response code and an updated [windowsCertificateProfileBase](../resources/windowscertificateprofilebase.md) object in the response body.
...
<!-- {
  "blockType": "request",
  "name": "update_windowscertificateprofilebase"
}
-->
``` http

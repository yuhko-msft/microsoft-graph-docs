...
Read the properties and relationships of a [userFlaggingResource](../resources/linkedin-userflaggingresource.md) object.
...
If successful, this method returns a `200 OK` response code and a [userFlaggingResource](../resources/linkedin-userflaggingresource.md) object in the response body.

...
Read the properties and relationships of a [groupPolicyPresentationValueLongDecimal](../resources/intune-grouppolicypresentationvaluelongdecimal.md) object.
...
If successful, this method returns a `200 OK` response code and a [groupPolicyPresentationValueLongDecimal](../resources/intune-grouppolicypresentationvaluelongdecimal.md) object in the response body.

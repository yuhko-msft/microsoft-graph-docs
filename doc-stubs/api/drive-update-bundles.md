...
description: "Update the properties of a bundles object."
...
Update the properties of a bundles object.
...
-->
``` http
PATCH https://graph.microsoft.com/beta/drive/bundles

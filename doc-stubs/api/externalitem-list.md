...
Get a list of the [externalItem](../resources/externalitem.md) objects and their properties.
...
-->
``` http
GET https://graph.microsoft.com/v1.0/connections/{connectionsId}/items
```

---
title: "List itemPatents"
description: "Get a list of the itemPatent objects and their properties."
...
Get a list of the [itemPatent](../resources/itempatent.md) objects and their properties.
...
-->
``` http
GET https://graph.microsoft.com/v1.0/me/profile/patents
```

...
-->
``` http
POST /me/authentication/methods/{authenticationMethodId}/resetPassword
POST /users/{usersId}/authentication/methods/{authenticationMethodId}/resetPassword
```
...
-->
``` http
POST https://graph.microsoft.com/v1.0/me/authentication/methods/{authenticationMethodId}/resetPassword

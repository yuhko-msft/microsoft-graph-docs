...
-->
``` http
PATCH /identity/b2xUserFlows/{b2xIdentityUserFlowId}/userAttributeAssignments
```
...
-->
``` http
PATCH https://graph.microsoft.com/beta/identity/b2xUserFlows/{b2xIdentityUserFlowId}/userAttributeAssignments

---
title: "Update defaultPages"
description: "Update the properties of a defaultPages object."
...
Update the properties of a defaultPages object.
...
-->
``` http
PATCH /identity/b2cUserFlows/{b2cIdentityUserFlowId}/languages/{userFlowLanguageConfigurationId}/defaultPages
```
...
<!-- {
  "blockType": "request",
  "name": "update_defaultpages"
}
-->
``` http
PATCH https://graph.microsoft.com/beta/identity/b2cUserFlows/{b2cIdentityUserFlowId}/languages/{userFlowLanguageConfigurationId}/defaultPages

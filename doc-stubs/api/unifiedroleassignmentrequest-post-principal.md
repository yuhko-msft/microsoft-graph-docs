...
-->
``` http
POST /rbacApplication/roleAssignmentRequests/{unifiedRoleAssignmentRequestId}/principal/$ref
```
...
-->
``` http
POST https://graph.microsoft.com/beta/rbacApplication/roleAssignmentRequests/{unifiedRoleAssignmentRequestId}/principal/$ref

...
-->
``` http
POST https://graph.microsoft.com/beta/deviceManagement/managementConditions/{managementConditionId}/managementConditionStatements/$ref
...
{
  "@odata.type": "#microsoft.graph.managementConditionStatement",
  "id": "53bc795a-795a-53bc-5a79-bc535a79bc53",
  "applicablePlatforms": [
    "String"
  ],

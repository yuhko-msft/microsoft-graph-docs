---
title: "extensionProperty: checkMemberObjects"
...
# extensionProperty: checkMemberObjects
...
-->
``` http
POST https://graph.microsoft.com/beta/applications/{applicationsId}/extensionProperties/{extensionPropertyId}/checkMemberObjects

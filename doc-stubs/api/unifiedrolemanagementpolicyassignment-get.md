...
-->
``` http
GET /policyRoot/roleManagementPolicyAssignments/{unifiedRoleManagementPolicyAssignmentId}
```
...
-->
``` http
GET https://graph.microsoft.com/beta/policyRoot/roleManagementPolicyAssignments/{unifiedRoleManagementPolicyAssignmentId}
```
...

{
  "value": {
    "@odata.type": "#Microsoft.Identity.Governance.Common.Data.ExternalModels.V1.unifiedRoleManagementPolicyAssignment",
    "id": "bdeae123-e123-bdea-23e1-eabd23e1eabd",
    "policyId": "String",
    "scopeId": "String",
    "scopeType": "String",

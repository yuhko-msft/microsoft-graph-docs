...
description: "Get the salesInvoiceLine resources from the salesInvoiceLines navigation property."
...
Get the salesInvoiceLine resources from the salesInvoiceLines navigation property.
...
-->
``` http
GET https://graph.microsoft.com/v1.0/financials/companies/{companyId}/salesInvoices/{salesInvoiceId}/salesInvoiceLines
```

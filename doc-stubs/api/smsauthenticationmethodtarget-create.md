...
Create a new [smsAuthenticationMethodTarget](../resources/smsauthenticationmethodtarget.md) object.
...
-->
``` http
POST https://graph.microsoft.com/v1.0/smsAuthenticationMethodConfiguration/includeTargets

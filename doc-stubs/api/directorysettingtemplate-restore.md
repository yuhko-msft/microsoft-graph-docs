---
title: "directorySettingTemplate: restore"
...
# directorySettingTemplate: restore
...
-->
``` http
POST https://graph.microsoft.com/beta/directorySettingTemplates/{directorySettingTemplatesId}/restore
```

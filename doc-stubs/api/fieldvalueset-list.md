...
description: "Get a list of the fieldValueSet objects and their properties."
...
Get a list of the [fieldValueSet](../resources/fieldvalueset.md) objects and their properties.
...
-->
``` http
GET https://graph.microsoft.com/beta** Collection URI for microsoft.graph.fieldValueSet not found
```

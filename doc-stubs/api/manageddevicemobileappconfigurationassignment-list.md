...
description: "Get a list of the managedDeviceMobileAppConfigurationAssignment objects and their properties."
...
Get a list of the [managedDeviceMobileAppConfigurationAssignment](../resources/manageddevicemobileappconfigurationassignment.md) objects and their properties.
...
<!-- {
  "blockType": "response",
  "truncated": true,
  "@odata.type": "Collection(microsoft.management.services.api.managedDeviceMobileAppConfigurationAssignment)"
}
-->
``` http
HTTP/1.1 200 OK

---
title: "List messageEvents"
description: "Get a list of the messageEvent objects and their properties."
...
Get a list of the [messageEvent](../resources/messageevent.md) objects and their properties.
...
-->
``` http
GET https://graph.microsoft.com/beta/messageEvents
```

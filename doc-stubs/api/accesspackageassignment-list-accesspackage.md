...
-->
``` http
GET /entitlementManagement/assignments/{accessPackageAssignmentId}/accessPackage
```
...
-->
``` http
GET https://graph.microsoft.com/v1.0/entitlementManagement/assignments/{accessPackageAssignmentId}/accessPackage
```

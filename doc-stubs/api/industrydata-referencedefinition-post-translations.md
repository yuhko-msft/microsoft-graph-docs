...
Create a new [referenceTranslation](../resources/industrydata-referencetranslation.md) object.
...
## Request body
In the request body, supply a JSON representation of the [referenceTranslation](../resources/industrydata-referencetranslation.md) object.
...
If successful, this method returns a `201 Created` response code and a [referenceTranslation](../resources/industrydata-referencetranslation.md) object in the response body.

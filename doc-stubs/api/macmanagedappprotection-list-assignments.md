...
-->
``` http
GET /deviceAppManagement/macManagedAppProtections/{macManagedAppProtectionId}/assignments
```
...
-->
``` http
GET https://graph.microsoft.com/beta/deviceAppManagement/macManagedAppProtections/{macManagedAppProtectionId}/assignments
```

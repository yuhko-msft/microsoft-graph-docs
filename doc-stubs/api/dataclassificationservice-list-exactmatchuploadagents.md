...
description: "Get the exactMatchUploadAgent resources from the exactMatchUploadAgents navigation property."
...
Get the exactMatchUploadAgent resources from the exactMatchUploadAgents navigation property.
...
-->
``` http
GET https://graph.microsoft.com/v1.0/dataClassification/exactMatchUploadAgents
```

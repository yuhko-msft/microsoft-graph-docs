...
description: "Get a list of the operation objects and their properties."
...
Get a list of the [operation](../resources/operation.md) objects and their properties.
...
-->
``` http
GET https://graph.microsoft.com/beta** Collection URI for microsoft.graph.operation not found
```

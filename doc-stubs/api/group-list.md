...
-->
``` http
GET https://graph.microsoft.com/v1.0** Collection URI for Microsoft.IGAELM.PDS.FrontEnd.ExternalModel.group not found
```
  ...
  "value": [
    {
      ...
      "id": "ec298bcc-8bcc-ec29-cc8b-29eccc8b29ec"
    }
  ]
}
```

...
-->
``` http
GET ** Collection URI for Microsoft.IGAELM.PDS.FrontEnd.ExternalModel.group not found
```
...
-->
``` http
GET https://graph.microsoft.com/beta** Collection URI for Microsoft.IGAELM.PDS.FrontEnd.ExternalModel.group not found
```
  ...
  "value": [
    {
      ...
      "id": "f57e3896-3896-f57e-9638-7ef596387ef5"
    }
  ]
}
```

...
-->
``` http
PATCH /user/{userId}/profile/websites/{personWebsiteId}
```
...
-->
``` http
PATCH https://graph.microsoft.com/beta/user/{userId}/profile/websites/{personWebsiteId}
...
{
  "@odata.type": "#microsoft.graph.personWebsite",
  "id": "5d3dc8ba-c8ba-5d3d-bac8-3d5dbac83d5d",
  "allowedAudiences": "String",
  "inference": {
    "@odata.type": "microsoft.graph.inferenceData"
  },

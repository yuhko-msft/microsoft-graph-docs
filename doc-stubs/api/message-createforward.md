...
POST /users/{usersId}/mailFolders/{mailFolderId}/messages/{messageId}/createForward
```
...
-->
``` http
POST https://graph.microsoft.com/beta/users/{usersId}/messages/{messageId}/createForward

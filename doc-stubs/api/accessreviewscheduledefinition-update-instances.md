...
-->
``` http
PATCH /user/pendingAccessReviewInstances/{accessReviewInstanceId}/definition/instances
```
...
-->
``` http
PATCH https://graph.microsoft.com/beta/user/pendingAccessReviewInstances/{accessReviewInstanceId}/definition/instances
...
{
  "@odata.type": "#microsoft.graph.accessReviewInstance",
  "id": "07aebb79-bb79-07ae-79bb-ae0779bbae07",
  "startDateTime": "String (timestamp)",
  "endDateTime": "String (timestamp)",
  "status": "String",
  "scope": {

---
title: "Get updateStateSummaries"
...
# Get updateStateSummaries
Namespace: microsoft.graph

Read the properties and relationships of a [macOSSoftwareUpdateStateSummary](../resources/intune-macossoftwareupdatestatesummary.md) object.
...
If successful, this method returns a `200 OK` response code and a [macOSSoftwareUpdateStateSummary](../resources/intune-macossoftwareupdatestatesummary.md) object in the response body.
...
Content-Type: application/json
{
  "value": {
    "@odata.type": "#microsoft.graph.macOSSoftwareUpdateStateSummary",
    "id": "ecce4510-4510-ecce-1045-ceec1045ceec",
    "displayName": "String",
    "productKey": "String",

...
description: "Deletes a deviceAndAppManagementRoleAssignment object."
...
Deletes a [deviceAndAppManagementRoleAssignment](../resources/deviceandappmanagementroleassignment.md) object.
...
<!-- {
  "blockType": "request",
  "name": "delete_deviceandappmanagementroleassignment"
}
-->
``` http

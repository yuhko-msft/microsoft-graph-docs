---
title: "windows10CustomConfiguration: assign"
...
# windows10CustomConfiguration: assign
...
-->
``` http
POST ** Entity URI for microsoft.graph.windows10CustomConfiguration not found/assign
```
...
<!-- {
  "blockType": "request",
  "name": "windows10customconfiguration_assign"
}
-->
``` http
POST https://graph.microsoft.com/beta** Entity URI for microsoft.graph.windows10CustomConfiguration not found/assign

...
Create a new [deviceManagementDerivedCredentialSettings](../resources/devicemanagementderivedcredentialsettings.md) object.
...
-->
``` http
POST https://graph.microsoft.com/v1.0/deviceManagement/derivedCredentials

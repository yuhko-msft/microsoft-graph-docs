---
title: "windowsDeliveryOptimizationConfiguration: assign"
...
# windowsDeliveryOptimizationConfiguration: assign
...
-->
``` http
POST ** Entity URI for microsoft.graph.windowsDeliveryOptimizationConfiguration not found/assign
```
...
<!-- {
  "blockType": "request",
  "name": "windowsdeliveryoptimizationconfiguration_assign"
}
-->
``` http
POST https://graph.microsoft.com/v1.0** Entity URI for microsoft.graph.windowsDeliveryOptimizationConfiguration not found/assign

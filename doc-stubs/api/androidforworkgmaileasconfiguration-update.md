...
The following table shows the properties that are required when you update the [androidForWorkGmailEasConfiguration](../resources/androidforworkgmaileasconfiguration.md).
...
-->
``` http
PATCH https://graph.microsoft.com/v1.0** Entity URI for microsoft.graph.androidForWorkGmailEasConfiguration not found
...
{
  "@odata.type": "#microsoft.graph.androidForWorkGmailEasConfiguration",
  "id": "d0712dba-2dba-d071-ba2d-71d0ba2d71d0",

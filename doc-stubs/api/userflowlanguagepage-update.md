...
-->
``` http
PATCH /identity/b2cUserFlows/{b2cIdentityUserFlowId}/languages/{userFlowLanguageConfigurationId}/defaultPages/{userFlowLanguagePageId}
PATCH /identity/b2cUserFlows/{b2cIdentityUserFlowId}/languages/{userFlowLanguageConfigurationId}/overridesPages/{userFlowLanguagePageId}
```
...
-->
``` http
PATCH https://graph.microsoft.com/beta/identity/b2cUserFlows/{b2cIdentityUserFlowId}/languages/{userFlowLanguageConfigurationId}/defaultPages/{userFlowLanguagePageId}
...
{
  "@odata.type": "#microsoft.graph.userFlowLanguagePage",
  "id": "0c091b89-1b89-0c09-891b-090c891b090c"
}
```

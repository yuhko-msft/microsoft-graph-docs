...
description: "Deletes a deviceManagementExportJob object."
...
Deletes a [deviceManagementExportJob](../resources/intune-devicemanagementexportjob.md) object.
...
<!-- {
  "blockType": "request",
  "name": "delete_devicemanagementexportjob"
}
-->
``` http

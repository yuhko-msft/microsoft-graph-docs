...
description: "Deletes a deviceConfigurationAssignment object."
...
Deletes a [deviceConfigurationAssignment](../resources/deviceconfigurationassignment.md) object.
...
<!-- {
  "blockType": "request",
  "name": "delete_deviceconfigurationassignment"
}
-->
``` http

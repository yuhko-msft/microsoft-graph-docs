...
-->
``` http
POST /workbooks/{workbooksId}/workbook/functions/nper
```
...
<!-- {
  "blockType": "request",
  "name": "workbookfunctions_nper"
}
-->
``` http
POST https://graph.microsoft.com/beta/workbooks/{workbooksId}/workbook/functions/nper

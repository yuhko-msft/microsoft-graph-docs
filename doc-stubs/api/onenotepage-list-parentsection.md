---
title: "List onenoteSection"
description: "Get the onenoteSection resources from the parentSection navigation property."
...
Get the onenoteSection resources from the parentSection navigation property.
...
-->
``` http
GET https://graph.microsoft.com/beta/users/{usersId}/onenote/notebooks/{notebookId}/sectionGroups/{sectionGroupId}/sections/{onenoteSectionId}/pages/{onenotePageId}/parentSection
```

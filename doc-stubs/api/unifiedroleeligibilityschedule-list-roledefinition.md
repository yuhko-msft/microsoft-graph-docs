...
-->
``` http
GET /unifiedRoleAssignmentSchedule/activatedUsing/roleDefinition
```
...
-->
``` http
GET https://graph.microsoft.com/beta/unifiedRoleAssignmentSchedule/activatedUsing/roleDefinition
```

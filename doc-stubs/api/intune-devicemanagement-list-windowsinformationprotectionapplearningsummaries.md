...
description: "Get the windowsInformationProtectionAppLearningSummary resources from the windowsInformationProtectionAppLearningSummaries navigation property."
...
Get the windowsInformationProtectionAppLearningSummary resources from the windowsInformationProtectionAppLearningSummaries navigation property.
...
<!-- {
  "blockType": "request",
  "name": "list_windowsinformationprotectionapplearningsummary"
}
-->
``` http
...
<!-- {
  "blockType": "response",
  "truncated": true,
  "@odata.type": "Collection(microsoft.management.services.api.windowsInformationProtectionAppLearningSummary)"
}
-->
``` http
HTTP/1.1 200 OK

...
-->
``` http
GET ** Collection URI for Microsoft.DirectoryServices.unifiedRoleDefinition not found
```
...
-->
``` http
GET https://graph.microsoft.com/beta** Collection URI for Microsoft.DirectoryServices.unifiedRoleDefinition not found
```

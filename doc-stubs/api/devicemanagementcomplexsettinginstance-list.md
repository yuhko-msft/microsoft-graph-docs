...
-->
``` http
GET https://graph.microsoft.com/beta** Collection URI for microsoft.graph.deviceManagementComplexSettingInstance not found
```
  ...
  "value": [
    {
      ...
      "id": "829c2b7e-2b7e-829c-7e2b-9c827e2b9c82",
      "definitionId": "String",
      "valueJson": "String"
    }
  ]

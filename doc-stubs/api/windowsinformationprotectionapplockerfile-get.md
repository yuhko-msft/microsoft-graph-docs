...
-->
``` http
GET /windowsInformationProtection/exemptAppLockerFiles/{windowsInformationProtectionAppLockerFileId}
GET /windowsInformationProtection/protectedAppLockerFiles/{windowsInformationProtectionAppLockerFileId}
```
...
-->
``` http
GET https://graph.microsoft.com/beta/windowsInformationProtection/exemptAppLockerFiles/{windowsInformationProtectionAppLockerFileId}
```

...
-->
``` http
POST /policyRoot/featureRolloutPolicies/{featureRolloutPolicyId}/appliesTo
```
...
-->
``` http
POST https://graph.microsoft.com/v1.0/policyRoot/featureRolloutPolicies/{featureRolloutPolicyId}/appliesTo
...
{
  "@odata.type": "#microsoft.graph.directoryObject",
  "id": "813114b8-14b8-8131-b814-3181b8143181"
}
```

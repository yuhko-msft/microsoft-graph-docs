...
Update the properties of an [itemPublication](../resources/itempublication.md) object.
...
-->
``` http
PATCH /me/profile/publications/{itemPublicationId}
PATCH /users/{usersId}/profile/publications/{itemPublicationId}
```
...
The following table shows the properties that are required when you update the [itemPublication](../resources/itempublication.md).
...
-->
``` http
PATCH https://graph.microsoft.com/v1.0/me/profile/publications/{itemPublicationId}
...
{
  "@odata.type": "#microsoft.graph.itemPublication",
  "id": "97048bec-8bec-9704-ec8b-0497ec8b0497",
  "allowedAudiences": "String",
  "createdBy": {
    "@odata.type": "microsoft.graph.identitySet"
  },

...
-->
``` http
POST /workbooks/{workbooksId}/activities/{itemActivityOLDId}/driveItem
```
...
-->
``` http
POST https://graph.microsoft.com/beta/workbooks/{workbooksId}/activities/{itemActivityOLDId}/driveItem

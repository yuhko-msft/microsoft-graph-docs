...
-->
``` http
PATCH /identityGovernance/entitlementManagement/accessPackageAssignmentPolicies
```
...
-->
``` http
PATCH https://graph.microsoft.com/beta/identityGovernance/entitlementManagement/accessPackageAssignmentPolicies
...
{
  "@odata.type": "#microsoft.graph.accessPackageAssignmentPolicy",
  "id": "d2624654-4654-d262-5446-62d2544662d2",
  "accessPackageId": "String",
  "displayName": "String",
  "description": "String",
  "canExtend": "Boolean",

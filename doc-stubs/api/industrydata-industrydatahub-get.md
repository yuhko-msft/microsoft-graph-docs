...
Read the properties and relationships of an [industryDataHub](../resources/industrydata-industrydatahub.md) object.
...
If successful, this method returns a `200 OK` response code and an [industryDataHub](../resources/industrydata-industrydatahub.md) object in the response body.

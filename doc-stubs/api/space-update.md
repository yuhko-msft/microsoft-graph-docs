---
title: "Update space"
description: "Update the properties of a space object."
...
Update the properties of a [space](../resources/space.md) object.
...
The following table shows the properties that are required when you update the [space](../resources/space.md).
...
If successful, this method returns a `200 OK` response code and an updated [space](../resources/space.md) object in the response body.
...
-->
``` http
PATCH https://graph.microsoft.com/beta/roomList/spaces/{spaceId}

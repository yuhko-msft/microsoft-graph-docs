...
-->
``` http
GET /roleManagement/cloudPC/roleAssignments/{unifiedRoleAssignmentMultipleId}
```
...
-->
``` http
GET https://graph.microsoft.com/v1.0/roleManagement/cloudPC/roleAssignments/{unifiedRoleAssignmentMultipleId}
```

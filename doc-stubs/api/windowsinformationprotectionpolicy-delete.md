...
description: "Deletes a windowsInformationProtectionPolicy object."
...
Deletes a [windowsInformationProtectionPolicy](../resources/windowsinformationprotectionpolicy.md) object.
...
<!-- {
  "blockType": "request",
  "name": "delete_windowsinformationprotectionpolicy"
}
-->
``` http

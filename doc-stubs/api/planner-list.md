---
title: "List planners"
description: "Get a list of the planner objects and their properties."
...
Get a list of the [planner](../resources/planner.md) objects and their properties.
...
-->
``` http
GET https://graph.microsoft.com/beta** Collection URI for microsoft.graph.planner not found
```

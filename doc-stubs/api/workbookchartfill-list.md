...
description: "Get a list of the workbookChartFill objects and their properties."
...
Get a list of the [workbookChartFill](../resources/workbookchartfill.md) objects and their properties.
...
-->
``` http
GET https://graph.microsoft.com/beta** Collection URI for microsoft.graph.workbookChartFill not found
```

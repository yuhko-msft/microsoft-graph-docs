...
Read the properties and relationships of a [microsoftTunnelSite](../resources/intune-microsofttunnelsite.md) object.
...
If successful, this method returns a `200 OK` response code and a [microsoftTunnelSite](../resources/intune-microsofttunnelsite.md) object in the response body.

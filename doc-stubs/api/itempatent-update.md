...
-->
``` http
PATCH /me/profile/patents/{itemPatentId}
PATCH /users/{usersId}/profile/patents/{itemPatentId}
```
...
The following table shows the properties that are required when you update the [itemPatent](../resources/itempatent.md).
...
-->
``` http
PATCH https://graph.microsoft.com/beta/me/profile/patents/{itemPatentId}
...
{
  "@odata.type": "#microsoft.graph.itemPatent",
  "id": "8832515d-515d-8832-5d51-32885d513288",
  "allowedAudiences": "String",
  "createdBy": {
    "@odata.type": "microsoft.graph.identitySet"
  },

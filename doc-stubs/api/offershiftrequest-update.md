...
-->
``` http
PATCH /teams/{teamsId}/schedule/offerShiftRequests/{offerShiftRequestId}
```
...
-->
``` http
PATCH https://graph.microsoft.com/beta/teams/{teamsId}/schedule/offerShiftRequests/{offerShiftRequestId}

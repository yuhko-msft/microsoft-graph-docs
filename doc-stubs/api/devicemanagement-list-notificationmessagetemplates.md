...
description: "Get the notificationMessageTemplate resources from the notificationMessageTemplates navigation property."
...
Get the notificationMessageTemplate resources from the notificationMessageTemplates navigation property.
...
<!-- {
  "blockType": "request",
  "name": "list_notificationmessagetemplate"
}
-->
``` http
  ...
  "value": [
    {
      ...
      "id": "7a2f2df0-2df0-7a2f-f02d-2f7af02d2f7a",

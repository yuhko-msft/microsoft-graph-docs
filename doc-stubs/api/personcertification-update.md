...
-->
``` http
PATCH /me/profile/certifications/{personCertificationId}
PATCH /users/{usersId}/profile/certifications/{personCertificationId}
```
...
-->
``` http
PATCH https://graph.microsoft.com/beta/me/profile/certifications/{personCertificationId}

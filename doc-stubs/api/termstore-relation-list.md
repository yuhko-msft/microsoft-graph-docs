...
Get a list of the [relation](../resources/termstore-relation.md) objects and their properties.
...
-->
``` http
GET /sites/{sitesId}/termStore/groups/{groupId}/sets/{setId}/relations
...
-->
``` http
GET https://graph.microsoft.com/beta/sites/{sitesId}/termStore/groups/{groupId}/sets/{setId}/relations
```

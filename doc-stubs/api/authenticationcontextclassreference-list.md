...
description: "Get a list of the authenticationContextClassReference objects and their properties."
...
Get a list of the [authenticationContextClassReference](../resources/authenticationcontextclassreference.md) objects and their properties.
...
-->
``` http
GET https://graph.microsoft.com/beta/conditionalAccess/authenticationContextClassReferences
```

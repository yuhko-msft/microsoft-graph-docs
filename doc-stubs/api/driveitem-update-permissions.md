...
-->
``` http
PATCH /drives/{drivesId}/activities/{itemActivityOLDId}/driveItem/permissions
```
...
-->
``` http
PATCH https://graph.microsoft.com/beta/drives/{drivesId}/activities/{itemActivityOLDId}/driveItem/permissions

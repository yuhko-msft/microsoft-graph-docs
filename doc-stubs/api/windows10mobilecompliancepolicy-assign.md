---
title: "windows10MobileCompliancePolicy: assign"
...
# windows10MobileCompliancePolicy: assign
...
-->
``` http
POST https://graph.microsoft.com/beta** Entity URI for microsoft.graph.windows10MobileCompliancePolicy not found/assign

...
Get a list of the [directoryMatchingProcessRun](../resources/directorymatchingprocessrun.md) objects and their properties.
...
-->
``` http
GET ** Collection URI for microsoft.industryData.directoryMatchingProcessRun not found
```
...
-->
``` http
GET https://graph.microsoft.com/beta** Collection URI for microsoft.industryData.directoryMatchingProcessRun not found
```
...
<!-- {
  "blockType": "response",
  "truncated": true,
  "@odata.type": "Collection(microsoft.industryData.directoryMatchingProcessRun)"
}
-->
``` http
HTTP/1.1 200 OK

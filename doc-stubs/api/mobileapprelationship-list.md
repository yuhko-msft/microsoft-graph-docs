...
description: "Get a list of the mobileAppRelationship objects and their properties."
...
Get a list of the [mobileAppRelationship](../resources/mobileapprelationship.md) objects and their properties.
...
-->
``` http
GET https://graph.microsoft.com/v1.0/deviceAppManagement/mobileApps/{mobileAppId}/relationships
```

...
description: "Get a list of the workbookChartTitle objects and their properties."
...
Get a list of the [workbookChartTitle](../resources/workbookcharttitle.md) objects and their properties.
...
-->
``` http
GET https://graph.microsoft.com/beta** Collection URI for microsoft.graph.workbookChartTitle not found
```

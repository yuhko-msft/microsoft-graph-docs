...
description: "Get the workbookOperation resources from the operations navigation property."
...
Get the workbookOperation resources from the operations navigation property.
...
-->
``` http
GET https://graph.microsoft.com/beta/workbooks/{workbooksId}/workbook/operations
```
  ...
  "value": [
    {
      ...
      "id": "bd98636d-636d-bd98-6d63-98bd6d6398bd",
      "error": {

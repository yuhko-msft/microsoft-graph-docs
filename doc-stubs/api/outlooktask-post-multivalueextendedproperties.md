...
-->
``` http
POST /users/{usersId}/outlook/taskFolders/{outlookTaskFolderId}/tasks/{outlookTaskId}/multiValueExtendedProperties
```
...
-->
``` http
POST https://graph.microsoft.com/beta/users/{usersId}/outlook/taskFolders/{outlookTaskFolderId}/tasks/{outlookTaskId}/multiValueExtendedProperties
...
{
  "@odata.type": "#microsoft.graph.multiValueLegacyExtendedProperty",
  "id": "3259ae84-ae84-3259-84ae-593284ae5932",
  "value": [
    "String"
  ]
}

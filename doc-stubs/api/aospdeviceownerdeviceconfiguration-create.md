...
-->
``` http
POST ** Collection URI for microsoft.management.services.api.aospDeviceOwnerDeviceConfiguration not found
```
...
The following table shows the properties that are required when you create the [aospDeviceOwnerDeviceConfiguration](../resources/aospdeviceownerdeviceconfiguration.md).
...
<!-- {
  "blockType": "request",
  "name": "create_aospdeviceownerdeviceconfiguration_from_"
}
-->
``` http
POST https://graph.microsoft.com/beta** Collection URI for microsoft.management.services.api.aospDeviceOwnerDeviceConfiguration not found

...
|saveAsBlocked|Boolean|Indicates whether users may use th   to save a copy of protected files.|
...
-->
``` http
PATCH https://graph.microsoft.com/beta/managedAppProtection
...
{
  "@odata.type": "#microsoft.graph.managedAppProtection",
  "id": "de26663e-663e-de26-3e66-26de3e6626de",

...
POST /users/{usersId}/informationProtection/policy/labels/evaluateRemoval
```
...
-->
``` http
POST https://graph.microsoft.com/v1.0/me/informationProtection/policy/labels/evaluateRemoval

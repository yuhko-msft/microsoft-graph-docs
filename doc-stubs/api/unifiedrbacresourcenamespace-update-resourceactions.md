...
description: "Update the properties of a resourceActions object."
...
Update the properties of a resourceActions object.
...
-->
``` http
PATCH /roleManagement/directory/resourceNamespaces/{unifiedRbacResourceNamespaceId}/resourceActions
```
...
-->
``` http
PATCH https://graph.microsoft.com/beta/roleManagement/directory/resourceNamespaces/{unifiedRbacResourceNamespaceId}/resourceActions

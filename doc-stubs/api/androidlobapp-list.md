...
-->
``` http
GET ** Collection URI for microsoft.graph.androidLobApp not found
```
...
<!-- {
  "blockType": "request",
  "name": "list_androidlobapp"
}
-->
``` http
GET https://graph.microsoft.com/beta** Collection URI for microsoft.graph.androidLobApp not found
```
...
<!-- {
  "blockType": "response",
  "truncated": true,
  "@odata.type": "Collection(microsoft.graph.androidLobApp)"
}
-->
``` http
HTTP/1.1 200 OK

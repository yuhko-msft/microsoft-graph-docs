...
description: "Get the paymentTerm resources from the paymentTerms navigation property."
...
Get the paymentTerm resources from the paymentTerms navigation property.
...
-->
``` http
GET https://graph.microsoft.com/v1.0/financials/companies/{companyId}/paymentTerms
```

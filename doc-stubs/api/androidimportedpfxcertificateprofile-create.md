---
title: "Create androidImportedPFXCertificateProfile"
description: "Create a new androidImportedPFXCertificateProfile object."
...
Create a new [androidImportedPFXCertificateProfile](../resources/androidimportedpfxcertificateprofile.md) object.
...
-->
``` http
POST ** Collection URI for microsoft.graph.androidImportedPFXCertificateProfile not found
```
...
## Request body
In the request body, supply a JSON representation of the [androidImportedPFXCertificateProfile](../resources/androidimportedpfxcertificateprofile.md) object.
...
If successful, this method returns a `201 Created` response code and an [androidImportedPFXCertificateProfile](../resources/androidimportedpfxcertificateprofile.md) object in the response body.
...
<!-- {
  "blockType": "request",
  "name": "create_androidimportedpfxcertificateprofile_from_"
}
-->
``` http
POST https://graph.microsoft.com/v1.0** Collection URI for microsoft.graph.androidImportedPFXCertificateProfile not found
...
{
  "@odata.type": "#microsoft.graph.androidImportedPFXCertificateProfile",
  "id": "d2c4cf60-cf60-d2c4-60cf-c4d260cfc4d2",

...
-->
``` http
POST https://graph.microsoft.com/beta** Collection URI for microsoft.graph.androidImportedPFXCertificateProfile not found
...
{
  "@odata.type": "#microsoft.graph.androidImportedPFXCertificateProfile",
  "id": "8d8852eb-52eb-8d88-eb52-888deb52888d",

---
title: "Update userSecurityProfiles"
description: "Update the properties of a userSecurityProfiles object."
...
# Update userSecurityProfiles
Namespace: microsoft.graph

Update the properties of a userSecurityProfiles object.
...
-->
``` http
PATCH /Security/userSecurityProfiles
```
...
<!-- {
  "blockType": "request",
  "name": "update_usersecurityprofiles"
}
-->
``` http
PATCH https://graph.microsoft.com/beta/Security/userSecurityProfiles

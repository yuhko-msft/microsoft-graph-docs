...
description: "Get a list of the deviceManagementIntentUserStateSummary objects and their properties."
...
Get a list of the [deviceManagementIntentUserStateSummary](../resources/devicemanagementintentuserstatesummary.md) objects and their properties.
...
<!-- {
  "blockType": "request",
  "name": "list_devicemanagementintentuserstatesummary"
}
-->
``` http
GET https://graph.microsoft.com/beta** Collection URI for microsoft.graph.deviceManagementIntentUserStateSummary not found
```
  ...
  "value": [
    {
      ...
      "id": "4a78186c-186c-4a78-6c18-784a6c18784a",

...
Update the properties of a [windowsAutopilotDeploymentProfilePolicySetItem](../resources/intune-windowsautopilotdeploymentprofilepolicysetitem.md) object.
...
If successful, this method returns a `200 OK` response code and an updated [windowsAutopilotDeploymentProfilePolicySetItem](../resources/intune-windowsautopilotdeploymentprofilepolicysetitem.md) object in the response body.
...
-->
``` http
PATCH https://graph.microsoft.com/beta/windowsAutopilotDeploymentProfilePolicySetItem

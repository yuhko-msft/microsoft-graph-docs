---
title: "Add windowsCertificateProfileBase"
...
# Add windowsCertificateProfileBase
...
-->
``` http
POST ** Collection URI for microsoft.graph.windowsCertificateProfileBase not found/$ref
```
...
## Request body
In the request body, supply a JSON representation of the [windowsCertificateProfileBase](../resources/windowscertificateprofilebase.md) object.

The following table shows the properties that are required when you create the [windowsCertificateProfileBase](../resources/windowscertificateprofilebase.md).
...
If successful, this method returns a `204 No Content` response code and a [windowsCertificateProfileBase](../resources/windowscertificateprofilebase.md) object in the response body.
...
<!-- {
  "blockType": "request",
  "name": "create_windowscertificateprofilebase_from_"
}
-->
``` http
POST https://graph.microsoft.com/v1.0** Collection URI for microsoft.graph.windowsCertificateProfileBase not found/$ref
...
{
  "@odata.type": "#microsoft.graph.windowsCertificateProfileBase",
  "id": "24c44109-4109-24c4-0941-c4240941c424",

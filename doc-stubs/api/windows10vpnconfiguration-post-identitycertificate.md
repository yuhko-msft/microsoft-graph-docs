...
-->
``` http
POST https://graph.microsoft.com/beta** Collection URI for microsoft.graph.windowsCertificateProfileBase not found/$ref
...
{
  "@odata.type": "#microsoft.graph.windowsCertificateProfileBase",
  "id": "2b69255f-255f-2b69-5f25-692b5f25692b",

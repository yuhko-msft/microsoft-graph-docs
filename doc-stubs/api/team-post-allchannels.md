---
title: "Add channel"
description: "Add allChannels by posting to the allChannels collection."
...
Add allChannels by posting to the allChannels collection.
...
-->
``` http
POST /teams/{teamsId}/allChannels/$ref
```
...
-->
``` http
POST https://graph.microsoft.com/beta/teams/{teamsId}/allChannels/$ref

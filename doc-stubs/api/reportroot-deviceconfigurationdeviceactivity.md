---
title: "reportRoot: deviceConfigurationDeviceActivity"
...
# reportRoot: deviceConfigurationDeviceActivity
...
GET /print/reports/deviceConfigurationDeviceActivity
```
...
<!-- {
  "blockType": "request",
  "name": "reportroot_deviceconfigurationdeviceactivity"
}
-->
``` http

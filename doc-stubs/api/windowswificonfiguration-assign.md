---
title: "windowsWifiConfiguration: assign"
...
# windowsWifiConfiguration: assign
...
-->
``` http
POST ** Entity URI for microsoft.graph.windowsWifiConfiguration not found/assign
```
...
<!-- {
  "blockType": "request",
  "name": "windowswificonfiguration_assign"
}
-->
``` http
POST https://graph.microsoft.com/v1.0** Entity URI for microsoft.graph.windowsWifiConfiguration not found/assign

...
# windows10SecureAssessmentConfiguration: assign
...
-->
``` http
POST https://graph.microsoft.com/beta** Entity URI for microsoft.graph.windows10SecureAssessmentConfiguration not found/assign

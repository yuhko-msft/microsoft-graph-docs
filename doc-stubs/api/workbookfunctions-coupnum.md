---
title: "workbookFunctions: coupNum"
...
-->
``` http
POST /workbooks/{workbooksId}/workbook/functions/coupNum
```
...
<!-- {
  "blockType": "request",
  "name": "workbookfunctions_coupnum"
}
-->
``` http
POST https://graph.microsoft.com/beta/workbooks/{workbooksId}/workbook/functions/coupNum

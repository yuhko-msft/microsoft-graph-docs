...
-->
``` http
GET /compliance/ediscovery/cases/{ediscoveryCaseId}/reviewSets/{reviewSetId}
```
...
-->
``` http
GET https://graph.microsoft.com/beta/compliance/ediscovery/cases/{ediscoveryCaseId}/reviewSets/{reviewSetId}
```
...

{
  "value": {
    ...
    "id": "edc06ad9-6ad9-edc0-d96a-c0edd96ac0ed",
    "displayName": "String",

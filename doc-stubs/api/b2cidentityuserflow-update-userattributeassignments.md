---
title: "Update userAttributeAssignments"
...
Update the properties of a userAttributeAssignments object.
...
-->
``` http
PATCH /identity/b2cUserFlows/{b2cIdentityUserFlowId}/userAttributeAssignments
```
...
-->
``` http
PATCH https://graph.microsoft.com/beta/identity/b2cUserFlows/{b2cIdentityUserFlowId}/userAttributeAssignments
...
{
  "@odata.type": "#microsoft.graph.identityUserFlowAttributeAssignment",
  "id": "972a8cb0-8cb0-972a-b08c-2a97b08c2a97",
  "isOptional": "Boolean",
  "requiresVerification": "Boolean",
  "userInputType": "String",
  "userAttributeValues": [

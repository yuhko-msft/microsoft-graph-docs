...
Get a list of the [apiDataConnector](../resources/industrydata-apidataconnector.md) objects and their properties.
...
-->
``` http
GET ** Collection URI for microsoft.graph.industryData.apiDataConnector not found
```
...
-->
``` http
GET https://graph.microsoft.com/beta** Collection URI for microsoft.graph.industryData.apiDataConnector not found
```
...
<!-- {
  "blockType": "response",
  "truncated": true,
  "@odata.type": "Collection(microsoft.graph.industryData.apiDataConnector)"
}
-->
``` http
HTTP/1.1 200 OK

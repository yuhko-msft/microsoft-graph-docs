...
-->
``` http
GET /users/{usersId}/outlook/taskFolders/{outlookTaskFolderId}/multiValueExtendedProperties
```
...
-->
``` http
GET https://graph.microsoft.com/beta/users/{usersId}/outlook/taskFolders/{outlookTaskFolderId}/multiValueExtendedProperties
```

---
title: "application: getMemberObjects"
...
-->
``` http
POST /applications/{applicationsId}/getMemberObjects
```
...
-->
``` http
POST https://graph.microsoft.com/beta/applications/{applicationsId}/getMemberObjects

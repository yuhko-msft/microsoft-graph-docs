...
-->
``` http
GET /drives/{drivesId}/activities/{itemActivityId}/driveItem/activities
```
...
-->
``` http
GET https://graph.microsoft.com/beta/drives/{drivesId}/activities/{itemActivityId}/driveItem/activities
```

...
The following table shows the properties that are required when you update the [deviceManagementAbstractComplexSettingDefinition](../resources/devicemanagementabstractcomplexsettingdefinition.md).
...
-->
``` http
PATCH https://graph.microsoft.com/v1.0/deviceManagementAbstractComplexSettingDefinition

...
-->
``` http
POST /policyRoot/tokenIssuancePolicies/$ref
...
-->
``` http
POST https://graph.microsoft.com/beta/policyRoot/tokenIssuancePolicies/$ref
...
{
  "@odata.type": "#Microsoft.DirectoryServices.tokenIssuancePolicy",
  "id": "a1601876-1876-a160-7618-60a1761860a1",
  "deletedDateTime": "String (timestamp)",
  "description": "String",
  "displayName": "String",
  "definition": [

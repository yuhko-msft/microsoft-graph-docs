...
-->
``` http
POST ** Collection URI for Microsoft.IdentityProtectionServices.identitySecurityDefaultsEnforcementPolicy not found
```
...
You can specify the following properties when creating an **identitySecurityDefaultsEnforcementPolicy**.
...
-->
``` http
POST https://graph.microsoft.com/beta** Collection URI for Microsoft.IdentityProtectionServices.identitySecurityDefaultsEnforcementPolicy not found

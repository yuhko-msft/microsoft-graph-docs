...
-->
``` http
GET /policyRoot/permissionGrantPolicies/{permissionGrantPolicyId}/includes/{permissionGrantConditionSetId}
GET /policyRoot/permissionGrantPolicies/{permissionGrantPolicyId}/excludes/{permissionGrantConditionSetId}
```
...
-->
``` http
GET https://graph.microsoft.com/v1.0/policyRoot/permissionGrantPolicies/{permissionGrantPolicyId}/includes/{permissionGrantConditionSetId}
```

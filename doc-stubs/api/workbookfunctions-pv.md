...
-->
``` http
POST /workbooks/{workbooksId}/workbook/functions/pv
```
...
-->
``` http
POST https://graph.microsoft.com/beta/workbooks/{workbooksId}/workbook/functions/pv

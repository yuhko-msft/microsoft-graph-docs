---
title: "deviceManagementReports: getConfigurationSettingDetailsReport"
...
# deviceManagementReports: getConfigurationSettingDetailsReport
...
<!-- {
  "blockType": "request",
  "name": "devicemanagementreports_getconfigurationsettingdetailsreport"
}
-->
``` http
POST https://graph.microsoft.com/v1.0/deviceManagement/reports/getConfigurationSettingDetailsReport

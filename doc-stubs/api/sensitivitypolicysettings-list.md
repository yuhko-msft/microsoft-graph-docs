...
description: "Get a list of the sensitivityPolicySettings objects and their properties."
...
Get a list of the [sensitivityPolicySettings](../resources/sensitivitypolicysettings.md) objects and their properties.
...
-->
``` http
GET https://graph.microsoft.com/beta** Collection URI for microsoft.graph.sensitivityPolicySettings not found
```
  ...
  "value": [
    {
      ...
      "id": "65926e7d-6e7d-6592-7d6e-92657d6e9265",
      "applicableTo": "String",

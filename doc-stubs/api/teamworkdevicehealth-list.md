---
title: "List teamworkDeviceHealths"
description: "Get a list of the teamworkDeviceHealth objects and their properties."
...
# List teamworkDeviceHealths
Namespace: microsoft.graph

[!INCLUDE [beta-disclaimer](../../includes/beta-disclaimer.md)]

Get a list of the [teamworkDeviceHealth](../resources/teamworkdevicehealth.md) objects and their properties.
...
-->
``` http
GET ** Collection URI for Microsoft.Teams.GraphSvc.teamworkDeviceHealth not found
```
...
-->
``` http
GET https://graph.microsoft.com/beta** Collection URI for Microsoft.Teams.GraphSvc.teamworkDeviceHealth not found
```

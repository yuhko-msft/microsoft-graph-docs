...
description: "Get a list of the onPremisesAgent objects and their properties."
...
Get a list of the [onPremisesAgent](../resources/onpremisesagent.md) objects and their properties.
...
-->
``` http
GET https://graph.microsoft.com/v1.0/onPremisesPublishingProfiles/{onPremisesPublishingProfilesId}/agents
```

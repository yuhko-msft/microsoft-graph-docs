---
title: "Add childPolicyBase"
description: "Add childPolicies by posting to the childPolicies collection."
...
Add childPolicies by posting to the childPolicies collection.
...
-->
``` http
POST /parentPolicyBase/childPolicies/$ref
```
...
If successful, this method returns a `204 No Content` response code and a [childPolicyBase](../resources/childpolicybase.md) object in the response body.
...
-->
``` http
POST https://graph.microsoft.com/beta/parentPolicyBase/childPolicies/$ref

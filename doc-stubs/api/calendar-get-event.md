...
-->
``` http
GET /users/{usersId}/messages/{messageId}/event/calendar/calendarView
```
...
-->
``` http
GET https://graph.microsoft.com/beta/users/{usersId}/messages/{messageId}/event/calendar/calendarView
```

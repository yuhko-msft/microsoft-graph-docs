...
-->
``` http
GET /me/pendingAccessReviewInstances/filterByCurrentUser
GET /users/{usersId}/pendingAccessReviewInstances/filterByCurrentUser
```
...
-->
``` http
GET https://graph.microsoft.com/beta/me/pendingAccessReviewInstances/filterByCurrentUser(on='parameterValue')
```

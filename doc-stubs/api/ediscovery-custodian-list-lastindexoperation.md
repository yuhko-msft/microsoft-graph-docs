...
-->
``` http
GET /compliance/ediscovery/cases/{caseId}/custodians/{custodianId}/lastIndexOperation
```
...
-->
``` http
GET https://graph.microsoft.com/beta/compliance/ediscovery/cases/{caseId}/custodians/{custodianId}/lastIndexOperation
```

...
description: "Get the currency resources from the currencies navigation property."
...
Get the currency resources from the currencies navigation property.
...
-->
``` http
GET https://graph.microsoft.com/v1.0/financials/companies/{companyId}/currencies
```

...
-->
``` http
PATCH /me/authentication/fido2Methods/{fido2AuthenticationMethodId}
PATCH /users/{usersId}/authentication/fido2Methods/{fido2AuthenticationMethodId}
```
...
-->
``` http
PATCH https://graph.microsoft.com/v1.0/me/authentication/fido2Methods/{fido2AuthenticationMethodId}

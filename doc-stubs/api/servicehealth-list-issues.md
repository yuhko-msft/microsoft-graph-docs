...
-->
``` http
GET /admin/serviceAnnouncement/healthOverviews/{serviceHealthId}/issues
```
...
-->
``` http
GET https://graph.microsoft.com/beta/admin/serviceAnnouncement/healthOverviews/{serviceHealthId}/issues
```

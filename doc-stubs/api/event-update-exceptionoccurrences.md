---
title: "Update exceptionOccurrences"
description: "Update the properties of an exceptionOccurrences object."
...
# Update exceptionOccurrences
Namespace: microsoft.graph

Update the properties of an exceptionOccurrences object.
...
-->
``` http
PATCH /users/{usersId}/messages/{messageId}/event/exceptionOccurrences
```
...
<!-- {
  "blockType": "request",
  "name": "update_exceptionoccurrences"
}
-->
``` http
PATCH https://graph.microsoft.com/beta/users/{usersId}/messages/{messageId}/event/exceptionOccurrences

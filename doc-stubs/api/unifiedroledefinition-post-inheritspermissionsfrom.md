...
-->
``` http
POST /rbacApplication/roleDefinitions/{unifiedRoleDefinitionId}/inheritsPermissionsFrom
```
...
-->
``` http
POST https://graph.microsoft.com/beta/rbacApplication/roleDefinitions/{unifiedRoleDefinitionId}/inheritsPermissionsFrom

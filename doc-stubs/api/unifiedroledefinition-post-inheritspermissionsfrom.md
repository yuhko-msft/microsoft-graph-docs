...
-->
``` http
POST /rbacApplication/roleAssignments/{unifiedRoleAssignmentId}/roleDefinition/inheritsPermissionsFrom
```
...
-->
``` http
POST https://graph.microsoft.com/v1.0/rbacApplication/roleAssignments/{unifiedRoleAssignmentId}/roleDefinition/inheritsPermissionsFrom

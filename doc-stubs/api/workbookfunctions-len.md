...
-->
``` http
POST /workbooks/{workbooksId}/workbook/functions/len
```
...
-->
``` http
POST https://graph.microsoft.com/beta/workbooks/{workbooksId}/workbook/functions/len

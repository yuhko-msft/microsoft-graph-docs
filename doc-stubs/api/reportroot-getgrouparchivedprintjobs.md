...
-->
``` http
GET https://graph.microsoft.com/beta/reports/getGroupArchivedPrintJobs(groupId='parameterValue',startDateTime=String (timestamp),endDateTime=String (timestamp))
```

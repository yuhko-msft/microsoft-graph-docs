...
The following table shows the properties that are required when you update the [managedAndroidLobApp](../resources/managedandroidlobapp.md).
...
-->
``` http
PATCH https://graph.microsoft.com/beta** Entity URI for microsoft.graph.managedAndroidLobApp not found

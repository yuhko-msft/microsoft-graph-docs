...
description: "Deletes a defaultManagedAppProtection object."
...
Deletes a [defaultManagedAppProtection](../resources/intune-defaultmanagedappprotection.md) object.
...
<!-- {
  "blockType": "request",
  "name": "delete_defaultmanagedappprotection"
}
-->
``` http

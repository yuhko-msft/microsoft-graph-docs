...
description: "Get the dataSharingConsent resources from the dataSharingConsents navigation property."
...
Get the dataSharingConsent resources from the dataSharingConsents navigation property.
...
<!-- {
  "blockType": "request",
  "name": "list_datasharingconsent"
}
-->
``` http
GET https://graph.microsoft.com/v1.0/deviceManagement/dataSharingConsents
```

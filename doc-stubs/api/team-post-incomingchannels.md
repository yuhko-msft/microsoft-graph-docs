---
title: "Add channel"
description: "Add incomingChannels by posting to the incomingChannels collection."
...
Add incomingChannels by posting to the incomingChannels collection.
...
-->
``` http
POST /teams/{teamsId}/incomingChannels/$ref
```
...
If successful, this method returns a `204 No Content` response code and a [channel](../resources/channel.md) object in the response body.
...
-->
``` http
POST https://graph.microsoft.com/beta/teams/{teamsId}/incomingChannels/$ref

...
description: "Get a list of the governanceSubject objects and their properties."
...
Get a list of the [governanceSubject](../resources/governancesubject.md) objects and their properties.
...
-->
``` http
GET https://graph.microsoft.com/v1.0/governanceSubjects
```

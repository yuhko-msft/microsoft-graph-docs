...
|dataDomain|incomingDomain|**TODO: Add Description** Inherited from [incomingFlow](../resources/incomingflow.md). The possible values are: `educationRostering`, `unknownFutureValue`. Required.|
|recurrenceEffectiveDateTime|DateTimeOffset|**TODO: Add Description** Inherited from [incomingFlow](../resources/incomingflow.md). Required.|
|recurrenceExpirationDateTime|DateTimeOffset|**TODO: Add Description** Inherited from [incomingFlow](../resources/incomingflow.md). Optional.|

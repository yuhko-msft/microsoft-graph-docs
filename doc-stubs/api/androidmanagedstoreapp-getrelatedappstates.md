...
-->
``` http
GET https://graph.microsoft.com/v1.0** Entity URI for microsoft.graph.androidManagedStoreApp not found/getRelatedAppStates(userPrincipalName='parameterValue',deviceId='parameterValue')
```

---
title: "windows10TeamGeneralConfiguration: assign"
...
# windows10TeamGeneralConfiguration: assign
...
-->
``` http
POST ** Entity URI for microsoft.graph.windows10TeamGeneralConfiguration not found/assign
```
...
<!-- {
  "blockType": "request",
  "name": "windows10teamgeneralconfiguration_assign"
}
-->
``` http
POST https://graph.microsoft.com/beta** Entity URI for microsoft.graph.windows10TeamGeneralConfiguration not found/assign

...
Read the properties and relationships of a [deviceEnrollmentConfiguration](../resources/deviceenrollmentconfiguration.md) object.
...
-->
``` http
GET https://graph.microsoft.com/v1.0/me/deviceEnrollmentConfigurations/{deviceEnrollmentConfigurationId}
```

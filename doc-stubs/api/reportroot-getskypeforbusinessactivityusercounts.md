...
GET /print/reports/getSkypeForBusinessActivityUserCounts
```
...
-->
``` http
GET https://graph.microsoft.com/v1.0/reports/getSkypeForBusinessActivityUserCounts(period='parameterValue')
```

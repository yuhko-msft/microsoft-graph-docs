...
-->
``` http
POST /process/runs/{runId}/process/$ref
```
...
If successful, this method returns a `204 No Content` response code and a [process](../resources/industrydata-process.md) object in the response body.
...
-->
``` http
POST https://graph.microsoft.com/beta/process/runs/{runId}/process/$ref

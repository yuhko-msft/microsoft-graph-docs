...
-->
``` http
POST /user/tasks/lists/{wellKnownTaskListId}/tasks/{taskId}/linkedResources
```
...
-->
``` http
POST https://graph.microsoft.com/beta/user/tasks/lists/{wellKnownTaskListId}/tasks/{taskId}/linkedResources

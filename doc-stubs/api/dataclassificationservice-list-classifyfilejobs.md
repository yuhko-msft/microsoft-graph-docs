...
description: "Get the jobResponseBase resources from the classifyFileJobs navigation property."
...
Get the jobResponseBase resources from the classifyFileJobs navigation property.
...
-->
``` http
GET https://graph.microsoft.com/v1.0/dataClassification/classifyFileJobs
```

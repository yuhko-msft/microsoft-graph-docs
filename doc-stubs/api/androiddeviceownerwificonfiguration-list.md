...
description: "Get a list of the androidDeviceOwnerWiFiConfiguration objects and their properties."
...
Get a list of the [androidDeviceOwnerWiFiConfiguration](../resources/androiddeviceownerwificonfiguration.md) objects and their properties.
...
<!-- {
  "blockType": "request",
  "name": "list_androiddeviceownerwificonfiguration"
}
-->
``` http
GET https://graph.microsoft.com/beta** Collection URI for microsoft.graph.androidDeviceOwnerWiFiConfiguration not found
```

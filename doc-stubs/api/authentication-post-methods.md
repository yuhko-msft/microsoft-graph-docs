...
-->
``` http
POST /users/{usersId}/authentication/methods
```
...
-->
``` http
POST https://graph.microsoft.com/beta/users/{usersId}/authentication/methods
...
{
  "@odata.type": "#microsoft.graph.authenticationMethod",
  "id": "d1ea815b-815b-d1ea-5b81-ead15b81ead1"
}
```

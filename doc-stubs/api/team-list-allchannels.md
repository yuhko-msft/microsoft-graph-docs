...
description: "Get the channel resources from the allChannels navigation property."
...
Get the channel resources from the allChannels navigation property.
...
-->
``` http
GET https://graph.microsoft.com/beta/teams/{teamsId}/allChannels
```

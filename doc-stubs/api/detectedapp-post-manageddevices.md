...
-->
``` http
POST /users/{usersId}/managedDevices/{managedDeviceId}/detectedApps/{detectedAppId}/managedDevices/$ref
```
...
-->
``` http
POST https://graph.microsoft.com/beta/users/{usersId}/managedDevices/{managedDeviceId}/detectedApps/{detectedAppId}/managedDevices/$ref

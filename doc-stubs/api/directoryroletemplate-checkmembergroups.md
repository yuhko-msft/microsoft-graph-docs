---
title: "directoryRoleTemplate: checkMemberGroups"
...
-->
``` http
POST /directoryRoleTemplates/{directoryRoleTemplatesId}/checkMemberGroups
```
...
-->
``` http
POST https://graph.microsoft.com/beta/directoryRoleTemplates/{directoryRoleTemplatesId}/checkMemberGroups

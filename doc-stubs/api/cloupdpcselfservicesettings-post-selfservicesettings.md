---
title: "Create cloupdPcSelfServiceSettings"
description: "Create a new cloupdPcSelfServiceSettings object."
...
# Create cloupdPcSelfServiceSettings
Namespace: microsoft.graph

Create a new [cloupdPcSelfServiceSettings](../resources/cloupdpcselfservicesettings.md) object.
...
If successful, this method returns a `201 Created` response code and a [cloupdPcSelfServiceSettings](../resources/cloupdpcselfservicesettings.md) object in the response body.
...
<!-- {
  "blockType": "request",
  "name": "create_cloupdpcselfservicesettings_from_selfservicesettings"
}
-->
``` http
POST https://graph.microsoft.com/beta/selfServiceSettings

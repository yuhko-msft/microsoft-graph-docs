---
title: "windows10XTrustedRootCertificate: assign"
...
# windows10XTrustedRootCertificate: assign
...
-->
``` http
POST ** Entity URI for microsoft.graph.windows10XTrustedRootCertificate not found/assign
```
...
<!-- {
  "blockType": "request",
  "name": "windows10xtrustedrootcertificate_assign"
}
-->
``` http
POST https://graph.microsoft.com/v1.0** Entity URI for microsoft.graph.windows10XTrustedRootCertificate not found/assign

...
-->
``` http
POST /governanceRoleAssignments/{governanceRoleAssignmentsId}/roleDefinition
```
...
-->
``` http
POST https://graph.microsoft.com/v1.0/governanceRoleAssignments/{governanceRoleAssignmentsId}/roleDefinition

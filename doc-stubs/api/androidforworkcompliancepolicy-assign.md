---
title: "androidForWorkCompliancePolicy: assign"
...
# androidForWorkCompliancePolicy: assign
...
-->
``` http
POST ** Entity URI for microsoft.graph.androidForWorkCompliancePolicy not found/assign
```
...
<!-- {
  "blockType": "request",
  "name": "androidforworkcompliancepolicy_assign"
}
-->
``` http
POST https://graph.microsoft.com/v1.0** Entity URI for microsoft.graph.androidForWorkCompliancePolicy not found/assign

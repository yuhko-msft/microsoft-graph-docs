...
description: "Get the permissionGrantPolicies from the permissionGrantPolicies navigation property."
...
Get the permissionGrantPolicies from the permissionGrantPolicies navigation property.
...
<!-- {
  "blockType": "response",
  "truncated": true,
  "@odata.type": "Collection(microsoft.graph.permissionGrantPolicy)"
}
-->
``` http
HTTP/1.1 200 OK
  ...
  "value": [
    {
      ...
      "id": "b14bd578-d578-b14b-78d5-4bb178d54bb1",

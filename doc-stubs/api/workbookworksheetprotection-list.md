...
description: "Get a list of the workbookWorksheetProtection objects and their properties."
...
Get a list of the [workbookWorksheetProtection](../resources/workbookworksheetprotection.md) objects and their properties.
...
<!-- {
  "blockType": "request",
  "name": "list_workbookworksheetprotection"
}
-->
``` http
GET https://graph.microsoft.com/beta** Collection URI for microsoft.graph.workbookWorksheetProtection not found
```

...
description: "Get a list of the mobileAppAssignment objects and their properties."
...
Get a list of the [mobileAppAssignment](../resources/mobileappassignment.md) objects and their properties.
...
<!-- {
  "blockType": "response",
  "truncated": true,
  "@odata.type": "Collection(microsoft.management.services.api.mobileAppAssignment)"
}
-->
``` http
HTTP/1.1 200 OK

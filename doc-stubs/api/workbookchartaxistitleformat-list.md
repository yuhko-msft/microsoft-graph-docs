...
description: "Get a list of the workbookChartAxisTitleFormat objects and their properties."
...
Get a list of the [workbookChartAxisTitleFormat](../resources/workbookchartaxistitleformat.md) objects and their properties.
...
-->
``` http
GET https://graph.microsoft.com/beta** Collection URI for microsoft.graph.workbookChartAxisTitleFormat not found
```

...
description: "Get a list of the androidOmaCpConfiguration objects and their properties."
...
Get a list of the [androidOmaCpConfiguration](../resources/androidomacpconfiguration.md) objects and their properties.
...
<!-- {
  "blockType": "request",
  "name": "list_androidomacpconfiguration"
}
-->
``` http
GET https://graph.microsoft.com/v1.0** Collection URI for microsoft.graph.androidOmaCpConfiguration not found
```

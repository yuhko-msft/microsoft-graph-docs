---
title: "workbookFunctions: besselK"
...
-->
``` http
POST /workbooks/{workbooksId}/workbook/functions/besselK
```
...
<!-- {
  "blockType": "request",
  "name": "workbookfunctions_besselk"
}
-->
``` http
POST https://graph.microsoft.com/beta/workbooks/{workbooksId}/workbook/functions/besselK

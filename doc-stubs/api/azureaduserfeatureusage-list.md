...
-->
``` http
GET ** Collection URI for Microsoft.AAD.Reporting.azureADUserFeatureUsage not found
```
...
-->
``` http
GET https://graph.microsoft.com/beta** Collection URI for Microsoft.AAD.Reporting.azureADUserFeatureUsage not found
```
  ...
  "value": [
    {
      ...
      "id": "37f14eec-4eec-37f1-ec4e-f137ec4ef137",

...
-->
``` http
GET /entitlementManagement/assignmentRequests/{accessPackageAssignmentRequestId}
```
...
-->
``` http
GET https://graph.microsoft.com/v1.0/entitlementManagement/assignmentRequests/{accessPackageAssignmentRequestId}
```

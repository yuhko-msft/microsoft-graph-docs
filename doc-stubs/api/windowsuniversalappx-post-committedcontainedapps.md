---
title: "Add committedContainedApps"
...
If successful, this method returns a `204 No Content` response code and a [mobileContainedApp](../resources/intune-mobilecontainedapp.md) object in the response body.
...
-->
``` http
POST https://graph.microsoft.com/beta/deviceAppManagement/mobileApps/{mobileAppId}/contentVersions/{mobileAppContentId}/containedApps/$ref

...
description: "Get a list of the plannerDelta objects and their properties."
...
Get a list of the [plannerDelta](../resources/plannerdelta.md) objects and their properties.
...
-->
``` http
GET https://graph.microsoft.com/v1.0/me/planner/all
```

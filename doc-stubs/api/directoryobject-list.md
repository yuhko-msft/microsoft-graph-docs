...
-->
``` http
GET ** Collection URI for Microsoft.Teams.GraphSvc.directoryObject not found
```
...
-->
``` http
GET https://graph.microsoft.com/beta** Collection URI for Microsoft.Teams.GraphSvc.directoryObject not found
```
...
<!-- {
  "blockType": "response",
  "truncated": true,
  "@odata.type": "Collection(Microsoft.Teams.GraphSvc.directoryObject)"
}
-->
``` http
HTTP/1.1 200 OK
  ...
  "value": [
    {
      ...
      "id": "bf3e43b0-43b0-bf3e-b043-3ebfb0433ebf"
    }
  ]
}
```

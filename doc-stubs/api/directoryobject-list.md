...
<!-- {
  "blockType": "response",
  "truncated": true,
  "@odata.type": "Collection(microsoft.education.rostering.api.directoryObject)"
}
-->
``` http
HTTP/1.1 200 OK
...

{
  "value": [
    {
      "@odata.type": "#microsoft.education.rostering.api.directoryObject",
      "id": "3f553576-3576-3f55-7635-553f7635553f"
    }
  ]
}
```

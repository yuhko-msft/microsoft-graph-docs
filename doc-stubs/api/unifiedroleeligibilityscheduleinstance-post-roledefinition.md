...
-->
``` http
POST /unifiedRoleAssignmentScheduleInstance/activatedUsing/roleDefinition/$ref
```
...
-->
``` http
POST https://graph.microsoft.com/beta/unifiedRoleAssignmentScheduleInstance/activatedUsing/roleDefinition/$ref

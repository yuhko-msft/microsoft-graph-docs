...
-->
``` http
PATCH /drives/{drivesId}/activities/{itemActivityOLDId}/driveItem/activities
```
...
-->
``` http
PATCH https://graph.microsoft.com/beta/drives/{drivesId}/activities/{itemActivityOLDId}/driveItem/activities

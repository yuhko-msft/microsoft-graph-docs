---
title: "List owners"
description: "Get the user resources from the owners navigation property."
...
Get the user resources from the owners navigation property.
...
-->
``` http
GET https://graph.microsoft.com/v1.0/teams/{teamsId}/owners
```

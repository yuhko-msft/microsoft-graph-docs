...
Create a new [deviceManagementCollectionSettingInstance](../resources/intune-devicemanagementcollectionsettinginstance.md) object.
...
If successful, this method returns a `201 Created` response code and a [deviceManagementCollectionSettingInstance](../resources/intune-devicemanagementcollectionsettinginstance.md) object in the response body.

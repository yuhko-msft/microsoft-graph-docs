...
-->
``` http
GET ** Collection URI for microsoft.graph.emailAuthenticationMethodConfiguration not found
```
...
-->
``` http
GET https://graph.microsoft.com/beta** Collection URI for microsoft.graph.emailAuthenticationMethodConfiguration not found
```
...
<!-- {
  "blockType": "response",
  "truncated": true,
  "@odata.type": "Collection(microsoft.graph.emailAuthenticationMethodConfiguration)"
}
-->
``` http
HTTP/1.1 200 OK
  ...
  "value": [
    {
      ...
      "id": "41c1fd97-fd97-41c1-97fd-c14197fdc141",
      "state": "String",

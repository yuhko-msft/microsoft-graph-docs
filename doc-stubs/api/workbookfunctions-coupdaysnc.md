---
title: "workbookFunctions: coupDaysNc"
...
-->
``` http
POST /workbooks/{workbooksId}/workbook/functions/coupDaysNc
```
...
<!-- {
  "blockType": "request",
  "name": "workbookfunctions_coupdaysnc"
}
-->
``` http
POST https://graph.microsoft.com/beta/workbooks/{workbooksId}/workbook/functions/coupDaysNc

...
Read the properties and relationships of a [windowsProtectionState](../resources/intune-windowsprotectionstate.md) object.
...
If successful, this method returns a `200 OK` response code and a [windowsProtectionState](../resources/intune-windowsprotectionstate.md) object in the response body.

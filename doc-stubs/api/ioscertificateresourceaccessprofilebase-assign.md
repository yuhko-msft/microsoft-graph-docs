---
title: "iosCertificateResourceAccessProfileBase: assign"
...
# iosCertificateResourceAccessProfileBase: assign
...
-->
``` http
POST ** Entity URI for microsoft.graph.iosCertificateResourceAccessProfileBase not found/assign
```
...
<!-- {
  "blockType": "request",
  "name": "ioscertificateresourceaccessprofilebase_assign"
}
-->
``` http
POST https://graph.microsoft.com/beta** Entity URI for microsoft.graph.iosCertificateResourceAccessProfileBase not found/assign

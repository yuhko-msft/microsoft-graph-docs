---
title: "macOSGeneralDeviceConfiguration: assign"
...
# macOSGeneralDeviceConfiguration: assign
...
-->
``` http
POST https://graph.microsoft.com/beta** Entity URI for microsoft.graph.macOSGeneralDeviceConfiguration not found/assign

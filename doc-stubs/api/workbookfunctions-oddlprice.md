---
title: "workbookFunctions: oddLPrice"
...
-->
``` http
POST /workbooks/{workbooksId}/workbook/functions/oddLPrice
```
...
|lastInterest|[Json](../resources/json.md)|**TODO: Add Description**|
|rate|[Json](../resources/json.md)|**TODO: Add Description**|
|yld|[Json](../resources/json.md)|**TODO: Add Description**|
...
<!-- {
  "blockType": "request",
  "name": "workbookfunctions_oddlprice"
}
-->
``` http
POST https://graph.microsoft.com/beta/workbooks/{workbooksId}/workbook/functions/oddLPrice

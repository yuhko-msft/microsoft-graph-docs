---
title: "workbookFunctions: imLog2"
...
-->
``` http
POST /workbooks/{workbooksId}/workbook/functions/imLog2
```
...
-->
``` http
POST https://graph.microsoft.com/beta/workbooks/{workbooksId}/workbook/functions/imLog2

...
Create a new [unifiedRoleManagementPolicyRule](../resources/unifiedrolemanagementpolicyrule.md) object.
...
-->
``` http
POST /policyRoot/roleManagementPolicies/{unifiedRoleManagementPolicyId}/rules
...
-->
``` http
POST https://graph.microsoft.com/beta/policyRoot/roleManagementPolicies/{unifiedRoleManagementPolicyId}/rules

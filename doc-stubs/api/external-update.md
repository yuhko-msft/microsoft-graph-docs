...
The following table shows the properties that are required when you update the [external](../resources/external.md).
...
-->
``` http
PATCH https://graph.microsoft.com/v1.0/external

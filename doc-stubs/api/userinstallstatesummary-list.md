...
description: "Get a list of the userInstallStateSummary objects and their properties."
...
Get a list of the [userInstallStateSummary](../resources/userinstallstatesummary.md) objects and their properties.
...
<!-- {
  "blockType": "request",
  "name": "list_userinstallstatesummary"
}
-->
``` http
  ...
  "value": [
    {
      ...
      "id": "e8293ab8-3ab8-e829-b83a-29e8b83a29e8",

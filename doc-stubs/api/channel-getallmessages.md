...
GET /teams/{teamsId}/allChannels/getAllMessages
GET /teams/{teamsId}/incomingChannels/getAllMessages
```
...
-->
``` http
GET https://graph.microsoft.com/beta/teams/{teamsId}/channels/getAllMessages
```

---
title: "List items"
description: "Get the driveItem resources from the items navigation property."
...
Get the driveItem resources from the items navigation property.
...
-->
``` http
GET https://graph.microsoft.com/beta/shares/{sharesId}/items
```

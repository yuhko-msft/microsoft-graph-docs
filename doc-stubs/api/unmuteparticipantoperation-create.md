...
If successful, this method returns a `201 Created` response code and an [unmuteParticipantOperation](../resources/unmuteparticipantoperation.md) object in the response body.
...
-->
``` http
POST https://graph.microsoft.com/beta** Collection URI for microsoft.graph.unmuteParticipantOperation not found

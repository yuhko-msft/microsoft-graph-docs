...
description: "Get the deviceHealthScriptDeviceState resources from the deviceRunStates navigation property."
...
Get the deviceHealthScriptDeviceState resources from the deviceRunStates navigation property.
...
<!-- {
  "blockType": "response",
  "truncated": true,
  "@odata.type": "Collection(microsoft.management.services.api.deviceHealthScriptDeviceState)"
}
-->
``` http
HTTP/1.1 200 OK

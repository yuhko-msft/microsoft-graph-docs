...
-->
``` http
POST /user/tasks/lists/{wellKnownTaskListId}/tasks/{taskId}/extensions
```
...
-->
``` http
POST https://graph.microsoft.com/beta/user/tasks/lists/{wellKnownTaskListId}/tasks/{taskId}/extensions

...
-->
``` http
GET /me/approvals/{approvalId}/steps/{approvalStepId}
GET /users/{usersId}/approvals/{approvalId}/steps/{approvalStepId}
```
...
-->
``` http
GET https://graph.microsoft.com/beta/me/approvals/{approvalId}/steps/{approvalStepId}
```

...
-->
``` http
GET /request/approval/pendingSteps/{approvalStepId}
GET /request/approval/completedSteps/{approvalStepId}
```
...
-->
``` http
GET https://graph.microsoft.com/beta/request/approval/pendingSteps/{approvalStepId}
```
...

{
  "value": {
    "@odata.type": "#microsoft.graph.approvalStep",
    "id": "38cd884f-884f-38cd-4f88-cd384f88cd38",
    "displayName": "String",
    "reviewedBy": {

...
description: "Get a list of the workbookChartAxis objects and their properties."
...
Get a list of the [workbookChartAxis](../resources/workbookchartaxis.md) objects and their properties.
...
-->
``` http
GET https://graph.microsoft.com/beta** Collection URI for microsoft.graph.workbookChartAxis not found
```
  ...
  "value": [
    {
      ...
      "id": "46fa8809-8809-46fa-0988-fa460988fa46",
      "majorUnit": {

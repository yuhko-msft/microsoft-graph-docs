...
-->
``` http
PATCH /policies/permissionGrantPolicies/{permissionGrantPolicyId}/includes/{permissionGrantConditionSetId}
PATCH /policies/permissionGrantPolicies/{permissionGrantPolicyId}/excludes/{permissionGrantConditionSetId}
```
...
-->
``` http
PATCH https://graph.microsoft.com/beta/policies/permissionGrantPolicies/{permissionGrantPolicyId}/includes/{permissionGrantConditionSetId}

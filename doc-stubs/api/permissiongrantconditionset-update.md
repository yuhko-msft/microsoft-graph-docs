...
-->
``` http
PATCH /policyRoot/permissionGrantPolicies/{permissionGrantPolicyId}/includes/{permissionGrantConditionSetId}
PATCH /policyRoot/permissionGrantPolicies/{permissionGrantPolicyId}/excludes/{permissionGrantConditionSetId}
```
...
-->
``` http
PATCH https://graph.microsoft.com/v1.0/policyRoot/permissionGrantPolicies/{permissionGrantPolicyId}/includes/{permissionGrantConditionSetId}
...
{
  "@odata.type": "#microsoft.graph.permissionGrantConditionSet",
  "id": "d139e261-e261-d139-61e2-39d161e239d1",
  "permissionClassification": "String",
  "permissionType": "String",
  "resourceApplication": "String",
  "permissions": [

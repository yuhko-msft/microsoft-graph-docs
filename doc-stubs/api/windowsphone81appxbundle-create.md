...
-->
``` http
POST ** Collection URI for microsoft.management.services.api.windowsPhone81AppXBundle not found
```
...
-->
``` http
POST https://graph.microsoft.com/beta** Collection URI for microsoft.management.services.api.windowsPhone81AppXBundle not found

---
title: "List workbookFunctions"
description: "Get a list of the workbookFunctions objects and their properties."
...
# List workbookFunctions
Namespace: microsoft.graph

[!INCLUDE [beta-disclaimer](../../includes/beta-disclaimer.md)]

Get a list of the [workbookFunctions](../resources/workbookfunctions.md) objects and their properties.
...
<!-- {
  "blockType": "request",
  "name": "list_workbookfunctions"
}
-->
``` http
GET https://graph.microsoft.com/beta** Collection URI for microsoft.graph.workbookFunctions not found
```

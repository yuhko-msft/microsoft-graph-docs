...
-->
``` http
GET ** Collection URI for microsoft.management.services.api.userExperienceAnalyticsOverview not found
```
...
-->
``` http
GET https://graph.microsoft.com/beta** Collection URI for microsoft.management.services.api.userExperienceAnalyticsOverview not found
```

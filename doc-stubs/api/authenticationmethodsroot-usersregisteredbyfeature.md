...
-->
``` http
GET /print/reports/authenticationMethods/usersRegisteredByFeature
```
...
-->
``` http
GET https://graph.microsoft.com/v1.0/print/reports/authenticationMethods/usersRegisteredByFeature(includedUserTypes='parameterValue',includedUserRoles='parameterValue')
```

...
-->
``` http
GET ** Entity URI for microsoft.management.services.api.iosVppApp not found/getRelatedAppStates
```
...
-->
``` http
GET https://graph.microsoft.com/beta** Entity URI for microsoft.management.services.api.iosVppApp not found/getRelatedAppStates(userPrincipalName='parameterValue',deviceId='parameterValue')
```

...
Get a list of the [teamworkTagMember](../resources/teamworktagmember.md) objects and their properties.
...
-->
``` http
GET https://graph.microsoft.com/v1.0/teams/{teamsId}/tags/{teamworkTagId}/members
```

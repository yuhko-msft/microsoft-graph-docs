...
-->
``` http
PATCH /users/{usersId}/contactFolders/{contactFolderId}/multiValueExtendedProperties
```
...
-->
``` http
PATCH https://graph.microsoft.com/beta/users/{usersId}/contactFolders/{contactFolderId}/multiValueExtendedProperties

...
If successful, this method returns a `201 Created` response code and a [deviceManagementTemplate](../resources/intune-devicemanagementtemplate.md) object in the response body.

...
description: "Get a list of the entitlementManagementSettings objects and their properties."
...
Get a list of the [entitlementManagementSettings](../resources/entitlementmanagementsettings.md) objects and their properties.
...
-->
``` http
GET ** Collection URI for Microsoft.IGAELM.EC.FrontEnd.ExternalModel.entitlementManagementSettings not found
```
...
-->
``` http
GET https://graph.microsoft.com/beta** Collection URI for Microsoft.IGAELM.EC.FrontEnd.ExternalModel.entitlementManagementSettings not found
```
  ...
  "value": [
    {
      ...
      "id": "f76a924f-924f-f76a-4f92-6af74f926af7",

...
description: "Get a list of the windowsHealthMonitoringConfiguration objects and their properties."
...
Get a list of the [windowsHealthMonitoringConfiguration](../resources/windowshealthmonitoringconfiguration.md) objects and their properties.
...
<!-- {
  "blockType": "request",
  "name": "list_windowshealthmonitoringconfiguration"
}
-->
``` http
GET https://graph.microsoft.com/beta** Collection URI for microsoft.graph.windowsHealthMonitoringConfiguration not found
```

...
description: "Get the profileCardProperty resources from the profileCardProperties navigation property."
...
Get the profileCardProperty resources from the profileCardProperties navigation property.
...
-->
``` http
GET /organization/settings/profileCardProperties
```
...
<!-- {
  "blockType": "response",
  "truncated": true,
  "@odata.type": "Collection(Microsoft.Fast.PI.ViewGenerator.V2.Profile.Models.profileCardProperty)"
}
-->
``` http
HTTP/1.1 200 OK

...
-->
``` http
POST /administrativeUnit/restore
POST /directory/administrativeUnits/{administrativeUnitId}/restore
```
...
-->
``` http
POST https://graph.microsoft.com/v1.0/administrativeUnit/restore
```

...
-->
``` http
POST /users/{usersId}/outlook/taskFolders/{outlookTaskFolderId}/singleValueExtendedProperties
```
...
-->
``` http
POST https://graph.microsoft.com/v1.0/users/{usersId}/outlook/taskFolders/{outlookTaskFolderId}/singleValueExtendedProperties

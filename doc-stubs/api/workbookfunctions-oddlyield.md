---
title: "workbookFunctions: oddLYield"
...
-->
``` http
POST /workbooks/{workbooksId}/workbook/functions/oddLYield
```
...
<!-- {
  "blockType": "request",
  "name": "workbookfunctions_oddlyield"
}
-->
``` http
POST https://graph.microsoft.com/beta/workbooks/{workbooksId}/workbook/functions/oddLYield

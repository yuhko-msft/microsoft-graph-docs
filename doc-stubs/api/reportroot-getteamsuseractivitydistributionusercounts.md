...
-->
``` http
GET /reports/getTeamsUserActivityDistributionUserCounts
GET /print/reports/getTeamsUserActivityDistributionUserCounts
```
...
<!-- {
  "blockType": "request",
  "name": "reportroot_getteamsuseractivitydistributionusercounts"
}
-->
``` http
GET https://graph.microsoft.com/beta/reports/getTeamsUserActivityDistributionUserCounts(period='parameterValue')
```

...
-->
``` http
GET https://graph.microsoft.com/beta/print/reports/getPrinterArchivedPrintJobs(printerId='parameterValue',periodStart=String (timestamp),periodEnd=String (timestamp))
```

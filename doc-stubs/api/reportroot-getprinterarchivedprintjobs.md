...
-->
``` http
GET https://graph.microsoft.com/beta/reports/getPrinterArchivedPrintJobs(printerId='parameterValue',startDateTime=String (timestamp),endDateTime=String (timestamp))
```

...
-->
``` http
PATCH https://graph.microsoft.com/beta/user/authentication/passwordlessMicrosoftAuthenticatorMethods/{passwordlessMicrosoftAuthenticatorAuthenticationMethodId}/device
...
{
  "@odata.type": "#microsoft.graph.device",
  "id": "9c6faa7d-aa7d-9c6f-7daa-6f9c7daa6f9c"
}
```

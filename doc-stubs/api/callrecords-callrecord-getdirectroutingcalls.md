...
If successful, this function returns a `200 OK` response code and a [microsoft.graph.callRecords.directRoutingLogRow](../resources/callrecords-directroutinglogrow.md) collection in the response body.

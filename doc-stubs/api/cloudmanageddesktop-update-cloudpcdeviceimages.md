...
-->
``` http
PATCH /deviceManagement/cloudManagedDesktop/cloudPcDeviceImages
```
...
-->
``` http
PATCH https://graph.microsoft.com/beta/deviceManagement/cloudManagedDesktop/cloudPcDeviceImages

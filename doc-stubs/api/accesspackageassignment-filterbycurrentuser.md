...
-->
``` http
GET /entitlementManagement/assignments/filterByCurrentUser
```
...
-->
``` http
GET https://graph.microsoft.com/v1.0/entitlementManagement/assignments/filterByCurrentUser(on='parameterValue')
```

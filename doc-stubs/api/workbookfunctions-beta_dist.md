---
title: "workbookFunctions: beta_Dist"
...
-->
``` http
POST /workbooks/{workbooksId}/workbook/functions/beta_Dist
```
...
<!-- {
  "blockType": "request",
  "name": "workbookfunctions_beta_dist"
}
-->
``` http
POST https://graph.microsoft.com/beta/workbooks/{workbooksId}/workbook/functions/beta_Dist

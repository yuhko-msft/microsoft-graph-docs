...
-->
``` http
POST /user/pendingAccessReviewInstances/{accessReviewInstanceId}/definition/$ref
```
...
-->
``` http
POST https://graph.microsoft.com/beta/user/pendingAccessReviewInstances/{accessReviewInstanceId}/definition/$ref
...
{
  "@odata.type": "#microsoft.graph.accessReviewScheduleDefinition",
  "id": "f5a63e42-3e42-f5a6-423e-a6f5423ea6f5",
  "displayName": "String",

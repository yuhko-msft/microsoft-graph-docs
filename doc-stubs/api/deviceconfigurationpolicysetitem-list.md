...
<!-- {
  "blockType": "request",
  "name": "list_deviceconfigurationpolicysetitem"
}
-->
``` http
GET https://graph.microsoft.com/v1.0** Collection URI for microsoft.graph.deviceConfigurationPolicySetItem not found
```

...
description: "Update the properties of a personAnnualEvent object."
...
Update the properties of a [personAnnualEvent](../resources/personannualevent.md) object.
...
-->
``` http
PATCH /me/profile/anniversaries/{personAnnualEventId}
PATCH /users/{usersId}/profile/anniversaries/{personAnnualEventId}
```
...
The following table shows the properties that are required when you update the [personAnnualEvent](../resources/personannualevent.md).
...
-->
``` http
PATCH https://graph.microsoft.com/beta/me/profile/anniversaries/{personAnnualEventId}

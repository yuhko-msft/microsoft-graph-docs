...
Read the properties and relationships of an [aospDeviceOwnerCompliancePolicy](../resources/intune-aospdeviceownercompliancepolicy.md) object.
...
If successful, this method returns a `200 OK` response code and an [aospDeviceOwnerCompliancePolicy](../resources/intune-aospdeviceownercompliancepolicy.md) object in the response body.

---
title: "emailSecurityEventsRoot: moveToJunk"
...
# emailSecurityEventsRoot: moveToJunk
...
-->
``` http
POST /security/emailSecurityEvents/moveToJunk
```
...
<!-- {
  "blockType": "request",
  "name": "emailsecurityeventsroot_movetojunk"
}
-->
``` http
POST https://graph.microsoft.com/beta/security/emailSecurityEvents/moveToJunk

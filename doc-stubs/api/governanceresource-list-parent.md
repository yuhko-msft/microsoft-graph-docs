...
description: "Get the governanceResource resources from the parent navigation property."
...
Get the governanceResource resources from the parent navigation property.
...
-->
``` http
GET https://graph.microsoft.com/beta/governanceResources/{governanceResourcesId}/parent
```
  ...
  "value": [
    {
      ...
      "id": "51acdbf2-dbf2-51ac-f2db-ac51f2dbac51",
      "displayName": "String",
      "externalId": "String",

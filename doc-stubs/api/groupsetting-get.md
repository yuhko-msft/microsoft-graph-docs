...
description: "Read the properties and relationships of a groupSetting object."
...
Read the properties and relationships of a [groupSetting](../resources/groupsetting.md) object.
...
-->
``` http
GET https://graph.microsoft.com/v1.0/groupSettings/{groupSettingsId}
```

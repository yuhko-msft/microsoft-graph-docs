...
description: "Deletes a customerPayment object."
...
Deletes a [customerPayment](../resources/customerpayment.md) object.
...
-->
``` http
DELETE https://graph.microsoft.com/v1.0/financials/companies/{companyId}/customerPayments/{customerPaymentId}
```

---
title: "appRoleAssignment: getMemberGroups"
...
-->
``` http
POST /me/appRoleAssignments/{appRoleAssignmentId}/getMemberGroups
```
...
-->
``` http
POST https://graph.microsoft.com/v1.0/me/appRoleAssignments/{appRoleAssignmentId}/getMemberGroups

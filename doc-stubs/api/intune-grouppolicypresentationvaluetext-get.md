...
Read the properties and relationships of a [groupPolicyPresentationValueText](../resources/intune-grouppolicypresentationvaluetext.md) object.
...
If successful, this method returns a `200 OK` response code and a [groupPolicyPresentationValueText](../resources/intune-grouppolicypresentationvaluetext.md) object in the response body.

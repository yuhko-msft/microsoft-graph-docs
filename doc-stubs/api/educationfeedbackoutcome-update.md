...
description: "Update the properties of an educationFeedbackOutcome object."
...
Update the properties of an [educationFeedbackOutcome](../resources/educationfeedbackoutcome.md) object.
...
-->
``` http
PATCH /educationFeedbackOutcome
```
...
The following table shows the properties that are required when you update the [educationFeedbackOutcome](../resources/educationfeedbackoutcome.md).
...
-->
``` http
PATCH https://graph.microsoft.com/v1.0/educationFeedbackOutcome

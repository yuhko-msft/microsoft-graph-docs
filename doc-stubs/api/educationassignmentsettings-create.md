...
-->
``` http
POST ** Collection URI for microsoft.education.assignments.api.educationAssignmentSettings not found
```
...
-->
``` http
POST https://graph.microsoft.com/beta** Collection URI for microsoft.education.assignments.api.educationAssignmentSettings not found

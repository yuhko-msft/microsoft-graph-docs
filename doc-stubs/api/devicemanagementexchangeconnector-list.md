...
description: "Get a list of the deviceManagementExchangeConnector objects and their properties."
...
Get a list of the [deviceManagementExchangeConnector](../resources/devicemanagementexchangeconnector.md) objects and their properties.
...
<!-- {
  "blockType": "request",
  "name": "list_devicemanagementexchangeconnector"
}
-->
``` http

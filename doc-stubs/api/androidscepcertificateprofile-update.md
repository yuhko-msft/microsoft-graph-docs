...
The following table shows the properties that are required when you update the [androidScepCertificateProfile](../resources/androidscepcertificateprofile.md).
...
{
  "@odata.type": "#microsoft.graph.androidScepCertificateProfile",
  "id": "5ec329dd-29dd-5ec3-dd29-c35edd29c35e",

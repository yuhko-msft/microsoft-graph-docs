---
title: "Update androidScepCertificateProfile"
description: "Update the properties of an androidScepCertificateProfile object."
...
Update the properties of an [androidScepCertificateProfile](../resources/androidscepcertificateprofile.md) object.
...
-->
``` http
PATCH ** Entity URI for microsoft.graph.androidScepCertificateProfile not found
```
...
## Request body
In the request body, supply a JSON representation of the [androidScepCertificateProfile](../resources/androidscepcertificateprofile.md) object.

The following table shows the properties that are required when you create the [androidScepCertificateProfile](../resources/androidscepcertificateprofile.md).
...
If successful, this method returns a `200 OK` response code and an updated [androidScepCertificateProfile](../resources/androidscepcertificateprofile.md) object in the response body.
...
<!-- {
  "blockType": "request",
  "name": "update_androidscepcertificateprofile"
}
-->
``` http
PATCH https://graph.microsoft.com/beta** Entity URI for microsoft.graph.androidScepCertificateProfile not found
...
{
  "@odata.type": "#microsoft.graph.androidScepCertificateProfile",
  "id": "21f2fee2-fee2-21f2-e2fe-f221e2fef221",

...
Create a new [dimensionValue](../resources/dimensionvalue.md) object.
...
-->
``` http
POST /financials/companies/{companyId}/dimensionValues
...
-->
``` http
POST https://graph.microsoft.com/v1.0/financials/companies/{companyId}/dimensionValues

...
description: "Get a list of the androidImportedPFXCertificateProfile objects and their properties."
...
Get a list of the [androidImportedPFXCertificateProfile](../resources/androidimportedpfxcertificateprofile.md) objects and their properties.
...
<!-- {
  "blockType": "request",
  "name": "list_androidimportedpfxcertificateprofile"
}
-->
``` http
GET https://graph.microsoft.com/v1.0** Collection URI for microsoft.graph.androidImportedPFXCertificateProfile not found
```

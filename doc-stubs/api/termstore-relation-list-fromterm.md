---
title: "List term"
description: "Get the term resources from the fromTerm navigation property."
...
Get the term resources from the fromTerm navigation property.
...
-->
``` http
GET https://graph.microsoft.com/v1.0/sites/{sitesId}/termStore/groups/{groupId}/sets/{setId}/children/{termId}/relations/{relationId}/fromTerm
```

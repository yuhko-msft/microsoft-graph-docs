...
-->
``` http
POST /workbooks/{workbooksId}/workbook/functions/vdb
```
...
|factor|[Json](../resources/json.md)|**TODO: Add Description**|
|noSwitch|[Json](../resources/json.md)|**TODO: Add Description**|
...
<!-- {
  "blockType": "request",
  "name": "workbookfunctions_vdb"
}
-->
``` http
POST https://graph.microsoft.com/beta/workbooks/{workbooksId}/workbook/functions/vdb

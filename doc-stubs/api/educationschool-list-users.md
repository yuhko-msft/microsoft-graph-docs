---
title: "List users"
description: "Get the educationUser resources from the users navigation property."
...
Get the educationUser resources from the users navigation property.
...
-->
``` http
GET https://graph.microsoft.com/beta/education/classes/{educationClassId}/members/{educationUserId}/schools/{educationSchoolId}/users
```

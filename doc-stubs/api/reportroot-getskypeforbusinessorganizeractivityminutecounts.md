...
GET /print/reports/getSkypeForBusinessOrganizerActivityMinuteCounts
```
...
-->
``` http
GET https://graph.microsoft.com/v1.0/reports/getSkypeForBusinessOrganizerActivityMinuteCounts(period='parameterValue')
```

...
description: "Get the roleAssignment resources from the roleAssignments navigation property."
...
Get the roleAssignment resources from the roleAssignments navigation property.
...
-->
``` http
GET https://graph.microsoft.com/beta/deviceManagement/roleAssignments/{deviceAndAppManagementRoleAssignmentId}/roleDefinition/roleAssignments
```
  ...
  "value": [
    {
      ...
      "id": "a46df987-f987-a46d-87f9-6da487f96da4",
      "description": "String",
      "displayName": "String",
      "resourceScopes": [
        "String"

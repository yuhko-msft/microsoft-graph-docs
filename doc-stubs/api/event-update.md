...
-->
``` http
PATCH /users/{usersId}/events/{eventId}
PATCH /groups/{groupsId}/events/{eventId}
PATCH /users/{usersId}/calendarView/{eventId}
PATCH /groups/{groupsId}/calendarView/{eventId}
PATCH /users/{usersId}/messages/{messageId}/event
PATCH /users/{usersId}/messages/{messageId}/event/instances/{eventId}
PATCH /users/{usersId}/messages/{messageId}/event/calendar/events/{eventId}
PATCH /users/{usersId}/messages/{messageId}/event/exceptionOccurrences/{eventId}
PATCH /users/{usersId}/messages/{messageId}/event/calendar/calendarView/{eventId}
```
...
-->
``` http
PATCH https://graph.microsoft.com/beta/users/{usersId}/events/{eventId}

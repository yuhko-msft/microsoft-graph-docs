...
The following table shows the properties that are required when you update the [event](../resources/event.md).
...
|creationOptions|[eventCreationOptions](../resources/eventcreationoptions.md)|**TODO: Add Description**|
...
-->
``` http
PATCH https://graph.microsoft.com/beta/me/events/{eventId}
...
{
  "@odata.type": "#microsoft.graph.event",
  "id": "59544dc2-4dc2-5954-c24d-5459c24d5459",

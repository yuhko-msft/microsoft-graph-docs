---
title: "Update resourceAccessProfiles"
description: "Update the properties of a resourceAccessProfiles object."
...
# Update resourceAccessProfiles
Namespace: microsoft.graph

Update the properties of a resourceAccessProfiles object.
...
-->
``` http
PATCH /deviceManagement/resourceAccessProfiles
```
...
<!-- {
  "blockType": "request",
  "name": "update_resourceaccessprofiles"
}
-->
``` http
PATCH https://graph.microsoft.com/beta/deviceManagement/resourceAccessProfiles

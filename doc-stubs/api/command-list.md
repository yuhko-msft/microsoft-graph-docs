---
title: "List commands"
description: "Get a list of the command objects and their properties."
...
Get a list of the [command](../resources/command.md) objects and their properties.
...
-->
``` http
GET https://graph.microsoft.com/v1.0/commands
```

...
description: "Update the properties of an androidLobApp object."
...
Update the properties of an [androidLobApp](../resources/androidlobapp.md) object.
...
-->
``` http
PATCH ** Entity URI for microsoft.graph.androidLobApp not found
```
...
The following table shows the properties that are required when you update the [androidLobApp](../resources/androidlobapp.md).
...
If successful, this method returns a `200 OK` response code and an updated [androidLobApp](../resources/androidlobapp.md) object in the response body.
...
<!-- {
  "blockType": "request",
  "name": "update_androidlobapp"
}
-->
``` http
PATCH https://graph.microsoft.com/beta** Entity URI for microsoft.graph.androidLobApp not found
...
{
  "@odata.type": "#microsoft.graph.androidLobApp",
  "id": "9e58692e-692e-9e58-2e69-589e2e69589e",

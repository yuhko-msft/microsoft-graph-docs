...
If successful, this method returns a `201 Created` response code and an [iosCompliancePolicy](../resources/ioscompliancepolicy.md) object in the response body.
...
<!-- {
  "blockType": "request",
  "name": "create_ioscompliancepolicy_from_"
}
-->
``` http
POST https://graph.microsoft.com/beta** Collection URI for microsoft.graph.iosCompliancePolicy not found

...
The following table shows the properties that are required when you update the [windows10EasEmailProfileConfiguration](../resources/windows10easemailprofileconfiguration.md).
...
<!-- {
  "blockType": "request",
  "name": "update_windows10easemailprofileconfiguration"
}
-->
``` http
PATCH https://graph.microsoft.com/beta** Entity URI for microsoft.graph.windows10EasEmailProfileConfiguration not found

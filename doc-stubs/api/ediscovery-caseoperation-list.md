...
Get a list of the [caseOperation](../resources/ediscovery-caseoperation.md) objects and their properties.
...
-->
``` http
GET https://graph.microsoft.com/v1.0/compliance/ediscovery/cases/{caseId}/operations
```

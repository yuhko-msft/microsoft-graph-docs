...
-->
``` http
POST /financials/companies/{companyId}/salesOrderLines/{salesOrderLineId}/account
```
...
-->
``` http
POST https://graph.microsoft.com/v1.0/financials/companies/{companyId}/salesOrderLines/{salesOrderLineId}/account

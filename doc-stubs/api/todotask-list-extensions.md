...
-->
``` http
GET /user/todo/lists/{todoTaskListId}/tasks/{todoTaskId}/extensions
```
...
-->
``` http
GET https://graph.microsoft.com/beta/user/todo/lists/{todoTaskListId}/tasks/{todoTaskId}/extensions
```

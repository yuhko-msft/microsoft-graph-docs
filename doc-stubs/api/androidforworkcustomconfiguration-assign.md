---
title: "androidForWorkCustomConfiguration: assign"
...
# androidForWorkCustomConfiguration: assign
...
-->
``` http
POST https://graph.microsoft.com/v1.0** Entity URI for microsoft.graph.androidForWorkCustomConfiguration not found/assign

---
title: "reportRoot: getPrintUsageSummariesByUser"
...
# reportRoot: getPrintUsageSummariesByUser
...
-->
``` http
GET ** Collection URI for microsoft.graph.reportRoot not found/getPrintUsageSummariesByUser
```
...
-->
``` http
GET https://graph.microsoft.com/v1.0** Collection URI for microsoft.graph.reportRoot not found/getPrintUsageSummariesByUser(periodStart=String (timestamp),periodEnd=String (timestamp))
```

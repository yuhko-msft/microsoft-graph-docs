...
description: "Get the mobileAppIntentAndState resources from the mobileAppIntentAndStates navigation property."
...
Get the mobileAppIntentAndState resources from the mobileAppIntentAndStates navigation property.
...
<!-- {
  "blockType": "request",
  "name": "list_mobileappintentandstate"
}
-->
``` http
GET https://graph.microsoft.com/v1.0/me/mobileAppIntentAndStates
```

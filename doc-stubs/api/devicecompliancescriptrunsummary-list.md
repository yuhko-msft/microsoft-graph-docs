...
-->
``` http
GET ** Collection URI for microsoft.management.services.api.deviceComplianceScriptRunSummary not found
```
...
-->
``` http
GET https://graph.microsoft.com/beta** Collection URI for microsoft.management.services.api.deviceComplianceScriptRunSummary not found
```
...
<!-- {
  "blockType": "response",
  "truncated": true,
  "@odata.type": "Collection(microsoft.management.services.api.deviceComplianceScriptRunSummary)"
}
-->
``` http
HTTP/1.1 200 OK

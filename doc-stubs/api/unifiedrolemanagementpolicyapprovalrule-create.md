...
-->
``` http
POST https://graph.microsoft.com/v1.0** Collection URI for microsoft.graph.unifiedRoleManagementPolicyApprovalRule not found
...
{
  "@odata.type": "#microsoft.graph.unifiedRoleManagementPolicyApprovalRule",
  "id": "3e0eed1c-ed1c-3e0e-1ced-0e3e1ced0e3e",
  "target": {
    "@odata.type": "microsoft.graph.unifiedRoleManagementPolicyRuleTarget"
  },
  "setting": {

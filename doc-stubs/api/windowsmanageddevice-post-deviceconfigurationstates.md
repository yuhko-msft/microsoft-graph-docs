...
Create a new deviceConfigurationState object.
...
-->
``` http
POST https://graph.microsoft.com/beta/users/{usersId}/managedDevices/{managedDeviceId}/deviceConfigurationStates

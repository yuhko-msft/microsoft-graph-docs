...
-->
``` http
GET /note/multiValueExtendedProperties/{multiValueLegacyExtendedPropertyId}
```
...
-->
``` http
GET https://graph.microsoft.com/beta/note/multiValueExtendedProperties/{multiValueLegacyExtendedPropertyId}
```

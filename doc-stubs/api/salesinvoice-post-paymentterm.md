...
-->
``` http
POST /financials/companies/{companyId}/salesInvoices/{salesInvoiceId}/paymentTerm
```
...
-->
``` http
POST https://graph.microsoft.com/v1.0/financials/companies/{companyId}/salesInvoices/{salesInvoiceId}/paymentTerm

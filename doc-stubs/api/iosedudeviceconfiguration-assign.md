---
title: "iosEduDeviceConfiguration: assign"
...
# iosEduDeviceConfiguration: assign
...
-->
``` http
POST ** Entity URI for microsoft.graph.iosEduDeviceConfiguration not found/assign
```
...
<!-- {
  "blockType": "request",
  "name": "iosedudeviceconfiguration_assign"
}
-->
``` http
POST https://graph.microsoft.com/v1.0** Entity URI for microsoft.graph.iosEduDeviceConfiguration not found/assign

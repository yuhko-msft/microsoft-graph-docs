---
title: "deviceManagementReports: getCertificatesReport"
...
# deviceManagementReports: getCertificatesReport
...
<!-- {
  "blockType": "request",
  "name": "devicemanagementreports_getcertificatesreport"
}
-->
``` http
POST https://graph.microsoft.com/v1.0/deviceManagement/reports/getCertificatesReport

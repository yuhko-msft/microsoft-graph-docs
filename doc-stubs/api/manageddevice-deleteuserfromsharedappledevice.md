...
-->
``` http
POST /me/managedDevices/{managedDeviceId}/deleteUserFromSharedAppleDevice
...
-->
``` http
POST https://graph.microsoft.com/beta/me/managedDevices/{managedDeviceId}/deleteUserFromSharedAppleDevice

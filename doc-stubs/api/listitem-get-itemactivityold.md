...
-->
``` http
GET /drives/{drivesId}/activities/{itemActivityOLDId}/driveItem/listItem/activities
```
...
-->
``` http
GET https://graph.microsoft.com/beta/drives/{drivesId}/activities/{itemActivityOLDId}/driveItem/listItem/activities
```

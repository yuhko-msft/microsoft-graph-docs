...
description: "Get the microsoftTunnelSite resources from the microsoftTunnelSites navigation property."
...
Get the microsoftTunnelSite resources from the microsoftTunnelSites navigation property.
...
<!-- {
  "blockType": "response",
  "truncated": true,
  "@odata.type": "Collection(microsoft.management.services.api.microsoftTunnelSite)"
}
-->
``` http
HTTP/1.1 200 OK

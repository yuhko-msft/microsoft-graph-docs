---
title: "Create policySetItem"
description: "Create a new policySetItem object."
...
# Create policySetItem
Namespace: microsoft.graph



Create a new [policySetItem](../resources/policysetitem.md) object.
...
-->
``` http
POST https://graph.microsoft.com/v1.0/deviceAppManagement/policySets/{policySetId}/items

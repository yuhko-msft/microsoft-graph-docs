...
Update the properties of a [managedAppProtectionPolicySetItem](../resources/intune-managedappprotectionpolicysetitem.md) object.
...
If successful, this method returns a `200 OK` response code and an updated [managedAppProtectionPolicySetItem](../resources/intune-managedappprotectionpolicysetitem.md) object in the response body.

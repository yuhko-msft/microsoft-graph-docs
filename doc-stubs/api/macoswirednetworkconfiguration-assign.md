---
title: "macOSWiredNetworkConfiguration: assign"
...
# macOSWiredNetworkConfiguration: assign
...
-->
``` http
POST https://graph.microsoft.com/v1.0** Entity URI for microsoft.graph.macOSWiredNetworkConfiguration not found/assign

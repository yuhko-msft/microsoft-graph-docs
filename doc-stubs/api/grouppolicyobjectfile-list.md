...
description: "Get a list of the groupPolicyObjectFile objects and their properties."
...
Get a list of the [groupPolicyObjectFile](../resources/grouppolicyobjectfile.md) objects and their properties.
...
-->
``` http
GET https://graph.microsoft.com/v1.0/deviceManagement/groupPolicyObjectFiles
```

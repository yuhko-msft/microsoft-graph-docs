...
-->
``` http
POST ** Collection URI for Microsoft.Teams.Shifts.shiftPreferences not found
```
...
-->
``` http
POST https://graph.microsoft.com/beta** Collection URI for Microsoft.Teams.Shifts.shiftPreferences not found

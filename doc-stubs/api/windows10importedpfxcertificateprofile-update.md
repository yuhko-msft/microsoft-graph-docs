...
The following table shows the properties that are required when you update the [windows10ImportedPFXCertificateProfile](../resources/windows10importedpfxcertificateprofile.md).
...
-->
``` http
PATCH https://graph.microsoft.com/v1.0** Entity URI for microsoft.graph.windows10ImportedPFXCertificateProfile not found
...
{
  "@odata.type": "#microsoft.graph.windows10ImportedPFXCertificateProfile",
  "id": "f95e7d88-7d88-f95e-887d-5ef9887d5ef9",

...
-->
``` http
POST /entitlementManagement/assignmentRequests/{accessPackageAssignmentRequestId}/assignment/$ref
```
...
-->
``` http
POST https://graph.microsoft.com/v1.0/entitlementManagement/assignmentRequests/{accessPackageAssignmentRequestId}/assignment/$ref

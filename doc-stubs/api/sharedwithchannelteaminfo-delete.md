...
Deletes a [sharedWithChannelTeamInfo](../resources/sharedwithchannelteaminfo.md) object.
...
-->
``` http
DELETE https://graph.microsoft.com/beta/teams/{teamsId}/channels/{channelId}/sharedWithTeams/{sharedWithChannelTeamInfoId}
```

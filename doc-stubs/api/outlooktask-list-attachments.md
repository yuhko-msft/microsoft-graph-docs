...
-->
``` http
GET /users/{usersId}/outlook/taskFolders/{outlookTaskFolderId}/tasks/{outlookTaskId}/attachments
```
...
-->
``` http
GET https://graph.microsoft.com/v1.0/users/{usersId}/outlook/taskFolders/{outlookTaskFolderId}/tasks/{outlookTaskId}/attachments
```

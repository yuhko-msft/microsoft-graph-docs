---
title: "directoryRole: checkMemberGroups"
...
-->
``` http
POST /directoryRoles/{directoryRolesId}/checkMemberGroups
```
...
-->
``` http
POST https://graph.microsoft.com/beta/directoryRoles/{directoryRolesId}/checkMemberGroups

---
title: "Update iosCertificateProfileBase"
description: "Update the properties of an iosCertificateProfileBase object."
...
# Update iosCertificateProfileBase
Namespace: microsoft.graph

[!INCLUDE [beta-disclaimer](../../includes/beta-disclaimer.md)]

Update the properties of an [iosCertificateProfileBase](../resources/ioscertificateprofilebase.md) object.
...
The following table shows the properties that are required when you update the [iosCertificateProfileBase](../resources/ioscertificateprofilebase.md).
...
If successful, this method returns a `200 OK` response code and an updated [iosCertificateProfileBase](../resources/ioscertificateprofilebase.md) object in the response body.
...
<!-- {
  "blockType": "request",
  "name": "update_ioscertificateprofilebase"
}
-->
``` http
...
{
  "@odata.type": "#microsoft.graph.iosCertificateProfileBase",
  "id": "e848de13-de13-e848-13de-48e813de48e8",

...
-->
``` http
PATCH https://graph.microsoft.com/v1.0/reports/credentialUserRegistrationDetails/{credentialUserRegistrationDetailsId}
...
{
  "@odata.type": "#microsoft.graph.credentialUserRegistrationDetails",
  "id": "0ff968d2-68d2-0ff9-d268-f90fd268f90f",
  "userPrincipalName": "String",
  "userDisplayName": "String",
  "authMethods": [
    "String"

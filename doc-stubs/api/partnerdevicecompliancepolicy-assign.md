---
title: "partnerDeviceCompliancePolicy: assign"
...
# partnerDeviceCompliancePolicy: assign
...
-->
``` http
POST ** Entity URI for microsoft.graph.partnerDeviceCompliancePolicy not found/assign
```
...
<!-- {
  "blockType": "request",
  "name": "partnerdevicecompliancepolicy_assign"
}
-->
``` http
POST https://graph.microsoft.com/beta** Entity URI for microsoft.graph.partnerDeviceCompliancePolicy not found/assign

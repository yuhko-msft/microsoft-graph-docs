...
The following table shows the properties that are required when you update the [iosGeneralDeviceConfiguration](../resources/intune-iosgeneraldeviceconfiguration.md).

...
description: "Deletes an iosManagedAppProtection object."
...
Deletes an [iosManagedAppProtection](../resources/iosmanagedappprotection.md) object.
...
<!-- {
  "blockType": "request",
  "name": "delete_iosmanagedappprotection"
}
-->
``` http

---
title: "macOSEndpointProtectionConfiguration: assign"
...
# macOSEndpointProtectionConfiguration: assign
...
-->
``` http
POST ** Entity URI for microsoft.graph.macOSEndpointProtectionConfiguration not found/assign
```
...
<!-- {
  "blockType": "request",
  "name": "macosendpointprotectionconfiguration_assign"
}
-->
``` http
POST https://graph.microsoft.com/v1.0** Entity URI for microsoft.graph.macOSEndpointProtectionConfiguration not found/assign

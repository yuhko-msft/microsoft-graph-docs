...
-->
``` http
GET /drive/following/{driveItemId}/workbook/operations/{workbookOperationId}
GET /drives/{drivesId}/following/{driveItemId}/workbook/operations/{workbookOperationId}
```
...
-->
``` http
GET https://graph.microsoft.com/v1.0/drive/following/{driveItemId}/workbook/operations/{workbookOperationId}
```

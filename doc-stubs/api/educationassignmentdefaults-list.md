...
-->
``` http
GET ** Collection URI for microsoft.education.assignments.api.educationAssignmentDefaults not found
```
...
-->
``` http
GET https://graph.microsoft.com/beta** Collection URI for microsoft.education.assignments.api.educationAssignmentDefaults not found
```

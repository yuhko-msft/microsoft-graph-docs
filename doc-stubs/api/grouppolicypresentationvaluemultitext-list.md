...
-->
``` http
GET https://graph.microsoft.com/beta** Collection URI for microsoft.graph.groupPolicyPresentationValueMultiText not found
```
  ...
  "value": [
    {
      ...
      "id": "bb303ac0-3ac0-bb30-c03a-30bbc03a30bb",

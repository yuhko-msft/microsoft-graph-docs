---
title: "windowsUpdateForBusinessConfiguration: assign"
...
# windowsUpdateForBusinessConfiguration: assign
...
-->
``` http
POST ** Entity URI for microsoft.graph.windowsUpdateForBusinessConfiguration not found/assign
```
...
<!-- {
  "blockType": "request",
  "name": "windowsupdateforbusinessconfiguration_assign"
}
-->
``` http
POST https://graph.microsoft.com/beta** Entity URI for microsoft.graph.windowsUpdateForBusinessConfiguration not found/assign

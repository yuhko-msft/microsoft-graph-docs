---
title: "androidForWorkGeneralDeviceConfiguration: assign"
...
# androidForWorkGeneralDeviceConfiguration: assign
...
-->
``` http
POST ** Entity URI for microsoft.graph.androidForWorkGeneralDeviceConfiguration not found/assign
```
...
<!-- {
  "blockType": "request",
  "name": "androidforworkgeneraldeviceconfiguration_assign"
}
-->
``` http
POST https://graph.microsoft.com/v1.0** Entity URI for microsoft.graph.androidForWorkGeneralDeviceConfiguration not found/assign

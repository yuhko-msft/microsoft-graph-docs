...
-->
``` http
POST ** Collection URI for Microsoft.OfficeGraph.itemInsights not found
```
...
-->
``` http
POST https://graph.microsoft.com/beta** Collection URI for Microsoft.OfficeGraph.itemInsights not found

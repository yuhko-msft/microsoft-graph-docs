...
-->
``` http
GET /teams/{teamsId}/schedule/schedulingGroups/{schedulingGroupId}
```
...
-->
``` http
GET https://graph.microsoft.com/beta/teams/{teamsId}/schedule/schedulingGroups/{schedulingGroupId}
```

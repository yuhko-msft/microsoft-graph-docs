...
-->
``` http
GET /deviceManagement/cloudManagedDesktop/selfServiceSettings
```
...
-->
``` http
GET https://graph.microsoft.com/beta/deviceManagement/cloudManagedDesktop/selfServiceSettings
```

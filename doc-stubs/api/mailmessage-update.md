...
-->
``` http
PATCH /security/emailSecurityEvents/mailMessages/{mailMessageId}
```
...
-->
``` http
PATCH https://graph.microsoft.com/beta/security/emailSecurityEvents/mailMessages/{mailMessageId}

...
-->
``` http
GET https://graph.microsoft.com/v1.0/reports/managedDeviceEnrollmentAbandonmentSummary(skip=Integer,top=Integer,filter='parameterValue',skipToken='parameterValue')
```

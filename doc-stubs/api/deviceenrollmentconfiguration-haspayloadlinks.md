---
title: "deviceEnrollmentConfiguration: hasPayloadLinks"
...
# deviceEnrollmentConfiguration: hasPayloadLinks
...
POST /users/{usersId}/deviceEnrollmentConfigurations/hasPayloadLinks
...
<!-- {
  "blockType": "request",
  "name": "deviceenrollmentconfiguration_haspayloadlinks"
}
-->
``` http
POST https://graph.microsoft.com/v1.0/me/deviceEnrollmentConfigurations/hasPayloadLinks

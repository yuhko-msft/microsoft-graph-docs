...
description: "Get the groupPolicyDefinitionFile resources from the groupPolicyDefinitionFiles navigation property."
...
Get the groupPolicyDefinitionFile resources from the groupPolicyDefinitionFiles navigation property.
...
-->
``` http
GET https://graph.microsoft.com/v1.0/deviceManagement/groupPolicyDefinitionFiles
```

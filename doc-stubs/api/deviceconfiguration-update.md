...
Update the properties of a [deviceConfiguration](../resources/deviceconfiguration.md) object.
...
The following table shows the properties that are required when you update the [deviceConfiguration](../resources/deviceconfiguration.md).

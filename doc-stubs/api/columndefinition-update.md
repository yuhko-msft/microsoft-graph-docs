...
PATCH /drive/list/columns/{columnDefinitionId}/sourceColumn
PATCH /drives/{drivesId}/list/columns/{columnDefinitionId}/sourceColumn
...
-->
``` http
PATCH https://graph.microsoft.com/v1.0/drive/list/columns/{columnDefinitionId}

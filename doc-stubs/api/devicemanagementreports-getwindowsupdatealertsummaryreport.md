...
# deviceManagementReports: getWindowsUpdateAlertSummaryReport
...
-->
``` http
POST https://graph.microsoft.com/v1.0/deviceManagement/reports/getWindowsUpdateAlertSummaryReport

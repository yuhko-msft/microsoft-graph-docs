...
-->
``` http
POST ** Collection URI for microsoft.graph.contract not found
```
...
<!-- {
  "blockType": "request",
  "name": "create_contract_from_"
}
-->
``` http
POST https://graph.microsoft.com/beta** Collection URI for microsoft.graph.contract not found
...
{
  "@odata.type": "#microsoft.graph.contract",
  "id": "019044a7-44a7-0190-a744-9001a7449001",
  "display": {
    "@odata.type": "microsoft.graph.display"
  },
  "input": {

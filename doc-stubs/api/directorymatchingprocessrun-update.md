...
Update the properties of a [directoryMatchingProcessRun](../resources/directorymatchingprocessrun.md) object.
...
-->
``` http
PATCH ** Entity URI for microsoft.industryData.directoryMatchingProcessRun not found
```
...
If successful, this method returns a `200 OK` response code and an updated [directoryMatchingProcessRun](../resources/directorymatchingprocessrun.md) object in the response body.
...
-->
``` http
PATCH https://graph.microsoft.com/beta** Entity URI for microsoft.industryData.directoryMatchingProcessRun not found

...
The following table shows the properties that are required when you update the [baseTask](../resources/basetask.md).
...
-->
``` http
PATCH https://graph.microsoft.com/beta/baseTask

...
-->
``` http
GET /deviceManagement/cloudManagedDesktop/provisioningPolicies
```
...
-->
``` http
GET https://graph.microsoft.com/beta/deviceManagement/cloudManagedDesktop/provisioningPolicies
```

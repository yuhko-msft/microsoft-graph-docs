...
-->
``` http
POST /accessPackageResources/{accessPackageResourcesId}/accessPackageResourceEnvironment/accessPackageResources/$ref
```
...
|attributes|[Microsoft.IGAELM.EC.FrontEnd.ExternalModel.accessPackageAttribute](../resources/accesspackageattribute.md) collection|**TODO: Add Description**|
...
-->
``` http
POST https://graph.microsoft.com/beta/accessPackageResources/{accessPackageResourcesId}/accessPackageResourceEnvironment/accessPackageResources/$ref

...
-->
``` http
POST /rbacApplication/roleAssignmentRequests/{unifiedRoleAssignmentRequestId}/activatedUsing/$ref
```
...
-->
``` http
POST https://graph.microsoft.com/beta/rbacApplication/roleAssignmentRequests/{unifiedRoleAssignmentRequestId}/activatedUsing/$ref

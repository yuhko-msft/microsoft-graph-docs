...
-->
``` http
PATCH https://graph.microsoft.com/beta/deviceManagement/deviceCompliancePolicies/{deviceCompliancePolicyId}/userStatuses
...
{
  "@odata.type": "#microsoft.graph.deviceComplianceUserStatus",
  "id": "6d64cf7a-cf7a-6d64-7acf-646d7acf646d",
  "userDisplayName": "String",
  "devicesCount": "Integer",
  "status": "String",
  "lastReportedDateTime": "String (timestamp)",

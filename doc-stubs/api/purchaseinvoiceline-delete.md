...
description: "Deletes a purchaseInvoiceLine object."
...
Deletes a [purchaseInvoiceLine](../resources/purchaseinvoiceline.md) object.
...
-->
``` http
DELETE https://graph.microsoft.com/v1.0/financials/companies/{companyId}/purchaseInvoiceLines/{purchaseInvoiceLineId}
```

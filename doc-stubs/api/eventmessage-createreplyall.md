---
title: "eventMessage: createReplyAll"
...
-->
``` http
POST ** Entity URI for microsoft.graph.eventMessage not found/createReplyAll
```
...
-->
``` http
POST https://graph.microsoft.com/beta** Entity URI for microsoft.graph.eventMessage not found/createReplyAll

...
-->
``` http
POST /entitlementManagement/assignmentRequests/{accessPackageAssignmentRequestId}/accessPackage/$ref
```
...
-->
``` http
POST https://graph.microsoft.com/v1.0/entitlementManagement/assignmentRequests/{accessPackageAssignmentRequestId}/accessPackage/$ref
...
{
  "@odata.type": "#Microsoft.IGAELM.EC.FrontEnd.ExternalModel.accessPackage",
  "id": "b51f596c-596c-b51f-6c59-1fb56c591fb5",
  "displayName": "String",
  "description": "String",
  "isHidden": "Boolean",

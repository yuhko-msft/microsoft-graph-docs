...
description: "Deletes a deviceComplianceUserStatus object."
...
Deletes a [deviceComplianceUserStatus](../resources/devicecomplianceuserstatus.md) object.
...
<!-- {
  "blockType": "request",
  "name": "delete_devicecomplianceuserstatus"
}
-->
``` http

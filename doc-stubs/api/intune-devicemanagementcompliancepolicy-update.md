...
# Update deviceManagementCompliancePolicy
Namespace: microsoft.graph

Update the properties of a [deviceManagementCompliancePolicy](../resources/intune-devicemanagementcompliancepolicy.md) object.
...
The following table shows the properties that are required when you update the [deviceManagementCompliancePolicy](../resources/intune-devicemanagementcompliancepolicy.md).
...
If successful, this method returns a `200 OK` response code and an updated [deviceManagementCompliancePolicy](../resources/intune-devicemanagementcompliancepolicy.md) object in the response body.
...
<!-- {
  "blockType": "request",
  "name": "update_devicemanagementcompliancepolicy"
}
-->
``` http

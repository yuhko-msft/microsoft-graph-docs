---
title: "email: movetoDeletedItems"
...
-->
``` http
POST /security/emailEvent/emails/{emailId}/movetoDeletedItems
```
...
<!-- {
  "blockType": "request",
  "name": "email_movetodeleteditems"
}
-->
``` http
POST https://graph.microsoft.com/beta/security/emailEvent/emails/{emailId}/movetoDeletedItems

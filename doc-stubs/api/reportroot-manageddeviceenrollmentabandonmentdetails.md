...
# reportRoot: managedDeviceEnrollmentAbandonmentDetails
...
GET /print/reports/managedDeviceEnrollmentAbandonmentDetails
```
...
-->
``` http
GET https://graph.microsoft.com/v1.0/reports/managedDeviceEnrollmentAbandonmentDetails(skip=Integer,top=Integer,filter='parameterValue',skipToken='parameterValue')
```

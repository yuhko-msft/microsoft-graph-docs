...
-->
``` http
GET https://graph.microsoft.com/beta** Collection URI for microsoft.graph.reportRoot not found/getPrinterUsageSummary(printerId='parameterValue',periodStart=String (timestamp),periodEnd=String (timestamp))
```

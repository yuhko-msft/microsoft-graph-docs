...
-->
``` http
PATCH ** Entity URI for microsoft.graph.mobileLobApp not found
```
...
-->
``` http
PATCH https://graph.microsoft.com/beta** Entity URI for microsoft.graph.mobileLobApp not found
...
{
  "@odata.type": "#microsoft.graph.mobileLobApp",
  "id": "99296c84-6c84-9929-846c-2999846c2999",
  "displayName": "String",
  "description": "String",
  "publisher": "String",
  "largeIcon": {

...
-->
``` http
POST ** Entity URI for microsoft.graph.iosVpnProfile not found/assign
```
...
<!-- {
  "blockType": "request",
  "name": "iosvpnprofile_assign"
}
-->
``` http
POST https://graph.microsoft.com/beta** Entity URI for microsoft.graph.iosVpnProfile not found/assign

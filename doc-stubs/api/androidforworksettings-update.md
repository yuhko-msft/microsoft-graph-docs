...
Update the properties of an [androidForWorkSettings](../resources/androidforworksettings.md) object.
...
The following table shows the properties that are required when you update the [androidForWorkSettings](../resources/androidforworksettings.md).

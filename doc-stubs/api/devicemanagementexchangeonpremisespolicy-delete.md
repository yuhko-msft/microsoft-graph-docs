...
description: "Deletes a deviceManagementExchangeOnPremisesPolicy object."
...
Deletes a [deviceManagementExchangeOnPremisesPolicy](../resources/devicemanagementexchangeonpremisespolicy.md) object.
...
-->
``` http
DELETE https://graph.microsoft.com/v1.0/deviceManagement/exchangeOnPremisesPolicy
```

...
-->
``` http
GET /reports/getTeamsUserActivityTotalCounts
GET /print/reports/{reportRootId}/getTeamsUserActivityTotalCounts
```
...
<!-- {
  "blockType": "request",
  "name": "reportroot_getteamsuseractivitytotalcounts"
}
-->
``` http
GET https://graph.microsoft.com/beta/reports/getTeamsUserActivityTotalCounts(period='parameterValue')
```

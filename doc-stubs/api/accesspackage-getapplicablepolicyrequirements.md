...
-->
``` http
POST /entitlementManagement/accessPackages/{accessPackageId}/getApplicablePolicyRequirements
```
...
-->
``` http
POST https://graph.microsoft.com/v1.0/entitlementManagement/accessPackages/{accessPackageId}/getApplicablePolicyRequirements
```
...
<!-- {
  "blockType": "response",
  "truncated": true,
  "@odata.type": "Collection(Microsoft.IGAELM.EC.FrontEnd.ExternalModel.accessPackageAssignmentRequestRequirements)"
}
-->
``` http
HTTP/1.1 200 OK

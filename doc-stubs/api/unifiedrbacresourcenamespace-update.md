...
-->
``` http
PATCH /rbacApplication/resourceNamespaces/{unifiedRbacResourceNamespaceId}
PATCH /rbacApplicationMultiple/resourceNamespaces/{unifiedRbacResourceNamespaceId}
```
...
-->
``` http
PATCH https://graph.microsoft.com/beta/rbacApplication/resourceNamespaces/{unifiedRbacResourceNamespaceId}

...
-->
``` http
POST /workbooks/{workbooksId}/activities/{itemActivityOLDId}/listItem/lastModifiedByUser/$ref
```
...
-->
``` http
POST https://graph.microsoft.com/beta/workbooks/{workbooksId}/activities/{itemActivityOLDId}/listItem/lastModifiedByUser/$ref

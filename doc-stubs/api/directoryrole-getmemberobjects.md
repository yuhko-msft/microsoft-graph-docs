---
title: "directoryRole: getMemberObjects"
...
-->
``` http
POST /directoryRoles/{directoryRolesId}/getMemberObjects
```
...
-->
``` http
POST https://graph.microsoft.com/beta/directoryRoles/{directoryRolesId}/getMemberObjects

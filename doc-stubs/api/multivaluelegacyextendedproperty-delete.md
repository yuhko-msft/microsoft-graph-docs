...
-->
``` http
DELETE /note/multiValueExtendedProperties/{multiValueLegacyExtendedPropertyId}
```
...
-->
``` http
DELETE https://graph.microsoft.com/beta/note/multiValueExtendedProperties/{multiValueLegacyExtendedPropertyId}
```

...
description: "Get the noncustodialDataSource resources from the noncustodialDataSources navigation property."
...
Get the noncustodialDataSource resources from the noncustodialDataSources navigation property.
...
-->
``` http
GET https://graph.microsoft.com/beta/compliance/ediscovery/cases/{caseId}/noncustodialDataSources
```
  ...
  "value": [
    {
      ...
      "id": "070485bd-85bd-0704-bd85-0407bd850407",
      "status": "String",

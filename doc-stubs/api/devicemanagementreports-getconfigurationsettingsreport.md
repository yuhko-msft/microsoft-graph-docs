---
title: "deviceManagementReports: getConfigurationSettingsReport"
...
# deviceManagementReports: getConfigurationSettingsReport
...
<!-- {
  "blockType": "request",
  "name": "devicemanagementreports_getconfigurationsettingsreport"
}
-->
``` http
POST https://graph.microsoft.com/v1.0/deviceManagement/reports/getConfigurationSettingsReport

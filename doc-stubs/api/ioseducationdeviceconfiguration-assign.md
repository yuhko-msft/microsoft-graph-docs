---
title: "iosEducationDeviceConfiguration: assign"
...
# iosEducationDeviceConfiguration: assign
...
-->
``` http
POST ** Entity URI for microsoft.graph.iosEducationDeviceConfiguration not found/assign
```
...
<!-- {
  "blockType": "request",
  "name": "ioseducationdeviceconfiguration_assign"
}
-->
``` http
POST https://graph.microsoft.com/v1.0** Entity URI for microsoft.graph.iosEducationDeviceConfiguration not found/assign

---
title: "iosVppApp: revokeUserLicense"
...
-->
``` http
POST ** Entity URI for microsoft.management.services.api.iosVppApp not found/revokeUserLicense
```
...
<!-- {
  "blockType": "request",
  "name": "iosvppapp_revokeuserlicense"
}
-->
``` http
POST https://graph.microsoft.com/beta** Entity URI for microsoft.management.services.api.iosVppApp not found/revokeUserLicense

...
description: "Deletes a windowsDefenderApplicationControlSupplementalPolicyDeploymentSummary object."
...
-->
``` http
DELETE https://graph.microsoft.com/v1.0/deviceAppManagement/wdacSupplementalPolicies/{windowsDefenderApplicationControlSupplementalPolicyId}/deploySummary
```

---
title: "appleExpeditedCheckinConfigurationBase: assign"
...
# appleExpeditedCheckinConfigurationBase: assign
...
-->
``` http
POST ** Entity URI for microsoft.graph.appleExpeditedCheckinConfigurationBase not found/assign
```
...
<!-- {
  "blockType": "request",
  "name": "appleexpeditedcheckinconfigurationbase_assign"
}
-->
``` http
POST https://graph.microsoft.com/v1.0** Entity URI for microsoft.graph.appleExpeditedCheckinConfigurationBase not found/assign

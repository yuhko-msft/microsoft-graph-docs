...
-->
``` http
GET https://graph.microsoft.com/beta** Collection URI for microsoft.graph.teamsUserActivityDistributionUserCounts not found
```
  ...
  "value": [
    {
      ...
      "id": "25afef95-ef95-25af-95ef-af2595efaf25",
      "calls": "Integer",
      "meetings": "Integer",

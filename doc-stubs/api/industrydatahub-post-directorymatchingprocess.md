...
Create a new [directoryMatchingProcess](../resources/directorymatchingprocess.md) object.
...
-->
``` http
POST ** Collection URI for microsoft.industryData.directoryMatchingProcess not found
```
...
## Request body
In the request body, supply a JSON representation of the [directoryMatchingProcess](../resources/directorymatchingprocess.md) object.
...
If successful, this method returns a `201 Created` response code and a [directoryMatchingProcess](../resources/directorymatchingprocess.md) object in the response body.
...
-->
``` http
POST https://graph.microsoft.com/beta** Collection URI for microsoft.industryData.directoryMatchingProcess not found

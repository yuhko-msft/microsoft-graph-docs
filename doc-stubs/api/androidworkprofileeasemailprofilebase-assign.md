---
title: "androidWorkProfileEasEmailProfileBase: assign"
...
# androidWorkProfileEasEmailProfileBase: assign
...
-->
``` http
POST ** Entity URI for microsoft.graph.androidWorkProfileEasEmailProfileBase not found/assign
```
...
<!-- {
  "blockType": "request",
  "name": "androidworkprofileeasemailprofilebase_assign"
}
-->
``` http
POST https://graph.microsoft.com/v1.0** Entity URI for microsoft.graph.androidWorkProfileEasEmailProfileBase not found/assign

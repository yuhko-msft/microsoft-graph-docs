...
-->
``` http
GET /rbacApplication/roleEligibilitySchedules/filterByCurrentUser
```
...
|:---|:---|:---|
|on|roleEligibilityScheduleFilterByCurrentUserOptions|**TODO: Add Description**|
...
-->
``` http
GET https://graph.microsoft.com/beta/rbacApplication/roleEligibilitySchedules/filterByCurrentUser(on='parameterValue')
```

...
-->
``` http
POST /users/{usersId}/insights/shared/{sharedInsightId}/resource/$ref
```
...
-->
``` http
POST https://graph.microsoft.com/beta/users/{usersId}/insights/shared/{sharedInsightId}/resource/$ref

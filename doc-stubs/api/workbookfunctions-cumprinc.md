---
title: "workbookFunctions: cumPrinc"
...
-->
``` http
POST /workbooks/{workbooksId}/workbook/functions/cumPrinc
```
...
<!-- {
  "blockType": "request",
  "name": "workbookfunctions_cumprinc"
}
-->
``` http
POST https://graph.microsoft.com/beta/workbooks/{workbooksId}/workbook/functions/cumPrinc

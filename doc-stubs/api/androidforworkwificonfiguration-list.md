...
description: "Get a list of the androidForWorkWiFiConfiguration objects and their properties."
...
Get a list of the [androidForWorkWiFiConfiguration](../resources/androidforworkwificonfiguration.md) objects and their properties.
...
<!-- {
  "blockType": "request",
  "name": "list_androidforworkwificonfiguration"
}
-->
``` http
GET https://graph.microsoft.com/beta** Collection URI for microsoft.graph.androidForWorkWiFiConfiguration not found
```

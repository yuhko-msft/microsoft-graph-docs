...
-->
``` http
PATCH /hardwareOathAuthenticationMethodConfiguration/includeTargets
```
...
-->
``` http
PATCH https://graph.microsoft.com/beta/hardwareOathAuthenticationMethodConfiguration/includeTargets

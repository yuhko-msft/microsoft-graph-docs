...
Update the properties of a [groupPolicyPresentationValueText](../resources/intune-grouppolicypresentationvaluetext.md) object.
...
## Request body
In the request body, supply a JSON representation of the [groupPolicyPresentationValueText](../resources/intune-grouppolicypresentationvaluetext.md) object.

The following table shows the properties that are required when you create the [groupPolicyPresentationValueText](../resources/intune-grouppolicypresentationvaluetext.md).
...
If successful, this method returns a `200 OK` response code and an updated [groupPolicyPresentationValueText](../resources/intune-grouppolicypresentationvaluetext.md) object in the response body.
...
{
  "@odata.type": "#microsoft.graph.groupPolicyPresentationValueText",
  "id": "3d7dbc5a-bc5a-3d7d-5abc-7d3d5abc7d3d",

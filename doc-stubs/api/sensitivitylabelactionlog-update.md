---
title: "Update sensitivityLabelActionLog"
description: "Update the properties of a sensitivityLabelActionLog object."
...
# Update sensitivityLabelActionLog
Namespace: microsoft.graph

Update the properties of a [sensitivityLabelActionLog](../resources/sensitivitylabelactionlog.md) object.
...
-->
``` http
PATCH /auditLogs/sensitivityLabelActionLogs/{sensitivityLabelActionLogId}
```
...
The following table shows the properties that are required when you update the [sensitivityLabelActionLog](../resources/sensitivitylabelactionlog.md).
...
If successful, this method returns a `200 OK` response code and an updated [sensitivityLabelActionLog](../resources/sensitivitylabelactionlog.md) object in the response body.
...
<!-- {
  "blockType": "request",
  "name": "update_sensitivitylabelactionlog"
}
-->
``` http
PATCH https://graph.microsoft.com/beta/auditLogs/sensitivityLabelActionLogs/{sensitivityLabelActionLogId}

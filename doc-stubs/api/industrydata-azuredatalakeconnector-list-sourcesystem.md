...
-->
``` http
GET /industryData/dataConnectors/{dataConnectorId}/sourceSystem
```
...
-->
``` http
GET https://graph.microsoft.com/beta/industryData/dataConnectors/{dataConnectorId}/sourceSystem
```

...
-->
``` http
POST /rbacApplication/roleEligibilityRequests/{unifiedRoleEligibilityRequestId}/principal/$ref
```
...
-->
``` http
POST https://graph.microsoft.com/beta/rbacApplication/roleEligibilityRequests/{unifiedRoleEligibilityRequestId}/principal/$ref

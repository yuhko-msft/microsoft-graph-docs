...
Read the properties and relationships of a [mobileAppInstallSummary](../resources/intune-mobileappinstallsummary.md) object.
...
If successful, this method returns a `200 OK` response code and a [mobileAppInstallSummary](../resources/intune-mobileappinstallsummary.md) object in the response body.

...
The following table shows the properties that are required when you update the [androidWorkProfileCompliancePolicy](../resources/androidworkprofilecompliancepolicy.md).

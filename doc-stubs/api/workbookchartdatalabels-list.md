...
description: "Get a list of the workbookChartDataLabels objects and their properties."
...
Get a list of the [workbookChartDataLabels](../resources/workbookchartdatalabels.md) objects and their properties.
...
-->
``` http
GET https://graph.microsoft.com/beta** Collection URI for microsoft.graph.workbookChartDataLabels not found
```

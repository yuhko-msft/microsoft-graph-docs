...
description: "Get the userExperienceAnalyticsWorkFromAnywhereMetric resources from the userExperienceAnalyticsWorkFromAnywhereMetrics navigation property."
...
Get the userExperienceAnalyticsWorkFromAnywhereMetric resources from the userExperienceAnalyticsWorkFromAnywhereMetrics navigation property.
...
<!-- {
  "blockType": "response",
  "truncated": true,
  "@odata.type": "Collection(microsoft.management.services.api.userExperienceAnalyticsWorkFromAnywhereMetric)"
}
-->
``` http
HTTP/1.1 200 OK

...
description: "Get a list of the deviceManagementScript objects and their properties."
...
Get a list of the [deviceManagementScript](../resources/devicemanagementscript.md) objects and their properties.
...
<!-- {
  "blockType": "response",
  "truncated": true,
  "@odata.type": "Collection(microsoft.management.services.api.deviceManagementScript)"
}
-->
``` http
HTTP/1.1 200 OK

...
The following table shows the properties that are required when you update the [macOSOfficeSuiteApp](../resources/macosofficesuiteapp.md).
...
-->
``` http
PATCH https://graph.microsoft.com/beta** Entity URI for microsoft.graph.macOSOfficeSuiteApp not found

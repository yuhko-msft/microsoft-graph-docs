...
-->
``` http
PATCH ** Entity URI for microsoft.management.services.api.macOSOfficeSuiteApp not found
```
...
-->
``` http
PATCH https://graph.microsoft.com/beta** Entity URI for microsoft.management.services.api.macOSOfficeSuiteApp not found

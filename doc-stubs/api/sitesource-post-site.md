...
-->
``` http
POST ** Collection URI for microsoft.compliance.ediscovery.contract.site not found/$ref
```
...
-->
``` http
POST https://graph.microsoft.com/beta** Collection URI for microsoft.compliance.ediscovery.contract.site not found/$ref

...
Update the properties of a listItem object.
...
-->
``` http
PATCH /drives/{drivesId}/activities/{itemActivityOLDId}/driveItem/listItem
```
...
-->
``` http
PATCH https://graph.microsoft.com/beta/drives/{drivesId}/activities/{itemActivityOLDId}/driveItem/listItem
...
{
  "@odata.type": "#microsoft.graph.listItem",
  "id": "be7bacad-acad-be7b-adac-7bbeadac7bbe",
  "createdBy": {
    "@odata.type": "microsoft.graph.identitySet"
  },

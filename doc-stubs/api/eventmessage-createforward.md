---
title: "eventMessage: createForward"
...
-->
``` http
POST ** Entity URI for microsoft.graph.eventMessage not found/createForward
```
...
-->
``` http
POST https://graph.microsoft.com/beta** Entity URI for microsoft.graph.eventMessage not found/createForward

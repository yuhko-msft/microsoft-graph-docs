---
title: "windowsAutopilotDeploymentProfile: hasPayloadLinks"
...
# windowsAutopilotDeploymentProfile: hasPayloadLinks
...
<!-- {
  "blockType": "request",
  "name": "windowsautopilotdeploymentprofile_haspayloadlinks"
}
-->
``` http
POST https://graph.microsoft.com/v1.0/deviceManagement/windowsAutopilotDeploymentProfiles/hasPayloadLinks

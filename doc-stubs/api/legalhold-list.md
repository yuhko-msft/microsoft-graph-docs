...
description: "Get a list of the legalhold objects and their properties."
...
<!-- {
  "blockType": "response",
  "truncated": true,
  "@odata.type": "Collection(microsoft.compliance.ediscovery.contract.legalhold)"
}
-->
``` http
HTTP/1.1 200 OK
...

{
  "value": [
    {
      "@odata.type": "#microsoft.compliance.ediscovery.contract.legalhold",
      "id": "9a4e28ab-28ab-9a4e-ab28-4e9aab284e9a",
      "description": "String",
      "createdBy": {

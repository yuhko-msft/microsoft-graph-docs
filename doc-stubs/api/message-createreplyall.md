...
POST /users/{usersId}/mailFolders/{mailFolderId}/messages/{messageId}/createReplyAll
```
...
-->
``` http
POST https://graph.microsoft.com/beta/users/{usersId}/messages/{messageId}/createReplyAll

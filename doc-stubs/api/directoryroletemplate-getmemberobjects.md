---
title: "directoryRoleTemplate: getMemberObjects"
...
-->
``` http
POST /directoryRoleTemplates/{directoryRoleTemplatesId}/getMemberObjects
```
...
-->
``` http
POST https://graph.microsoft.com/beta/directoryRoleTemplates/{directoryRoleTemplatesId}/getMemberObjects

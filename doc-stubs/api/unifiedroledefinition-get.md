...
``` http
GET /unifiedRoleDefinition
GET /unifiedRoleAssignment/roleDefinition
GET /unifiedRoleDefinition/inheritsPermissionsFrom/{unifiedRoleDefinitionId}
```
...
-->
``` http
GET https://graph.microsoft.com/beta/unifiedRoleDefinition
```

---
title: "Create plannerDelta"
description: "Create a new plannerDelta object."
...
Create a new [plannerDelta](../resources/plannerdelta.md) object.
...
-->
``` http
POST https://graph.microsoft.com/v1.0/me/planner/all

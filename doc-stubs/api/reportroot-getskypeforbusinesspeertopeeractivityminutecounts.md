...
GET /print/reports/getSkypeForBusinessPeerToPeerActivityMinuteCounts
```
...
-->
``` http
GET https://graph.microsoft.com/v1.0/reports/getSkypeForBusinessPeerToPeerActivityMinuteCounts(period='parameterValue')
```

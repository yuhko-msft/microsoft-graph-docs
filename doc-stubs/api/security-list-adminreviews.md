...
description: "Get the adminReview resources from the adminReviews navigation property."
...
Get the adminReview resources from the adminReviews navigation property.
...
-->
``` http
GET https://graph.microsoft.com/beta/security/adminReviews
```

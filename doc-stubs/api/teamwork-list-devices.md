---
title: "List devices"
description: "Get the teamworkDevice resources from the devices navigation property."
...
Get the teamworkDevice resources from the devices navigation property.
...
<!-- {
  "blockType": "response",
  "truncated": true,
  "@odata.type": "Collection(Microsoft.Teams.GraphSvc.teamworkDevice)"
}
-->
``` http
HTTP/1.1 200 OK

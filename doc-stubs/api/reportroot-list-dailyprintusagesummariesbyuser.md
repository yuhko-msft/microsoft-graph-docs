...
description: "Get the printUsageByUser resources from the dailyPrintUsageSummariesByUser navigation property."
...
Get the printUsageByUser resources from the dailyPrintUsageSummariesByUser navigation property.
...
-->
``` http
GET https://graph.microsoft.com/v1.0/print/reports/dailyPrintUsageSummariesByUser
```

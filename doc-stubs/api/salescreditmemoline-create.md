...
Create a new [salesCreditMemoLine](../resources/salescreditmemoline.md) object.
...
-->
``` http
POST https://graph.microsoft.com/v1.0/financials/companies/{companyId}/salesCreditMemoLines

...
Read the properties and relationships of an [iosGeneralDeviceConfiguration](../resources/intune-iosgeneraldeviceconfiguration.md) object.
...
If successful, this method returns a `200 OK` response code and an [iosGeneralDeviceConfiguration](../resources/intune-iosgeneraldeviceconfiguration.md) object in the response body.

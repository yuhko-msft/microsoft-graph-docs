---
title: "macManagedAppProtection: hasPayloadLinks"
...
# macManagedAppProtection: hasPayloadLinks
...
If successful, this action returns a `200 OK` response code and a [hasPayloadLinkResultItem](../resources/intune-haspayloadlinkresultitem.md) collection in the response body.

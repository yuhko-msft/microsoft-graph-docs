...
The following table shows the properties that are required when you update the [fileAssessmentRequest](../resources/fileassessmentrequest.md).
...
-->
``` http
PATCH https://graph.microsoft.com/beta** Entity URI for microsoft.graph.fileAssessmentRequest not found

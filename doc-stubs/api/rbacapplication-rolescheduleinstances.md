...
GET /roleManagement/entitlementManagement/roleScheduleInstances
```
...
-->
``` http
GET https://graph.microsoft.com/v1.0/roleManagement/directory/roleScheduleInstances(directoryScopeId='parameterValue',appScopeId='parameterValue',principalId='parameterValue',roleDefinitionId='parameterValue')
```

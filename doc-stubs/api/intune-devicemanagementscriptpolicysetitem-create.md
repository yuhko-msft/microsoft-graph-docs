...
Create a new [deviceManagementScriptPolicySetItem](../resources/intune-devicemanagementscriptpolicysetitem.md) object.
...
If successful, this method returns a `201 Created` response code and a [deviceManagementScriptPolicySetItem](../resources/intune-devicemanagementscriptpolicysetitem.md) object in the response body.

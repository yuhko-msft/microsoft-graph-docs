...
-->
``` http
GET /users/{usersId}/mailFolders/{mailFolderId}/messages/{messageId}/multiValueExtendedProperties
```
...
-->
``` http
GET https://graph.microsoft.com/beta/users/{usersId}/mailFolders/{mailFolderId}/messages/{messageId}/multiValueExtendedProperties
```

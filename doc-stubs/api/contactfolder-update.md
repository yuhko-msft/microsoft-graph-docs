...
PATCH /users/{usersId}/contactFolders/{contactFolderId}/childFolders/{contactFolderId}
```
...
-->
``` http
PATCH https://graph.microsoft.com/beta/users/{usersId}/contactFolders/{contactFolderId}

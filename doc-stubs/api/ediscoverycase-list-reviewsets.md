...
-->
``` http
GET /compliance/ediscovery/cases/{ediscoveryCaseId}/reviewSets
```
...
-->
``` http
GET https://graph.microsoft.com/beta/compliance/ediscovery/cases/{ediscoveryCaseId}/reviewSets
```
  ...
  "value": [
    {
      ...
      "id": "04ece0d2-e0d2-04ec-d2e0-ec04d2e0ec04",
      "createdBy": {

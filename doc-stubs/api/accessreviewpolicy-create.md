...
Create a new [accessReviewPolicy](../resources/accessreviewpolicy.md) object.
...
-->
``` http
POST ** Collection URI for microsoft.graph.accessReviewPolicy not found
```
...
-->
``` http
POST https://graph.microsoft.com/beta** Collection URI for microsoft.graph.accessReviewPolicy not found

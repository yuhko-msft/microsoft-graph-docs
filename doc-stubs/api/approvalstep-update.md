...
-->
``` http
PATCH /me/approvals/{approvalId}/steps/{approvalStepId}
PATCH /users/{usersId}/approvals/{approvalId}/steps/{approvalStepId}
```
...
-->
``` http
PATCH https://graph.microsoft.com/beta/me/approvals/{approvalId}/steps/{approvalStepId}

...
-->
``` http
PATCH /me/appConsentRequestsForApproval/{appConsentRequestId}/userConsentRequests/{userConsentRequestId}/approval/steps/{approvalStepId}
PATCH /users/{usersId}/appConsentRequestsForApproval/{appConsentRequestId}/userConsentRequests/{userConsentRequestId}/approval/steps/{approvalStepId}
```
...
-->
``` http
PATCH https://graph.microsoft.com/beta/me/appConsentRequestsForApproval/{appConsentRequestId}/userConsentRequests/{userConsentRequestId}/approval/steps/{approvalStepId}
...
{
  "@odata.type": "#microsoft.graph.approvalStep",
  "id": "636f42db-42db-636f-db42-6f63db426f63",
  "assignedToMe": "Boolean",
  "displayName": "String",
  "justification": "String",
  "reviewedBy": {

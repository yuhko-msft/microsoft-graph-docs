...
-->
``` http
GET /rbacApplication/roleAssignmentScheduleInstances/filterByCurrentUser
```
...
-->
``` http
GET https://graph.microsoft.com/beta/rbacApplication/roleAssignmentScheduleInstances/filterByCurrentUser(on='parameterValue')
```

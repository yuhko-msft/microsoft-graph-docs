...
-->
``` http
GET /entitlementManagement/accessPackageAssignmentResourceRoles
```
...
-->
``` http
GET https://graph.microsoft.com/beta/entitlementManagement/accessPackageAssignmentResourceRoles
```

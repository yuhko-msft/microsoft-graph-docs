...
-->
``` http
PATCH /deviceManagement/cloudManagedDesktop/provisioningPolicies
```
...
-->
``` http
PATCH https://graph.microsoft.com/beta/deviceManagement/cloudManagedDesktop/provisioningPolicies

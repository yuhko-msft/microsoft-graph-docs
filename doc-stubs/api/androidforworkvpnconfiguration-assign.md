---
title: "androidForWorkVpnConfiguration: assign"
...
# androidForWorkVpnConfiguration: assign
...
-->
``` http
POST ** Entity URI for microsoft.graph.androidForWorkVpnConfiguration not found/assign
```
...
<!-- {
  "blockType": "request",
  "name": "androidforworkvpnconfiguration_assign"
}
-->
``` http
POST https://graph.microsoft.com/v1.0** Entity URI for microsoft.graph.androidForWorkVpnConfiguration not found/assign

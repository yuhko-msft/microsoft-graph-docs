...
-->
``` http
PATCH /unifiedRoleScheduleBase/appScope
PATCH /unifiedRoleScheduleInstanceBase/appScope
```
...
-->
``` http
PATCH https://graph.microsoft.com/beta/unifiedRoleScheduleBase/appScope

---
title: "List itemPhones"
description: "Get a list of the itemPhone objects and their properties."
...
Get a list of the [itemPhone](../resources/itemphone.md) objects and their properties.
...
-->
``` http
GET https://graph.microsoft.com/v1.0/me/profile/phones
```

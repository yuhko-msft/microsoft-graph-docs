...
Create a new [relation](../resources/termstore-relation.md) object.
...
-->
``` http
POST /sites/{sitesId}/termStore/groups/{groupId}/sets/{setId}/relations
...
-->
``` http
POST https://graph.microsoft.com/v1.0/sites/{sitesId}/termStore/groups/{groupId}/sets/{setId}/relations

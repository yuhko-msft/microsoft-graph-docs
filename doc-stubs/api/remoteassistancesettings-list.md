...
description: "Get a list of the remoteAssistanceSettings objects and their properties."
...
Get a list of the [remoteAssistanceSettings](../resources/remoteassistancesettings.md) objects and their properties.
...
-->
``` http
GET ** Collection URI for microsoft.graph.remoteAssistanceSettings not found
```
...
-->
``` http
GET https://graph.microsoft.com/beta** Collection URI for microsoft.graph.remoteAssistanceSettings not found
```

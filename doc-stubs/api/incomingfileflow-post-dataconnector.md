...
-->
``` http
POST /industryData/incomingFlows/{incomingFlowId}/runs/{runId}/process/dataConnector/$ref
```
...
-->
``` http
POST https://graph.microsoft.com/beta/industryData/incomingFlows/{incomingFlowId}/runs/{runId}/process/dataConnector/$ref

...
PATCH /directory/administrativeUnits/{administrativeUnitId}
```
...
-->
``` http
PATCH https://graph.microsoft.com/v1.0/administrativeUnit
...
{
  "@odata.type": "#microsoft.graph.administrativeUnit",
  "id": "2f98ccab-ccab-2f98-abcc-982fabcc982f",
  "deletedDateTime": "String (timestamp)",
  "displayName": "String",
  "description": "String",
  "visibility": "String"

---
title: "List linkedResource_v2"
description: "Get a list of the linkedResource_v2 objects and their properties."
...
# List linkedResource_v2
Namespace: microsoft.graph

[!INCLUDE [beta-disclaimer](../../includes/beta-disclaimer.md)]

Get a list of the [linkedResource_v2](../resources/linkedresource_v2.md) objects and their properties.
...
-->
``` http
GET https://graph.microsoft.com/beta/baseTask/linkedResources
```

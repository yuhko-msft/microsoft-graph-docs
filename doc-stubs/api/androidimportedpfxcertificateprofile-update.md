...
description: "Update the properties of an androidImportedPFXCertificateProfile object."
...
Update the properties of an [androidImportedPFXCertificateProfile](../resources/androidimportedpfxcertificateprofile.md) object.
...
The following table shows the properties that are required when you update the [androidImportedPFXCertificateProfile](../resources/androidimportedpfxcertificateprofile.md).
...
-->
``` http
PATCH https://graph.microsoft.com/v1.0** Entity URI for microsoft.graph.androidImportedPFXCertificateProfile not found

...
description: "Get a list of the bookingCurrency objects and their properties."
...
Get a list of the [bookingCurrency](../resources/bookingcurrency.md) objects and their properties.
...
<!-- {
  "blockType": "request",
  "name": "list_bookingcurrency"
}
-->
``` http
GET https://graph.microsoft.com/v1.0/bookingCurrencies
```

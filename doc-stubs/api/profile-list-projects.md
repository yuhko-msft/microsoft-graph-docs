---
title: "List projects"
description: "Get the projectParticipation resources from the projects navigation property."
...
Get the projectParticipation resources from the projects navigation property.
...
-->
``` http
GET https://graph.microsoft.com/v1.0/users/{usersId}/profile/projects
```

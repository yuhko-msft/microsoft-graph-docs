---
title: "List userExperienceAnalyticsMetricHistory"
description: "Get the userExperienceAnalyticsMetricHistory resources from the userExperienceAnalyticsMetricHistory navigation property."
...
# List userExperienceAnalyticsMetricHistory
Namespace: microsoft.graph

[!INCLUDE [beta-disclaimer](../../includes/beta-disclaimer.md)]

Get the userExperienceAnalyticsMetricHistory resources from the userExperienceAnalyticsMetricHistory navigation property.
...
<!-- {
  "blockType": "response",
  "truncated": true,
  "@odata.type": "Collection(microsoft.management.services.api.userExperienceAnalyticsMetricHistory)"
}
-->
``` http
HTTP/1.1 200 OK

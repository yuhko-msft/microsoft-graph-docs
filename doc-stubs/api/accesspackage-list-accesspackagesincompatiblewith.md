...
-->
``` http
GET /accessPackages/{accessPackagesId}/accessPackagesIncompatibleWith
```
...
-->
``` http
GET https://graph.microsoft.com/beta/accessPackages/{accessPackagesId}/accessPackagesIncompatibleWith
```

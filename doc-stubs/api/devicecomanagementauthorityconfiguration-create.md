...
-->
``` http
POST https://graph.microsoft.com/beta** Collection URI for microsoft.graph.deviceComanagementAuthorityConfiguration not found
...
{
  "@odata.type": "#microsoft.graph.deviceComanagementAuthorityConfiguration",
  "id": "08a78ac2-8ac2-08a7-c28a-a708c28aa708",

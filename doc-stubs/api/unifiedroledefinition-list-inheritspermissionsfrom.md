...
-->
``` http
GET /rbacApplication/roleDefinitions/{unifiedRoleDefinitionId}/inheritsPermissionsFrom
```
...
-->
``` http
GET https://graph.microsoft.com/beta/rbacApplication/roleDefinitions/{unifiedRoleDefinitionId}/inheritsPermissionsFrom
```

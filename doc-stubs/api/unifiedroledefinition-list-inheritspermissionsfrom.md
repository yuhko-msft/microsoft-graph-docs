...
-->
``` http
GET /rbacApplication/roleAssignments/{unifiedRoleAssignmentId}/roleDefinition/inheritsPermissionsFrom
```
...
-->
``` http
GET https://graph.microsoft.com/v1.0/rbacApplication/roleAssignments/{unifiedRoleAssignmentId}/roleDefinition/inheritsPermissionsFrom
```

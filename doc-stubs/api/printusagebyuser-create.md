...
-->
``` http
POST /print/reports/dailyPrintUsageByUser
POST /print/reports/monthlyPrintUsageByUser
POST /print/reports/dailyPrintUsageSummariesByUser
...
-->
``` http
POST https://graph.microsoft.com/v1.0/print/reports/dailyPrintUsageByUser

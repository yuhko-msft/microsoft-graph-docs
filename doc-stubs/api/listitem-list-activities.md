...
-->
``` http
GET /drives/{drivesId}/activities/{itemActivityId}/driveItem/listItem/activities
```
...
-->
``` http
GET https://graph.microsoft.com/beta/drives/{drivesId}/activities/{itemActivityId}/driveItem/listItem/activities
```

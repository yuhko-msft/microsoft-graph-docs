...
-->
``` http
GET /workbooks/{workbooksId}/activities/{itemActivityOLDId}/listItem/activities
```
...
-->
``` http
GET https://graph.microsoft.com/beta/workbooks/{workbooksId}/activities/{itemActivityOLDId}/listItem/activities
```

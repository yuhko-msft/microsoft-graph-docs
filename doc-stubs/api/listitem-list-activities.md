...
-->
``` http
GET /drives/{drivesId}/activities/{itemActivityOLDId}/listItem/activities
```
...
-->
``` http
GET https://graph.microsoft.com/v1.0/drives/{drivesId}/activities/{itemActivityOLDId}/listItem/activities
```

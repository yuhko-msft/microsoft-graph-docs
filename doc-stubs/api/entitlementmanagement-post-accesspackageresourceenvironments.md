...
-->
``` http
POST /entitlementManagement/accessPackageResourceEnvironments
```
...
-->
``` http
POST https://graph.microsoft.com/beta/entitlementManagement/accessPackageResourceEnvironments

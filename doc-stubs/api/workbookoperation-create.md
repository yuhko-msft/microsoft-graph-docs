...
-->
``` http
POST /drive/following/{driveItemId}/workbook/operations
POST /drives/{drivesId}/following/{driveItemId}/workbook/operations
```
...
-->
``` http
POST https://graph.microsoft.com/v1.0/drive/following/{driveItemId}/workbook/operations

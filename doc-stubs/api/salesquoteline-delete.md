...
description: "Deletes a salesQuoteLine object."
...
Deletes a [salesQuoteLine](../resources/salesquoteline.md) object.
...
-->
``` http
DELETE https://graph.microsoft.com/v1.0/financials/companies/{companyId}/salesQuoteLines/{salesQuoteLineId}
```

...
description: "Get a list of the deviceCompliancePolicyAssignment objects and their properties."
...
Get a list of the [deviceCompliancePolicyAssignment](../resources/devicecompliancepolicyassignment.md) objects and their properties.
...
<!-- {
  "blockType": "request",
  "name": "list_devicecompliancepolicyassignment"
}
-->
``` http
  ...
  "value": [
    {
      ...
      "id": "02d07d5b-7d5b-02d0-5b7d-d0025b7dd002",
      "source": "String",
      "sourceId": "String",
      "target": {

...
-->
``` http
GET /unifiedRoleAssignmentScheduleInstance/activatedUsing/directoryScope
```
...
-->
``` http
GET https://graph.microsoft.com/beta/unifiedRoleAssignmentScheduleInstance/activatedUsing/directoryScope
```

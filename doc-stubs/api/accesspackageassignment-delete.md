...
-->
``` http
DELETE /entitlementManagement/assignments/{accessPackageAssignmentId}
```
...
-->
``` http
DELETE https://graph.microsoft.com/v1.0/entitlementManagement/assignments/{accessPackageAssignmentId}
```

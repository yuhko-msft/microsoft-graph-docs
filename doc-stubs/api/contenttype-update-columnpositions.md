---
title: "Update columnPositions"
description: "Update the properties of a columnPositions object."
...
# Update columnPositions
Namespace: microsoft.graph

Update the properties of a columnPositions object.
...
-->
``` http
PATCH /drives/{drivesId}/list/contentTypes/{contentTypeId}/columnPositions
```
...
<!-- {
  "blockType": "request",
  "name": "update_columnpositions"
}
-->
``` http
PATCH https://graph.microsoft.com/beta/drives/{drivesId}/list/contentTypes/{contentTypeId}/columnPositions
...
{
  "@odata.type": "#microsoft.graph.columnDefinition",
  "id": "39a1ef7f-ef7f-39a1-7fef-a1397fefa139",
  "boolean": {
    "@odata.type": "microsoft.graph.booleanColumn"
  },
  "calculated": {

---
title: "workbookFunctions: bitxor"
...
-->
``` http
POST /workbooks/{workbooksId}/workbook/functions/bitxor
```
...
<!-- {
  "blockType": "request",
  "name": "workbookfunctions_bitxor"
}
-->
``` http
POST https://graph.microsoft.com/beta/workbooks/{workbooksId}/workbook/functions/bitxor

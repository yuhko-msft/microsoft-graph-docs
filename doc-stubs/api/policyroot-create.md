...
-->
``` http
POST ** Collection URI for microsoft.authMethodPolicy.policyRoot not found
```
...
-->
``` http
POST https://graph.microsoft.com/beta** Collection URI for microsoft.authMethodPolicy.policyRoot not found

---
title: "androidForWorkWiFiConfiguration: assign"
...
# androidForWorkWiFiConfiguration: assign
...
-->
``` http
POST ** Entity URI for microsoft.graph.androidForWorkWiFiConfiguration not found/assign
```
...
<!-- {
  "blockType": "request",
  "name": "androidforworkwificonfiguration_assign"
}
-->
``` http
POST https://graph.microsoft.com/v1.0** Entity URI for microsoft.graph.androidForWorkWiFiConfiguration not found/assign

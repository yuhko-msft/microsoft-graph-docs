...
-->
``` http
GET /policyRoot/roleManagementPolicies/{unifiedRoleManagementPolicyId}/rules
GET /policyRoot/roleManagementPolicies/{unifiedRoleManagementPolicyId}/effectiveRules
```
...
-->
``` http
GET https://graph.microsoft.com/beta/policyRoot/roleManagementPolicies/{unifiedRoleManagementPolicyId}/rules
```
...
<!-- {
  "blockType": "response",
  "truncated": true,
  "@odata.type": "Collection(Microsoft.Identity.Governance.Common.Data.ExternalModels.V1.unifiedRoleManagementPolicyRule)"
}
-->
``` http
HTTP/1.1 200 OK

...
-->
``` http
GET ** Collection URI for microsoft.graph.caseIndexOperation not found
```
...
-->
``` http
GET https://graph.microsoft.com/beta** Collection URI for microsoft.graph.caseIndexOperation not found
```
...
<!-- {
  "blockType": "response",
  "truncated": true,
  "@odata.type": "Collection(microsoft.graph.caseIndexOperation)"
}
-->
``` http
HTTP/1.1 200 OK

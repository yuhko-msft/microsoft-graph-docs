...
PATCH /identityContainer/conditionalAccess
```
...
The following table shows the properties that are required when you update the [conditionalAccessRoot](../resources/conditionalaccessroot.md).
...
-->
``` http
PATCH https://graph.microsoft.com/v1.0/conditionalAccess

...
-->
``` http
POST /users/{usersId}/mailFolders/{mailFolderId}/messages/{messageId}/singleValueExtendedProperties
```
...
-->
``` http
POST https://graph.microsoft.com/beta/users/{usersId}/mailFolders/{mailFolderId}/messages/{messageId}/singleValueExtendedProperties

...
description: "Deletes a jobResponseBase object."
...
Deletes a [jobResponseBase](../resources/jobresponsebase.md) object.
...
-->
``` http
DELETE https://graph.microsoft.com/beta/dataClassification/jobs/{jobResponseBaseId}
```

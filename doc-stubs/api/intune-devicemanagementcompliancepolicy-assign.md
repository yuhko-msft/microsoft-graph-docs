---
title: "deviceManagementCompliancePolicy: assign"
...
# deviceManagementCompliancePolicy: assign
...
If successful, this action returns a `200 OK` response code and a [deviceManagementConfigurationPolicyAssignment](../resources/intune-devicemanagementconfigurationpolicyassignment.md) collection in the response body.
...
<!-- {
  "blockType": "request",
  "name": "devicemanagementcompliancepolicy_assign"
}
-->
``` http

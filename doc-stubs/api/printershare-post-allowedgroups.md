---
title: "Add group"
description: "Add allowedGroups by posting to the allowedGroups collection."
...
Add allowedGroups by posting to the allowedGroups collection.
...
-->
``` http
POST /print/printers/{printerId}/share/allowedGroups/$ref
```
...
-->
``` http
POST https://graph.microsoft.com/beta/print/printers/{printerId}/share/allowedGroups/$ref

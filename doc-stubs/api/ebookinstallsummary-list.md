...
description: "Get a list of the eBookInstallSummary objects and their properties."
...
Get a list of the [eBookInstallSummary](../resources/ebookinstallsummary.md) objects and their properties.
...
<!-- {
  "blockType": "request",
  "name": "list_ebookinstallsummary"
}
-->
``` http
GET https://graph.microsoft.com/beta** Collection URI for microsoft.graph.eBookInstallSummary not found
```

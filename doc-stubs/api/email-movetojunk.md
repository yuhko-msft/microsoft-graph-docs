...
-->
``` http
POST /security/emailEvent/emails/{emailId}/moveToJunk
```
...
<!-- {
  "blockType": "request",
  "name": "email_movetojunk"
}
-->
``` http
POST https://graph.microsoft.com/beta/security/emailEvent/emails/{emailId}/moveToJunk

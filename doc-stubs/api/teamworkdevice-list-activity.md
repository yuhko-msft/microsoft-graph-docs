---
title: "List teamworkDeviceActivity"
description: "Get the teamworkDeviceActivity resources from the activity navigation property."
...
# List teamworkDeviceActivity
Namespace: microsoft.graph

[!INCLUDE [beta-disclaimer](../../includes/beta-disclaimer.md)]

Get the teamworkDeviceActivity resources from the activity navigation property.
...
<!-- {
  "blockType": "response",
  "truncated": true,
  "@odata.type": "Collection(Microsoft.Teams.GraphSvc.teamworkDeviceActivity)"
}
-->
``` http
HTTP/1.1 200 OK

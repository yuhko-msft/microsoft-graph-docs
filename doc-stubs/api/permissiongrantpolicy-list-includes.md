---
title: "List includes"
description: "Get the permissionGrantConditionSets from the includes navigation property."
...
Get the permissionGrantConditionSets from the includes navigation property.
...
-->
``` http
GET https://graph.microsoft.com/beta/policies/permissionGrantPolicies/{permissionGrantPolicyId}/includes
```

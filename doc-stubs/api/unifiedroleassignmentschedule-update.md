...
-->
``` http
PATCH /unifiedRoleAssignmentSchedule
PATCH /rbacApplication/roleAssignmentSchedules/{unifiedRoleAssignmentScheduleId}
```
...
-->
``` http
PATCH https://graph.microsoft.com/beta/unifiedRoleAssignmentSchedule

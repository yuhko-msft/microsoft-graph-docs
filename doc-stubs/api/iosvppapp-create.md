...
-->
``` http
POST ** Collection URI for microsoft.management.services.api.iosVppApp not found
```
...
If successful, this method returns a `201 Created` response code and an [iosVppApp](../resources/iosvppapp.md) object in the response body.
...
-->
``` http
POST https://graph.microsoft.com/beta** Collection URI for microsoft.management.services.api.iosVppApp not found

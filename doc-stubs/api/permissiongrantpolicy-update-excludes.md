...
-->
``` http
PATCH /policies/permissionGrantPolicies/{permissionGrantPolicyId}/excludes
```
...
-->
``` http
PATCH https://graph.microsoft.com/beta/policies/permissionGrantPolicies/{permissionGrantPolicyId}/excludes

...
-->
``` http
POST /users/{usersId}/contactFolders/{contactFolderId}/contacts/{contactId}/extensions
```
...
-->
``` http
POST https://graph.microsoft.com/beta/users/{usersId}/contactFolders/{contactFolderId}/contacts/{contactId}/extensions

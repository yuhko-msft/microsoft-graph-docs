...
description: "Update the properties of an informationProtectionPolicy object."
...
Update the properties of an [informationProtectionPolicy](../resources/informationprotectionpolicy.md) object.
...
The following table shows the properties that are required when you update the [informationProtectionPolicy](../resources/informationprotectionpolicy.md).
...
-->
``` http
PATCH https://graph.microsoft.com/beta/me/informationProtection/policy

...
description: "Get a list of the deviceManagementScriptGroupAssignment objects and their properties."
...
Get a list of the [deviceManagementScriptGroupAssignment](../resources/devicemanagementscriptgroupassignment.md) objects and their properties.
...
-->
``` http
GET https://graph.microsoft.com/v1.0/deviceManagement/deviceShellScripts/{deviceShellScriptId}/groupAssignments
```

---
title: "Update externalColumns"
description: "Update the properties of an externalColumns object."
...
# Update externalColumns
Namespace: microsoft.graph

Update the properties of an externalColumns object.
...
-->
``` http
PATCH /sites/{sitesId}/externalColumns
```
...
<!-- {
  "blockType": "request",
  "name": "update_externalcolumns"
}
-->
``` http
PATCH https://graph.microsoft.com/beta/sites/{sitesId}/externalColumns

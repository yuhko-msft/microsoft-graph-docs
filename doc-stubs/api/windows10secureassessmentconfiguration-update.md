...
The following table shows the properties that are required when you update the [windows10SecureAssessmentConfiguration](../resources/windows10secureassessmentconfiguration.md).
...
{
  "@odata.type": "#microsoft.graph.windows10SecureAssessmentConfiguration",
  "id": "96c84ab8-4ab8-96c8-b84a-c896b84ac896",

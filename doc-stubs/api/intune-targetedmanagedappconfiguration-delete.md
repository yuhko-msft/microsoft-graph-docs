...
description: "Deletes a targetedManagedAppConfiguration object."
...
Deletes a [targetedManagedAppConfiguration](../resources/intune-targetedmanagedappconfiguration.md) object.
...
<!-- {
  "blockType": "request",
  "name": "delete_targetedmanagedappconfiguration"
}
-->
``` http

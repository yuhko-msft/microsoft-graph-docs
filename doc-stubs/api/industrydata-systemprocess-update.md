---
title: "Update systemProcess"
description: "Update the properties of a systemProcess object."
...
Update the properties of a [systemProcess](../resources/industrydata-systemprocess.md) object.
...
-->
``` http
PATCH ** Entity URI for microsoft.graph.industryData.systemProcess not found
```
...
If successful, this method returns a `200 OK` response code and an updated [systemProcess](../resources/industrydata-systemprocess.md) object in the response body.
...
<!-- {
  "blockType": "request",
  "name": "update_systemprocess"
}
-->
``` http
PATCH https://graph.microsoft.com/beta** Entity URI for microsoft.graph.industryData.systemProcess not found

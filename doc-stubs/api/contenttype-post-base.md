...
description: "Add base by posting to the base collection."
...
Add base by posting to the base collection.
...
-->
``` http
POST /drives/{drivesId}/list/contentTypes/{contentTypeId}/base/$ref
```
...
-->
``` http
POST https://graph.microsoft.com/beta/drives/{drivesId}/list/contentTypes/{contentTypeId}/base/$ref
...
{
  "@odata.type": "#microsoft.graph.contentType",
  "id": "a45054e0-54e0-a450-e054-50a4e05450a4",
  "associatedHubsUrls": [
    "String"
  ],
  "description": "String",

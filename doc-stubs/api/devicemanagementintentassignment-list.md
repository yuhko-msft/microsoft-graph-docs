...
description: "Get a list of the deviceManagementIntentAssignment objects and their properties."
...
Get a list of the [deviceManagementIntentAssignment](../resources/devicemanagementintentassignment.md) objects and their properties.
...
<!-- {
  "blockType": "request",
  "name": "list_devicemanagementintentassignment"
}
-->
``` http
GET https://graph.microsoft.com/v1.0/deviceManagement/intents/{deviceManagementIntentId}/assignments
```

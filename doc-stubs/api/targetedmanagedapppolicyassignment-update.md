...
-->
``` http
PATCH /targetedManagedAppProtection/assignments/{targetedManagedAppPolicyAssignmentId}
PATCH /windowsInformationProtection/assignments/{targetedManagedAppPolicyAssignmentId}
```
...
The following table shows the properties that are required when you update the [targetedManagedAppPolicyAssignment](../resources/targetedmanagedapppolicyassignment.md).
...
-->
``` http
PATCH https://graph.microsoft.com/v1.0/targetedManagedAppProtection/assignments/{targetedManagedAppPolicyAssignmentId}

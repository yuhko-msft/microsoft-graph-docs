...
description: "Deletes a deviceComplianceDeviceStatus object."
...
Deletes a [deviceComplianceDeviceStatus](../resources/intune-devicecompliancedevicestatus.md) object.
...
<!-- {
  "blockType": "request",
  "name": "delete_devicecompliancedevicestatus"
}
-->
``` http

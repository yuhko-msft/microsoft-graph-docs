...
-->
``` http
POST ** Entity URI for microsoft.graph.iosWifiProfile not found/assign
```
...
<!-- {
  "blockType": "request",
  "name": "ioswifiprofile_assign"
}
-->
``` http
POST https://graph.microsoft.com/beta** Entity URI for microsoft.graph.iosWifiProfile not found/assign

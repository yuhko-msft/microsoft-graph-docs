---
title: "Get delegatedPermissionClassifications"
...
-->
``` http
GET https://graph.microsoft.com/v1.0/servicePrincipals/{servicePrincipalsId}/delegatedPermissionClassifications
```
...
Content-Type: application/json
{
  "value": {
    "@odata.type": "#microsoft.graph.delegatedPermissionClassification",
    "id": "857d0bfb-0bfb-857d-fb0b-7d85fb0b7d85",
    "permissionId": "String",

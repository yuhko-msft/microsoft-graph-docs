...
-->
``` http
POST /unifiedRoleScheduleBase/principal/getMemberGroups
POST /groups/{groupsId}/createdOnBehalfOf/getMemberGroups
POST /directoryObjects/{directoryObjectsId}/getMemberGroups
POST /unifiedRoleScheduleBase/directoryScope/getMemberGroups
POST /stsPolicy/appliesTo/{directoryObjectId}/getMemberGroups
POST /unifiedRoleScheduleInstanceBase/principal/getMemberGroups
POST /directory/deletedItems/{directoryObjectId}/getMemberGroups
POST /unifiedRoleScheduleInstanceBase/directoryScope/getMemberGroups
```
...
-->
``` http
POST https://graph.microsoft.com/beta/unifiedRoleScheduleBase/principal/getMemberGroups

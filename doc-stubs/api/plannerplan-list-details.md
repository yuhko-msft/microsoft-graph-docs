...
description: "Get the plannerPlanDetails resources from the details navigation property."
...
Get the plannerPlanDetails resources from the details navigation property.
...
-->
``` http
GET https://graph.microsoft.com/beta/users/{usersId}/planner/favoritePlans/{plannerPlanId}/details
```

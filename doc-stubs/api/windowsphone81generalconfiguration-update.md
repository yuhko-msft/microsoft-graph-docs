...
The following table shows the properties that are required when you update the [windowsPhone81GeneralConfiguration](../resources/windowsphone81generalconfiguration.md).
...
{
  "@odata.type": "#microsoft.graph.windowsPhone81GeneralConfiguration",
  "id": "1aba9284-9284-1aba-8492-ba1a8492ba1a",

...
description: "Create a new excludes object."
...
-->
``` http
POST https://graph.microsoft.com/beta/policies/permissionGrantPolicies/{permissionGrantPolicyId}/includes

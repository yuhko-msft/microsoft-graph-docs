...
-->
``` http
POST /policyRoot/permissionGrantPolicies/{permissionGrantPolicyId}/excludes
```
...
|permissionType|permissionType|**TODO: Add Description**. The possible values are: `delegatedUserConsentable`, `delegated`, `application`. Optional.|
...
-->
``` http
POST https://graph.microsoft.com/beta/policyRoot/permissionGrantPolicies/{permissionGrantPolicyId}/excludes

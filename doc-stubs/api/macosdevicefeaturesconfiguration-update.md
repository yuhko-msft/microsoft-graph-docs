...
The following table shows the properties that are required when you update the [macOSDeviceFeaturesConfiguration](../resources/macosdevicefeaturesconfiguration.md).

...
-->
``` http
POST /unifiedRoleScheduleBase/principal/getMemberObjects
POST /groups/{groupsId}/createdOnBehalfOf/getMemberObjects
POST /directoryObjects/{directoryObjectsId}/getMemberObjects
POST /unifiedRoleScheduleBase/directoryScope/getMemberObjects
POST /stsPolicy/appliesTo/{directoryObjectId}/getMemberObjects
POST /unifiedRoleScheduleInstanceBase/principal/getMemberObjects
POST /directory/deletedItems/{directoryObjectId}/getMemberObjects
POST /unifiedRoleScheduleInstanceBase/directoryScope/getMemberObjects
```
...
-->
``` http
POST https://graph.microsoft.com/beta/unifiedRoleScheduleBase/principal/getMemberObjects

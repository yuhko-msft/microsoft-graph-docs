...
Create a new [macOSScepCertificateProfile](../resources/intune-macosscepcertificateprofile.md) object.
...
The following table shows the properties that are required when you create the [macOSScepCertificateProfile](../resources/intune-macosscepcertificateprofile.md).
...
If successful, this method returns a `201 Created` response code and a [macOSScepCertificateProfile](../resources/intune-macosscepcertificateprofile.md) object in the response body.

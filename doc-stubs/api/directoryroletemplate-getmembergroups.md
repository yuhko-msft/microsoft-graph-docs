---
title: "directoryRoleTemplate: getMemberGroups"
...
-->
``` http
POST /directoryRoleTemplates/{directoryRoleTemplatesId}/getMemberGroups
```
...
-->
``` http
POST https://graph.microsoft.com/beta/directoryRoleTemplates/{directoryRoleTemplatesId}/getMemberGroups

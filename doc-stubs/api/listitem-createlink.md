...
-->
``` http
POST /shares/{sharesId}/listItem/createLink
POST /workbooks/{workbooksId}/listItem/createLink
```
...
-->
``` http
POST https://graph.microsoft.com/v1.0/shares/{sharesId}/listItem/createLink

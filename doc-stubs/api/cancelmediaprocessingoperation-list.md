...
<!-- {
  "blockType": "request",
  "name": "list_cancelmediaprocessingoperation"
}
-->
``` http
GET https://graph.microsoft.com/beta** Collection URI for microsoft.graph.cancelMediaProcessingOperation not found
```

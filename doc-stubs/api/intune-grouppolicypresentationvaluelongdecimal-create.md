...
Create a new [groupPolicyPresentationValueLongDecimal](../resources/intune-grouppolicypresentationvaluelongdecimal.md) object.
...
If successful, this method returns a `201 Created` response code and a [groupPolicyPresentationValueLongDecimal](../resources/intune-grouppolicypresentationvaluelongdecimal.md) object in the response body.

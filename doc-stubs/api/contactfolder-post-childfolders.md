...
-->
``` http
POST /users/{usersId}/contactFolders/{contactFolderId}/childFolders
```
...
-->
``` http
POST https://graph.microsoft.com/beta/users/{usersId}/contactFolders/{contactFolderId}/childFolders

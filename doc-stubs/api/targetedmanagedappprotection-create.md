---
title: "Create targetedManagedAppProtection"
description: "Create a new targetedManagedAppProtection object."
...
# Create targetedManagedAppProtection
Namespace: microsoft.graph

[!INCLUDE [beta-disclaimer](../../includes/beta-disclaimer.md)]

Create a new [targetedManagedAppProtection](../resources/targetedmanagedappprotection.md) object.
...
-->
``` http
POST ** Collection URI for microsoft.graph.targetedManagedAppProtection not found
```
...
The following table shows the properties that are required when you create the [targetedManagedAppProtection](../resources/targetedmanagedappprotection.md).
...
|allowedDataStorageLocations|managedAppDataStorageLocation collection|**TODO: Add Description** Inherited from [managedAppProtection](../resources/managedappprotection.md). Possible values are: `oneDriveForBusiness`, `sharePoint`, `box`, `localStorage`.|
...
If successful, this method returns a `201 Created` response code and a [targetedManagedAppProtection](../resources/targetedmanagedappprotection.md) object in the response body.
...
<!-- {
  "blockType": "request",
  "name": "create_targetedmanagedappprotection_from_"
}
-->
``` http
POST https://graph.microsoft.com/beta** Collection URI for microsoft.graph.targetedManagedAppProtection not found

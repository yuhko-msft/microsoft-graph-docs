...
description: "Get a list of the enrollmentConfigurationAssignment objects and their properties."
...
Get a list of the [enrollmentConfigurationAssignment](../resources/enrollmentconfigurationassignment.md) objects and their properties.
...
-->
``` http
GET https://graph.microsoft.com/v1.0/me/deviceEnrollmentConfigurations/{deviceEnrollmentConfigurationId}/assignments
```

...
-->
``` http
POST /rbacApplication/roleAssignments/{unifiedRoleAssignmentId}/principal/$ref
```
...
-->
``` http
POST https://graph.microsoft.com/v1.0/rbacApplication/roleAssignments/{unifiedRoleAssignmentId}/principal/$ref

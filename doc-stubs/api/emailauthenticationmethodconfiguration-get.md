...
Read the properties and relationships of an [emailAuthenticationMethodConfiguration](../resources/emailauthenticationmethodconfiguration.md) object.
...
-->
``` http
GET https://graph.microsoft.com/beta/emailAuthenticationMethodConfiguration
```

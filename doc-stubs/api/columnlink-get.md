...
-->
``` http
GET /drive/list/contentTypes/{contentTypeId}/columnLinks/{columnLinkId}
GET /drives/{drivesId}/list/contentTypes/{contentTypeId}/columnLinks/{columnLinkId}
```
...
-->
``` http
GET https://graph.microsoft.com/beta/drive/list/contentTypes/{contentTypeId}/columnLinks/{columnLinkId}
```

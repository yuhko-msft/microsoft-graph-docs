...
-->
``` http
POST /workbooks/{workbooksId}/workbook/functions/delta
```
...
<!-- {
  "blockType": "request",
  "name": "workbookfunctions_delta"
}
-->
``` http
POST https://graph.microsoft.com/beta/workbooks/{workbooksId}/workbook/functions/delta

...
description: "Get the accessPackageAssignmentPolicy resources from the assignmentPolicy navigation property."
...
Get the accessPackageAssignmentPolicy resources from the assignmentPolicy navigation property.
...
-->
``` http
GET https://graph.microsoft.com/v1.0/identityGovernance/entitlementManagement/assignments/{accessPackageAssignmentId}/assignmentPolicy
```

...
description: "Get the dimensionValue resources from the dimensionValues navigation property."
...
Get the dimensionValue resources from the dimensionValues navigation property.
...
-->
``` http
GET https://graph.microsoft.com/v1.0/financials/companies/{companyId}/dimensions/{dimensionId}/dimensionValues
```

...
-->
``` http
POST /deviceManagement/virtualEndpoint/userSettings/{cloudPcUserSettingId}/assign
```
...
-->
``` http
POST https://graph.microsoft.com/beta/deviceManagement/virtualEndpoint/userSettings/{cloudPcUserSettingId}/assign

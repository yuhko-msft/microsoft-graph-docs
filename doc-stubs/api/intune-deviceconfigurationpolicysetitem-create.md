...
Create a new [deviceConfigurationPolicySetItem](../resources/intune-deviceconfigurationpolicysetitem.md) object.
...
If successful, this method returns a `201 Created` response code and a [deviceConfigurationPolicySetItem](../resources/intune-deviceconfigurationpolicysetitem.md) object in the response body.
...
-->
``` http
POST https://graph.microsoft.com/beta** Collection URI for microsoft.graph.deviceConfigurationPolicySetItem not found

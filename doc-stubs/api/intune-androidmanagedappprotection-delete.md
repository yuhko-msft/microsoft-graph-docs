...
description: "Deletes an androidManagedAppProtection object."
...
Deletes an [androidManagedAppProtection](../resources/intune-androidmanagedappprotection.md) object.
...
<!-- {
  "blockType": "request",
  "name": "delete_androidmanagedappprotection"
}
-->
``` http

...
GET /print/reports/getSkypeForBusinessParticipantActivityMinuteCounts
```
...
-->
``` http
GET https://graph.microsoft.com/v1.0/reports/getSkypeForBusinessParticipantActivityMinuteCounts(period='parameterValue')
```

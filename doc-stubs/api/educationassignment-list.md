...
-->
``` http
GET /educationUser/assignments
GET /educationClass/assignments
```
...
-->
``` http
GET https://graph.microsoft.com/beta/educationUser/assignments
```
...
<!-- {
  "blockType": "response",
  "truncated": true,
  "@odata.type": "Collection(microsoft.education.assignments.api.educationAssignment)"
}
-->
``` http
HTTP/1.1 200 OK

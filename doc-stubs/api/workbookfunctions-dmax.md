...
-->
``` http
POST /workbooks/{workbooksId}/workbook/functions/dmax
```
...
<!-- {
  "blockType": "request",
  "name": "workbookfunctions_dmax"
}
-->
``` http
POST https://graph.microsoft.com/beta/workbooks/{workbooksId}/workbook/functions/dmax

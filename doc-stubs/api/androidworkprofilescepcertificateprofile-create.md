...
Create a new [androidWorkProfileScepCertificateProfile](../resources/androidworkprofilescepcertificateprofile.md) object.
...
-->
``` http
POST ** Collection URI for microsoft.graph.androidWorkProfileScepCertificateProfile not found
```
...
If successful, this method returns a `201 Created` response code and an [androidWorkProfileScepCertificateProfile](../resources/androidworkprofilescepcertificateprofile.md) object in the response body.
...
<!-- {
  "blockType": "request",
  "name": "create_androidworkprofilescepcertificateprofile_from_"
}
-->
``` http
POST https://graph.microsoft.com/beta** Collection URI for microsoft.graph.androidWorkProfileScepCertificateProfile not found
...
{
  "@odata.type": "#microsoft.graph.androidWorkProfileScepCertificateProfile",
  "id": "4da7420d-420d-4da7-0d42-a74d0d42a74d",

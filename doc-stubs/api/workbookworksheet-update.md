...
The following table shows the properties that are required when you update the [workbookWorksheet](../resources/workbookworksheet.md).
...
-->
``` http
PATCH https://graph.microsoft.com/beta/workbookRange/worksheet

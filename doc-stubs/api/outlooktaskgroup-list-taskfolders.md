...
description: "Get the outlookTaskFolder resources from the taskFolders navigation property."
...
Get the outlookTaskFolder resources from the taskFolders navigation property.
...
-->
``` http
GET https://graph.microsoft.com/beta/users/{usersId}/outlook/taskGroups/{outlookTaskGroupId}/taskFolders
```
  ...
  "value": [
    {
      ...
      "id": "666f89b7-89b7-666f-b789-6f66b7896f66",
      "changeKey": "String",

---
title: "Update base"
description: "Update the properties of a base object."
...
Update the properties of a base object.
...
-->
``` http
PATCH https://graph.microsoft.com/beta/drives/{drivesId}/list/contentTypes/{contentTypeId}/base

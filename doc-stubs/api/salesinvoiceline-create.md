...
Create a new [salesInvoiceLine](../resources/salesinvoiceline.md) object.
...
-->
``` http
POST https://graph.microsoft.com/v1.0/financials/companies/{companyId}/salesInvoiceLines

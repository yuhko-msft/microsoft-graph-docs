...
-->
``` http
POST /user/todo/lists/{todoTaskListId}/tasks/{todoTaskId}/extensions
```
...
-->
``` http
POST https://graph.microsoft.com/beta/user/todo/lists/{todoTaskListId}/tasks/{todoTaskId}/extensions

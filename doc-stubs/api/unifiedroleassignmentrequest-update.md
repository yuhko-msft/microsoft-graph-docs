...
-->
``` http
PATCH /rbacApplication/roleAssignmentRequests/{unifiedRoleAssignmentRequestId}
```
...
-->
``` http
PATCH https://graph.microsoft.com/beta/rbacApplication/roleAssignmentRequests/{unifiedRoleAssignmentRequestId}
...
{
  "@odata.type": "#microsoft.graph.unifiedRoleAssignmentRequest",
  "id": "195d208b-208b-195d-8b20-5d198b205d19",
  "action": "String",
  "principalId": "String",
  "roleDefinitionId": "String",
  "directoryScopeId": "String",

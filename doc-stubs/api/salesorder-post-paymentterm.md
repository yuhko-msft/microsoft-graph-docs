...
-->
``` http
POST /financials/companies/{companyId}/salesOrders/{salesOrderId}/paymentTerm
```
...
-->
``` http
POST https://graph.microsoft.com/v1.0/financials/companies/{companyId}/salesOrders/{salesOrderId}/paymentTerm

...
description: "Get the driveItem resources from the root navigation property."
...
Get the driveItem resources from the root navigation property.
...
-->
``` http
GET https://graph.microsoft.com/beta/shares/{sharesId}/root
```

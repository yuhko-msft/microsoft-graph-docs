...
Read the properties and relationships of a [deviceEnrollmentLimitConfiguration](../resources/intune-deviceenrollmentlimitconfiguration.md) object.
...
If successful, this method returns a `200 OK` response code and a [deviceEnrollmentLimitConfiguration](../resources/intune-deviceenrollmentlimitconfiguration.md) object in the response body.

...
The following table shows the properties that are required when you update the [dataSource](../resources/datasource.md).
...
-->
``` http
PATCH https://graph.microsoft.com/beta/compliance/ediscovery/cases/{caseId}/sourceCollections/{sourceCollectionId}/custodianSources/{dataSourceId}

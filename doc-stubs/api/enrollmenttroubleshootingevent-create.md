...
If successful, this method returns a `201 Created` response code and an [enrollmentTroubleshootingEvent](../resources/enrollmenttroubleshootingevent.md) object in the response body.

...
description: "Get a list of the deviceManagementDerivedCredentialSettings objects and their properties."
...
Get a list of the [deviceManagementDerivedCredentialSettings](../resources/devicemanagementderivedcredentialsettings.md) objects and their properties.
...
-->
``` http
GET https://graph.microsoft.com/v1.0/deviceManagement/derivedCredentials
```

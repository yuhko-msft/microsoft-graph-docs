...
-->
``` http
POST https://graph.microsoft.com/v1.0/chats/{chatsId}/installedApps/{teamsAppInstallationId}/teamsApp/appDefinitions/{teamsAppDefinitionId}/colorIcon/hostedContent
...
{
  "@odata.type": "#microsoft.graph.teamworkHostedContent",
  "id": "901d602e-602e-901d-2e60-1d902e601d90",
  "contentBytes": "Binary",
  "contentType": "String"
}
```

...
-->
``` http
POST https://graph.microsoft.com/beta** Collection URI for Microsoft.Teams.GraphSvc.teamworkHostedContent not found
...
{
  "@odata.type": "#Microsoft.Teams.GraphSvc.teamworkHostedContent",
  "id": "006b8754-8754-006b-5487-6b0054876b00",
  "contentBytes": "Binary",
  "contentType": "String"
}
```

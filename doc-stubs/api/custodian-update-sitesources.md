---
title: "Update siteSources"
description: "Update the properties of a siteSources object."
...
Update the properties of a siteSources object.
...
-->
``` http
PATCH /compliance/ediscovery/cases/{ediscoveryCaseId}/custodians/{custodianId}/siteSources
```
...
<!-- {
  "blockType": "request",
  "name": "update_sitesources"
}
-->
``` http
PATCH https://graph.microsoft.com/beta/compliance/ediscovery/cases/{ediscoveryCaseId}/custodians/{custodianId}/siteSources

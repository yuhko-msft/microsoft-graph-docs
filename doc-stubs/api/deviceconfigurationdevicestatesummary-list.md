...
description: "Get a list of the deviceConfigurationDeviceStateSummary objects and their properties."
...
Get a list of the [deviceConfigurationDeviceStateSummary](../resources/deviceconfigurationdevicestatesummary.md) objects and their properties.
...
-->
``` http
GET https://graph.microsoft.com/beta** Collection URI for microsoft.graph.deviceConfigurationDeviceStateSummary not found
```

...
-->
``` http
GET ** Collection URI for Microsoft.Teams.Shifts.team not found
```
...
-->
``` http
GET https://graph.microsoft.com/beta** Collection URI for Microsoft.Teams.Shifts.team not found
```
...
<!-- {
  "blockType": "response",
  "truncated": true,
  "@odata.type": "Collection(Microsoft.Teams.Shifts.team)"
}
-->
``` http
HTTP/1.1 200 OK
...

{
  "value": [
    {
      "@odata.type": "#Microsoft.Teams.Shifts.team"
    }
  ]
}
```

...
-->
``` http
GET ** Collection URI for microsoft.privacyManagement.team not found
```
...
-->
``` http
GET https://graph.microsoft.com/beta** Collection URI for microsoft.privacyManagement.team not found
```
...
<!-- {
  "blockType": "response",
  "truncated": true,
  "@odata.type": "Collection(microsoft.privacyManagement.team)"
}
-->
``` http
HTTP/1.1 200 OK
  ...
  "value": [
    {
      ...
      "id": "bc3f8e8d-8e8d-bc3f-8d8e-3fbc8d8e3fbc"
    }
  ]
}
```

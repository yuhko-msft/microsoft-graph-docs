...
-->
``` http
POST /roleManagement/cloudPC/roleAssignments/{unifiedRoleAssignmentMultipleId}/roleDefinition/$ref
```
...
-->
``` http
POST https://graph.microsoft.com/v1.0/roleManagement/cloudPC/roleAssignments/{unifiedRoleAssignmentMultipleId}/roleDefinition/$ref

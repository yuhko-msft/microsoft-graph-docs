...
-->
``` http
POST /workbooks/{workbooksId}/workbook/functions/fvschedule
```
...
-->
``` http
POST https://graph.microsoft.com/beta/workbooks/{workbooksId}/workbook/functions/fvschedule

...
-->
``` http
POST /rbacApplication/roleAssignmentRequests/{unifiedRoleAssignmentRequestId}/appScope/$ref
```
...
-->
``` http
POST https://graph.microsoft.com/beta/rbacApplication/roleAssignmentRequests/{unifiedRoleAssignmentRequestId}/appScope/$ref

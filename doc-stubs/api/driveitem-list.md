...
-->
``` http
GET ** Collection URI for Microsoft.Teams.GraphSvc.driveItem not found
```
...
-->
``` http
GET https://graph.microsoft.com/beta** Collection URI for Microsoft.Teams.GraphSvc.driveItem not found
```
...
<!-- {
  "blockType": "response",
  "truncated": true,
  "@odata.type": "Collection(Microsoft.Teams.GraphSvc.driveItem)"
}
-->
``` http
HTTP/1.1 200 OK
  ...
  "value": [
    {
      ...
      "id": "4afbf16e-f16e-4afb-6ef1-fb4a6ef1fb4a"
    }
  ]
}
```

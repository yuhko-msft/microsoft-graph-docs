---
title: "Create groupPolicyPresentation"
description: "Create a new groupPolicyPresentation object."
...
# Create groupPolicyPresentation
Namespace: microsoft.graph



Create a new [groupPolicyPresentation](../resources/grouppolicypresentation.md) object.
...
-->
``` http
POST /deviceManagement/groupPolicyCategories/{groupPolicyCategoryId}/definitionFile/definitions/{groupPolicyDefinitionId}/presentations
```
...
-->
``` http
POST https://graph.microsoft.com/v1.0/deviceManagement/groupPolicyCategories/{groupPolicyCategoryId}/definitionFile/definitions/{groupPolicyDefinitionId}/presentations

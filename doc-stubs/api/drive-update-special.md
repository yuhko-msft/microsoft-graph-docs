...
description: "Update the properties of a special object."
...
Update the properties of a special object.
...
-->
``` http
PATCH https://graph.microsoft.com/beta/drive/special

...
-->
``` http
GET /drive/activities/{itemActivityOLDId}/driveItem/listItem/fields
GET /drives/{drivesId}/activities/{itemActivityOLDId}/driveItem/listItem/fields
GET /drive/activities/{itemActivityOLDId}/driveItem/listItem/versions/{listItemVersionId}/fields
...
-->
``` http
GET https://graph.microsoft.com/beta/drive/activities/{itemActivityOLDId}/driveItem/listItem/fields
```

...
description: "Deletes a deviceComplianceSettingState object."
...
Deletes a [deviceComplianceSettingState](../resources/devicecompliancesettingstate.md) object.
...
<!-- {
  "blockType": "request",
  "name": "delete_devicecompliancesettingstate"
}
-->
``` http

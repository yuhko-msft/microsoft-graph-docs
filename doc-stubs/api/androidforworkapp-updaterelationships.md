...
-->
``` http
POST ** Entity URI for microsoft.management.services.api.androidForWorkApp not found/updateRelationships
```
...
-->
``` http
POST https://graph.microsoft.com/beta** Entity URI for microsoft.management.services.api.androidForWorkApp not found/updateRelationships

...
-->
``` http
GET /policies/activityBasedTimeoutPolicies/{activityBasedTimeoutPolicyId}
```
...
-->
``` http
GET https://graph.microsoft.com/beta/policies/activityBasedTimeoutPolicies/{activityBasedTimeoutPolicyId}
```
...
Content-Type: application/json
{
  "value": {
    "@odata.type": "#microsoft.graph.activityBasedTimeoutPolicy",
    "id": "c41f11f9-11f9-c41f-f911-1fc4f9111fc4",

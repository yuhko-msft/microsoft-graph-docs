...
description: "Get the printUsageByPrinter resources from the dailyPrintUsageSummariesByPrinter navigation property."
...
Get the printUsageByPrinter resources from the dailyPrintUsageSummariesByPrinter navigation property.
...
-->
``` http
GET https://graph.microsoft.com/v1.0/print/reports/dailyPrintUsageSummariesByPrinter
```

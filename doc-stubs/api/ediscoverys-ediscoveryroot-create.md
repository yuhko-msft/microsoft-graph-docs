...
Create a new [ediscoveryroot](../resources/ediscoverys-ediscoveryroot.md) object.
...
-->
``` http
POST ** Collection URI for microsoft.graph.ediscoverys.ediscoveryroot not found
```
...
-->
``` http
POST https://graph.microsoft.com/beta** Collection URI for microsoft.graph.ediscoverys.ediscoveryroot not found

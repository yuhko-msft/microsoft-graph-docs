...
The following table shows the properties that are required when you update the [deviceManagementCollectionSettingDefinition](../resources/devicemanagementcollectionsettingdefinition.md).
...
-->
``` http
PATCH https://graph.microsoft.com/v1.0/deviceManagementCollectionSettingDefinition

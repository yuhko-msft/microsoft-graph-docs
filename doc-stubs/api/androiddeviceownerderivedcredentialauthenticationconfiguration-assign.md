---
title: "androidDeviceOwnerDerivedCredentialAuthenticationConfiguration: assign"
...
# androidDeviceOwnerDerivedCredentialAuthenticationConfiguration: assign
...
-->
``` http
POST ** Entity URI for microsoft.graph.androidDeviceOwnerDerivedCredentialAuthenticationConfiguration not found/assign
```
...
<!-- {
  "blockType": "request",
  "name": "androiddeviceownerderivedcredentialauthenticationconfiguration_assign"
}
-->
``` http
POST https://graph.microsoft.com/v1.0** Entity URI for microsoft.graph.androidDeviceOwnerDerivedCredentialAuthenticationConfiguration not found/assign

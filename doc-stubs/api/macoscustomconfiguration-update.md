...
## Request body
In the request body, supply a JSON representation of the [macOSCustomConfiguration](../resources/macoscustomconfiguration.md) object.

The following table shows the properties that are required when you update the [macOSCustomConfiguration](../resources/macoscustomconfiguration.md).
...
{
  "@odata.type": "#microsoft.graph.macOSCustomConfiguration",
  "id": "aa385b1a-5b1a-aa38-1a5b-38aa1a5b38aa",

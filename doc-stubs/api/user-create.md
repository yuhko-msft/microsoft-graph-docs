...
-->
``` http
POST ** Collection URI for Microsoft.AAD.Reporting.user not found
```
...
-->
``` http
POST https://graph.microsoft.com/v1.0** Collection URI for Microsoft.AAD.Reporting.user not found

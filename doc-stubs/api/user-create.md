...
-->
``` http
POST ** Collection URI for Microsoft.IGAELM.PDS.FrontEnd.ExternalModel.user not found
```
...
-->
``` http
POST https://graph.microsoft.com/beta** Collection URI for Microsoft.IGAELM.PDS.FrontEnd.ExternalModel.user not found

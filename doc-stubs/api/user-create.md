...
-->
``` http
POST ** Collection URI for microsoft.graph.user not found
```
...
-->
``` http
POST https://graph.microsoft.com/beta** Collection URI for microsoft.graph.user not found
...
{
  "@odata.type": "#microsoft.graph.user",
  "id": "5cd9a15b-a15b-5cd9-5ba1-d95c5ba1d95c",
  "signInActivity": {
    "@odata.type": "microsoft.graph.signInActivity"
  }
}

...
-->
``` http
POST ** Collection URI for Microsoft.OfficeGraph.user not found
```
...
-->
``` http
POST https://graph.microsoft.com/beta** Collection URI for Microsoft.OfficeGraph.user not found

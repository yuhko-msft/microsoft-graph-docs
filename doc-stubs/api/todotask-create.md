...
Create a new [todoTask](../resources/todotask.md) object.
...
-->
``` http
POST /user/todo/lists/{todoTaskListId}/tasks
```
...
-->
``` http
POST https://graph.microsoft.com/beta/user/todo/lists/{todoTaskListId}/tasks
...

{
  ...
  "bodyLastModifiedDateTime": "String (timestamp)",
  "id": "dba0aab7-aab7-dba0-b7aa-a0dbb7aaa0db"
}
```

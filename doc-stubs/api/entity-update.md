...
-->
``` http
PATCH ** Entity URI for BadUnresolvedEntityType:microsoft.graph.entity not found
```
...
-->
``` http
PATCH https://graph.microsoft.com/beta** Entity URI for BadUnresolvedEntityType:microsoft.graph.entity not found

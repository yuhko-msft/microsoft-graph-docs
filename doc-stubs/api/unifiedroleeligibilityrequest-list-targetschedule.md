...
-->
``` http
GET https://graph.microsoft.com/beta/roleManagement/directory/roleEligibilityRequests/{unifiedRoleEligibilityRequestId}/targetSchedule
```
  ...
  "value": [
    {
      ...
      "id": "9d53b745-b745-9d53-45b7-539d45b7539d",
      "principalId": "String",

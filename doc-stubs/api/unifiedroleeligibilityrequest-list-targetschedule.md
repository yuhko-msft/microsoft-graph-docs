...
description: "Get the unifiedRoleEligibilitySchedule resources from the targetSchedule navigation property."
...
Get the unifiedRoleEligibilitySchedule resources from the targetSchedule navigation property.
...
-->
``` http
GET /rbacApplication/roleEligibilityRequests/{unifiedRoleEligibilityRequestId}/targetSchedule
```
...
-->
``` http
GET https://graph.microsoft.com/beta/rbacApplication/roleEligibilityRequests/{unifiedRoleEligibilityRequestId}/targetSchedule
```
  ...
  "value": [
    {
      ...
      "id": "e1ddddf6-ddf6-e1dd-f6dd-dde1f6dddde1",
      "principalId": "String",

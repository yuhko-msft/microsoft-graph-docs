...
description: "Get the accessPackageAssignment resources from the assignments navigation property."
...
Get the accessPackageAssignment resources from the assignments navigation property.
...
-->
``` http
GET /entitlementManagement/assignments
```
...
-->
``` http
GET https://graph.microsoft.com/v1.0/entitlementManagement/assignments
```

...
description: "Deletes a mdmWindowsInformationProtectionPolicy object."
...
Deletes a [mdmWindowsInformationProtectionPolicy](../resources/mdmwindowsinformationprotectionpolicy.md) object.
...
<!-- {
  "blockType": "request",
  "name": "delete_mdmwindowsinformationprotectionpolicy"
}
-->
``` http

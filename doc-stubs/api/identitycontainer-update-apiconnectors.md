---
title: "Update apiConnectors"
description: "Update the properties of an apiConnectors object."
...
Update the properties of an apiConnectors object.
...
<!-- {
  "blockType": "request",
  "name": "update_apiconnectors"
}
-->
``` http
PATCH https://graph.microsoft.com/beta/identity/apiConnectors

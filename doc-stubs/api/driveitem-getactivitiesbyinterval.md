...
# driveItem: getActivitiesByInterval
...
-->
``` http
GET https://graph.microsoft.com/beta/workbooks/{workbooksId}/getActivitiesByInterval(startDateTime='parameterValue',endDateTime='parameterValue',interval='parameterValue')
```

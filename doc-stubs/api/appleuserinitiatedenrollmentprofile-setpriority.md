---
title: "appleUserInitiatedEnrollmentProfile: setPriority"
...
# appleUserInitiatedEnrollmentProfile: setPriority
...
<!-- {
  "blockType": "request",
  "name": "appleuserinitiatedenrollmentprofile_setpriority"
}
-->
``` http

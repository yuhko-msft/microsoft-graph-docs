...
-->
``` http
PATCH /teams/{teamsId}/schedule/timeOffRequests/{timeOffRequestId}
```
...
The following table shows the properties that are required when you update the [timeOffRequest](../resources/timeoffrequest.md).
...
-->
``` http
PATCH https://graph.microsoft.com/beta/teams/{teamsId}/schedule/timeOffRequests/{timeOffRequestId}

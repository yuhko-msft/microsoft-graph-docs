...
-->
``` http
POST /unifiedRoleScheduleBase/principal/restore
POST /groups/{groupsId}/createdOnBehalfOf/restore
POST /directoryObjects/{directoryObjectsId}/restore
POST /unifiedRoleScheduleBase/directoryScope/restore
POST /stsPolicy/appliesTo/{directoryObjectId}/restore
POST /unifiedRoleScheduleInstanceBase/principal/restore
POST /directory/deletedItems/{directoryObjectId}/restore
POST /unifiedRoleScheduleInstanceBase/directoryScope/restore
```
...
-->
``` http
POST https://graph.microsoft.com/beta/unifiedRoleScheduleBase/principal/restore
```

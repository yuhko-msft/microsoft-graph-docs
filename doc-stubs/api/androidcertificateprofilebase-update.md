---
title: "Update androidCertificateProfileBase"
description: "Update the properties of an androidCertificateProfileBase object."
...
# Update androidCertificateProfileBase
Namespace: microsoft.graph

[!INCLUDE [beta-disclaimer](../../includes/beta-disclaimer.md)]

Update the properties of an [androidCertificateProfileBase](../resources/androidcertificateprofilebase.md) object.
...
The following table shows the properties that are required when you update the [androidCertificateProfileBase](../resources/androidcertificateprofilebase.md).
...
If successful, this method returns a `200 OK` response code and an updated [androidCertificateProfileBase](../resources/androidcertificateprofilebase.md) object in the response body.
...
<!-- {
  "blockType": "request",
  "name": "update_androidcertificateprofilebase"
}
-->
``` http
...

{
  ...
  "id": "fdd75fb6-5fb6-fdd7-b65f-d7fdb65fd7fd",

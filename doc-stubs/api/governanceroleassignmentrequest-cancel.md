---
title: "governanceRoleAssignmentRequest: cancel"
...
-->
``` http
POST https://graph.microsoft.com/v1.0/governanceRoleAssignmentRequests/{governanceRoleAssignmentRequestsId}/cancel
```

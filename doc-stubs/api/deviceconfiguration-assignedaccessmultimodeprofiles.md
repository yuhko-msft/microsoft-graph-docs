---
title: "deviceConfiguration: assignedAccessMultiModeProfiles"
...
<!-- {
  "blockType": "request",
  "name": "deviceconfiguration_assignedaccessmultimodeprofiles"
}
-->
``` http
POST https://graph.microsoft.com/v1.0/deviceManagement/deviceConfigurations/{deviceConfigurationId}/assignedAccessMultiModeProfiles

...
-->
``` http
GET /policies/privateLinkResourcePolicies/{privateLinkResourcePolicyId}/privateEndpointConnections/{privateEndpointConnectionId}
```
...
-->
``` http
GET https://graph.microsoft.com/beta/policies/privateLinkResourcePolicies/{privateLinkResourcePolicyId}/privateEndpointConnections/{privateEndpointConnectionId}
```
...

{
  "value": {
    "@odata.type": "#microsoft.graph.privateEndpointConnection",
    "id": "0b1affd3-ffd3-0b1a-d3ff-1a0bd3ff1a0b",

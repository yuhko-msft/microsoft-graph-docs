...
-->
``` http
GET https://graph.microsoft.com/beta** Collection URI for microsoft.graph.groupPolicyPresentationDropdownList not found
```
  ...
  "value": [
    {
      ...
      "id": "147424f9-24f9-1474-f924-7414f9247414",
      "label": "String",

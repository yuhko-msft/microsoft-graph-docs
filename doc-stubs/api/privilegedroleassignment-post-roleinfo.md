...
-->
``` http
POST /privilegedRoleAssignments/{privilegedRoleAssignmentsId}/roleInfo
```
...
-->
``` http
POST https://graph.microsoft.com/beta/privilegedRoleAssignments/{privilegedRoleAssignmentsId}/roleInfo

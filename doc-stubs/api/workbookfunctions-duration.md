---
title: "workbookFunctions: duration"
...
-->
``` http
POST /workbooks/{workbooksId}/workbook/functions/duration
```
...
<!-- {
  "blockType": "request",
  "name": "workbookfunctions_duration"
}
-->
``` http
POST https://graph.microsoft.com/beta/workbooks/{workbooksId}/workbook/functions/duration

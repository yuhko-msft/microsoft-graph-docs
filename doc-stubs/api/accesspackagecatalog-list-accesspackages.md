...
-->
``` http
GET /entitlementManagement/catalogs/{accessPackageCatalogId}/accessPackages
```
...
-->
``` http
GET https://graph.microsoft.com/v1.0/entitlementManagement/catalogs/{accessPackageCatalogId}/accessPackages
```

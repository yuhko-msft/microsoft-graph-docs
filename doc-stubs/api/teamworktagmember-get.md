...
-->
``` http
GET /teams/{teamsId}/tags/{teamworkTagId}/members/{teamworkTagMemberId}
```
...
-->
``` http
GET https://graph.microsoft.com/v1.0/teams/{teamsId}/tags/{teamworkTagId}/members/{teamworkTagMemberId}
```

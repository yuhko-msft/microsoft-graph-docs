---
title: "workbookFunctions: yieldDisc"
...
-->
``` http
POST /workbooks/{workbooksId}/workbook/functions/yieldDisc
```
...
<!-- {
  "blockType": "request",
  "name": "workbookfunctions_yielddisc"
}
-->
``` http
POST https://graph.microsoft.com/beta/workbooks/{workbooksId}/workbook/functions/yieldDisc

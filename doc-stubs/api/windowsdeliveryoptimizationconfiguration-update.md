...
The following table shows the properties that are required when you update the [windowsDeliveryOptimizationConfiguration](../resources/windowsdeliveryoptimizationconfiguration.md).
...
The default value is 0. The value 0 (zero) mean ervice default value will be used. Valid values 0 to 100|

...
-->
``` http
PATCH /unifiedRoleAssignmentScheduleInstance/activatedUsing
PATCH /rbacApplication/roleEligibilityScheduleInstances/{unifiedRoleEligibilityScheduleInstanceId}
```
...
-->
``` http
PATCH https://graph.microsoft.com/beta/unifiedRoleAssignmentScheduleInstance/activatedUsing

...
description: "Get a list of the workbookChartDataLabelFormat objects and their properties."
...
Get a list of the [workbookChartDataLabelFormat](../resources/workbookchartdatalabelformat.md) objects and their properties.
...
-->
``` http
GET https://graph.microsoft.com/beta** Collection URI for microsoft.graph.workbookChartDataLabelFormat not found
```

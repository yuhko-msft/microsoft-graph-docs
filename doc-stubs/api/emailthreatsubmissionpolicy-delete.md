...
Deletes an [emailThreatSubmissionPolicy](../resources/emailthreatsubmissionpolicy.md) object.
...
``` http
DELETE /emailThreatSubmissionPolicy
DELETE /submission/emailThreatSubmissionPolicies/{emailThreatSubmissionPolicyId}
```

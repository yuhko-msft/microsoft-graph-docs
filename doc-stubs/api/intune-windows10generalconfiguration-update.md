...
The following table shows the properties that are required when you update the [windows10GeneralConfiguration](../resources/intune-windows10generalconfiguration.md).

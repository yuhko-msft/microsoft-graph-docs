---
title: "List teachers"
description: "Get the educationUser resources from the teachers navigation property."
...
Get the educationUser resources from the teachers navigation property.
...
-->
``` http
GET https://graph.microsoft.com/beta/education/classes/{educationClassId}/teachers
```

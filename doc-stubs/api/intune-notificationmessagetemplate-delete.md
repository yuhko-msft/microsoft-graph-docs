...
description: "Deletes a notificationMessageTemplate object."
...
Deletes a [notificationMessageTemplate](../resources/intune-notificationmessagetemplate.md) object.
...
<!-- {
  "blockType": "request",
  "name": "delete_notificationmessagetemplate"
}
-->
``` http

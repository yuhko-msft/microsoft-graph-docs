...
-->
``` http
POST /financials/companies/{companyId}/salesOrders/{salesOrderId}/customer
```
...
-->
``` http
POST https://graph.microsoft.com/v1.0/financials/companies/{companyId}/salesOrders/{salesOrderId}/customer

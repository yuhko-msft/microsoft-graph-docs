...
-->
``` http
POST /entitlementManagement/assignments/{accessPackageAssignmentId}/accessPackage/$ref
```
...
-->
``` http
POST https://graph.microsoft.com/v1.0/entitlementManagement/assignments/{accessPackageAssignmentId}/accessPackage/$ref

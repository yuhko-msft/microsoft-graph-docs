...
description: "Get a list of the incomingFlow objects and their properties."
...
Get a list of the [incomingFlow](../resources/industrydata-incomingflow.md) objects and their properties.
...
<!-- {
  "blockType": "response",
  "truncated": true,
  "@odata.type": "Collection(microsoft.graph.industryData.incomingFlow)"
}
-->
``` http
HTTP/1.1 200 OK

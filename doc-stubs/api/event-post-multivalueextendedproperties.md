...
-->
``` http
POST /users/{usersId}/calendar/calendarView/{eventId}/multiValueExtendedProperties
```
...
-->
``` http
POST https://graph.microsoft.com/beta/users/{usersId}/calendar/calendarView/{eventId}/multiValueExtendedProperties

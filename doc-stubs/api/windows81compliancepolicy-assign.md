---
title: "windows81CompliancePolicy: assign"
...
# windows81CompliancePolicy: assign
...
-->
``` http
POST https://graph.microsoft.com/beta** Entity URI for microsoft.graph.windows81CompliancePolicy not found/assign

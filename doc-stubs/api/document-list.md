...
description: "Get a list of the document objects and their properties."
...
Get a list of the [document](../resources/document.md) objects and their properties.
...
-->
``` http
GET https://graph.microsoft.com/v1.0** Collection URI for microsoft.graph.document not found
```

...
-->
``` http
POST /security/emailSecurityEvents/mailMessages/{mailMessageId}/movetoInbox
```
...
<!-- {
  "blockType": "request",
  "name": "mailmessage_movetoinbox"
}
-->
``` http
POST https://graph.microsoft.com/beta/security/emailSecurityEvents/mailMessages/{mailMessageId}/movetoInbox

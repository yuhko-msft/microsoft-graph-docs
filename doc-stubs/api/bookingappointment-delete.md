...
description: "Deletes a bookingAppointment object."
...
Deletes a [bookingAppointment](../resources/bookingappointment.md) object.
...
-->
``` http
DELETE https://graph.microsoft.com/v1.0/bookingBusinesses/{bookingBusinessesId}/appointments/{bookingAppointmentId}
```

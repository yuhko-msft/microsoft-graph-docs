...
-->
``` http
POST /roleManagement/cloudPC/roleAssignments/{unifiedRoleAssignmentMultipleId}/directoryScopes/$ref
```
...
-->
``` http
POST https://graph.microsoft.com/beta/roleManagement/cloudPC/roleAssignments/{unifiedRoleAssignmentMultipleId}/directoryScopes/$ref

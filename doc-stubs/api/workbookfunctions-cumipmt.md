...
-->
``` http
POST /workbooks/{workbooksId}/workbook/functions/cumIPmt
```
...
-->
``` http
POST https://graph.microsoft.com/beta/workbooks/{workbooksId}/workbook/functions/cumIPmt

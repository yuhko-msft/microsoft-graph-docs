---
title: "workbookFunctions: countA"
...
-->
``` http
POST /workbooks/{workbooksId}/workbook/functions/countA
```
...
-->
``` http
POST https://graph.microsoft.com/beta/workbooks/{workbooksId}/workbook/functions/countA

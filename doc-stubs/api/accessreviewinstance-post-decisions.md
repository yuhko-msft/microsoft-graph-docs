...
-->
``` http
POST https://graph.microsoft.com/beta/users/{usersId}/pendingAccessReviewInstances/{accessReviewInstanceId}/decisions
...
{
  "@odata.type": "#microsoft.graph.accessReviewInstanceDecisionItem",
  "id": "1b4eb011-b011-1b4e-11b0-4e1b11b04e1b",
  "accessReviewId": "String",
  "appliedBy": {
    "@odata.type": "microsoft.graph.userIdentity"
  },

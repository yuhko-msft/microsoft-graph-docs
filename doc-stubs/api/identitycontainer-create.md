...
-->
``` http
POST ** Collection URI for Microsoft.IdentityProtectionServices.identityContainer not found
```
...
-->
``` http
POST https://graph.microsoft.com/v1.0** Collection URI for Microsoft.IdentityProtectionServices.identityContainer not found

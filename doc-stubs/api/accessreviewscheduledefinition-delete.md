...
-->
``` http
DELETE /accessReviewSet/definitions/{accessReviewScheduleDefinitionId}
```
...
-->
``` http
DELETE https://graph.microsoft.com/beta/accessReviewSet/definitions/{accessReviewScheduleDefinitionId}
```

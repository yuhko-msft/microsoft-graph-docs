...
-->
``` http
DELETE /me/pendingAccessReviewInstances/{accessReviewInstanceId}/definition
DELETE /identityGovernance/accessReviews/definitions/{accessReviewScheduleDefinitionId}
DELETE /users/{usersId}/pendingAccessReviewInstances/{accessReviewInstanceId}/definition
```
...
-->
``` http
DELETE https://graph.microsoft.com/v1.0/me/pendingAccessReviewInstances/{accessReviewInstanceId}/definition
```

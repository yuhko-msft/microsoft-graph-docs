...
The following table shows the properties that are required when you update the [windowsUniversalAppX](../resources/windowsuniversalappx.md).
...
<!-- {
  "blockType": "request",
  "name": "update_windowsuniversalappx"
}
-->
``` http
PATCH https://graph.microsoft.com/beta** Entity URI for microsoft.graph.windowsUniversalAppX not found
...
{
  "@odata.type": "#microsoft.graph.windowsUniversalAppX",
  "id": "91011081-1081-9101-8110-019181100191",
  "displayName": "String",
  "description": "String",
  "publisher": "String",
  "largeIcon": {

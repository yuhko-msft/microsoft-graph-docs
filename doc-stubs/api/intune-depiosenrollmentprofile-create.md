...
Create a new [depIOSEnrollmentProfile](../resources/intune-depiosenrollmentprofile.md) object.
...
The following table shows the properties that are required when you create the [depIOSEnrollmentProfile](../resources/intune-depiosenrollmentprofile.md).
...
If successful, this method returns a `201 Created` response code and a [depIOSEnrollmentProfile](../resources/intune-depiosenrollmentprofile.md) object in the response body.

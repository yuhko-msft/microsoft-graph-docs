...
-->
``` http
PATCH ** Entity URI for microsoft.management.services.api.macOSMicrosoftEdgeApp not found
```
...
<!-- {
  "blockType": "request",
  "name": "update_macosmicrosoftedgeapp"
}
-->
``` http
PATCH https://graph.microsoft.com/beta** Entity URI for microsoft.management.services.api.macOSMicrosoftEdgeApp not found

...
-->
``` http
GET /rbacApplication/roleEligibilityRequests/filterByCurrentUser
```
...
|:---|:---|:---|
|on|roleEligibilityRequestFilterByCurrentUserOptions|**TODO: Add Description**|
...
-->
``` http
GET https://graph.microsoft.com/beta/rbacApplication/roleEligibilityRequests/filterByCurrentUser(on='parameterValue')
```

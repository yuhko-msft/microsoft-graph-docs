...
Read the properties and relationships of a [deviceSetupConfiguration](../resources/intune-devicesetupconfiguration.md) object.
...
If successful, this method returns a `200 OK` response code and a [deviceSetupConfiguration](../resources/intune-devicesetupconfiguration.md) object in the response body.

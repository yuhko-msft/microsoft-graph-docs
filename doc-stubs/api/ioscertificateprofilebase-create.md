---
title: "Create iosCertificateProfileBase"
description: "Create a new iosCertificateProfileBase object."
...
# Create iosCertificateProfileBase
Namespace: microsoft.graph

[!INCLUDE [beta-disclaimer](../../includes/beta-disclaimer.md)]

Create a new [iosCertificateProfileBase](../resources/ioscertificateprofilebase.md) object.
...
-->
``` http
POST ** Collection URI for microsoft.graph.iosCertificateProfileBase not found
```
...
If successful, this method returns a `201 Created` response code and an [iosCertificateProfileBase](../resources/ioscertificateprofilebase.md) object in the response body.
...
-->
``` http
POST https://graph.microsoft.com/beta** Collection URI for microsoft.graph.iosCertificateProfileBase not found

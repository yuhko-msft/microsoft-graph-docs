...
## Request body
In the request body, supply a JSON representation of the [sharedDriveItem](../resources/shareddriveitem.md) object.

The following table shows the properties that are required when you update the [sharedDriveItem](../resources/shareddriveitem.md).
...
{
  "@odata.type": "#microsoft.graph.sharedDriveItem",
  "id": "bd672aa8-2aa8-bd67-a82a-67bda82a67bd",
  "createdBy": {
    "@odata.type": "microsoft.graph.identitySet"
  },

---
title: "groupSettingTemplate: restore"
...
-->
``` http
POST https://graph.microsoft.com/v1.0/groupSettingTemplates/{groupSettingTemplatesId}/restore
```

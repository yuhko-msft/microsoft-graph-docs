...
<!-- {
  "blockType": "request",
  "name": "list_androidforworkeasemailprofilebase"
}
-->
``` http
GET https://graph.microsoft.com/v1.0** Collection URI for microsoft.graph.androidForWorkEasEmailProfileBase not found
```

...
description: "Get a list of the workbookChartPointFormat objects and their properties."
...
Get a list of the [workbookChartPointFormat](../resources/workbookchartpointformat.md) objects and their properties.
...
-->
``` http
GET https://graph.microsoft.com/beta** Collection URI for microsoft.graph.workbookChartPointFormat not found
```

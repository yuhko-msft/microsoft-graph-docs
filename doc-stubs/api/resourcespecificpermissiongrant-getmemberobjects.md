---
title: "resourceSpecificPermissionGrant: getMemberObjects"
...
# resourceSpecificPermissionGrant: getMemberObjects
...
-->
``` http
POST https://graph.microsoft.com/beta/permissionGrants/{permissionGrantsId}/getMemberObjects

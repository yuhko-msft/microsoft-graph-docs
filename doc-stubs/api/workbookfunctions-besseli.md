---
title: "workbookFunctions: besselI"
...
-->
``` http
POST /workbooks/{workbooksId}/workbook/functions/besselI
```
...
<!-- {
  "blockType": "request",
  "name": "workbookfunctions_besseli"
}
-->
``` http
POST https://graph.microsoft.com/beta/workbooks/{workbooksId}/workbook/functions/besselI

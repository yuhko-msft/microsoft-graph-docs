...
description: "Deletes a salesInvoiceLine object."
...
Deletes a [salesInvoiceLine](../resources/salesinvoiceline.md) object.
...
-->
``` http
DELETE https://graph.microsoft.com/v1.0/financials/companies/{companyId}/salesInvoiceLines/{salesInvoiceLineId}
```

---
title: "windowsVpnConfiguration: assign"
...
# windowsVpnConfiguration: assign
...
-->
``` http
POST ** Entity URI for microsoft.graph.windowsVpnConfiguration not found/assign
```
...
<!-- {
  "blockType": "request",
  "name": "windowsvpnconfiguration_assign"
}
-->
``` http
POST https://graph.microsoft.com/v1.0** Entity URI for microsoft.graph.windowsVpnConfiguration not found/assign

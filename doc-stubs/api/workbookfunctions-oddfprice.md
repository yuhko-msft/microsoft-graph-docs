---
title: "workbookFunctions: oddFPrice"
...
-->
``` http
POST /workbooks/{workbooksId}/workbook/functions/oddFPrice
```
...
-->
``` http
POST https://graph.microsoft.com/beta/workbooks/{workbooksId}/workbook/functions/oddFPrice

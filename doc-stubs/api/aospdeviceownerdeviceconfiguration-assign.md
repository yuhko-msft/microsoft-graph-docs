...
-->
``` http
POST ** Entity URI for microsoft.management.services.api.aospDeviceOwnerDeviceConfiguration not found/assign
```
...
-->
``` http
POST https://graph.microsoft.com/beta** Entity URI for microsoft.management.services.api.aospDeviceOwnerDeviceConfiguration not found/assign
...
<!-- {
  "blockType": "response",
  "truncated": true,
  "@odata.type": "Collection(microsoft.management.services.api.deviceConfigurationAssignment)"
}
-->
``` http
HTTP/1.1 200 OK

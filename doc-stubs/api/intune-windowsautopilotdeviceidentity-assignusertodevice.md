---
title: "windowsAutopilotDeviceIdentity: assignUserToDevice"
...
# windowsAutopilotDeviceIdentity: assignUserToDevice
...
<!-- {
  "blockType": "request",
  "name": "windowsautopilotdeviceidentity_assignusertodevice"
}
-->
``` http

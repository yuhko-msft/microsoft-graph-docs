---
title: "Update file"
description: "Update the properties of a file object."
...
Update the properties of a [file](../resources/ediscovery-file.md) object.
...
-->
``` http
PATCH /compliance/ediscovery/cases/{caseId}/reviewSets/{reviewSetId}/files/{fileId}
```
...
The following table shows the properties that are required when you update the [file](../resources/ediscovery-file.md).
...
If successful, this method returns a `200 OK` response code and an updated [file](../resources/ediscovery-file.md) object in the response body.
...
-->
``` http
PATCH https://graph.microsoft.com/beta/compliance/ediscovery/cases/{caseId}/reviewSets/{reviewSetId}/files/{fileId}

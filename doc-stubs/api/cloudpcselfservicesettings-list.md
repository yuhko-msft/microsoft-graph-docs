---
title: "List cloudPcSelfServiceSettings"
description: "Get a list of the cloudPcSelfServiceSettings objects and their properties."
...
# List cloudPcSelfServiceSettings
Namespace: microsoft.graph

Get a list of the [cloudPcSelfServiceSettings](../resources/cloudpcselfservicesettings.md) objects and their properties.
...
-->
``` http
GET https://graph.microsoft.com/v1.0** Collection URI for microsoft.graph.cloudPcSelfServiceSettings not found
```

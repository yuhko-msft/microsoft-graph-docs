...
-->
``` http
GET ** Collection URI for Microsoft.AAD.Reporting.azureADFeatureUsage not found
```
...
-->
``` http
GET https://graph.microsoft.com/beta** Collection URI for Microsoft.AAD.Reporting.azureADFeatureUsage not found
```
  ...
  "value": [
    {
      ...
      "id": "69e5b80c-b80c-69e5-0cb8-e5690cb8e569",

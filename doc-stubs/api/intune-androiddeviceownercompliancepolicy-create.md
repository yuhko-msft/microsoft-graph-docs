...
Create a new [androidDeviceOwnerCompliancePolicy](../resources/intune-androiddeviceownercompliancepolicy.md) object.
...
The following table shows the properties that are required when you create the [androidDeviceOwnerCompliancePolicy](../resources/intune-androiddeviceownercompliancepolicy.md).
...
If successful, this method returns a `201 Created` response code and an [androidDeviceOwnerCompliancePolicy](../resources/intune-androiddeviceownercompliancepolicy.md) object in the response body.

...
description: "Deletes a termsAndConditionsAssignment object."
...
Deletes a [termsAndConditionsAssignment](../resources/termsandconditionsassignment.md) object.
...
<!-- {
  "blockType": "request",
  "name": "delete_termsandconditionsassignment"
}
-->
``` http

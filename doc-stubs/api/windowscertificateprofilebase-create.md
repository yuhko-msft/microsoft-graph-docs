---
title: "Create windowsCertificateProfileBase"
description: "Create a new windowsCertificateProfileBase object."
...
# Create windowsCertificateProfileBase
Namespace: microsoft.graph



Create a new [windowsCertificateProfileBase](../resources/windowscertificateprofilebase.md) object.
...
-->
``` http
POST ** Collection URI for microsoft.graph.windowsCertificateProfileBase not found
```
...
If successful, this method returns a `201 Created` response code and a [windowsCertificateProfileBase](../resources/windowscertificateprofilebase.md) object in the response body.
...
-->
``` http
POST https://graph.microsoft.com/v1.0** Collection URI for microsoft.graph.windowsCertificateProfileBase not found

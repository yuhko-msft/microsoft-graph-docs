...
description: "Get a list of the teamsAppInstallation objects and their properties."
...
Get a list of the [teamsAppInstallation](../resources/teamsappinstallation.md) objects and their properties.
...
-->
``` http
GET https://graph.microsoft.com/beta/chats/{chatsId}/installedApps
```
  ...
  "value": [
    {
      ...
      "id": "cbeb56f7-56f7-cbeb-f756-ebcbf756ebcb",

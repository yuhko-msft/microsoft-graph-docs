---
title: "List alltasks"
description: "Get the task resources from the alltasks navigation property."
...
Get the task resources from the alltasks navigation property.
...
-->
``` http
GET https://graph.microsoft.com/beta/user/tasks/alltasks
```

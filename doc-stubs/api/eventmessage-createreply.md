---
title: "eventMessage: createReply"
...
-->
``` http
POST ** Entity URI for microsoft.graph.eventMessage not found/createReply
```
...
-->
``` http
POST https://graph.microsoft.com/beta** Entity URI for microsoft.graph.eventMessage not found/createReply

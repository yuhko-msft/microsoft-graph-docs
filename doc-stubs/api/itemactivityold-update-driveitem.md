...
-->
``` http
PATCH /drives/{drivesId}/activities/{itemActivityOLDId}/driveItem
```
...
-->
``` http
PATCH https://graph.microsoft.com/beta/drives/{drivesId}/activities/{itemActivityOLDId}/driveItem

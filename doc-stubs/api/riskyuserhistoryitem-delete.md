...
description: "Deletes a riskyUserHistoryItem object."
...
Deletes a [riskyUserHistoryItem](../resources/riskyuserhistoryitem.md) object.
...
-->
``` http
DELETE https://graph.microsoft.com/v1.0/riskyUsers/{riskyUsersId}/history/{riskyUserHistoryItemId}
```

...
-->
``` http
POST /workbooks/{workbooksId}/workbook/functions/exact
```
...
-->
``` http
POST https://graph.microsoft.com/beta/workbooks/{workbooksId}/workbook/functions/exact

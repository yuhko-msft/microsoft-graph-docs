...
description: "Create a new salesOrderLine object."
...
Create a new [salesOrderLine](../resources/salesorderline.md) object.
...
-->
``` http
POST /financials/companies/{companyId}/salesOrderLines
POST /financials/companies/{companyId}/salesOrders/{salesOrderId}/salesOrderLines
```
...
-->
``` http
POST https://graph.microsoft.com/v1.0/financials/companies/{companyId}/salesOrderLines

---
title: "deviceManagement: enableAndroidDeviceAdministratorEnrollment"
...
-->
``` http
POST https://graph.microsoft.com/v1.0/deviceManagement/enableAndroidDeviceAdministratorEnrollment
```

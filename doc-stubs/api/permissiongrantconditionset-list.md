...
-->
``` http
GET /policyRoot/permissionGrantPolicies/{permissionGrantPolicyId}/includes
GET /policyRoot/permissionGrantPolicies/{permissionGrantPolicyId}/excludes
```
...
-->
``` http
GET https://graph.microsoft.com/v1.0/policyRoot/permissionGrantPolicies/{permissionGrantPolicyId}/includes
```

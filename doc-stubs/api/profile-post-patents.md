...
-->
``` http
POST /user/{userId}/profile/patents
```
...
You can specify the following properties when creating an **itemPatent**.
...
-->
``` http
POST https://graph.microsoft.com/beta/user/{userId}/profile/patents
...
{
  "@odata.type": "#Microsoft.Fast.PI.ViewGenerator.V2.Profile.Models.itemPatent",
  "id": "b104d83f-d83f-b104-3fd8-04b13fd804b1",
  "allowedAudiences": "String",
  "inference": {
    "@odata.type": "microsoft.graph.inferenceData"
  },

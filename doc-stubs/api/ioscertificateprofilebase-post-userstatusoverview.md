...
-->
``` http
POST /deviceManagement/deviceConfigurations/{deviceConfigurationId}/identityCertificate/userStatusOverview
```
...
-->
``` http
POST https://graph.microsoft.com/beta/deviceManagement/deviceConfigurations/{deviceConfigurationId}/identityCertificate/userStatusOverview
...
{
  "@odata.type": "#microsoft.graph.deviceConfigurationUserOverview",
  "id": "efcc1d6b-1d6b-efcc-6b1d-ccef6b1dccef",
  "configurationVersion": "Integer",
  "conflictCount": "Integer",
  "errorCount": "Integer",
  "failedCount": "Integer",

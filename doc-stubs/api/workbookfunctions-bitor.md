...
-->
``` http
POST /workbooks/{workbooksId}/workbook/functions/bitor
```
...
<!-- {
  "blockType": "request",
  "name": "workbookfunctions_bitor"
}
-->
``` http
POST https://graph.microsoft.com/beta/workbooks/{workbooksId}/workbook/functions/bitor

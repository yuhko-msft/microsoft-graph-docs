...
-->
``` http
POST /governanceRoleSettings/{governanceRoleSettingsId}/roleDefinition
```
...
-->
``` http
POST https://graph.microsoft.com/v1.0/governanceRoleSettings/{governanceRoleSettingsId}/roleDefinition

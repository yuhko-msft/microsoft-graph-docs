...
The following table shows the properties that are required when you update the [windows10TeamGeneralConfiguration](../resources/windows10teamgeneralconfiguration.md).

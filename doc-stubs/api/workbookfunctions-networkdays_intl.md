---
title: "workbookFunctions: networkDays_Intl"
...
# workbookFunctions: networkDays_Intl
...
-->
``` http
POST /workbooks/{workbooksId}/workbook/functions/networkDays_Intl
```
...
-->
``` http
POST https://graph.microsoft.com/beta/workbooks/{workbooksId}/workbook/functions/networkDays_Intl

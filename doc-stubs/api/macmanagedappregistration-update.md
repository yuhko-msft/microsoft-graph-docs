---
title: "Update macManagedAppRegistration"
description: "Update the properties of a macManagedAppRegistration object."
...
# Update macManagedAppRegistration
Namespace: microsoft.graph

Update the properties of a [macManagedAppRegistration](../resources/macmanagedappregistration.md) object.
...
-->
``` http
PATCH ** Entity URI for microsoft.graph.macManagedAppRegistration not found
```
...
The following table shows the properties that are required when you update the [macManagedAppRegistration](../resources/macmanagedappregistration.md).
...
If successful, this method returns a `200 OK` response code and an updated [macManagedAppRegistration](../resources/macmanagedappregistration.md) object in the response body.
...
<!-- {
  "blockType": "request",
  "name": "update_macmanagedappregistration"
}
-->
``` http
PATCH https://graph.microsoft.com/beta** Entity URI for microsoft.graph.macManagedAppRegistration not found

...
description: "Deletes a hardwareConfigurationDeviceState object."
...
Deletes a [hardwareConfigurationDeviceState](../resources/intune-hardwareconfigurationdevicestate.md) object.
...
<!-- {
  "blockType": "request",
  "name": "delete_hardwareconfigurationdevicestate"
}
-->
``` http

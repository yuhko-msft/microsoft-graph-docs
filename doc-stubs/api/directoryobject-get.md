...
-->
``` http
GET /entitlementManagement/assignments/{accessPackageAssignmentId}/target/connectedOrganization/internalSponsors/{directoryObjectId}
GET /entitlementManagement/assignments/{accessPackageAssignmentId}/target/connectedOrganization/externalSponsors/{directoryObjectId}
```
...
-->
``` http
GET https://graph.microsoft.com/v1.0/entitlementManagement/assignments/{accessPackageAssignmentId}/target/connectedOrganization/internalSponsors/{directoryObjectId}
```

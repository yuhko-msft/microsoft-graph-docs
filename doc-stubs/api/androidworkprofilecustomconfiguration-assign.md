---
title: "androidWorkProfileCustomConfiguration: assign"
...
# androidWorkProfileCustomConfiguration: assign
...
-->
``` http
POST ** Entity URI for microsoft.graph.androidWorkProfileCustomConfiguration not found/assign
```
...
<!-- {
  "blockType": "request",
  "name": "androidworkprofilecustomconfiguration_assign"
}
-->
``` http
POST https://graph.microsoft.com/beta** Entity URI for microsoft.graph.androidWorkProfileCustomConfiguration not found/assign

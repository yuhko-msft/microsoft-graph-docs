...
-->
``` http
POST ** Entity URI for microsoft.graph.androidForWorkMobileAppConfiguration not found/assign
```
...
-->
``` http
POST https://graph.microsoft.com/beta** Entity URI for microsoft.graph.androidForWorkMobileAppConfiguration not found/assign

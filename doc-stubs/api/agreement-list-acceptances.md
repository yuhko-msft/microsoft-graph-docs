...
description: "Get the agreementAcceptance resources from the acceptances navigation property."
...
Get the agreementAcceptance resources from the acceptances navigation property.
...
-->
``` http
GET /agreements/{agreementsId}/acceptances
```
...
-->
``` http
GET https://graph.microsoft.com/beta/agreements/{agreementsId}/acceptances
```

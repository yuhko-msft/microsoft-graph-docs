...
description: "Deletes an onlineMeeting object."
...
Deletes an [onlineMeeting](../resources/onlinemeeting.md) object.
...
-->
``` http
DELETE https://graph.microsoft.com/v1.0/me/onlineMeetings/{onlineMeetingId}
```

---
title: "Update domainSecurityProfiles"
description: "Update the properties of a domainSecurityProfiles object."
...
# Update domainSecurityProfiles
Namespace: microsoft.graph

Update the properties of a domainSecurityProfiles object.
...
-->
``` http
PATCH /Security/domainSecurityProfiles
```
...
<!-- {
  "blockType": "request",
  "name": "update_domainsecurityprofiles"
}
-->
``` http
PATCH https://graph.microsoft.com/beta/Security/domainSecurityProfiles

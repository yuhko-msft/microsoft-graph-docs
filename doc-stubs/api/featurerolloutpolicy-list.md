...
description: "Get a list of the featureRolloutPolicy objects and their properties."
...
Get a list of the [featureRolloutPolicy](../resources/featurerolloutpolicy.md) objects and their properties.
...
-->
``` http
GET /policyRoot/featureRolloutPolicies
```
...
-->
``` http
GET https://graph.microsoft.com/v1.0/policyRoot/featureRolloutPolicies
```

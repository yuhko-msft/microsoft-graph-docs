...
-->
``` http
GET /rbacApplication/roleAssignmentRequests/{unifiedRoleAssignmentRequestId}/directoryScope
```
...
-->
``` http
GET https://graph.microsoft.com/beta/rbacApplication/roleAssignmentRequests/{unifiedRoleAssignmentRequestId}/directoryScope
```

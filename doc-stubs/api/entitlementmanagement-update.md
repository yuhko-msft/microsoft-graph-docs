...
The following table shows the properties that are required when you update the [entitlementManagement](../resources/entitlementmanagement.md).
...
-->
``` http
PATCH https://graph.microsoft.com/v1.0/entitlementManagement
...
{
  "@odata.type": "#microsoft.graph.entitlementManagement",
  "id": "32fcc7e4-c7e4-32fc-e4c7-fc32e4c7fc32"
}
```

...
-->
``` http
PATCH /rbacApplication/roleDefinitions/{unifiedRoleDefinitionId}
PATCH /rbacApplicationMultiple/roleDefinitions/{unifiedRoleDefinitionId}
```
...
-->
``` http
PATCH https://graph.microsoft.com/beta/rbacApplication/roleDefinitions/{unifiedRoleDefinitionId}

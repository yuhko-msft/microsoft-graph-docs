...
description: "Deletes a windowsAutopilotDeviceIdentity object."
...
Deletes a [windowsAutopilotDeviceIdentity](../resources/intune-windowsautopilotdeviceidentity.md) object.
...
<!-- {
  "blockType": "request",
  "name": "delete_windowsautopilotdeviceidentity"
}
-->
``` http

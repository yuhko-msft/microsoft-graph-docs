...
-->
``` http
PATCH /users/{usersId}/messages/{messageId}/event/calendar/calendarView
```
...
<!-- {
  "blockType": "request",
  "name": "update_calendarview"
}
-->
``` http
PATCH https://graph.microsoft.com/beta/users/{usersId}/messages/{messageId}/event/calendar/calendarView

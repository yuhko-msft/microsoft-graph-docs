---
title: "Update emailFileSubmission"
description: "Update the properties of an emailFileSubmission object."
...
# Update emailFileSubmission
Namespace: microsoft.graph

[!INCLUDE [beta-disclaimer](../../includes/beta-disclaimer.md)]

Update the properties of an [emailFileSubmission](../resources/emailfilesubmission.md) object.
...
The following table shows the properties that are required when you update the [emailFileSubmission](../resources/emailfilesubmission.md).
...
If successful, this method returns a `200 OK` response code and an updated [emailFileSubmission](../resources/emailfilesubmission.md) object in the response body.
...
<!-- {
  "blockType": "request",
  "name": "update_emailfilesubmission"
}
-->
``` http
PATCH https://graph.microsoft.com/beta/emailFileSubmission

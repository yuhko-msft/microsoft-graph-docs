...
Get a list of the [addToReviewSetOperation](../resources/ediscovery-addtoreviewsetoperation.md) objects and their properties.
...
-->
``` http
GET https://graph.microsoft.com/v1.0** Collection URI for microsoft.graph.ediscovery.addToReviewSetOperation not found
```
  ...
  "value": [
    {
      ...
      "id": "fc775dfa-5dfa-fc77-fa5d-77fcfa5d77fc",

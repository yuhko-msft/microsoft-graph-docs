---
title: "androidForWorkEasEmailProfileBase: assign"
...
# androidForWorkEasEmailProfileBase: assign
...
-->
``` http
POST ** Entity URI for microsoft.graph.androidForWorkEasEmailProfileBase not found/assign
```
...
<!-- {
  "blockType": "request",
  "name": "androidforworkeasemailprofilebase_assign"
}
-->
``` http
POST https://graph.microsoft.com/v1.0** Entity URI for microsoft.graph.androidForWorkEasEmailProfileBase not found/assign

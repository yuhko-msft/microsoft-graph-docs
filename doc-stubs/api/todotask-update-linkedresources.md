...
-->
``` http
PATCH /user/todo/lists/{todoTaskListId}/tasks/{todoTaskId}/linkedResources
```
...
-->
``` http
PATCH https://graph.microsoft.com/v1.0/user/todo/lists/{todoTaskListId}/tasks/{todoTaskId}/linkedResources

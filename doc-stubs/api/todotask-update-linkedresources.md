...
-->
``` http
PATCH /users/{usersId}/todo/lists/{todoTaskListId}/tasks/{todoTaskId}/linkedResources
```
...
-->
``` http
PATCH https://graph.microsoft.com/beta/users/{usersId}/todo/lists/{todoTaskListId}/tasks/{todoTaskId}/linkedResources

...
# List accessPackageAssignmentApprovals
Namespace: microsoft.graph

[!INCLUDE [beta-disclaimer](../../includes/beta-disclaimer.md)]

Get the approval resources from the accessPackageAssignmentApprovals navigation property.
...
-->
``` http
GET /entitlementManagement/accessPackageAssignmentApprovals
```
...
-->
``` http
GET https://graph.microsoft.com/beta/entitlementManagement/accessPackageAssignmentApprovals
```

...
The following table shows the properties that are required when you update the [depIOSEnrollmentProfile](../resources/depiosenrollmentprofile.md).
...
-->
``` http
PATCH https://graph.microsoft.com/v1.0/deviceManagement/depOnboardingSettings/{depOnboardingSettingId}/defaultIosEnrollmentProfile

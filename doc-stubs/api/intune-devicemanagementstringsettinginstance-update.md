...
Update the properties of a [deviceManagementStringSettingInstance](../resources/intune-devicemanagementstringsettinginstance.md) object.
...
If successful, this method returns a `200 OK` response code and an updated [deviceManagementStringSettingInstance](../resources/intune-devicemanagementstringsettinginstance.md) object in the response body.

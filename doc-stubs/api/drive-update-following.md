...
description: "Update the properties of a following object."
...
Update the properties of a following object.
...
-->
``` http
PATCH /drive/following
PATCH /drives/{drivesId}/following
```
...
-->
``` http
PATCH https://graph.microsoft.com/beta/drive/following

---
title: "List printer"
description: "Get the printer resources from the printer navigation property."
...
Get the printer resources from the printer navigation property.
...
-->
``` http
GET https://graph.microsoft.com/beta/printerCreateOperation/printer
```

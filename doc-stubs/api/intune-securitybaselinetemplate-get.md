...
Read the properties and relationships of a [securityBaselineTemplate](../resources/intune-securitybaselinetemplate.md) object.
...
If successful, this method returns a `200 OK` response code and a [securityBaselineTemplate](../resources/intune-securitybaselinetemplate.md) object in the response body.

---
title: "deviceConfiguration: hasPayloadLinks"
...
# deviceConfiguration: hasPayloadLinks
...
-->
``` http
POST https://graph.microsoft.com/v1.0/deviceManagement/deviceConfigurations/hasPayloadLinks

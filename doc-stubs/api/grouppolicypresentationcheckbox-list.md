...
-->
``` http
GET https://graph.microsoft.com/beta** Collection URI for microsoft.graph.groupPolicyPresentationCheckBox not found
```
  ...
  "value": [
    {
      ...
      "id": "78e0ebab-ebab-78e0-abeb-e078abebe078",
      "label": "String",

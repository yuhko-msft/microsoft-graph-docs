---
title: "Add fromTerm"
description: "Add fromTerm by posting to the fromTerm collection."
...
Add fromTerm by posting to the fromTerm collection.
...
-->
``` http
POST /termStore/groups/{groupId}/sets/{setId}/terms/$ref
POST /termStore/groups/{groupId}/sets/{setId}/children/$ref
POST /termStore/groups/{groupId}/sets/{setId}/terms/{termId}/children/$ref
```
...
If successful, this method returns a `204 No Content` response code and a [term](../resources/termstore-term.md) object in the response body.
...
-->
``` http
POST https://graph.microsoft.com/beta/termStore/groups/{groupId}/sets/{setId}/terms/$ref

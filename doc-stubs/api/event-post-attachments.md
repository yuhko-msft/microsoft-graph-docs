...
-->
``` http
POST /users/{usersId}/calendar/calendarView/{eventId}/attachments
```
...
-->
``` http
POST https://graph.microsoft.com/beta/users/{usersId}/calendar/calendarView/{eventId}/attachments

---
title: "List cloudPcServicePlans"
description: "Get a list of the cloudPcServicePlan objects and their properties."
...
# List cloudPcServicePlans
Namespace: microsoft.graph

[!INCLUDE [beta-disclaimer](../../includes/beta-disclaimer.md)]

Get a list of the [cloudPcServicePlan](../resources/cloudpcserviceplan.md) objects and their properties.
...
<!-- {
  "blockType": "response",
  "truncated": true,
  "@odata.type": "Collection(microsoft.graph.cloudPcServicePlan)"
}
-->
``` http
HTTP/1.1 200 OK

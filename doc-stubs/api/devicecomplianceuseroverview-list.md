...
description: "Get a list of the deviceComplianceUserOverview objects and their properties."
...
Get a list of the [deviceComplianceUserOverview](../resources/devicecomplianceuseroverview.md) objects and their properties.
...
<!-- {
  "blockType": "request",
  "name": "list_devicecomplianceuseroverview"
}
-->
``` http
GET https://graph.microsoft.com/v1.0** Collection URI for microsoft.graph.deviceComplianceUserOverview not found
```

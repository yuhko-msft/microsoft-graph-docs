...
-->
``` http
GET /drives/{drivesId}/activities/{itemActivityOLDId}/driveItem/subscriptions
```
...
-->
``` http
GET https://graph.microsoft.com/beta/drives/{drivesId}/activities/{itemActivityOLDId}/driveItem/subscriptions
```

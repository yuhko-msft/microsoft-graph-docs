---
title: "Update resourceAccessIosSCEPCertificateProfile"
description: "Update the properties of a resourceAccessIosSCEPCertificateProfile object."
...
# Update resourceAccessIosSCEPCertificateProfile
Namespace: microsoft.graph

Update the properties of a [resourceAccessIosSCEPCertificateProfile](../resources/resourceaccessiosscepcertificateprofile.md) object.
...
-->
``` http
PATCH ** Entity URI for microsoft.graph.resourceAccessIosSCEPCertificateProfile not found
```
...
The following table shows the properties that are required when you update the [resourceAccessIosSCEPCertificateProfile](../resources/resourceaccessiosscepcertificateprofile.md).
...
If successful, this method returns a `200 OK` response code and an updated [resourceAccessIosSCEPCertificateProfile](../resources/resourceaccessiosscepcertificateprofile.md) object in the response body.
...
<!-- {
  "blockType": "request",
  "name": "update_resourceaccessiosscepcertificateprofile"
}
-->
``` http
PATCH https://graph.microsoft.com/beta** Entity URI for microsoft.graph.resourceAccessIosSCEPCertificateProfile not found

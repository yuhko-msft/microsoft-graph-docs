---
title: "Update providerTenantSettings"
description: "Update the properties of a providerTenantSettings object."
...
# Update providerTenantSettings
Namespace: microsoft.graph

Update the properties of a providerTenantSettings object.
...
-->
``` http
PATCH /Security/providerTenantSettings
```
...
<!-- {
  "blockType": "request",
  "name": "update_providertenantsettings"
}
-->
``` http
PATCH https://graph.microsoft.com/beta/Security/providerTenantSettings

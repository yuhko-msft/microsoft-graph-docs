---
title: "application: getMemberGroups"
...
-->
``` http
POST /applications/{applicationsId}/getMemberGroups
```
...
-->
``` http
POST https://graph.microsoft.com/beta/applications/{applicationsId}/getMemberGroups

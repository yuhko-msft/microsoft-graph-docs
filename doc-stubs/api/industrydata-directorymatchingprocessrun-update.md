---
title: "Update directoryMatchingProcessRun"
description: "Update the properties of a directoryMatchingProcessRun object."
...
# Update directoryMatchingProcessRun
Namespace: microsoft.graph.industryData

[!INCLUDE [beta-disclaimer](../../includes/beta-disclaimer.md)]

Update the properties of a [directoryMatchingProcessRun](../resources/industrydata-directorymatchingprocessrun.md) object.
...
-->
``` http
PATCH ** Entity URI for microsoft.graph.industryData.directoryMatchingProcessRun not found
```
...
If successful, this method returns a `200 OK` response code and an updated [directoryMatchingProcessRun](../resources/industrydata-directorymatchingprocessrun.md) object in the response body.
...
<!-- {
  "blockType": "request",
  "name": "update_directorymatchingprocessrun"
}
-->
``` http
PATCH https://graph.microsoft.com/beta** Entity URI for microsoft.graph.industryData.directoryMatchingProcessRun not found

...
-->
``` http
POST /unifiedRoleAssignmentScheduleInstance/activatedUsing/principal/$ref
```
...
-->
``` http
POST https://graph.microsoft.com/beta/unifiedRoleAssignmentScheduleInstance/activatedUsing/principal/$ref

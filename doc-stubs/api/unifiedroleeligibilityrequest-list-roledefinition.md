...
-->
``` http
GET /roleManagement/directory/roleEligibilityRequests/{unifiedRoleEligibilityRequestId}/roleDefinition
```
...
-->
``` http
GET https://graph.microsoft.com/beta/roleManagement/directory/roleEligibilityRequests/{unifiedRoleEligibilityRequestId}/roleDefinition
```
  ...
  "value": [
    {
      ...
      "id": "8c1b4e85-4e85-8c1b-854e-1b8c854e1b8c",
      "description": "String",
      "displayName": "String",
      "isBuiltIn": "Boolean",
      "isEnabled": "Boolean",

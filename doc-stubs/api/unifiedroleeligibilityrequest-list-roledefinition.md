...
-->
``` http
GET /rbacApplication/roleEligibilityRequests/{unifiedRoleEligibilityRequestId}/roleDefinition
```
...
-->
``` http
GET https://graph.microsoft.com/beta/rbacApplication/roleEligibilityRequests/{unifiedRoleEligibilityRequestId}/roleDefinition
```

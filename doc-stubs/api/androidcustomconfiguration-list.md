...
description: "Get a list of the androidCustomConfiguration objects and their properties."
...
Get a list of the [androidCustomConfiguration](../resources/androidcustomconfiguration.md) objects and their properties.
...
<!-- {
  "blockType": "request",
  "name": "list_androidcustomconfiguration"
}
-->
``` http
GET https://graph.microsoft.com/beta** Collection URI for microsoft.graph.androidCustomConfiguration not found
```

...
description: "Create a new openShiftChangeRequest object."
...
Create a new [openShiftChangeRequest](../resources/openshiftchangerequest.md) object.
...
-->
``` http
POST /teams/{teamsId}/schedule/openShiftChangeRequests
```
...
If successful, this method returns a `201 Created` response code and an [openShiftChangeRequest](../resources/openshiftchangerequest.md) object in the response body.
...
-->
``` http
POST https://graph.microsoft.com/beta/teams/{teamsId}/schedule/openShiftChangeRequests

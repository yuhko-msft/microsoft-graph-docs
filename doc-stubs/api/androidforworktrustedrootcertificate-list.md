...
description: "Get a list of the androidForWorkTrustedRootCertificate objects and their properties."
...
Get a list of the [androidForWorkTrustedRootCertificate](../resources/androidforworktrustedrootcertificate.md) objects and their properties.
...
-->
``` http
GET https://graph.microsoft.com/v1.0** Collection URI for microsoft.graph.androidForWorkTrustedRootCertificate not found
```

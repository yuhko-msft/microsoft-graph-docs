---
title: "List catalogs"
description: "Get the accessPackageCatalog resources from the catalogs navigation property."
...
Get the accessPackageCatalog resources from the catalogs navigation property.
...
-->
``` http
GET /entitlementManagement/catalogs
```
...
-->
``` http
GET https://graph.microsoft.com/v1.0/entitlementManagement/catalogs
```

...
-->
``` http
POST /financials/companies/{companyId}/salesQuotes/{salesQuoteId}/shipmentMethod
```
...
-->
``` http
POST https://graph.microsoft.com/beta/financials/companies/{companyId}/salesQuotes/{salesQuoteId}/shipmentMethod

...
description: "Get a list of the deviceHealthScriptAssignment objects and their properties."
...
# List deviceHealthScriptAssignments
Namespace: microsoft.graph



Get a list of the [deviceHealthScriptAssignment](../resources/devicehealthscriptassignment.md) objects and their properties.
...
-->
``` http
GET https://graph.microsoft.com/v1.0/deviceManagement/deviceHealthScripts/{deviceHealthScriptId}/assignments
```

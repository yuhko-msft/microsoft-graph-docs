...
description: "Get the userExperienceAnalyticsCategory resources from the resourcePerformanceMetrics navigation property."
...
Get the userExperienceAnalyticsCategory resources from the resourcePerformanceMetrics navigation property.
...
-->
``` http
GET https://graph.microsoft.com/v1.0/deviceManagement/userExperienceAnalyticsBaselines/{userExperienceAnalyticsBaselineId}/resourcePerformanceMetrics
```

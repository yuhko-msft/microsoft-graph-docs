...
-->
``` http
POST /deviceManagement/userExperienceAnalyticsAppHealthOverview
```
...
-->
``` http
POST https://graph.microsoft.com/v1.0/deviceManagement/userExperienceAnalyticsAppHealthOverview

...
description: "Update the properties of an editionUpgradeConfiguration object."
...
Update the properties of an [editionUpgradeConfiguration](../resources/editionupgradeconfiguration.md) object.
...
## Request body
In the request body, supply a JSON representation of the [editionUpgradeConfiguration](../resources/editionupgradeconfiguration.md) object.
...
|licenseType|editionUpgradeLicenseType|**TODO: Add Description**. Possible values are: `productKey`, `licenseFile`, `notConfigured`.|
...
|windowsSMode|windowsSModeConfiguration|**TODO: Add Description**. Possible values are: `noRestriction`, `block`, `unlock`.|
...
-->
``` http
PATCH https://graph.microsoft.com/beta** Entity URI for microsoft.graph.editionUpgradeConfiguration not found
...
{
  "@odata.type": "#microsoft.graph.editionUpgradeConfiguration",
  "id": "704facee-acee-704f-eeac-4f70eeac4f70",

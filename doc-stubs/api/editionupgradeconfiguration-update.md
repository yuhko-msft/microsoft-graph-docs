...
The following table shows the properties that are required when you update the [editionUpgradeConfiguration](../resources/editionupgradeconfiguration.md).
...
{
  "@odata.type": "#microsoft.graph.editionUpgradeConfiguration",
  "id": "7c5613ef-13ef-7c56-ef13-567cef13567c",

...
description: "Update the properties of an androidDeviceOwnerScepCertificateProfile object."
...
# Update androidDeviceOwnerScepCertificateProfile
Namespace: microsoft.graph

[!INCLUDE [beta-disclaimer](../../includes/beta-disclaimer.md)]

Update the properties of an [androidDeviceOwnerScepCertificateProfile](../resources/androiddeviceownerscepcertificateprofile.md) object.
...
-->
``` http
PATCH ** Entity URI for microsoft.graph.androidDeviceOwnerScepCertificateProfile not found
```
...
The following table shows the properties that are required when you update the [androidDeviceOwnerScepCertificateProfile](../resources/androiddeviceownerscepcertificateprofile.md).
...
If successful, this method returns a `200 OK` response code and an updated [androidDeviceOwnerScepCertificateProfile](../resources/androiddeviceownerscepcertificateprofile.md) object in the response body.
...
<!-- {
  "blockType": "request",
  "name": "update_androiddeviceownerscepcertificateprofile"
}
-->
``` http
PATCH https://graph.microsoft.com/beta** Entity URI for microsoft.graph.androidDeviceOwnerScepCertificateProfile not found
...
{
  "@odata.type": "#microsoft.graph.androidDeviceOwnerScepCertificateProfile",
  "id": "9a39d897-d897-9a39-97d8-399a97d8399a",

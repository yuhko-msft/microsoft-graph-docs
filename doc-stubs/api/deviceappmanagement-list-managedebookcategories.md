...
description: "Get the managedEBookCategory resources from the managedEBookCategories navigation property."
...
Get the managedEBookCategory resources from the managedEBookCategories navigation property.
...
-->
``` http
GET https://graph.microsoft.com/v1.0/deviceAppManagement/managedEBookCategories
```

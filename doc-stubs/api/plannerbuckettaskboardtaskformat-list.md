...
description: "Get a list of the plannerBucketTaskBoardTaskFormat objects and their properties."
...
Get a list of the [plannerBucketTaskBoardTaskFormat](../resources/plannerbuckettaskboardtaskformat.md) objects and their properties.
...
-->
``` http
GET https://graph.microsoft.com/beta** Collection URI for microsoft.graph.plannerBucketTaskBoardTaskFormat not found
```

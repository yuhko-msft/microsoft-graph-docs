---
title: "windowsPhone81GeneralConfiguration: assign"
...
# windowsPhone81GeneralConfiguration: assign
...
-->
``` http
POST ** Entity URI for microsoft.graph.windowsPhone81GeneralConfiguration not found/assign
```
...
<!-- {
  "blockType": "request",
  "name": "windowsphone81generalconfiguration_assign"
}
-->
``` http
POST https://graph.microsoft.com/beta** Entity URI for microsoft.graph.windowsPhone81GeneralConfiguration not found/assign

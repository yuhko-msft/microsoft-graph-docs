---
title: "List settings"
description: "Get the groupSetting resources from the settings navigation property."
...
Get the groupSetting resources from the settings navigation property.
...
-->
``` http
GET https://graph.microsoft.com/v1.0/groups/{groupsId}/settings
```

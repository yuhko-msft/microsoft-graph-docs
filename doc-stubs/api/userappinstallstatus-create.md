...
Create a new [userAppInstallStatus](../resources/userappinstallstatus.md) object.
...
-->
``` http
POST https://graph.microsoft.com/v1.0/deviceAppManagement/mobileApps/{mobileAppId}/userStatuses

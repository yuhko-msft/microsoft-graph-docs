...
Create a new [androidVpnConfiguration](../resources/androidvpnconfiguration.md) object.
...
-->
``` http
POST ** Collection URI for microsoft.graph.androidVpnConfiguration not found
```
...
The following table shows the properties that are required when you create the [androidVpnConfiguration](../resources/androidvpnconfiguration.md).
...
If successful, this method returns a `201 Created` response code and an [androidVpnConfiguration](../resources/androidvpnconfiguration.md) object in the response body.
...
<!-- {
  "blockType": "request",
  "name": "create_androidvpnconfiguration_from_"
}
-->
``` http
POST https://graph.microsoft.com/beta** Collection URI for microsoft.graph.androidVpnConfiguration not found
...
{
  "@odata.type": "#microsoft.graph.androidVpnConfiguration",
  "id": "d38489ad-89ad-d384-ad89-84d3ad8984d3",

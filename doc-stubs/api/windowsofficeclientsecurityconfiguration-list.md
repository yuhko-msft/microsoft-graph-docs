...
description: "Get a list of the windowsOfficeClientSecurityConfiguration objects and their properties."
...
Get a list of the [windowsOfficeClientSecurityConfiguration](../resources/windowsofficeclientsecurityconfiguration.md) objects and their properties.
...
<!-- {
  "blockType": "request",
  "name": "list_windowsofficeclientsecurityconfiguration"
}
-->
``` http
GET https://graph.microsoft.com/beta** Collection URI for microsoft.graph.windowsOfficeClientSecurityConfiguration not found
```

...
-->
``` http
GET /teams/{teamsId}/channels/{channelId}/messages/{chatMessageId}/hostedContents/{chatMessageHostedContentId}
```
...
-->
``` http
GET https://graph.microsoft.com/beta/teams/{teamsId}/channels/{channelId}/messages/{chatMessageId}/hostedContents/{chatMessageHostedContentId}
```
...

{
  "value": {
    "@odata.type": "#microsoft.graph.chatMessageHostedContent",
    "id": "116c41ed-41ed-116c-ed41-6c11ed416c11",
    "contentBytes": "Binary",
    "contentType": "String"
  }
}

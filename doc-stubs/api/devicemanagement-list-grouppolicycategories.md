...
description: "Get the groupPolicyCategory resources from the groupPolicyCategories navigation property."
...
Get the groupPolicyCategory resources from the groupPolicyCategories navigation property.
...
-->
``` http
GET https://graph.microsoft.com/v1.0/deviceManagement/groupPolicyCategories
```

...
-->
``` http
GET /user/{userId}/profile/addresses
```
...
-->
``` http
GET https://graph.microsoft.com/beta/user/{userId}/profile/addresses
```
...
<!-- {
  "blockType": "response",
  "truncated": true,
  "@odata.type": "Collection(Microsoft.Fast.PI.ViewGenerator.V2.Profile.Models.itemAddress)"
}
-->
``` http
HTTP/1.1 200 OK

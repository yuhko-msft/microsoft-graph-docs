...
Read the properties and relationships of a [remoteAssistancePartner](../resources/intune-remoteassistancepartner.md) object.
...
If successful, this method returns a `200 OK` response code and a [remoteAssistancePartner](../resources/intune-remoteassistancepartner.md) object in the response body.

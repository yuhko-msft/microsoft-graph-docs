...
description: "Get a list of the editionUpgradeConfiguration objects and their properties."
...
Get a list of the [editionUpgradeConfiguration](../resources/editionupgradeconfiguration.md) objects and their properties.
...
<!-- {
  "blockType": "request",
  "name": "list_editionupgradeconfiguration"
}
-->
``` http
GET https://graph.microsoft.com/beta** Collection URI for microsoft.graph.editionUpgradeConfiguration not found
```

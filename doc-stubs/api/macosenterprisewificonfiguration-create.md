...
-->
``` http
POST ** Collection URI for microsoft.graph.macOSEnterpriseWiFiConfiguration not found
```
...
<!-- {
  "blockType": "request",
  "name": "create_macosenterprisewificonfiguration_from_"
}
-->
``` http
POST https://graph.microsoft.com/beta** Collection URI for microsoft.graph.macOSEnterpriseWiFiConfiguration not found

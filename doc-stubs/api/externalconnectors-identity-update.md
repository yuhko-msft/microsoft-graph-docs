...
Update the properties of an [identity](../resources/externalconnectors-identity.md) object.
...
The following table shows the properties that are required when you update the [identity](../resources/externalconnectors-identity.md).
...
If successful, this method returns a `200 OK` response code and an updated [identity](../resources/externalconnectors-identity.md) object in the response body.

...
-->
``` http
GET /user/tasks/lists/{wellKnownTaskListId}/tasks/{taskId}/parentList/extensions
```
...
-->
``` http
GET https://graph.microsoft.com/beta/user/tasks/lists/{wellKnownTaskListId}/tasks/{taskId}/parentList/extensions
```

...
-->
``` http
POST ** Collection URI for microsoft.graph.androidDeviceOwnerCertificateProfileBase not found/$ref
```
...
If successful, this method returns a `204 No Content` response code and an [androidDeviceOwnerCertificateProfileBase](../resources/androiddeviceownercertificateprofilebase.md) object in the response body.
...
-->
``` http
POST https://graph.microsoft.com/beta** Collection URI for microsoft.graph.androidDeviceOwnerCertificateProfileBase not found/$ref
...
{
  "@odata.type": "#microsoft.graph.androidDeviceOwnerCertificateProfileBase",
  "id": "9a05cc8e-cc8e-9a05-8ecc-059a8ecc059a",

---
title: "workbookFunctions: dproduct"
...
-->
``` http
POST /workbooks/{workbooksId}/workbook/functions/dproduct
```
...
<!-- {
  "blockType": "request",
  "name": "workbookfunctions_dproduct"
}
-->
``` http
POST https://graph.microsoft.com/beta/workbooks/{workbooksId}/workbook/functions/dproduct

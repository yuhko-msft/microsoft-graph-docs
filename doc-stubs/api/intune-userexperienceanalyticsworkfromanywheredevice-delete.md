...
description: "Deletes a userExperienceAnalyticsWorkFromAnywhereDevice object."
...
Deletes a [userExperienceAnalyticsWorkFromAnywhereDevice](../resources/intune-userexperienceanalyticsworkfromanywheredevice.md) object.
...
<!-- {
  "blockType": "request",
  "name": "delete_userexperienceanalyticsworkfromanywheredevice"
}
-->
``` http

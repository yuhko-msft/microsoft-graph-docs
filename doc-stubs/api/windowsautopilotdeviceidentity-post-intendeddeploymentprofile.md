...
description: "Add intendedDeploymentProfile by posting to the intendedDeploymentProfile collection."
...
Add intendedDeploymentProfile by posting to the intendedDeploymentProfile collection.
...
-->
``` http
POST /deviceManagement/windowsAutopilotDeploymentProfiles/{windowsAutopilotDeploymentProfileId}/assignedDevices/{windowsAutopilotDeviceIdentityId}/intendedDeploymentProfile/$ref
```
...
-->
``` http
POST https://graph.microsoft.com/v1.0/deviceManagement/windowsAutopilotDeploymentProfiles/{windowsAutopilotDeploymentProfileId}/assignedDevices/{windowsAutopilotDeviceIdentityId}/intendedDeploymentProfile/$ref

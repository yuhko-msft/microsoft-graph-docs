...
-->
``` http
POST /app/calls/{callId}/unmute
POST /communications/calls/{callId}/unmute
POST /participantLeftNotification/call/unmute
POST /participantJoiningNotification/call/unmute
```
...
-->
``` http
POST https://graph.microsoft.com/beta/app/calls/{callId}/unmute

---
title: "workbookFunctions: daverage"
...
-->
``` http
POST /workbooks/{workbooksId}/workbook/functions/daverage
```
...
<!-- {
  "blockType": "request",
  "name": "workbookfunctions_daverage"
}
-->
``` http
POST https://graph.microsoft.com/beta/workbooks/{workbooksId}/workbook/functions/daverage

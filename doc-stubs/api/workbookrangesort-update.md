...
The following table shows the properties that are required when you update the [workbookRangeSort](../resources/workbookrangesort.md).
...
-->
``` http
PATCH https://graph.microsoft.com/beta/workbookRange/sort

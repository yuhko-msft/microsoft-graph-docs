---
title: "Update managedDeviceCertificateStates"
description: "Update the properties of a managedDeviceCertificateStates object."
...
# Update managedDeviceCertificateStates
Namespace: microsoft.graph

Update the properties of a managedDeviceCertificateStates object.
...
-->
``` http
PATCH ** Collection URI for microsoft.graph.managedDeviceCertificateState not found
```
...
<!-- {
  "blockType": "request",
  "name": "update_manageddevicecertificatestates"
}
-->
``` http
PATCH https://graph.microsoft.com/beta** Collection URI for microsoft.graph.managedDeviceCertificateState not found

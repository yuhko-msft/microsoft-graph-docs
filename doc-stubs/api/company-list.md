...
description: "Get a list of the company objects and their properties."
...
Get a list of the [company](../resources/company.md) objects and their properties.
...
-->
``` http
GET https://graph.microsoft.com/v1.0/financials/companies
```

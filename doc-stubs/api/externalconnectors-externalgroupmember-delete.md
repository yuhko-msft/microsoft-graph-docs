...
Deletes an [externalGroupMember](../resources/externalconnectors-externalgroupmember.md) object.
...
-->
``` http
DELETE https://graph.microsoft.com/v1.0/connections/{connectionsId}/groups/{externalGroupId}/members/{externalGroupMemberId}
```

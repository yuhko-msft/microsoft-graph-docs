...
The following table shows the properties that are required when you update the [secureScore](../resources/securescore.md).
...
{
  "@odata.type": "#microsoft.graph.secureScore",
  "id": "483e7dcb-7dcb-483e-cb7d-3e48cb7d3e48",
  "activeUserCount": "Integer",
  "averageComparativeScores": [
    {
      "@odata.type": "microsoft.graph.averageComparativeScore"

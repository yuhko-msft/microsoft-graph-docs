---
title: "extensionProperty: restore"
...
-->
``` http
POST https://graph.microsoft.com/v1.0/applications/{applicationsId}/extensionProperties/{extensionPropertyId}/restore
```

...
-->
``` http
GET https://graph.microsoft.com/beta** Collection URI for microsoft.graph.deviceManagementIntegerSettingInstance not found
```
  ...
  "value": [
    {
      ...
      "id": "eab046a1-46a1-eab0-a146-b0eaa146b0ea",
      "definitionId": "String",
      "valueJson": "String",
      "value": "Integer"
    }

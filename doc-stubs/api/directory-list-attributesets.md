...
description: "Get the attributeSet resources from the attributeSets navigation property."
...
Get the attributeSet resources from the attributeSets navigation property.
...
<!-- {
  "blockType": "response",
  "truncated": true,
  "@odata.type": "Collection(Microsoft.DirectoryServices.attributeSet)"
}
-->
``` http
HTTP/1.1 200 OK

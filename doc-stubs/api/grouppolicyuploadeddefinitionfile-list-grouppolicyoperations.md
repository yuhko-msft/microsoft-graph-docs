...
description: "Get the groupPolicyOperation resources from the groupPolicyOperations navigation property."
...
Get the groupPolicyOperation resources from the groupPolicyOperations navigation property.
...
<!-- {
  "blockType": "request",
  "name": "list_grouppolicyoperation"
}
-->
``` http
GET https://graph.microsoft.com/v1.0** Collection URI for microsoft.graph.groupPolicyOperation not found
```

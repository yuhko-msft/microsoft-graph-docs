---
title: "reportRoot: managedDeviceEnrollmentTopFailures"
...
# reportRoot: managedDeviceEnrollmentTopFailures
...
GET /print/reports/managedDeviceEnrollmentTopFailures
```
...
<!-- {
  "blockType": "request",
  "name": "reportroot_manageddeviceenrollmenttopfailures"
}
-->
``` http

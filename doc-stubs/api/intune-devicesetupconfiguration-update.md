...
Update the properties of a [deviceSetupConfiguration](../resources/intune-devicesetupconfiguration.md) object.
...
If successful, this method returns a `200 OK` response code and an updated [deviceSetupConfiguration](../resources/intune-devicesetupconfiguration.md) object in the response body.

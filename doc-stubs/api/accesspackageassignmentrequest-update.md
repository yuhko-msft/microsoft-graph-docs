...
-->
``` http
PATCH /entitlementManagement/assignmentRequests/{accessPackageAssignmentRequestId}
```
...
-->
``` http
PATCH https://graph.microsoft.com/v1.0/entitlementManagement/assignmentRequests/{accessPackageAssignmentRequestId}

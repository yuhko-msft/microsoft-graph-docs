...
description: "Get the deviceAppManagementTask resources from the deviceAppManagementTasks navigation property."
...
Get the deviceAppManagementTask resources from the deviceAppManagementTasks navigation property.
...
<!-- {
  "blockType": "request",
  "name": "list_deviceappmanagementtask"
}
-->
``` http
GET https://graph.microsoft.com/v1.0/deviceAppManagement/deviceAppManagementTasks
```

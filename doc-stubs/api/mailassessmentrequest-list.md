...
description: "Get a list of the mailAssessmentRequest objects and their properties."
...
Get a list of the [mailAssessmentRequest](../resources/mailassessmentrequest.md) objects and their properties.
...
<!-- {
  "blockType": "request",
  "name": "list_mailassessmentrequest"
}
-->
``` http
GET https://graph.microsoft.com/beta** Collection URI for microsoft.graph.mailAssessmentRequest not found
```

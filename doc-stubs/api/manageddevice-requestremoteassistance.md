...
-->
``` http
POST /me/managedDevices/{managedDeviceId}/requestRemoteAssistance
...
-->
``` http
POST https://graph.microsoft.com/beta/me/managedDevices/{managedDeviceId}/requestRemoteAssistance
```

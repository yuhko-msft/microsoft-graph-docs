...
description: "Get the windowsManagementAppHealthState resources from the healthStates navigation property."
...
Get the windowsManagementAppHealthState resources from the healthStates navigation property.
...
<!-- {
  "blockType": "response",
  "truncated": true,
  "@odata.type": "Collection(microsoft.management.services.api.windowsManagementAppHealthState)"
}
-->
``` http
HTTP/1.1 200 OK
  ...
  "value": [
    {
      ...
      "id": "efe365fe-65fe-efe3-fe65-e3effe65e3ef",
      "healthState": "String",

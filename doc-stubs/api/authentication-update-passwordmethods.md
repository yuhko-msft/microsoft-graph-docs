...
description: "Update the properties of a passwordMethods object."
...
Update the properties of a passwordMethods object.
...
-->
``` http
PATCH /user/authentication/passwordMethods
```
...
-->
``` http
PATCH https://graph.microsoft.com/beta/user/authentication/passwordMethods

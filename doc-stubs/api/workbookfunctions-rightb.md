---
title: "workbookFunctions: rightb"
...
-->
``` http
POST /workbooks/{workbooksId}/workbook/functions/rightb
```
...
<!-- {
  "blockType": "request",
  "name": "workbookfunctions_rightb"
}
-->
``` http
POST https://graph.microsoft.com/beta/workbooks/{workbooksId}/workbook/functions/rightb

...
-->
``` http
PATCH /drives/{drivesId}/list/contentTypes/{contentTypeId}/columns
```
...
-->
``` http
PATCH https://graph.microsoft.com/beta/drives/{drivesId}/list/contentTypes/{contentTypeId}/columns

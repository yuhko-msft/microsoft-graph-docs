...
description: "Get a list of the workbookChartTitleFormat objects and their properties."
...
Get a list of the [workbookChartTitleFormat](../resources/workbookcharttitleformat.md) objects and their properties.
...
-->
``` http
GET https://graph.microsoft.com/beta** Collection URI for microsoft.graph.workbookChartTitleFormat not found
```

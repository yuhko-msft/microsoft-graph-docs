...
Deletes an [emailAuthenticationMethodConfiguration](../resources/emailauthenticationmethodconfiguration.md) object.
...
-->
``` http
DELETE https://graph.microsoft.com/beta/emailAuthenticationMethodConfiguration
```

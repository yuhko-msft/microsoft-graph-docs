...
Create a new [unifiedRoleAssignmentSchedule](../resources/unifiedroleassignmentschedule.md) object.
...
-->
``` http
POST /rbacApplication/roleAssignmentSchedules
```
...
-->
``` http
POST https://graph.microsoft.com/beta/rbacApplication/roleAssignmentSchedules

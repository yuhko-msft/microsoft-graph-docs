...
description: "Deletes a microsoftTunnelConfiguration object."
...
Deletes a [microsoftTunnelConfiguration](../resources/intune-microsofttunnelconfiguration.md) object.
...
<!-- {
  "blockType": "request",
  "name": "delete_microsofttunnelconfiguration"
}
-->
``` http

...
-->
``` http
GET ** Collection URI for Microsoft.DirectoryServices.authorizationPolicy not found
```
...
-->
``` http
GET https://graph.microsoft.com/v1.0** Collection URI for Microsoft.DirectoryServices.authorizationPolicy not found
```

---
title: "emailSecurityEventsRoot: movetoInbox"
...
# emailSecurityEventsRoot: movetoInbox
...
-->
``` http
POST /security/emailSecurityEvents/movetoInbox
```
...
<!-- {
  "blockType": "request",
  "name": "emailsecurityeventsroot_movetoinbox"
}
-->
``` http
POST https://graph.microsoft.com/beta/security/emailSecurityEvents/movetoInbox

---
title: "workbookFunctions: dcountA"
...
-->
``` http
POST /workbooks/{workbooksId}/workbook/functions/dcountA
```
...
<!-- {
  "blockType": "request",
  "name": "workbookfunctions_dcounta"
}
-->
``` http
POST https://graph.microsoft.com/beta/workbooks/{workbooksId}/workbook/functions/dcountA

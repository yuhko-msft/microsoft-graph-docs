...
-->
``` http
PATCH /skypeForBusinessActivityCounts
```
...
The following table shows the properties that are required when you update the [skypeForBusinessActivityCounts](../resources/skypeforbusinessactivitycounts.md).
...
-->
``` http
PATCH https://graph.microsoft.com/v1.0/skypeForBusinessActivityCounts

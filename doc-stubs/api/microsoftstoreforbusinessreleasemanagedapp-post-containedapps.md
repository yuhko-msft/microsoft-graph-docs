...
-->
``` http
POST /deviceAppManagement/mobileApps/{mobileAppId}/containedApps
```
...
If successful, this method returns a `201 Created` response code and a [mobileContainedApp](../resources/intune-mobilecontainedapp.md) object in the response body.
...
-->
``` http
POST https://graph.microsoft.com/beta/deviceAppManagement/mobileApps/{mobileAppId}/containedApps
...
{
  "@odata.type": "#microsoft.graph.mobileContainedApp",
  "id": "1601f137-f137-1601-37f1-011637f10116"
}
```

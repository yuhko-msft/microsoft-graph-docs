---
title: "workbookFunctions: yieldMat"
...
-->
``` http
POST /workbooks/{workbooksId}/workbook/functions/yieldMat
```
...
<!-- {
  "blockType": "request",
  "name": "workbookfunctions_yieldmat"
}
-->
``` http
POST https://graph.microsoft.com/beta/workbooks/{workbooksId}/workbook/functions/yieldMat

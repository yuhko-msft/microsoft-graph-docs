...
-->
``` http
GET /users/{usersId}/mailFolders/{mailFolderId}/messages/{messageId}/event
```
...
-->
``` http
GET https://graph.microsoft.com/beta/users/{usersId}/mailFolders/{mailFolderId}/messages/{messageId}/event
```

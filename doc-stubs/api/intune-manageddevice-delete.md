...
description: "Deletes a managedDevice object."
...
Deletes a [managedDevice](../resources/intune-manageddevice.md) object.
...
-->
``` http
DELETE https://graph.microsoft.com/beta/me/managedDevices/{managedDeviceId}
```

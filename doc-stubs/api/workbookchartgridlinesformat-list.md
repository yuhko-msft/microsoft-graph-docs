...
description: "Get a list of the workbookChartGridlinesFormat objects and their properties."
...
Get a list of the [workbookChartGridlinesFormat](../resources/workbookchartgridlinesformat.md) objects and their properties.
...
-->
``` http
GET https://graph.microsoft.com/beta** Collection URI for microsoft.graph.workbookChartGridlinesFormat not found
```

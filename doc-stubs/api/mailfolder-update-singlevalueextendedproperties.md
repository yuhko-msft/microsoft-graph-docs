...
-->
``` http
PATCH /users/{usersId}/mailFolders/{mailFolderId}/singleValueExtendedProperties
```
...
-->
``` http
PATCH https://graph.microsoft.com/beta/users/{usersId}/mailFolders/{mailFolderId}/singleValueExtendedProperties

...
description: "Update the properties of a temporaryAccessPassMethods object."
...
Update the properties of a temporaryAccessPassMethods object.
...
-->
``` http
PATCH /user/authentication/temporaryAccessPassMethods
```
...
-->
``` http
PATCH https://graph.microsoft.com/beta/user/authentication/temporaryAccessPassMethods
...
{
  "@odata.type": "#microsoft.graph.temporaryAccessPassAuthenticationMethod",
  "id": "7fce7a75-7a75-7fce-757a-ce7f757ace7f",
  "temporaryAccessPass": "String",

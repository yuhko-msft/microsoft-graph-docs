...
-->
``` http
POST /administrativeUnit/scopedRoleMembers
```
...
-->
``` http
POST https://graph.microsoft.com/v1.0/administrativeUnit/scopedRoleMembers
...
{
  "@odata.type": "#Microsoft.DirectoryServices.scopedRoleMembership",
  "id": "e618d179-d179-e618-79d1-18e679d118e6",
  "roleId": "String",
  "administrativeUnitId": "String",
  "roleMemberInfo": {
    "@odata.type": "microsoft.graph.identity"

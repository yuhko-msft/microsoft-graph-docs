...
Read the properties and relationships of an [androidWorkProfileEnterpriseWiFiConfiguration](../resources/intune-androidworkprofileenterprisewificonfiguration.md) object.
...
If successful, this method returns a `200 OK` response code and an [androidWorkProfileEnterpriseWiFiConfiguration](../resources/intune-androidworkprofileenterprisewificonfiguration.md) object in the response body.

...
-->
``` http
GET /deviceManagementConfigurationPolicyTemplate/settingTemplates
```
...
-->
``` http
GET https://graph.microsoft.com/beta/deviceManagementConfigurationPolicyTemplate/settingTemplates
```

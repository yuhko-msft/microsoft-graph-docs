...
The following table shows the properties that are required when you update the [continuousAccessEvaluationPolicy](../resources/continuousaccessevaluationpolicy.md).
...
-->
``` http
PATCH https://graph.microsoft.com/v1.0/identity/continuousAccessEvaluationPolicy

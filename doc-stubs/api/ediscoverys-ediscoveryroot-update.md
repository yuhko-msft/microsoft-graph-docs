...
Update the properties of an [ediscoveryroot](../resources/ediscoverys-ediscoveryroot.md) object.
...
The following table shows the properties that are required when you update the [ediscoveryroot](../resources/ediscoverys-ediscoveryroot.md).
...
If successful, this method returns a `200 OK` response code and an updated [ediscoveryroot](../resources/ediscoverys-ediscoveryroot.md) object in the response body.

...
Update the properties of a [managedIOSStoreApp](../resources/managediosstoreapp.md) object.
...
-->
``` http
PATCH ** Entity URI for microsoft.graph.managedIOSStoreApp not found
```
...
The following table shows the properties that are required when you update the [managedIOSStoreApp](../resources/managediosstoreapp.md).
...
If successful, this method returns a `200 OK` response code and an updated [managedIOSStoreApp](../resources/managediosstoreapp.md) object in the response body.
...
<!-- {
  "blockType": "request",
  "name": "update_managediosstoreapp"
}
-->
``` http
PATCH https://graph.microsoft.com/beta** Entity URI for microsoft.graph.managedIOSStoreApp not found

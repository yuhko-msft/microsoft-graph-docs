...
-->
``` http
PATCH ** Entity URI for microsoft.management.services.api.managedIOSStoreApp not found
```
...
-->
``` http
PATCH https://graph.microsoft.com/beta** Entity URI for microsoft.management.services.api.managedIOSStoreApp not found
...
{
  "@odata.type": "#microsoft.graph.managedIOSStoreApp",
  "id": "74d6ab7f-ab7f-74d6-7fab-d6747fabd674",
  "displayName": "String",
  "description": "String",
  "publisher": "String",
  "largeIcon": {

...
description: "Get the groupLifecyclePolicy resources from the groupLifecyclePolicies navigation property."
...
Get the groupLifecyclePolicy resources from the groupLifecyclePolicies navigation property.
...
<!-- {
  "blockType": "request",
  "name": "list_grouplifecyclepolicy"
}
-->
``` http

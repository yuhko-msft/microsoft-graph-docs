---
title: "workbookFunctions: besselY"
...
-->
``` http
POST /workbooks/{workbooksId}/workbook/functions/besselY
```
...
<!-- {
  "blockType": "request",
  "name": "workbookfunctions_bessely"
}
-->
``` http
POST https://graph.microsoft.com/beta/workbooks/{workbooksId}/workbook/functions/besselY

---
title: "emailEventRoot: softDelete"
...
-->
``` http
POST /security/emailEvent/softDelete
```
...
<!-- {
  "blockType": "request",
  "name": "emaileventroot_softdelete"
}
-->
``` http
POST https://graph.microsoft.com/beta/security/emailEvent/softDelete

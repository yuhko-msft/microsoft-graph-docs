...
-->
``` http
GET https://graph.microsoft.com/v1.0** Collection URI for microsoft.graph.reportRoot not found/getOverallPrintUsageSummary(periodStart=String (timestamp),periodEnd=String (timestamp),topListsSize=Integer)
```

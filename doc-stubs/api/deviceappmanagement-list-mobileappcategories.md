...
description: "Get the mobileAppCategory resources from the mobileAppCategories navigation property."
...
Get the mobileAppCategory resources from the mobileAppCategories navigation property.
...
<!-- {
  "blockType": "response",
  "truncated": true,
  "@odata.type": "Collection(microsoft.management.services.api.mobileAppCategory)"
}
-->
``` http
HTTP/1.1 200 OK

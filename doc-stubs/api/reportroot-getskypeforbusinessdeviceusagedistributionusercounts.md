...
GET /print/reports/getSkypeForBusinessDeviceUsageDistributionUserCounts
```
...
-->
``` http
GET https://graph.microsoft.com/v1.0/reports/getSkypeForBusinessDeviceUsageDistributionUserCounts(period='parameterValue')
```

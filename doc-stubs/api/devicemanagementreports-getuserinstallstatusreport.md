---
title: "deviceManagementReports: getUserInstallStatusReport"
...
# deviceManagementReports: getUserInstallStatusReport
...
-->
``` http
POST /deviceManagementReports/getUserInstallStatusReport
```
...
<!-- {
  "blockType": "request",
  "name": "devicemanagementreports_getuserinstallstatusreport"
}
-->
``` http
POST https://graph.microsoft.com/beta/deviceManagementReports/getUserInstallStatusReport

...
-->
``` http
POST https://graph.microsoft.com/beta** Collection URI for microsoft.graph.delegatedPermissionClassification not found
...
{
  "@odata.type": "#microsoft.graph.delegatedPermissionClassification",
  "id": "68d11756-1756-68d1-5617-d1685617d168",
  "permissionId": "String",
  "permissionName": "String",
  "classification": "String"
}

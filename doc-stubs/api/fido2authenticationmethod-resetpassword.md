...
-->
``` http
POST /me/authentication/fido2Methods/{fido2AuthenticationMethodId}/resetPassword
POST /users/{usersId}/authentication/fido2Methods/{fido2AuthenticationMethodId}/resetPassword
```
...
-->
``` http
POST https://graph.microsoft.com/beta/me/authentication/fido2Methods/{fido2AuthenticationMethodId}/resetPassword

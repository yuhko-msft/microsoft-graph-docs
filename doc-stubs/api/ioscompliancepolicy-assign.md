---
title: "iosCompliancePolicy: assign"
...
-->
``` http
POST https://graph.microsoft.com/beta** Entity URI for microsoft.graph.iosCompliancePolicy not found/assign

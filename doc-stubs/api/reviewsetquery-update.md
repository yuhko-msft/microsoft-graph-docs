...
-->
``` http
PATCH /compliance/ediscovery/cases/{ediscoveryCaseId}/reviewSets/{reviewSetId}/queries/{reviewSetQueryId}
```
...
-->
``` http
PATCH https://graph.microsoft.com/beta/compliance/ediscovery/cases/{ediscoveryCaseId}/reviewSets/{reviewSetId}/queries/{reviewSetQueryId}
...

{
  ...
  "id": "ad28f57b-f57b-ad28-7bf5-28ad7bf528ad",
  "displayName": "String",

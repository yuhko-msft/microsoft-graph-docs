...
-->
``` http
GET /entitlementManagement/assignmentRequests/{accessPackageAssignmentRequestId}/accessPackage
```
...
-->
``` http
GET https://graph.microsoft.com/v1.0/entitlementManagement/assignmentRequests/{accessPackageAssignmentRequestId}/accessPackage
```

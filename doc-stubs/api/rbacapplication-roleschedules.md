...
-->
``` http
GET https://graph.microsoft.com/v1.0/roleManagement/directory/roleSchedules(directoryScopeId='parameterValue',appScopeId='parameterValue',principalId='parameterValue',roleDefinitionId='parameterValue')
```

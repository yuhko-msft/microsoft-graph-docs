...
-->
``` http
POST /compliance/ediscovery/cases/{caseId}/noncustodialDataSources/{noncustodialDataSourceId}/lastIndexOperation/$ref
```
...
-->
``` http
POST https://graph.microsoft.com/beta/compliance/ediscovery/cases/{caseId}/noncustodialDataSources/{noncustodialDataSourceId}/lastIndexOperation/$ref
...
{
  "@odata.type": "#microsoft.graph.ediscovery.caseIndexOperation",
  "id": "7fc69e5e-9e5e-7fc6-5e9e-c67f5e9ec67f",

...
description: "Update the properties of an iosLobApp object."
...
Update the properties of an [iosLobApp](../resources/ioslobapp.md) object.
...
The following table shows the properties that are required when you update the [iosLobApp](../resources/ioslobapp.md).
...
-->
``` http
PATCH https://graph.microsoft.com/beta** Entity URI for microsoft.graph.iosLobApp not found
...
{
  "@odata.type": "#microsoft.graph.iosLobApp",
  "id": "1b244c61-4c61-1b24-614c-241b614c241b",

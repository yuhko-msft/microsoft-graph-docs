...
GET /print/reports/getSkypeForBusinessDeviceUsageUserDetail
```
...
-->
``` http
GET https://graph.microsoft.com/v1.0/reports/getSkypeForBusinessDeviceUsageUserDetail(period='parameterValue')
```

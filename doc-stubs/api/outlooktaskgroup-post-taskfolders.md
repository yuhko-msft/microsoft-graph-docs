...
-->
``` http
POST /users/{usersId}/outlook/taskGroups/{outlookTaskGroupId}/taskFolders
```
...
-->
``` http
POST https://graph.microsoft.com/beta/users/{usersId}/outlook/taskGroups/{outlookTaskGroupId}/taskFolders

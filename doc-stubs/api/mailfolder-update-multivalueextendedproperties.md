...
-->
``` http
PATCH /users/{usersId}/mailFolders/{mailFolderId}/multiValueExtendedProperties
```
...
-->
``` http
PATCH https://graph.microsoft.com/beta/users/{usersId}/mailFolders/{mailFolderId}/multiValueExtendedProperties

...
-->
``` http
GET /rbacApplication/roleAssignmentRequests/{unifiedRoleAssignmentRequestId}/appScope
```
...
-->
``` http
GET https://graph.microsoft.com/beta/rbacApplication/roleAssignmentRequests/{unifiedRoleAssignmentRequestId}/appScope
```

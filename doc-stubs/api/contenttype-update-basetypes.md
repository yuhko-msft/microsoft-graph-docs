---
title: "Update baseTypes"
description: "Update the properties of a baseTypes object."
...
Update the properties of a baseTypes object.
...
-->
``` http
PATCH /drives/{drivesId}/list/contentTypes/{contentTypeId}/baseTypes
```
...
<!-- {
  "blockType": "request",
  "name": "update_basetypes"
}
-->
``` http
PATCH https://graph.microsoft.com/beta/drives/{drivesId}/list/contentTypes/{contentTypeId}/baseTypes

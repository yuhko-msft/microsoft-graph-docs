...
-->
``` http
POST /groups/{groupsId}/calendar/calendarView/{eventId}/exceptionOccurrences
```
...
-->
``` http
POST https://graph.microsoft.com/v1.0/groups/{groupsId}/calendar/calendarView/{eventId}/exceptionOccurrences

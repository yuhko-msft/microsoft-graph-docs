...
-->
``` http
POST /users/{usersId}/calendar/calendarView/{eventId}/exceptionOccurrences
```
...
-->
``` http
POST https://graph.microsoft.com/beta/users/{usersId}/calendar/calendarView/{eventId}/exceptionOccurrences

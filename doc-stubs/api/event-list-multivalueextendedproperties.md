...
-->
``` http
GET /users/{usersId}/calendar/calendarView/{eventId}/multiValueExtendedProperties
```
...
-->
``` http
GET https://graph.microsoft.com/beta/users/{usersId}/calendar/calendarView/{eventId}/multiValueExtendedProperties
```

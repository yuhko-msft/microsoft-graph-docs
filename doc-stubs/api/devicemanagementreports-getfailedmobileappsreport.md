---
title: "deviceManagementReports: getFailedMobileAppsReport"
...
# deviceManagementReports: getFailedMobileAppsReport
...
<!-- {
  "blockType": "request",
  "name": "devicemanagementreports_getfailedmobileappsreport"
}
-->
``` http
POST https://graph.microsoft.com/v1.0/deviceManagement/reports/getFailedMobileAppsReport

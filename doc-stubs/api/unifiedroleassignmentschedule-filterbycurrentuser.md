...
-->
``` http
GET /rbacApplication/roleAssignmentSchedules/filterByCurrentUser
```
...
-->
``` http
GET https://graph.microsoft.com/beta/rbacApplication/roleAssignmentSchedules/filterByCurrentUser(on='parameterValue')
```

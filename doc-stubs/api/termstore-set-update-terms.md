---
title: "Update terms"
description: "Update the properties of a terms object."
...
Update the properties of a terms object.
...
-->
``` http
PATCH /termStore/groups/{groupId}/sets/{setId}/terms
```
...
-->
``` http
PATCH https://graph.microsoft.com/beta/termStore/groups/{groupId}/sets/{setId}/terms

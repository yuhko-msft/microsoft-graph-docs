...
-->
``` http
GET /workbooks/{workbooksId}/activities/{itemActivityOLDId}/listItem/driveItem
```
...
-->
``` http
GET https://graph.microsoft.com/beta/workbooks/{workbooksId}/activities/{itemActivityOLDId}/listItem/driveItem
```

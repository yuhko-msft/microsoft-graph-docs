...
-->
``` http
POST /users/{usersId}/outlook/taskFolders/{outlookTaskFolderId}/multiValueExtendedProperties
```
...
-->
``` http
POST https://graph.microsoft.com/beta/users/{usersId}/outlook/taskFolders/{outlookTaskFolderId}/multiValueExtendedProperties

...
-->
``` http
PATCH /chats/{chatsId}/installedApps/{teamsAppInstallationId}/teamsApp/appDefinitions/{teamsAppDefinitionId}/bot/{teamworkBotId}
```
...
-->
``` http
PATCH https://graph.microsoft.com/beta/chats/{chatsId}/installedApps/{teamsAppInstallationId}/teamsApp/appDefinitions/{teamsAppDefinitionId}/bot/{teamworkBotId}
...
{
  "@odata.type": "#microsoft.graph.teamworkBot",
  "id": "f168bcbc-bcbc-f168-bcbc-68f1bcbc68f1"
}
```

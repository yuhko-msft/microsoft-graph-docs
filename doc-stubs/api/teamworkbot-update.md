...
-->
``` http
PATCH /teams/{teamsId}/channels/{channelId}/tabs/{teamsTabId}/teamsApp/appDefinitions/{teamsAppDefinitionId}/bot
```
...
-->
``` http
PATCH https://graph.microsoft.com/v1.0/teams/{teamsId}/channels/{channelId}/tabs/{teamsTabId}/teamsApp/appDefinitions/{teamsAppDefinitionId}/bot

...
-->
``` http
GET /print/reports/applicationSignInDetailedSummary/{applicationSignInDetailedSummaryId}
```
...
-->
``` http
GET https://graph.microsoft.com/v1.0/print/reports/applicationSignInDetailedSummary/{applicationSignInDetailedSummaryId}
```

...
description: "Update the properties of a localizations object."
...
Update the properties of a localizations object.
...
-->
``` http
PATCH /organization/{organizationId}/branding/localizations
```
...
-->
``` http
PATCH https://graph.microsoft.com/beta/organization/{organizationId}/branding/localizations

...
-->
``` http
POST /me/authentication/temporaryAccessPassMethods/{temporaryAccessPassAuthenticationMethodId}/resetPassword
POST /users/{usersId}/authentication/temporaryAccessPassMethods/{temporaryAccessPassAuthenticationMethodId}/resetPassword
```
...
-->
``` http
POST https://graph.microsoft.com/beta/me/authentication/temporaryAccessPassMethods/{temporaryAccessPassAuthenticationMethodId}/resetPassword

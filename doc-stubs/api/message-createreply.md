...
-->
``` http
POST /users/{usersId}/messages/{messageId}/createReply
POST /users/{usersId}/mailFolders/{mailFolderId}/messages/{messageId}/createReply
```
...
-->
``` http
POST https://graph.microsoft.com/beta/users/{usersId}/messages/{messageId}/createReply

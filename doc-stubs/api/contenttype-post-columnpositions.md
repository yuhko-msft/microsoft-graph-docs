...
description: "Add columnPositions by posting to the columnPositions collection."
...
Add columnPositions by posting to the columnPositions collection.
...
-->
``` http
POST /drives/{drivesId}/list/contentTypes/{contentTypeId}/columnPositions/$ref
```
...
-->
``` http
POST https://graph.microsoft.com/beta/drives/{drivesId}/list/contentTypes/{contentTypeId}/columnPositions/$ref
...
{
  "@odata.type": "#microsoft.graph.columnDefinition",
  "id": "0e0fec85-ec85-0e0f-85ec-0f0e85ec0f0e",
  "boolean": {
    "@odata.type": "microsoft.graph.booleanColumn"
  },
  "calculated": {

---
title: "Create windows10CertificateProfileBase"
description: "Create a new windows10CertificateProfileBase object."
...
# Create windows10CertificateProfileBase
Namespace: microsoft.graph



Create a new [windows10CertificateProfileBase](../resources/windows10certificateprofilebase.md) object.
...
-->
``` http
POST ** Collection URI for microsoft.graph.windows10CertificateProfileBase not found
```
...
The following table shows the properties that are required when you create the [windows10CertificateProfileBase](../resources/windows10certificateprofilebase.md).
...
If successful, this method returns a `201 Created` response code and a [windows10CertificateProfileBase](../resources/windows10certificateprofilebase.md) object in the response body.
...
<!-- {
  "blockType": "request",
  "name": "create_windows10certificateprofilebase_from_"
}
-->
``` http
POST https://graph.microsoft.com/v1.0** Collection URI for microsoft.graph.windows10CertificateProfileBase not found

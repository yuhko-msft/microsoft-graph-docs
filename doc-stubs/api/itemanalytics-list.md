...
description: "Get a list of the itemAnalytics objects and their properties."
...
Get a list of the [itemAnalytics](../resources/itemanalytics.md) objects and their properties.
...
-->
``` http
GET https://graph.microsoft.com/beta** Collection URI for microsoft.graph.itemAnalytics not found
```

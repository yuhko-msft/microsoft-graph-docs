...
-->
``` http
GET /me/appConsentRequestsForApproval/filterByCurrentUser
GET /users/{usersId}/appConsentRequestsForApproval/filterByCurrentUser
...
-->
``` http
GET https://graph.microsoft.com/beta/me/appConsentRequestsForApproval/filterByCurrentUser(on='parameterValue')
```

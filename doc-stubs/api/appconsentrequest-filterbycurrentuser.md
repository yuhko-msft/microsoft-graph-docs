...
-->
``` http
GET /user/appConsentRequestsForApproval/filterByCurrentUser
...
-->
``` http
GET https://graph.microsoft.com/beta/user/appConsentRequestsForApproval/filterByCurrentUser(on='parameterValue')
```

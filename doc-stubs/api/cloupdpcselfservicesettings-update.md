---
title: "Update cloupdPcSelfServiceSettings"
description: "Update the properties of a cloupdPcSelfServiceSettings object."
...
# Update cloupdPcSelfServiceSettings
Namespace: microsoft.graph

Update the properties of a [cloupdPcSelfServiceSettings](../resources/cloupdpcselfservicesettings.md) object.
...
-->
``` http
PATCH /selfServiceSettings/{selfServiceSettingsId}
```
...
<!-- {
  "blockType": "request",
  "name": "update_cloupdpcselfservicesettings"
}
-->
``` http
PATCH https://graph.microsoft.com/beta/selfServiceSettings/{selfServiceSettingsId}

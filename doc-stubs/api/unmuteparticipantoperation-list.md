...
description: "Get a list of the unmuteParticipantOperation objects and their properties."
...
Get a list of the [unmuteParticipantOperation](../resources/unmuteparticipantoperation.md) objects and their properties.
...
<!-- {
  "blockType": "request",
  "name": "list_unmuteparticipantoperation"
}
-->
``` http
GET https://graph.microsoft.com/beta** Collection URI for microsoft.graph.unmuteParticipantOperation not found
```

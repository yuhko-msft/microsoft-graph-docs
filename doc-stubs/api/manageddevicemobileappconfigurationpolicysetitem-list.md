...
description: "Get a list of the managedDeviceMobileAppConfigurationPolicySetItem objects and their properties."
...
Get a list of the [managedDeviceMobileAppConfigurationPolicySetItem](../resources/manageddevicemobileappconfigurationpolicysetitem.md) objects and their properties.
...
<!-- {
  "blockType": "request",
  "name": "list_manageddevicemobileappconfigurationpolicysetitem"
}
-->
``` http
GET https://graph.microsoft.com/v1.0** Collection URI for microsoft.graph.managedDeviceMobileAppConfigurationPolicySetItem not found
```
  ...
  "value": [
    {
      ...
      "id": "99e789c9-89c9-99e7-c989-e799c989e799",

...
description: "Get the runGroup resources from the runGroups navigation property."
...
Get the runGroup resources from the runGroups navigation property.
...
<!-- {
  "blockType": "response",
  "truncated": true,
  "@odata.type": "Collection(microsoft.industryData.runGroup)"
}
-->
``` http
HTTP/1.1 200 OK

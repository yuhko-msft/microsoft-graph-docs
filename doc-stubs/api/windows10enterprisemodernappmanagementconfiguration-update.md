...
## Request body
In the request body, supply a JSON representation of the [windows10EnterpriseModernAppManagementConfiguration](../resources/windows10enterprisemodernappmanagementconfiguration.md) object.

The following table shows the properties that are required when you update the [windows10EnterpriseModernAppManagementConfiguration](../resources/windows10enterprisemodernappmanagementconfiguration.md).
...
-->
``` http
PATCH https://graph.microsoft.com/beta** Entity URI for microsoft.graph.windows10EnterpriseModernAppManagementConfiguration not found
...
{
  "@odata.type": "#microsoft.graph.windows10EnterpriseModernAppManagementConfiguration",
  "id": "3b5b7557-7557-3b5b-5775-5b3b57755b3b",

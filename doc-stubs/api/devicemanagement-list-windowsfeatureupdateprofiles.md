...
description: "Get the windowsFeatureUpdateProfile resources from the windowsFeatureUpdateProfiles navigation property."
...
Get the windowsFeatureUpdateProfile resources from the windowsFeatureUpdateProfiles navigation property.
...
<!-- {
  "blockType": "request",
  "name": "list_windowsfeatureupdateprofile"
}
-->
``` http
GET https://graph.microsoft.com/v1.0/deviceManagement/windowsFeatureUpdateProfiles
```

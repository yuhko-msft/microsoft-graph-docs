...
description: "Read the properties and relationships of a userExperienceAnalyticsModelScores object."
...
Read the properties and relationships of a [userExperienceAnalyticsModelScores](../resources/intune-userexperienceanalyticsmodelscores.md) object.
...
If successful, this method returns a `200 OK` response code and a [userExperienceAnalyticsModelScores](../resources/intune-userexperienceanalyticsmodelscores.md) object in the response body.
...
<!-- {
  "blockType": "request",
  "name": "get_userexperienceanalyticsmodelscores"
}
-->
``` http

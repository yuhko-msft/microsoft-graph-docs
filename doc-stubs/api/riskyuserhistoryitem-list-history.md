---
title: "List history"
description: "Get the riskyUserHistoryItem resources from the history navigation property."
...
Get the riskyUserHistoryItem resources from the history navigation property.
...
-->
``` http
GET https://graph.microsoft.com/v1.0/riskyUsers/{riskyUsersId}/history/{riskyUserHistoryItemId}/history
```

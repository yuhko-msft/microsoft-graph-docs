...
# reportRoot: getPrintUsageSummariesByTimeSpan
...
-->
``` http
GET ** Collection URI for microsoft.graph.reportRoot not found/getPrintUsageSummariesByTimeSpan
```
...
|timeSpanInMinutes|Int32|**TODO: Add Description**|
...
-->
``` http
GET https://graph.microsoft.com/v1.0** Collection URI for microsoft.graph.reportRoot not found/getPrintUsageSummariesByTimeSpan(periodStart=String (timestamp),periodEnd=String (timestamp),timeSpanInMinutes=Integer)
```

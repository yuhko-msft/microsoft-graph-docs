...
-->
``` http
POST ** Collection URI for Microsoft.Teams.Shifts.userSettings not found
```
...
-->
``` http
POST https://graph.microsoft.com/beta** Collection URI for Microsoft.Teams.Shifts.userSettings not found

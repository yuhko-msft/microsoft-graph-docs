...
Get a list of the [macOSCustomConfiguration](../resources/intune-macoscustomconfiguration.md) objects and their properties.
...
<!-- {
  "blockType": "request",
  "name": "list_macoscustomconfiguration"
}
-->
``` http

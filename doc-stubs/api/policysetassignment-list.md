...
description: "Get a list of the policySetAssignment objects and their properties."
...
Get a list of the [policySetAssignment](../resources/policysetassignment.md) objects and their properties.
...
<!-- {
  "blockType": "request",
  "name": "list_policysetassignment"
}
-->
``` http
GET https://graph.microsoft.com/v1.0/deviceAppManagement/policySets/{policySetId}/assignments
```

...
description: "Get the educationCategory resources from the categories navigation property."
...
Get the educationCategory resources from the categories navigation property.
...
<!-- {
  "blockType": "request",
  "name": "list_educationcategory"
}
-->
``` http
GET https://graph.microsoft.com/v1.0/education/classes/{educationClassId}/assignments/{educationAssignmentId}/categories
```

---
title: "workbookFunctions: coupDayBs"
...
-->
``` http
POST /workbooks/{workbooksId}/workbook/functions/coupDayBs
```
...
<!-- {
  "blockType": "request",
  "name": "workbookfunctions_coupdaybs"
}
-->
``` http
POST https://graph.microsoft.com/beta/workbooks/{workbooksId}/workbook/functions/coupDayBs

...
-->
``` http
POST /users/{usersId}/notes/{noteId}/extensions
```
...
-->
``` http
POST https://graph.microsoft.com/v1.0/users/{usersId}/notes/{noteId}/extensions
...
{
  "@odata.type": "#microsoft.graph.extension",
  "id": "db47c5c0-c5c0-db47-c0c5-47dbc0c547db"
}
```

...
description: "Get a list of the privilegedRole objects and their properties."
...
Get a list of the [privilegedRole](../resources/privilegedrole.md) objects and their properties.
...
-->
``` http
GET https://graph.microsoft.com/v1.0/privilegedRoles
```

...
If successful, this method returns a `201 Created` response code and an [androidForWorkPkcsCertificateProfile](../resources/androidforworkpkcscertificateprofile.md) object in the response body.
...
-->
``` http
POST https://graph.microsoft.com/beta** Collection URI for microsoft.graph.androidForWorkPkcsCertificateProfile not found
...
{
  "@odata.type": "#microsoft.graph.androidForWorkPkcsCertificateProfile",
  "id": "5d81be9b-be9b-5d81-9bbe-815d9bbe815d",

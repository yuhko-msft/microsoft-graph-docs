...
-->
``` http
GET /admin/serviceAnnouncement/healthOverviews/{serviceHealthId}
```
...
-->
``` http
GET https://graph.microsoft.com/beta/admin/serviceAnnouncement/healthOverviews/{serviceHealthId}
```

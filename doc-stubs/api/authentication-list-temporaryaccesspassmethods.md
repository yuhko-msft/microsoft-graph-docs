...
-->
``` http
GET /users/{usersId}/authentication/temporaryAccessPassMethods
```
...
-->
``` http
GET https://graph.microsoft.com/beta/users/{usersId}/authentication/temporaryAccessPassMethods
```
  ...
  "value": [
    {
      ...
      "id": "f8e8d453-d453-f8e8-53d4-e8f853d4e8f8",

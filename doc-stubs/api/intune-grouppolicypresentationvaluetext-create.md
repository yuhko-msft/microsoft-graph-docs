...
Create a new [groupPolicyPresentationValueText](../resources/intune-grouppolicypresentationvaluetext.md) object.
...
If successful, this method returns a `201 Created` response code and a [groupPolicyPresentationValueText](../resources/intune-grouppolicypresentationvaluetext.md) object in the response body.

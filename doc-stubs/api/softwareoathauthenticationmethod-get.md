...
-->
``` http
GET /user/authentication/oathMethods/{softwareOathAuthenticationMethodId}
```
...
-->
``` http
GET https://graph.microsoft.com/beta/user/authentication/oathMethods/{softwareOathAuthenticationMethodId}
```

---
title: "workbookFunctions: gamma_Inv"
...
-->
``` http
POST /workbooks/{workbooksId}/workbook/functions/gamma_Inv
```
...
<!-- {
  "blockType": "request",
  "name": "workbookfunctions_gamma_inv"
}
-->
``` http
POST https://graph.microsoft.com/beta/workbooks/{workbooksId}/workbook/functions/gamma_Inv

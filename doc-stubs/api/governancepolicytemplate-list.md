...
description: "Get a list of the governancePolicyTemplate objects and their properties."
...
Get a list of the [governancePolicyTemplate](../resources/governancepolicytemplate.md) objects and their properties.
...
-->
``` http
GET https://graph.microsoft.com/v1.0/approvalWorkflowProviders/{approvalWorkflowProvidersId}/policyTemplates
```
  ...
  "value": [
    {
      ...
      "id": "db8d8f47-8f47-db8d-478f-8ddb478f8ddb",
      "displayName": "String",
      "policy": {

---
title: "deviceManagementReports: getAppStatusOverviewReport"
...
# deviceManagementReports: getAppStatusOverviewReport
...
-->
``` http
POST /deviceManagementReports/getAppStatusOverviewReport
```
...
<!-- {
  "blockType": "request",
  "name": "devicemanagementreports_getappstatusoverviewreport"
}
-->
``` http
POST https://graph.microsoft.com/beta/deviceManagementReports/getAppStatusOverviewReport

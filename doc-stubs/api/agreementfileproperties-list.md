...
-->
``` http
GET ** Collection URI for microsoft.graph.agreementFileProperties not found
```
...
-->
``` http
GET https://graph.microsoft.com/beta** Collection URI for microsoft.graph.agreementFileProperties not found
```
...
<!-- {
  "blockType": "response",
  "truncated": true,
  "@odata.type": "Collection(microsoft.graph.agreementFileProperties)"
}
-->
``` http
HTTP/1.1 200 OK
  ...
  "value": [
    {
      ...
      "id": "8de2e75a-e75a-8de2-5ae7-e28d5ae7e28d",

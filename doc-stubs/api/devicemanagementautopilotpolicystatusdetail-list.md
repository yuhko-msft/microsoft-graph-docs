...
description: "Get a list of the deviceManagementAutopilotPolicyStatusDetail objects and their properties."
...
Get a list of the [deviceManagementAutopilotPolicyStatusDetail](../resources/devicemanagementautopilotpolicystatusdetail.md) objects and their properties.
...
<!-- {
  "blockType": "request",
  "name": "list_devicemanagementautopilotpolicystatusdetail"
}
-->
``` http
GET https://graph.microsoft.com/v1.0/deviceManagement/autopilotEvents/{deviceManagementAutopilotEventId}/policyStatusDetails
```

...
-->
``` http
PATCH /drive/list/subscriptions/{subscriptionId}
PATCH /drives/{drivesId}/list/subscriptions/{subscriptionId}
PATCH /drive/activities/{itemActivityOLDId}/driveItem/subscriptions/{subscriptionId}
PATCH /drives/{drivesId}/activities/{itemActivityOLDId}/driveItem/subscriptions/{subscriptionId}
```
...
-->
``` http
PATCH https://graph.microsoft.com/beta/drive/list/subscriptions/{subscriptionId}

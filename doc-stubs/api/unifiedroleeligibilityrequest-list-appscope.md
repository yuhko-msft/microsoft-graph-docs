...
-->
``` http
GET /rbacApplication/roleEligibilityRequests/{unifiedRoleEligibilityRequestId}/appScope
```
...
-->
``` http
GET https://graph.microsoft.com/beta/rbacApplication/roleEligibilityRequests/{unifiedRoleEligibilityRequestId}/appScope
```
...
<!-- {
  "blockType": "response",
  "truncated": true,
  "@odata.type": "Collection(Microsoft.Identity.Governance.Common.Data.ExternalModels.V1.appScope)"
}
-->
``` http
HTTP/1.1 200 OK

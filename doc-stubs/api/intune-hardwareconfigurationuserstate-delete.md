...
description: "Deletes a hardwareConfigurationUserState object."
...
Deletes a [hardwareConfigurationUserState](../resources/intune-hardwareconfigurationuserstate.md) object.
...
<!-- {
  "blockType": "request",
  "name": "delete_hardwareconfigurationuserstate"
}
-->
``` http

...
-->
``` http
GET /drives/{drivesId}/activities/{itemActivityOLDId}/driveItem/listItem/driveItem
```
...
-->
``` http
GET https://graph.microsoft.com/beta/drives/{drivesId}/activities/{itemActivityOLDId}/driveItem/listItem/driveItem
```

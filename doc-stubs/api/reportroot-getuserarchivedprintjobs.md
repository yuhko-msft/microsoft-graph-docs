...
-->
``` http
GET https://graph.microsoft.com/beta/print/reports/getUserArchivedPrintJobs(userId='parameterValue',periodStart=String (timestamp),periodEnd=String (timestamp))
```

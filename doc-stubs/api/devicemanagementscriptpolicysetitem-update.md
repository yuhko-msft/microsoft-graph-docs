...
The following table shows the properties that are required when you update the [deviceManagementScriptPolicySetItem](../resources/devicemanagementscriptpolicysetitem.md).
...
{
  "@odata.type": "#microsoft.graph.deviceManagementScriptPolicySetItem",
  "id": "63777493-7493-6377-9374-776393747763",

...
description: "Deletes a deviceComplianceActionItem object."
...
Deletes a [deviceComplianceActionItem](../resources/devicecomplianceactionitem.md) object.
...
<!-- {
  "blockType": "request",
  "name": "delete_devicecomplianceactionitem"
}
-->
``` http

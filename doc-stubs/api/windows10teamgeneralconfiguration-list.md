---
title: "List windows10TeamGeneralConfiguration"
description: "Get a list of the windows10TeamGeneralConfiguration objects and their properties."
...
# List windows10TeamGeneralConfiguration
Namespace: microsoft.graph

[!INCLUDE [beta-disclaimer](../../includes/beta-disclaimer.md)]

Get a list of the [windows10TeamGeneralConfiguration](../resources/windows10teamgeneralconfiguration.md) objects and their properties.
...
<!-- {
  "blockType": "request",
  "name": "list_windows10teamgeneralconfiguration"
}
-->
``` http
GET https://graph.microsoft.com/beta** Collection URI for microsoft.graph.windows10TeamGeneralConfiguration not found
```

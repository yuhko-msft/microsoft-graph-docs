---
title: "windowsPhone81CustomConfiguration: assign"
...
# windowsPhone81CustomConfiguration: assign
...
-->
``` http
POST https://graph.microsoft.com/beta** Entity URI for microsoft.graph.windowsPhone81CustomConfiguration not found/assign

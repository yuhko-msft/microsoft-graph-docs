...
description: "Get a list of the lookupResultRow objects and their properties."
...
Get a list of the [lookupResultRow](../resources/lookupresultrow.md) objects and their properties.
...
-->
``` http
GET /exactMatchLookupJob/matchingRows
```
...
<!-- {
  "blockType": "request",
  "name": "list_lookupresultrow"
}
-->
``` http
GET https://graph.microsoft.com/v1.0/exactMatchLookupJob/matchingRows
```

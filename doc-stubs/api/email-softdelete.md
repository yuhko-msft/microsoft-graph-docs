...
-->
``` http
POST /security/emailEvent/emails/{emailId}/softDelete
```
...
<!-- {
  "blockType": "request",
  "name": "email_softdelete"
}
-->
``` http
POST https://graph.microsoft.com/beta/security/emailEvent/emails/{emailId}/softDelete

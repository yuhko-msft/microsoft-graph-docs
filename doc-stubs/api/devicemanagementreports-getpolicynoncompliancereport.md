---
title: "deviceManagementReports: getPolicyNonComplianceReport"
...
# deviceManagementReports: getPolicyNonComplianceReport
...
<!-- {
  "blockType": "request",
  "name": "devicemanagementreports_getpolicynoncompliancereport"
}
-->
``` http

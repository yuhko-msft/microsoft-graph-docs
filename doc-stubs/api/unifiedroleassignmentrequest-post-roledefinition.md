...
-->
``` http
POST /rbacApplication/roleAssignmentRequests/{unifiedRoleAssignmentRequestId}/roleDefinition/$ref
```
...
-->
``` http
POST https://graph.microsoft.com/beta/rbacApplication/roleAssignmentRequests/{unifiedRoleAssignmentRequestId}/roleDefinition/$ref

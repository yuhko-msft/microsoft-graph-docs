---
title: "directoryRole: getMemberGroups"
...
-->
``` http
POST /directoryRoles/{directoryRolesId}/getMemberGroups
```
...
-->
``` http
POST https://graph.microsoft.com/beta/directoryRoles/{directoryRolesId}/getMemberGroups

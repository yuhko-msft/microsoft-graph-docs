...
description: "Get the meetingRegistrant resources from the registrants navigation property."
...
Get the meetingRegistrant resources from the registrants navigation property.
...
-->
``` http
GET https://graph.microsoft.com/beta/users/{usersId}/onlineMeetings/{onlineMeetingId}/registration/registrants
```

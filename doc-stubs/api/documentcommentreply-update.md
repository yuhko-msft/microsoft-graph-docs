...
-->
``` http
PATCH /presentation/comments/{documentCommentId}/replies/{documentCommentReplyId}
```
...
-->
``` http
PATCH https://graph.microsoft.com/beta/presentation/comments/{documentCommentId}/replies/{documentCommentReplyId}

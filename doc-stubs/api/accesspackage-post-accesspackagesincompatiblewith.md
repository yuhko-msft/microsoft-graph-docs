...
-->
``` http
POST /accessPackages/{accessPackagesId}/accessPackagesIncompatibleWith/$ref
```
...
-->
``` http
POST https://graph.microsoft.com/beta/accessPackages/{accessPackagesId}/accessPackagesIncompatibleWith/$ref

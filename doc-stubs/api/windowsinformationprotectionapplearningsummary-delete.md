...
description: "Deletes a windowsInformationProtectionAppLearningSummary object."
...
Deletes a [windowsInformationProtectionAppLearningSummary](../resources/windowsinformationprotectionapplearningsummary.md) object.
...
<!-- {
  "blockType": "request",
  "name": "delete_windowsinformationprotectionapplearningsummary"
}
-->
``` http

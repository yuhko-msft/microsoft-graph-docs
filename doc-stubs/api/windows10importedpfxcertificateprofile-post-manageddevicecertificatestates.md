---
title: "Add managedDeviceCertificateStates"
...
# Add managedDeviceCertificateStates
...
If successful, this method returns a `204 No Content` response code and a [managedDeviceCertificateState](../resources/intune-manageddevicecertificatestate.md) object in the response body.

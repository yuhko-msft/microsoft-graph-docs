...
-->
``` http
GET ** Entity URI for BadUnresolvedEntityType:microsoft.graph.entity not found
```
...
-->
``` http
GET https://graph.microsoft.com/beta** Entity URI for BadUnresolvedEntityType:microsoft.graph.entity not found
```

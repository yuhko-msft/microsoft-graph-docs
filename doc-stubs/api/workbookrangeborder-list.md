...
description: "Get a list of the workbookRangeBorder objects and their properties."
...
Get a list of the [workbookRangeBorder](../resources/workbookrangeborder.md) objects and their properties.
...
-->
``` http
GET /workbookRange/format/borders
```
...
<!-- {
  "blockType": "request",
  "name": "list_workbookrangeborder"
}
-->
``` http
GET https://graph.microsoft.com/beta/workbookRange/format/borders
```

...
-->
``` http
GET ** Collection URI for Microsoft.IdentityProtectionServices.ipNamedLocation not found
```
...
<!-- {
  "blockType": "request",
  "name": "list_ipnamedlocation"
}
-->
``` http
GET https://graph.microsoft.com/beta** Collection URI for Microsoft.IdentityProtectionServices.ipNamedLocation not found
```
...
<!-- {
  "blockType": "response",
  "truncated": true,
  "@odata.type": "Collection(Microsoft.IdentityProtectionServices.ipNamedLocation)"
}
-->
``` http
HTTP/1.1 200 OK

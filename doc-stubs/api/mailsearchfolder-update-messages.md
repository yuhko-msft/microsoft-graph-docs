...
-->
``` http
PATCH /users/{usersId}/mailFolders/{mailFolderId}/messages
```
...
-->
``` http
PATCH https://graph.microsoft.com/beta/users/{usersId}/mailFolders/{mailFolderId}/messages
...
{
  "@odata.type": "#microsoft.graph.message",
  "id": "57653be0-3be0-5765-e03b-6557e03b6557",

---
title: "workbookFunctions: intRate"
...
-->
``` http
POST /workbooks/{workbooksId}/workbook/functions/intRate
```
...
<!-- {
  "blockType": "request",
  "name": "workbookfunctions_intrate"
}
-->
``` http
POST https://graph.microsoft.com/beta/workbooks/{workbooksId}/workbook/functions/intRate

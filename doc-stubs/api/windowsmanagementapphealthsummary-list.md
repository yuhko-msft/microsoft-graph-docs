...
-->
``` http
GET ** Collection URI for microsoft.management.services.api.windowsManagementAppHealthSummary not found
```
...
-->
``` http
GET https://graph.microsoft.com/beta** Collection URI for microsoft.management.services.api.windowsManagementAppHealthSummary not found
```
...
<!-- {
  "blockType": "response",
  "truncated": true,
  "@odata.type": "Collection(microsoft.management.services.api.windowsManagementAppHealthSummary)"
}
-->
``` http
HTTP/1.1 200 OK
  ...
  "value": [
    {
      ...
      "id": "a2eabc30-bc30-a2ea-30bc-eaa230bceaa2",

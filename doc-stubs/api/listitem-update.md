...
The following table shows the properties that are required when you update the [listItem](../resources/listitem.md).
...
-->
``` http
PATCH https://graph.microsoft.com/v1.0/shares/{sharesId}/listItem

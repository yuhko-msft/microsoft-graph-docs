...
Update the properties of a [microsoftTunnelConfiguration](../resources/intune-microsofttunnelconfiguration.md) object.
...
The following table shows the properties that are required when you update the [microsoftTunnelConfiguration](../resources/intune-microsofttunnelconfiguration.md).
...
If successful, this method returns a `200 OK` response code and an updated [microsoftTunnelConfiguration](../resources/intune-microsofttunnelconfiguration.md) object in the response body.

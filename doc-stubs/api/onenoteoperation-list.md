...
description: "Get a list of the onenoteOperation objects and their properties."
...
Get a list of the [onenoteOperation](../resources/onenoteoperation.md) objects and their properties.
...
-->
``` http
GET https://graph.microsoft.com/beta/me/onenote/operations
```

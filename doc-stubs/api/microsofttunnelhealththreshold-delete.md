...
description: "Deletes a microsoftTunnelHealthThreshold object."
...
Deletes a [microsoftTunnelHealthThreshold](../resources/microsofttunnelhealththreshold.md) object.
...
<!-- {
  "blockType": "request",
  "name": "delete_microsofttunnelhealththreshold"
}
-->
``` http

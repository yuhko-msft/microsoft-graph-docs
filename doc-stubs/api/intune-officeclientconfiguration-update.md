...
Update the properties of an [officeClientConfiguration](../resources/intune-officeclientconfiguration.md) object.
...
## Request body
In the request body, supply a JSON representation of the [officeClientConfiguration](../resources/intune-officeclientconfiguration.md) object.

The following table shows the properties that are required when you update the [officeClientConfiguration](../resources/intune-officeclientconfiguration.md).
...
If successful, this method returns a `200 OK` response code and an updated [officeClientConfiguration](../resources/intune-officeclientconfiguration.md) object in the response body.

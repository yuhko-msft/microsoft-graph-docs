...
-->
``` http
POST /entitlementManagement/catalogs/{accessPackageCatalogId}/accessPackages/{accessPackageId}/catalog/$ref
```
...
-->
``` http
POST https://graph.microsoft.com/v1.0/entitlementManagement/catalogs/{accessPackageCatalogId}/accessPackages/{accessPackageId}/catalog/$ref

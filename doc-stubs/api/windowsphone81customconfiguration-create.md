...
-->
``` http
POST https://graph.microsoft.com/beta** Collection URI for microsoft.graph.windowsPhone81CustomConfiguration not found
...
{
  "@odata.type": "#microsoft.graph.windowsPhone81CustomConfiguration",
  "id": "f441bfe7-bfe7-f441-e7bf-41f4e7bf41f4",

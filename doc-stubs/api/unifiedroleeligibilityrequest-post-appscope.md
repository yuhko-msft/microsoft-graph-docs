...
-->
``` http
POST /rbacApplication/roleEligibilityRequests/{unifiedRoleEligibilityRequestId}/appScope/$ref
```
...
-->
``` http
POST https://graph.microsoft.com/beta/rbacApplication/roleEligibilityRequests/{unifiedRoleEligibilityRequestId}/appScope/$ref

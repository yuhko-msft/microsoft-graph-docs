...
-->
``` http
POST /users/{usersId}/profile/awards
```
...
The following table shows the properties that are required when you create the [personAward](../resources/personaward.md).
...
-->
``` http
POST https://graph.microsoft.com/beta/users/{usersId}/profile/awards

...
# iosLobAppProvisioningConfiguration: hasPayloadLinks
...
-->
``` http
POST https://graph.microsoft.com/v1.0/deviceAppManagement/iosLobAppProvisioningConfigurations/hasPayloadLinks

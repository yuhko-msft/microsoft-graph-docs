...
-->
``` http
GET /unifiedRoleAssignmentScheduleInstance/activatedUsing/appScope
```
...
-->
``` http
GET https://graph.microsoft.com/beta/unifiedRoleAssignmentScheduleInstance/activatedUsing/appScope
```

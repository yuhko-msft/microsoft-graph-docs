---
title: "sharedPCConfiguration: assign"
...
-->
``` http
POST ** Entity URI for microsoft.graph.sharedPCConfiguration not found/assign
```
...
<!-- {
  "blockType": "request",
  "name": "sharedpcconfiguration_assign"
}
-->
``` http
POST https://graph.microsoft.com/beta** Entity URI for microsoft.graph.sharedPCConfiguration not found/assign

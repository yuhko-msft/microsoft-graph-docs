...
description: "Get the printUsageByUser resources from the monthlyPrintUsageByUser navigation property."
...
Get the printUsageByUser resources from the monthlyPrintUsageByUser navigation property.
...
-->
``` http
GET https://graph.microsoft.com/beta/reports/monthlyPrintUsageByUser
```
  ...
  "value": [
    {
      ...
      "id": "206f259c-259c-206f-9c25-6f209c256f20",

...
description: "Add rebootAnalyticsMetrics by posting to the rebootAnalyticsMetrics collection."
...
Add rebootAnalyticsMetrics by posting to the rebootAnalyticsMetrics collection.
...
-->
``` http
POST /deviceManagement/userExperienceAnalyticsBaselines/{userExperienceAnalyticsBaselineId}/rebootAnalyticsMetrics/$ref
```
...
-->
``` http
POST https://graph.microsoft.com/v1.0/deviceManagement/userExperienceAnalyticsBaselines/{userExperienceAnalyticsBaselineId}/rebootAnalyticsMetrics/$ref

...
-->
``` http
POST /users/{usersId}/informationProtection/sensitivityLabels/{sensitivityLabelId}/sublabels
```
...
-->
``` http
POST https://graph.microsoft.com/v1.0/users/{usersId}/informationProtection/sensitivityLabels/{sensitivityLabelId}/sublabels

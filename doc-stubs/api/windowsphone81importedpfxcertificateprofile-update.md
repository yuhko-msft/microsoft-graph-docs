...
The following table shows the properties that are required when you create the [windowsPhone81ImportedPFXCertificateProfile](../resources/windowsphone81importedpfxcertificateprofile.md).
...
-->
``` http
PATCH https://graph.microsoft.com/beta** Entity URI for microsoft.graph.windowsPhone81ImportedPFXCertificateProfile not found
...
{
  "@odata.type": "#microsoft.graph.windowsPhone81ImportedPFXCertificateProfile",
  "id": "f7db2dcd-2dcd-f7db-cd2d-dbf7cd2ddbf7",

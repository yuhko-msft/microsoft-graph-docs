...
Create a new [androidEnterpriseWiFiConfiguration](../resources/intune-androidenterprisewificonfiguration.md) object.
...
The following table shows the properties that are required when you create the [androidEnterpriseWiFiConfiguration](../resources/intune-androidenterprisewificonfiguration.md).
...
If successful, this method returns a `201 Created` response code and an [androidEnterpriseWiFiConfiguration](../resources/intune-androidenterprisewificonfiguration.md) object in the response body.
...
-->
``` http
POST https://graph.microsoft.com/beta** Collection URI for microsoft.graph.androidEnterpriseWiFiConfiguration not found

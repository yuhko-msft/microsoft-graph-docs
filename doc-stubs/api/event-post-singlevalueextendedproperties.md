...
-->
``` http
POST /users/{usersId}/calendar/calendarView/{eventId}/singleValueExtendedProperties
```
...
-->
``` http
POST https://graph.microsoft.com/beta/users/{usersId}/calendar/calendarView/{eventId}/singleValueExtendedProperties

...
-->
``` http
POST /user/tasks/lists/{wellKnownTaskListId}/tasks/{taskId}/parentList/extensions
```
...
-->
``` http
POST https://graph.microsoft.com/beta/user/tasks/lists/{wellKnownTaskListId}/tasks/{taskId}/parentList/extensions

---
title: "androidWorkProfileCompliancePolicy: assign"
...
# androidWorkProfileCompliancePolicy: assign
...
-->
``` http
POST https://graph.microsoft.com/beta** Entity URI for microsoft.graph.androidWorkProfileCompliancePolicy not found/assign

...
description: "Get a list of the workbookTableSort objects and their properties."
...
Get a list of the [workbookTableSort](../resources/workbooktablesort.md) objects and their properties.
...
-->
``` http
GET https://graph.microsoft.com/beta** Collection URI for microsoft.graph.workbookTableSort not found
```
  ...
  "value": [
    {
      ...
      "id": "402ee919-e919-402e-19e9-2e4019e92e40",
      "fields": [
        {

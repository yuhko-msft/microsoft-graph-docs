...
description: "Update the properties of an itemEmail object."
...
Update the properties of an [itemEmail](../resources/itememail.md) object.
...
PATCH /users/{usersId}/profile/emails/{itemEmailId}
```
...
The following table shows the properties that are required when you update the [itemEmail](../resources/itememail.md).
...
-->
``` http
PATCH https://graph.microsoft.com/v1.0/me/profile/emails/{itemEmailId}

...
-->
``` http
GET /me/calendar/calendarPermissions/{calendarPermissionId}
GET /users/{usersId}/calendar/calendarPermissions/{calendarPermissionId}
```
...
-->
``` http
GET https://graph.microsoft.com/beta/me/calendar/calendarPermissions/{calendarPermissionId}
```

...
description: "Get the educationAssignmentDefaults resources from the assignmentDefaults navigation property."
...
Get the educationAssignmentDefaults resources from the assignmentDefaults navigation property.
...
-->
``` http
GET /educationClass/assignmentDefaults
```
...
<!-- {
  "blockType": "response",
  "truncated": true,
  "@odata.type": "Collection(microsoft.education.assignments.api.educationAssignmentDefaults)"
}
-->
``` http
HTTP/1.1 200 OK

...
description: "Get the channel resources from the incomingChannels navigation property."
...
Get the channel resources from the incomingChannels navigation property.
...
-->
``` http
GET https://graph.microsoft.com/beta/teams/{teamsId}/incomingChannels
```

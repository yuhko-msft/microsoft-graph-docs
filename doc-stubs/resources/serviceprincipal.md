...
|[List policies](../api/serviceprincipal-list-policies.md)|[directoryObject](../resources/directoryobject.md) collection|Get the directoryObject resources from the policies navigation property.|
|[Add policies](../api/serviceprincipal-post-policies.md)|[directoryObject](../resources/directoryobject.md)|Add policies by posting to the policies collection.|
|[Remove policies](../api/serviceprincipal-delete-policies.md)|None|Remove a [directoryObject](../resources/directoryobject.md) object.|

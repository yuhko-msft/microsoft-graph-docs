...
|[List federatedIdentityCredentials](../api/serviceprincipal-list-federatedidentitycredentials.md)|[federatedIdentityCredential](../resources/federatedidentitycredential.md) collection|Get the federatedIdentityCredential resources from the federatedIdentityCredentials navigation property.|
|[Create federatedIdentityCredential](../api/serviceprincipal-post-federatedidentitycredentials.md)|[federatedIdentityCredential](../resources/federatedidentitycredential.md)|Create a new federatedIdentityCredential object.|

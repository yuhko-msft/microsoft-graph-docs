...
|[Create teamworkTag](../api/team-post-tags.md)|[teamworkTag](../resources/teamworktag.md)|Create a new [teamworkTag](../resources/teamworktag.md) object.|
...
|tagType|teamworkTagType|**TODO: Add Description**. The possible values are: `standard`.|

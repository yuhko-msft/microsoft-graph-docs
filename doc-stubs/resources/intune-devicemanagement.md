...
|[userExperienceAnalyticsSummarizeWorkFromAnywhereDevices](../api/intune-devicemanagement-userexperienceanalyticssummarizeworkfromanywheredevices.md)|[userExperienceAnalyticsWorkFromAnywhereDevicesSummary](../resources/intune-userexperienceanalyticsworkfromanywheredevicessummary.md)|**TODO: Add Description**|
|[List userExperienceAnalyticsNotAutopilotReadyDevice](../api/intune-devicemanagement-list-userexperienceanalyticsnotautopilotreadydevice.md)|[userExperienceAnalyticsNotAutopilotReadyDevice](../resources/intune-userexperienceanalyticsnotautopilotreadydevice.md) collection|Get the userExperienceAnalyticsNotAutopilotReadyDevice resources from the userExperienceAnalyticsNotAutopilotReadyDevice navigation property.|
|[Create userExperienceAnalyticsNotAutopilotReadyDevice](../api/intune-devicemanagement-post-userexperienceanalyticsnotautopilotreadydevice.md)|[userExperienceAnalyticsNotAutopilotReadyDevice](../resources/intune-userexperienceanalyticsnotautopilotreadydevice.md)|Create a new userExperienceAnalyticsNotAutopilotReadyDevice object.|

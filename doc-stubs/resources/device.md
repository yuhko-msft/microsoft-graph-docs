...
|[List commands](../api/device-list-commands.md)|[command](../resources/command.md) collection|Get the command resources from the commands navigation property.|
|[Create command](../api/device-post-commands.md)|[command](../resources/command.md)|Create a new command object.|
|[List extensions](../api/device-list-extensions.md)|[extension](../resources/extension.md) collection|Get the extension resources from the extensions navigation property.|
|[Create extension](../api/device-post-extensions.md)|[extension](../resources/extension.md)|Create a new extension object.|

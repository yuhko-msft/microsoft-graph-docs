...
|:---|:---|:---|
|[List users](../api/intune-manageddevice-list-users.md)|[user](../resources/user.md) collection|Get the user resources from the users navigation property.|
|[Create users](../api/intune-manageddevice-post-users.md)|[user](../resources/user.md)|Create a new user object.|
|[Update users](../api/intune-manageddevice-update-users.md)|[user](../resources/user.md)|Update the properties of a users object.|
|[Get users](../api/intune-manageddevice-get-user.md)|[user](../resources/user.md)|Read the properties and relationships of a [user](../resources/user.md) object.|
|[Delete users](../api/intune-manageddevice-delete-users.md)|None|Delete a [user](../resources/user.md) object.|

...
|[List tasks](../api/user-list-tasks.md)|[tasks](../resources/tasks.md) collection|Get the tasks resources from the tasks navigation property.|
|[Create tasks](../api/user-post-tasks.md)|[tasks](../resources/tasks.md)|Create a new tasks object.|

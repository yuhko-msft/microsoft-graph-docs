...
|[Create usageRights](../api/user-post-usagerights.md)|[UsageRight](../resources/usageright.md)|Create a new UsageRight object.|
|[Get usageRights](../api/user-get-usageright.md)|[UsageRight](../resources/usageright.md)|Read the properties and relationships of an [UsageRight](../resources/usageright.md) object.|
|[Update usageRights](../api/user-update-usagerights.md)|[UsageRight](../resources/usageright.md)|Update the properties of an usageRights object.|
|[Delete usageRights](../api/user-delete-usagerights.md)|None|Delete an [UsageRight](../resources/usageright.md) object.|

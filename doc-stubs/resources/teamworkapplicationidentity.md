...
|:---|:---|:---|
|applicationIdentityType|teamworkApplicationIdentityType|**TODO: Add Description**. Possible values are: `aadApplication`, `bot`, `tenantBot`, `office365Connector`, `outgoingWebhook`, `unknownFutureValue`.|

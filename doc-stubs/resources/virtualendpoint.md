...
|[List azureConnections](../api/virtualendpoint-list-azureconnections.md)|[AzureConnection](../resources/azureconnection.md) collection|Get the AzureConnection resources from the azureConnections navigation property.|
|[Create azureConnections](../api/virtualendpoint-post-azureconnections.md)|[AzureConnection](../resources/azureconnection.md)|Create a new AzureConnection object.|
|[Get azureConnections](../api/virtualendpoint-get-azureconnection.md)|[AzureConnection](../resources/azureconnection.md)|Read the properties and relationships of an [AzureConnection](../resources/azureconnection.md) object.|
|[Update azureConnections](../api/virtualendpoint-update-azureconnections.md)|[AzureConnection](../resources/azureconnection.md)|Update the properties of an azureConnections object.|
|[Delete azureConnections](../api/virtualendpoint-delete-azureconnections.md)|None|Delete an [AzureConnection](../resources/azureconnection.md) object.|
|[List cloudPcDeviceImages](../api/virtualendpoint-list-cloudpcdeviceimages.md)|[cloudPcDeviceImage](../resources/cloudpcdeviceimage.md) collection|Get the cloudPcDeviceImage resources from the cloudPcDeviceImages navigation property.|
|[Create cloudPcDeviceImages](../api/virtualendpoint-post-cloudpcdeviceimages.md)|[cloudPcDeviceImage](../resources/cloudpcdeviceimage.md)|Create a new cloudPcDeviceImage object.|
...
|[Update cloudPcDeviceImages](../api/virtualendpoint-update-cloudpcdeviceimages.md)|[cloudPcDeviceImage](../resources/cloudpcdeviceimage.md)|Update the properties of a cloudPcDeviceImages object.|
|[Delete cloudPcDeviceImages](../api/virtualendpoint-delete-cloudpcdeviceimages.md)|None|Delete a [cloudPcDeviceImage](../resources/cloudpcdeviceimage.md) object.|
...
|[List selfServiceSettings](../api/virtualendpoint-list-selfservicesettings.md)|[cloupdPcSelfServiceSettings](../resources/cloupdpcselfservicesettings.md) collection|Get the cloupdPcSelfServiceSettings resources from the selfServiceSettings navigation property.|
|[Create selfServiceSettings](../api/virtualendpoint-post-selfservicesettings.md)|[cloupdPcSelfServiceSettings](../resources/cloupdpcselfservicesettings.md)|Create a new cloupdPcSelfServiceSettings object.|
|[Get selfServiceSettings](../api/virtualendpoint-get-cloupdpcselfservicesettings.md)|[cloupdPcSelfServiceSettings](../resources/cloupdpcselfservicesettings.md)|Read the properties and relationships of a [cloupdPcSelfServiceSettings](../resources/cloupdpcselfservicesettings.md) object.|
|[Update selfServiceSettings](../api/virtualendpoint-update-selfservicesettings.md)|[cloupdPcSelfServiceSettings](../resources/cloupdpcselfservicesettings.md)|Update the properties of a selfServiceSettings object.|
|[Delete selfServiceSettings](../api/virtualendpoint-delete-selfservicesettings.md)|None|Delete a [cloupdPcSelfServiceSettings](../resources/cloupdpcselfservicesettings.md) object.|
|[List workspaces](../api/virtualendpoint-list-workspaces.md)|[WorkspaceResponseModel](../resources/workspaceresponsemodel.md) collection|Get the WorkspaceResponseModel resources from the workspaces navigation property.|
|[Create workspaces](../api/virtualendpoint-post-workspaces.md)|[WorkspaceResponseModel](../resources/workspaceresponsemodel.md)|Create a new WorkspaceResponseModel object.|
|[Get workspaces](../api/virtualendpoint-get-workspaceresponsemodel.md)|[WorkspaceResponseModel](../resources/workspaceresponsemodel.md)|Read the properties and relationships of a [WorkspaceResponseModel](../resources/workspaceresponsemodel.md) object.|
|[Update workspaces](../api/virtualendpoint-update-workspaces.md)|[WorkspaceResponseModel](../resources/workspaceresponsemodel.md)|Update the properties of a workspaces object.|
|[Delete workspaces](../api/virtualendpoint-delete-workspaces.md)|None|Delete a [WorkspaceResponseModel](../resources/workspaceresponsemodel.md) object.|

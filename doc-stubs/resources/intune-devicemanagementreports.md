...
|[getCompliancePoliciesReportForDevice](../api/intune-devicemanagementreports-getcompliancepoliciesreportfordevice.md)|Stream|**TODO: Add Description**|
|[getCompliancePolicyDevicesReport](../api/intune-devicemanagementreports-getcompliancepolicydevicesreport.md)|Stream|**TODO: Add Description**|
|[getCompliancePolicyDeviceSummaryReport](../api/intune-devicemanagementreports-getcompliancepolicydevicesummaryreport.md)|Stream|**TODO: Add Description**|
|[getRemoteAssistanceSessionsReport](../api/intune-devicemanagementreports-getremoteassistancesessionsreport.md)|Stream|**TODO: Add Description**|
|[getRemoteAssistanceMonitorActiveSessionsReport](../api/intune-devicemanagementreports-getremoteassistancemonitoractivesessionsreport.md)|Stream|**TODO: Add Description**|
|[getRemoteAssistanceMonitorTotalSessionsReport](../api/intune-devicemanagementreports-getremoteassistancemonitortotalsessionsreport.md)|Stream|**TODO: Add Description**|
|[getRemoteAssistanceMonitorAvgSessionTimeReport](../api/intune-devicemanagementreports-getremoteassistancemonitoravgsessiontimereport.md)|Stream|**TODO: Add Description**|
|[getDeviceManagementIntentPerSettingContributingProfiles](../api/intune-devicemanagementreports-getdevicemanagementintentpersettingcontributingprofiles.md)|Stream|**TODO: Add Description**|

...
|[List settings](../api/group-list-settings.md)|[groupSetting](../resources/groupsetting.md) collection|Get the groupSetting resources from the settings navigation property.|
|[Create groupSetting](../api/group-post-settings.md)|[groupSetting](../resources/groupsetting.md)|Create a new groupSetting object.|

...
|connectivityDownloadingOfPrintDriversOverHttp|enablement|**TODO: Add Description**. Possible values are: `notConfigured`, `enabled`, `disabled`.|
|connectivityHardenedUncPaths|[hardenedUncPathBase](../resources/intune-hardeneduncpathbase.md)|**TODO: Add Description**|
|connectivityInternetDownloadForWebPublishingAndOnlineOrderingWizards|enablement|**TODO: Add Description**. Possible values are: `notConfigured`, `enabled`, `disabled`.|
|connectivityPrintingOverHttp|enablement|**TODO: Add Description**. Possible values are: `notConfigured`, `enabled`, `disabled`.|
...
|defenderSignatureUpdateFallbackOrder|updateSources collection|**TODO: Add Description**|
...
|eventLogServiceApplicationLogMaximumFileSizeInKb|Int64|**TODO: Add Description**|
|eventLogServiceSecurityLogMaximumFileSizeInKb|Int64|**TODO: Add Description**|
|eventLogServiceSystemLogMaximumFileSizeInKb|Int64|**TODO: Add Description**|
...
|networkIpSourceRoutingProtectionLevel|ipSourceRoutingProtectionLevel|**TODO: Add Description**. Possible values are: `notConfigured`, `disabled`, `noAdditionalProtection`, `mediumProtection`, `highestProtection`.|
|networkIpV6SourceRoutingProtectionLevel|ipSourceRoutingProtectionLevel|**TODO: Add Description**. Possible values are: `notConfigured`, `disabled`, `noAdditionalProtection`, `mediumProtection`, `highestProtection`.|
|passwordPinLogOn|enablement|**TODO: Add Description**. Possible values are: `notConfigured`, `enabled`, `disabled`.|
...
|remoteDesktopServicesDriveRedirection|enablement|**TODO: Add Description**. Possible values are: `notConfigured`, `enabled`, `disabled`.|
|remoteDesktopServicesPasswordSaving|enablement|**TODO: Add Description**. Possible values are: `notConfigured`, `enabled`, `disabled`.|
|remoteDesktopServicesPromptForPasswordUponConnection|enablement|**TODO: Add Description**. Possible values are: `notConfigured`, `enabled`, `disabled`.|
|remoteDesktopServicesSecureRpcCommunication|enablement|**TODO: Add Description**. Possible values are: `notConfigured`, `enabled`, `disabled`.|
...
|remoteManagementClientBasicAuthentication|enablement|**TODO: Add Description**. Possible values are: `notConfigured`, `enabled`, `disabled`.|
|remoteManagementClientDigestAuthentication|enablement|**TODO: Add Description**. Possible values are: `notConfigured`, `enabled`, `disabled`.|
|remoteManagementClientUnencryptedTraffic|enablement|**TODO: Add Description**. Possible values are: `notConfigured`, `enabled`, `disabled`.|
|remoteManagementServiceBasicAuthentication|enablement|**TODO: Add Description**. Possible values are: `notConfigured`, `enabled`, `disabled`.|
|remoteManagementServiceStoringRunAsCredentials|enablement|**TODO: Add Description**. Possible values are: `notConfigured`, `enabled`, `disabled`.|
|remoteManagementServiceUnencryptedTraffic|enablement|**TODO: Add Description**. Possible values are: `notConfigured`, `enabled`, `disabled`.|
|roleScopeTagIds|String collection|**TODO: Add Description** Inherited from [deviceConfiguration](../resources/intune-deviceconfiguration.md)|
|rpcUnauthenticatedClientOptions|rpcUnauthenticatedClientOptions|**TODO: Add Description**. Possible values are: `notConfigured`, `disable`, `none`, `authenticated`, `authenticatedWithoutExceptions`.|
...
|windowsConnectionManagerConnectionToNonDomainNetworks|enablement|**TODO: Add Description**. Possible values are: `notConfigured`, `enabled`, `disabled`.|
...
|windowsLogOnSignInLastInteractiveUserAfterSystemInitiatedRestart|enablement|**TODO: Add Description**. Possible values are: `notConfigured`, `enabled`, `disabled`.|

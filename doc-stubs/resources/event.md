...
|[List exceptionOccurrences](../api/event-list-exceptionoccurrences.md)|[event](../resources/event.md) collection|Get the events from the exceptionOccurrences navigation property.|
|[Create exceptionOccurrences](../api/event-post-exceptionoccurrences.md)|[event](../resources/event.md)|Create a new exceptionOccurrences object.|
|[Get exceptionOccurrences](../api/event-get-event.md)|[event](../resources/event.md)|Read the properties and relationships of an [event](../resources/event.md) object.|
|[Update exceptionOccurrences](../api/event-update-exceptionoccurrences.md)|[event](../resources/event.md)|Update the properties of an exceptionOccurrences object.|
|[Delete exceptionOccurrences](../api/event-delete-exceptionoccurrences.md)|None|Delete an [event](../resources/event.md) object.|

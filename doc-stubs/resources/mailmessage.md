...
description: "MailMessage resource in this context indicates a full 360 degree view of an email including email properties, threat and detection information coming from MDO, and reference to underlying Entities."
...
MailMessage resource in this context indicates a full 360 degree view of an email including email properties, threat and detection information coming from MDO, and reference to underlying Entities.
...
|attachments|[securityEmailAttachments](../resources/securityemailattachments.md) collection|Collection of the Attachments in the Email.|
|bulkComplaintLevel|Int32|Bulk complaint level (BCL), The bulk complaint level (BCL) of the message. A higher BCL indicates a bulk mail message is more likely to generate complaints (and is therefore more likely to be spam).|
...
|domainCreationDate|DateTimeOffset|Shows the date on which the domain was created.|
...
|emailOverrides|[emailOverrides](../resources/emailoverrides.md)|Name of the ETRs which are part of the email.|
|exchangeTransportRules|String|Name of the ETRs which are part of the email.|
...
|location|String|It is the last detected location of the sending IP address (ipV4) mail server.|
...
|phishConfidenceLevel|confidenceLevel|Indicates the degree of confidence with which the phish threat was identified. Can be Normal or High. The possible values are: `normal`, `high`, `unknownFutureValue`.|
...
|spamConfidenceLevel|confidenceLevel|Indicates the degree of confidence with which the spam threat was identified. Can be Normal or High. The possible values are: `normal`, `high`, `unknownFutureValue`.|
...
|urls|[securityEmailUrls](../resources/securityemailurls.md) collection|Collection of URLs in the email.|

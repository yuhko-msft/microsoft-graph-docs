...
|certificateConnectorDetails|[certificateConnectorDetails](../resources/certificateconnectordetails.md) collection|Collection of certificate connector details, each associated with a corresponding Intune Certificate Connector.|
...
|complianceCategories|[deviceManagementConfigurationCategory](../resources/devicemanagementconfigurationcategory.md) collection|List of all compliance categories|
...
|compliancePolicies|[deviceManagementCompliancePolicy](../resources/devicemanagementcompliancepolicy.md) collection|List of all compliance policies|
|complianceSettings|[deviceManagementConfigurationSettingDefinition](../resources/devicemanagementconfigurationsettingdefinition.md) collection|List of all ComplianceSettings|
...
|operationApprovalPolicies|[operationApprovalPolicy](../resources/operationapprovalpolicy.md) collection|The Operation Approval Policies|
...
|userExperienceAnalyticsBatteryHealthAppImpact|[userExperienceAnalyticsBatteryHealthAppImpact](../resources/userexperienceanalyticsbatteryhealthappimpact.md) collection|User Experience Analytics Battery Health App Impact|
|userExperienceAnalyticsBatteryHealthCapacityDetails|[userExperienceAnalyticsBatteryHealthCapacityDetails](../resources/userexperienceanalyticsbatteryhealthcapacitydetails.md)|User Experience Analytics Battery Health Capacity Details|
|userExperienceAnalyticsBatteryHealthDeviceAppImpact|[userExperienceAnalyticsBatteryHealthDeviceAppImpact](../resources/userexperienceanalyticsbatteryhealthdeviceappimpact.md) collection|User Experience Analytics Battery Health Device App Impact|
|userExperienceAnalyticsBatteryHealthDevicePerformance|[userExperienceAnalyticsBatteryHealthDevicePerformance](../resources/userexperienceanalyticsbatteryhealthdeviceperformance.md) collection|User Experience Analytics Battery Health Device Performance|
|userExperienceAnalyticsBatteryHealthDeviceRuntimeHistory|[userExperienceAnalyticsBatteryHealthDeviceRuntimeHistory](../resources/userexperienceanalyticsbatteryhealthdeviceruntimehistory.md) collection|User Experience Analytics Battery Health Device Runtime History|
|userExperienceAnalyticsBatteryHealthModelPerformance|[userExperienceAnalyticsBatteryHealthModelPerformance](../resources/userexperienceanalyticsbatteryhealthmodelperformance.md) collection|User Experience Analytics Battery Health Model Performance|
|userExperienceAnalyticsBatteryHealthOsPerformance|[userExperienceAnalyticsBatteryHealthOsPerformance](../resources/userexperienceanalyticsbatteryhealthosperformance.md) collection|User Experience Analytics Battery Health Os Performance|
|userExperienceAnalyticsBatteryHealthRuntimeDetails|[userExperienceAnalyticsBatteryHealthRuntimeDetails](../resources/userexperienceanalyticsbatteryhealthruntimedetails.md)|User Experience Analytics Battery Health Runtime Details|

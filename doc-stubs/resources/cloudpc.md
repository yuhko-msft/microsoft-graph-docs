...
|[reboot](../api/cloudpc-reboot.md)|None|**TODO: Add Description**|
|[rename](../api/cloudpc-rename.md)|None|**TODO: Add Description**|
|[troubleshoot](../api/cloudpc-troubleshoot.md)|None|**TODO: Add Description**|
...
|status|cloudPcStatus|**TODO: Add Description**. The possible values are: `notProvisioned`, `provisioning`, `provisioned`, `inGracePeriod`, `deprovisioning`, `failed`, `provisionedWithWarnings`, `resizing`, `unknownFutureValue`.|

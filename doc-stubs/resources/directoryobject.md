...
|:---|:---|:---|
|[List directoryObjects](../api/policy-list-appliesto.md)|[directoryObject](../resources/directoryobject.md) collection|Get the directoryObject resources from the appliesTo navigation property.|
|[Add directoryObject](../api/policy-post-appliesto.md)|[directoryObject](../resources/directoryobject.md)|Add appliesTo by posting to the appliesTo collection.|
|[Remove directoryObject](../api/policy-delete-appliesto.md)|None|Remove a [directoryObject](../resources/directoryobject.md) object.|

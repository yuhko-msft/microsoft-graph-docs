...
|[List accessPackageAssignmentPolicy](../api/accesspackageassignment-list-assignmentpolicy.md)|[accessPackageAssignmentPolicy](../resources/accesspackageassignmentpolicy.md) collection|Get the accessPackageAssignmentPolicy resources from the assignmentPolicy navigation property.|
|[Add accessPackageAssignmentPolicy](../api/accesspackageassignment-post-assignmentpolicy.md)|[accessPackageAssignmentPolicy](../resources/accesspackageassignmentpolicy.md)|Add assignmentPolicy by posting to the assignmentPolicy collection.|
...
|assignmentPolicy|[accessPackageAssignmentPolicy](../resources/accesspackageassignmentpolicy.md)|**TODO: Add Description**|

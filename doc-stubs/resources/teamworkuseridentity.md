...
|userIdentityType|teamworkUserIdentityType|**TODO: Add Description**. The possible values are: `aadUser`, `onPremiseAadUser`, `anonymousGuest`, `federatedUser`, `personalMicrosoftAccountUser`, `skypeUser`, `phoneUser`, `unknownFutureValue`.|

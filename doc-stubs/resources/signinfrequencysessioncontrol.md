...
|:---|:---|:---|
|authenticationType|signInFrequencyAuthenticationType|**TODO: Add Description**. Possible values are: `primaryAndSecondaryAuthentication`, `secondaryAuthentication`, `unknownFutureValue`.|
|frequencyInterval|signInFrequencyInterval|**TODO: Add Description**. Possible values are: `timeBased`, `everyTime`, `unknownFutureValue`.|

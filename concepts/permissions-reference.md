...
|   Permission    |  Display String   |  Description | Admin Consent Required |
|:----------------|:------------------|:-------------|:-----------------------|
| _Alerts.Read.All_ | Read all alerts | Allows the app to read all alerts, without a signed-in user. | Yes | No |
| _Alerts.ReadWrite.All_ | Read and write to all alerts | Allows the app to read and write to all alerts, without a signed-in user. | Yes | No |
...
* _Alerts.Read.All_: Read alerts (`GET /security/m365Alerts`)
* _Alerts.ReadWrite.All_: Read alerts (`GET /security/m365Alerts`)

#### Application

* m365Alerts.Read.All_: Read all alerts (`GET /security/m365Alerts`)
* m365Alerts.ReadWrite.All_: Read all alerts (`GET /security/m365Alerts`)

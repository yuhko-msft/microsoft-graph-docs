...
Devices are automatically registered with the service when added to the members or exclusions collections of a deployment audience (i.e. an Azure AD Device object is automatically created if it does not already exist).
